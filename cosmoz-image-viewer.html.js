...
<div on-mouseenter="_onMouse" on-mouseleave="_onMouse">
	<div class="nav counter" hidden$="[[_hidePageNumber(_showPageNumber, _showInterfaceButtons)]]">
		[[selectedImageNumber]]/[[total]]
	</div>

	<div class="actions layout horizontal center" hidden$="[[!_showInterfaceButtons]]">
