export const
	 ...
	 */
	getBounded = (val, min, max) => Math.max(min, Math.min(max, val)),
	 ...
	 */
	getFitScale = (iw, ih, cw, ch) => cw / ch < iw / ih ? cw / iw : ch / ih,
	 ...
	 * @return {Number}    amount to scale
	 */
	getCoverScale = (iw, ih, cw, ch) => cw / ch > iw / ih ? cw / iw : ch / ih,
