import { f as f$1, j, p, v, r as r$1, h as h$2, m as m$1, w, T, x, a as j$1, i as i$4 } from './directive-helpers-BXW8nDWk.js';
...
const fit = (rect, bounds) => {
  ...
  const options = { credentials: "include"  }, [{ jsPDF }, ...responses$] = await Promise.all([
    import('./jspdf.es.min-BJtMnuek.js').then(function (n) { return n.j; }),
    ...urls.map(async (_url) => {
