import{x as w}from"./iframe-CnOtHJIt.js";import{GlobalWorkerOptions as c}from"./pdf-C4heYEAT.js";import"./cosmoz-image-viewer-CvXwSElo.js";const g=["stories/images/stockholm.jpg","this-is-a-loading-error.jpg",()=>"stories/images/a_size.png",()=>new Promise(e=>setTimeout(()=>e("stories/images/strasbourg.jpg"),500))];c.workerSrc=new URL(""+new URL("pdf.worker.min-FHbmGBN0.mjs",import.meta.url).href,import.meta.url).href;const d={title:"Cosmoz Image Viewer",component:"cosmoz-image-viewer"},r=({showDetach:e,showFullscreen:s,showPageNumber:a,showNav:o,loop:m,showZoom:i,detachedShowZoom:t})=>w`
    <cosmoz-image-viewer
        ?show-detach=${e}
        ?show-fullscreen=${s}
        ?show-page-number=${a}
