...
import{r as yi,D as bt,A as G,b as w,E as U,p as bi,n as bn,M as vn,u as oe,v as Ce,h as Qe,j as wn}from"./iframe-Ba-QTkVn.js";import{_ as rs}from"./preload-helper-PPVm8Dsz.js";let it,vi=0;function ys(t){it=t}function bs(){it=null,vi=0}function xn(){return vi++}const It=Symbol("haunted.phase"),et=Symbol("haunted.hook"),vs=Symbol("haunted.update"),ws=Symbol("haunted.commit"),ue=Symbol("haunted.effects"),Le=Symbol("haunted.layoutEffects"),Kt="haunted.context";class Sn{update;host;virtual;[et];[ue];[Le];constructor(e,s){this.update=e,this.host=s,this[et]=new Map,this[ue]=[],this[Le]=[]}run(e){ys(this);let s=e();return bs(),s}_runEffects(e){let s=this[e];ys(this);for(let i of s)i.call(this);bs()}runEffects(){this._runEffects(ue)}runLayoutEffects(){this._runEffects(Le)}teardown(){this[et].forEach(s=>{typeof s.teardown=="function"&&s.teardown(!0)})}}const Pn=Promise.resolve().then.bind(Promise.resolve());function wi(){let t=[],e;function s(){e=null;let i=t;t=[];for(var n=0,r=i.length;n<r;n++)i[n]()}return function(i){t.push(i),e==null&&(e=Pn(s))}}const Cn=wi(),xs=wi();class En{renderer;host;state;[It];_updateQueued;_active;constructor(e,s){this.renderer=e,this.host=s,this.state=new Sn(this.update.bind(this),s),this[It]=null,this._updateQueued=!1,this._active=!1}update(){this._active&&(this._updateQueued||(Cn(()=>{let e=this.handlePhase(vs);xs(()=>{this.handlePhase(ws,e),xs(()=>{this.handlePhase(ue)})}),this._updateQueued=!1}),this._updateQueued=!0))}handlePhase(e,s){switch(this[It]=e,e){case ws:this.commit(s),this.runEffects(Le);return;case vs:return this.render();case ue:return this.runEffects(ue)}}render(){return this.state.run(()=>this.renderer.call(this.host,this.host))}runEffects(e){this.state._runEffects(e)}teardown(){this.state.teardown()}pause(){this._active=!1}resume(){this._active=!0}}const os=(...t)=>{const e=new CSSStyleSheet;return e.replaceSync(t.join("")),e},On=t=>t?.map(e=>typeof e=="string"?os(e):e),$n=(t,...e)=>t.flatMap((s,i)=>[s,e[i]||""]).join(""),pe=$n,Tn=(t="")=>t.replace(/-+([a-z])?/g,(e,s)=>s?s.toUpperCase():"");function zn(t){class e extends En{frag;renderResult;constructor(n,r,o){super(n,o||r),this.frag=r}commit(n){this.renderResult=t(n,this.frag)}}function s(i,n,r){const o=(r||n||{}).baseElement||HTMLElement,{observedAttributes:a=[],useShadowDOM:l=!0,shadowRootInit:c={},styleSheets:u}=r||n||{},h=On(i.styleSheets||u);class d extends o{_scheduler;static get observedAttributes(){return i.observedAttributes||a||[]}constructor(){if(super(),l===!1)this._scheduler=new e(i,this);else{const m=this.attachShadow({mode:"open",...c});h&&(m.adoptedStyleSheets=h),this._scheduler=new e(i,m,this)}}connectedCallback(){this._scheduler.resume(),this._scheduler.update(),this._scheduler.renderResult?.setConnected(!0)}disconnectedCallback(){this._scheduler.pause(),this._scheduler.teardown(),this._scheduler.renderResult?.setConnected(!1)}attributeChangedCallback(m,_,v){if(_===v)return;let b=v===""?!0:v;Reflect.set(this,Tn(m),b)}}function p(g){let m=g,_=!1;return Object.freeze({enumerable:!0,configurable:!0,get(){return m},set(v){_&&m===v||(_=!0,m=v,this._scheduler&&this._scheduler.update())}})}const f=new Proxy(o.prototype,{getPrototypeOf(g){return g},set(g,m,_,v){let b;return m in g?(b=Object.getOwnPropertyDescriptor(g,m),b&&b.set?(b.set.call(v,_),!0):(Reflect.set(g,m,_,v),!0)):(typeof m=="symbol"||m[0]==="_"?b={enumerable:!0,configurable:!0,writable:!0,value:_}:b=p(_),Object.defineProperty(v,m,b),b.set&&b.set.call(v,_),!0)}});return Object.setPrototypeOf(d.prototype,f),d}return s}class ee{id;state;constructor(e,s){this.id=e,this.state=s}}function Ln(t,...e){let s=xn(),i=it[et],n=i.get(s);return n||(n=new t(s,it,...e),i.set(s,n)),n.update(...e)}function te(t){return Ln.bind(null,t)}function xi(t){return te(class extends ee{callback;lastValues;values;_teardown;constructor(e,s,i,n){super(e,s),t(s,this)}update(e,s){this.callback=e,this.values=s}call(){const e=!this.values||this.hasChanged();this.lastValues=this.values,e&&this.run()}run(){this.teardown(),this._teardown=this.callback.call(this.state)}teardown(e){typeof this._teardown=="function"&&(this._teardown(),this._teardown=void 0),e&&(this.lastValues=this.values=void 0)}hasChanged(){return!this.lastValues||this.values.some((e,s)=>this.lastValues[s]!==e)}})}function Si(t,e){t[ue].push(e)}const E=xi(Si),An=t=>t instanceof Element?t:t.startNode||t.endNode||t.parentNode,Pi=te(class extends ee{Context;value;_ranEffect;_unsubscribe;constructor(t,e,s){super(t,e),this._updater=this._updater.bind(this),this._ranEffect=!1,this._unsubscribe=null,Si(e,this)}update(t){return this.Context!==t&&(this._subscribe(t),this.Context=t),this.value}call(){this._ranEffect||(this._ranEffect=!0,this._unsubscribe&&this._unsubscribe(),this._subscribe(this.Context),this.state.update())}_updater(t){this.value=t,this.state.update()}_subscribe(t){const e={Context:t,callback:this._updater};An(this.state.host).dispatchEvent(new CustomEvent(Kt,{detail:e,bubbles:!0,cancelable:!0,composed:!0}));const{unsubscribe:i=null,value:n}=e;this.value=i?n:t.defaultValue,this._unsubscribe=i}teardown(){this._unsubscribe&&this._unsubscribe()}});function Rn(t){return e=>{const s={Provider:class extends HTMLElement{listeners;_value;constructor(){super(),this.style.display="contents",this.listeners=new Set,this.addEventListener(Kt,this)}disconnectedCallback(){this.removeEventListener(Kt,this)}handleEvent(i){const{detail:n}=i;n.Context===s&&(n.value=this.value,n.unsubscribe=this.unsubscribe.bind(this,n.callback),this.listeners.add(n.callback),i.stopPropagation())}unsubscribe(i){this.listeners.delete(i)}set value(i){this._value=i;for(let n of this.listeners)n(i)}get value(){return this._value}},Consumer:t(function({render:i}){const n=Pi(s);return i(n)},{useShadowDOM:!1}),defaultValue:e};return s}}const I=te(class extends ee{value;values;constructor(t,e,s,i){super(t,e),this.value=s(),this.values=i}update(t,e){return this.hasChanged(e)&&(this.values=e,this.value=t()),this.value}hasChanged(t=[]){return t.some((e,s)=>this.values[s]!==e)}}),x=(t,e)=>I(()=>t,e);function kn(t,e){t[Le].push(e)}const nt=xi(kn),Q=te(class extends ee{args;constructor(t,e,s){super(t,e),this.updater=this.updater.bind(this),typeof s=="function"&&(s=s()),this.makeArgs(s)}update(){return this.args}updater(t){const[e]=this.args;typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&(this.makeArgs(t),this.state.update())}makeArgs(t){this.args=Object.freeze([t,this.updater])}}),He=te(class extends ee{reducer;currentState;constructor(t,e,s,i,n){super(t,e),this.dispatch=this.dispatch.bind(this),this.currentState=n!==void 0?n(i):i}update(t){return this.reducer=t,[this.currentState,this.dispatch]}dispatch(t){this.currentState=this.reducer(this.currentState,t),this.state.update()}}),Nn=/([A-Z])/gu,Ie=te(class extends ee{property;eventName;constructor(t,e,s,i){if(super(t,e),this.state.virtual)throw new Error("Can't be used with virtual components.");this.updater=this.updater.bind(this),this.property=s,this.eventName=s.replace(Nn,"-$1").toLowerCase()+"-changed",this.state.host[this.property]==null&&(typeof i=="function"&&(i=i()),i!=null&&this.updateProp(i))}update(t,e){return[this.state.host[this.property],this.updater]}updater(t){const e=this.state.host[this.property];typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&this.updateProp(t)}updateProp(t){this.notify(t).defaultPrevented||(this.state.host[this.property]=t)}notify(t){const e=new CustomEvent(this.eventName,{detail:{value:t,path:this.property},cancelable:!0});return this.state.host.dispatchEvent(e),e}}),Ss=t=>e=>{e.preventDefault(),t(e.detail.value)};function In(t){let e=t;return{get current(){return e},set current(s){e=s},get value(){return e},set value(s){e=s}}}function le(t){return I(()=>In(t),[])}te(class extends ee{update(){return this.state.host}});function Mn({render:t}){const e=zn(t),s=Rn(e);return{component:e,createContext:s}}/**
 * @license
...
`,Un=t=>{const{placement:e="bottom span-right",disabled:s,openOnHover:i,openOnFocus:n}=t,r=le(),[o,a]=Ie("opened",!1),l=x(()=>{s||(a(!0),r.current?.showPopover())},[s]),c=x(()=>{a(!1),r.current?.hidePopover()},[]),u=x(()=>{if(s)return;r.current?.matches(":popover-open")?c():l()},[s]);E(()=>{const g=r.current;g&&(o?g.showPopover():g.hidePopover())},[o]),E(()=>{t.toggleAttribute("opened",!!o)},[o]);const{scheduleClose:h,cancelClose:d}=Bn({host:t,popoverRef:r,disabled:s,openOnHover:i,openOnFocus:n,open:l,close:c}),p=n?l:u,f=x(g=>{Hn(g),a(g.newState==="open"),t.dispatchEvent(new ToggleEvent("dropdown-toggle",{newState:g.newState,oldState:g.oldState,composed:!0}))},[]);return w`
	...
	`};customElements.define("cosmoz-dropdown-next",X(Un,{styleSheets:[Yn],observedAttributes:["placement","disabled","open-on-hover","open-on-focus"],shadowRootInit:{mode:"open",delegatesFocus:!0}}));/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const xt=ne(class extends we{constructor(t){if(super(t),t.type!==q.PROPERTY&&t.type!==q.ATTRIBUTE&&t.type!==q.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!yi(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===U||e===G)return e;const s=t.element,i=t.name;if(t.type===q.PROPERTY){if(e===s[i])return U}else if(t.type===q.BOOLEAN_ATTRIBUTE){if(!!e===s.hasAttribute(i))return U}else if(t.type===q.ATTRIBUTE&&s.getAttribute(i)===e+"")return U;return bi(t),e}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function k(t,e,s){return t?e(t):s?.(t)}const Ei=(t,{label:e,invalid:s,errorMessage:i})=>w`
		...
		<div class="wrap" part="wrap">
			...
			<div class="control" part="control">
				...
				${t}
				${k(e,()=>w`<label for="input" part="label">${e}</label>`)}
			</div>
			<slot name="suffix"></slot>
		</div>
		<div class="line" part="line"></div>
		${k(s&&i,()=>w`<div class="error" part="error">${i}</div>`)}
	`,Oi=["autocomplete","readonly","disabled","maxlength","invalid","no-label-float","always-float-label"],Ps=wt`
	.wrap {
...
`,Xn=t=>I(()=>{if(t==null)return;const e=new RegExp(t,"u");return s=>{!s.defaultPrevented&&s.data&&!e.test(s.data)&&s.preventDefault()}},[t]),ls=te(class extends ee{values;constructor(t,e,s,i){super(t,e),Object.assign(e.host,s),this.values=i}update(t,e){this.hasChanged(e)&&(this.values=e,Object.assign(this.state.host,t))}hasChanged(t=[]){return t.some((e,s)=>this.values[s]!==e)}}),Se=te(class extends ee{update(){return this.state.host}}),Kn=/([A-Z])/gu,Jt=(t,e,s)=>{t[e]=s,t.dispatchEvent(new CustomEvent(e.replace(Kn,"-$1").toLowerCase()+"-changed",{detail:{value:s}}))},Jn=(t,e,s=[e])=>{const i=Se();E(()=>{Jt(i,t,e)},s)},Ti=t=>{const e=le(void 0),s=x(l=>e.current=l,[]),i=t.shadowRoot,n=x(l=>t.dispatchEvent(new Event(l.type,{bubbles:l.bubbles})),[]),r=x(l=>Jt(t,"value",l.target.value),[]),o=x(l=>Jt(t,"focused",l.type==="focus"),[]),a=x(()=>{const l=e.current?.checkValidity();return t.toggleAttribute("invalid",!l),l},[]);return ls({validate:a},[a]),E(()=>{const l=c=>{c.composedPath()[0]?.closest?.("input, textarea")||(c.preventDefault(),e.current?.focus())};return i.addEventListener("mousedown",l),()=>i.removeEventListener("mousedown",l)},[]),{onChange:n,onFocus:o,onInput:r,onRef:s}},Wn=({placeholder:t,noLabelFloat:e,label:s})=>(e?s:void 0)||t||" ",Gn=["type","pattern","allowed-pattern","min","max","step","autosize","label","placeholder",...Oi],qn=t=>{const{type:e="text",pattern:s,allowedPattern:i,autocomplete:n,value:r,readonly:o,disabled:a,min:l,max:c,step:u,maxlength:h}=t,{onChange:d,onFocus:p,onInput:f,onRef:g}=Ti(t),m=Xn(i);return Ei(w`
			<input
				...
				step=${J(u)}
			/>
		`,t)};customElements.define("cosmoz-input",X(qn,{observedAttributes:Gn,styleSheets:[os($i)],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const Cs=t=>{t.style.height="",t.style.height=`${t.scrollHeight}px`},Zn=(t,e=0)=>{if(e>0){const s=t.getAttribute("rows")??"",i=t.style.height;t.style.height="",t.setAttribute("rows",e),t.style.maxHeight=t.getBoundingClientRect().height+"px",t.style.height=i,t.setAttribute("rows",s)}},Qn=t=>{const{value:e,maxRows:s}=t,i=I(()=>()=>t.shadowRoot.querySelector("#input"),[]);E(()=>Zn(i(),s),[s,i]),E(()=>Cs(i()),[i,e]),E(()=>{const n=i(),r=new ResizeObserver(()=>requestAnimationFrame(()=>Cs(n)));return r.observe(n),()=>r.unobserve(n)},[i])},er=["rows","placeholder",...Oi],tr=t=>{const{autocomplete:e,value:s,placeholder:i,readonly:n,disabled:r,rows:o,cols:a,maxlength:l}=t,{onChange:c,onFocus:u,onInput:h,onRef:d}=Ti(t);return Qn(t),Ei(w`
			<textarea id="input" part="input"
				...
				@change=${c} @focus=${u} @blur=${u}>`,t)};customElements.define("cosmoz-textarea",X(tr,{observedAttributes:er,styleSheets:[os($i)],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const sr=t=>{const{label:e,value:s,disabled:i,error:n}=t,r=x(o=>t.dispatchEvent(new CustomEvent("change",{detail:o.target.checked})),[]);return w`<input
			id="toggle"
			class="toggle"
			part="toggle"
			type="checkbox"
			...
			@change=${r}
		/>
		${k(e,()=>w`<label for="toggle">${e}</label>`)}
		<slot name="suffix"></slot>
		${k(n,o=>w`<div class="failure">${o}</div>`)} `},ir=pe`
	.toggle {
		appearance: none;
		width: 35px;
		height: 18px;
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ms=t=>!bn(t)&&typeof t.then=="function",Ds=1073741823;let Ar=class extends vt{constructor(){super(...arguments),this._$Cwt=Ds,this._$Cbt=[],this._$CK=new zr(this),this._$CX=new Lr}render(...e){return e.find(s=>!Ms(s))??U}update(e,s){const i=this._$Cbt;let n=i.length;this._$Cbt=s;const r=this._$CK,o=this._$CX;this.isConnected||this.disconnected();for(let a=0;a<s.length&&!(a>this._$Cwt);a++){const l=s[a];if(!Ms(l))return this._$Cwt=a,l;a<n&&l===i[a]||(this._$Cwt=Ds,n=0,Promise.resolve(l).then(async c=>{for(;o.get();)await o.get();const u=r.deref();if(u!==void 0){const h=u._$Cbt.indexOf(l);h>-1&&h<u._$Cwt&&(u._$Cwt=h,u.setValue(c))}}))}return U}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}};const De=ne(Ar);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Fs=(t,e,s)=>{const i=new Map;for(let n=e;n<=s;n++)i.set(t[n],n);return i},Ai=ne(class extends we{constructor(t){if(super(t),t.type!==q.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const n=[],r=[];let o=0;for(const a of t)n[o]=i?i(a,o):o,r[o]=s(a,o),o++;return{values:r,keys:n}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const n=vn(t),{values:r,keys:o}=this.dt(e,s,i);if(!Array.isArray(n))return this.ut=o,r;const a=this.ut??=[],l=[];let c,u,h=0,d=n.length-1,p=0,f=r.length-1;for(;h<=d&&p<=f;)if(n[h]===null)h++;else if(n[d]===null)d--;else if(a[h]===o[p])l[p]=oe(n[h],r[p]),h++,p++;else if(a[d]===o[f])l[f]=oe(n[d],r[f]),d--,f--;else if(a[h]===o[f])l[f]=oe(n[h],r[f]),Ce(t,l[f+1],n[h]),h++,f--;else if(a[d]===o[p])l[p]=oe(n[d],r[p]),Ce(t,n[h],n[d]),d--,p++;else if(c===void 0&&(c=Fs(o,p,f),u=Fs(a,h,d)),c.has(a[h]))if(c.has(a[d])){const g=u.get(o[p]),m=g!==void 0?n[g]:null;if(m===null){const _=Ce(t,n[h]);oe(_,r[p]),l[p]=_}else l[p]=oe(m,r[p]),Ce(t,n[h],m),n[g]=null;p++}else Qe(n[d]),d--;else Qe(n[h]),h++;for(;p<=f;){const g=Ce(t,l[f+1]);oe(g,r[p]),l[p++]=g}for(;h<=d;){const g=n[h++];g!==null&&Qe(g)}return this.ut=o,bi(t,l),U}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,eo=t=>{const e=t==="auto",[s,i]=Q(e?40:t);return[s,n=>e?i(n):void 0]},ki=Vn(()=>Ri);customElements.define("cosmoz-keybinding-provider",ki.Provider);const us=t=>{const e=I(()=>({}),[]);return I(()=>Object.assign(e,t),[e,...Object.values(t)])},ke=(t,e)=>{const s=Pi(ki),i=us(t);E(()=>s(i),e)},to=Symbol("listbox.navigate.up"),so=Symbol("listbox.navigate.down"),io=Symbol("listbox.select"),no=({onUp:t,onDown:e,onEnter:s})=>{const i=Se();ke({activity:to,callback:t,element:()=>i},[]),ke({activity:so,callback:e,element:()=>i},[]),ke({activity:io,callback:s,element:()=>i},[])},ro=({items:t,onSelect:e,defaultIndex:s=0})=>{const[i,n]=Q({index:s}),{index:r}=i,{length:o}=t;return E(()=>{n({index:i.index<0?s:Math.min(i.index,t.length-1),scroll:!0})},[t,s]),no({onUp:x(()=>n(a=>({index:a.index>0?a.index-1:o-1,scroll:!0})),[o]),onDown:x(()=>n(a=>({index:a.index<o-1?a.index+1:0,scroll:!0})),[o]),onEnter:x(()=>r>-1&&r<o&&e?.(t[r],r),[r,t,e])}),{position:i,highlight:x(a=>n({index:a}),[]),select:x(a=>e?.(a),[e])}},oo=t=>typeof t=="object"&&t!==null&&Symbol.iterator in t;function ae(t){return t==null?[]:Array.isArray(t)?t:typeof t=="string"?[t]:oo(t)?Array.from(t):[t]}const jt=(t,e=ut)=>s=>{const i=ae(t).map(e);return ae(s).filter(n=>!i.includes(e(n)))},ao=(t,e)=>e?s=>s!=null&&ae(t).find(i=>i[e]===s[e]):s=>s!=null&&ae(t).includes(s),lo=(t,e)=>{if(!e||!t)return t;const s=t.toLowerCase().indexOf(e.toLowerCase());if(s<0)return t;const i=s+e.length;return[t.slice(0,s),w`<mark>${t.slice(s,i)}</mark>`,t.slice(i)]},co=(t=ut)=>(e,s,{highlight:i,select:n,textual:r=ut,query:o,isSelected:a})=>{const l=r(e),c=lo(l,o),u=t(c,e,s);return w`<div
		...
		<slot></slot>`};customElements.define("cosmoz-listbox",X(fo,{styleSheets:[as(Zr)]}));const go=({multi:t,...e},s)=>w`<cosmoz-listbox
		part="listbox"
		?multi=${t}
		...=${Ur(Gr(ho)(e))}
		>${s}</cosmoz-listbox
...
`;customElements.define("cosmoz-autocomplete-chip",X(yo,{observedAttributes:["disabled"],styleSheets:[as(mo)]}));const bo=({content:t,onClear:e,disabled:s,hidden:i,className:n="chip",slot:r})=>w`<cosmoz-autocomplete-chip
		class=${J(n)}
		slot=${J(r)}
		part="chip"
	...
	>`,vo=({value:t,min:e=0,onDeselect:s,textual:i,disabled:n,chipRenderer:r=bo})=>[...t.filter(Boolean).map(o=>r({item:o,content:i(o),onClear:t.length>e&&(()=>s(o)),disabled:n,slot:"control"})),r({item:null,content:w`<span></span>`,className:"badge",disabled:!0,slot:"control",hidden:!0})],wo=pe`
	:host {
		display: inline-block;
		vertical-align: middle;
...
`,hs=(t,e=()=>({}))=>{const s={type:t,toString(){return t}};return Object.assign((...n)=>Object.assign(e(...n),s),s)},Ys=t=>t.type||t.toString(),Us=t=>Array.isArray(t)?t:[t],So=(t,e)=>{const s=Us(e),i=(s.every(Array.isArray)?s:[s]).map(([n,r])=>({actions:Us(n).map(Ys),handle:r}));return(n=t,r)=>{const o=i.find(a=>a.actions.includes(Ys(r)));return o?o.handle(n,r):n}},he={pending:"pending",rejected:"rejected",resolved:"resolved"},Ni={error:void 0,result:void 0,state:he.pending},Ii=hs(he.pending),Mi=hs(he.resolved,t=>({result:t})),Di=hs(he.rejected,t=>({error:t})),Po=So(Ni,[[Ii,()=>({error:void 0,result:void 0,state:he.pending})],[Mi,(t,{result:e})=>({error:void 0,result:e,state:he.resolved})],[Di,(t,{error:e})=>({error:e,result:void 0,state:he.rejected})]]),Fi=t=>{const[{error:e,result:s,state:i},n]=He(Po,Ni);return E(()=>{if(!t)return;let r=!1;return n(Ii()),t.then(o=>!r&&n(Mi(o)),o=>!r&&n(Di(o))),()=>{r=!0}},[t]),[s,e,i]},Co=Symbol("autocomplete.deselect.last"),Eo=Symbol("autocomplete.search.when.selected"),Xs=t=>t.normalize("NFD").replace(/[\u0300-\u036f]/gu,""),Oo=(t,e,s)=>{if(!e)return t;const i=Xs(e.toLowerCase()),n=[];for(const r of t){const a=Xs(s(r).toLowerCase()).indexOf(i);a<0||n.push({item:r,index:a})}return n.sort((r,o)=>r.index-o.index).map(({item:r})=>r)},$o=t=>t===!1||t==null?[]:t,To=(t,e,s)=>t.dispatchEvent(new CustomEvent(e,{detail:s})),Ks=[],zo=t=>(...e)=>{let s;const i=()=>{s&&cancelAnimationFrame(s)};return i(),s=requestAnimationFrame(()=>{s=void 0,t(...e)}),i},Lo=(t,e,s)=>x(i=>{e?.(i),t.dispatchEvent(new CustomEvent(s,{detail:i}))},[e]),Ao=({value:t,text:e,onChange:s,onText:i,onSelect:n,limit:r,min:o,source:a,textProperty:l,textual:c,valueProperty:u,keepOpened:h,keepQuery:d,preserveOrder:p,defaultIndex:f,externalSearch:g,disabled:m,lazyOpen:_})=>{const v=r!=null?Number(r):void 0,b=I(()=>(c??Wr)(l),[c,l]),S=Se(),[C,O]=Ie("opened",!1),T=!e,N=I(()=>e?.trim(),[e]),M=Lo(S,i,"text"),R=x(y=>{s?.(y,()=>O(!1)),To(S,"value",y)},[s]),[D,me]=Q([]),K=!!(_&&!N),j=I(()=>K?Promise.resolve([]):Promise.resolve(typeof a=="function"?a({query:N,active:C}):a).then($o),[a,C,N,K]),V=I(()=>ae(t),[t]);E(()=>j.then(me),[j]),ke({activity:Co,callback:()=>{const y=ae(V);y.length>0&&R(y.slice(0,-1))},check:()=>!m&&T&&S.matches(":focus-within"),element:()=>S},[]),ke({activity:Eo,callback:y=>{const A=ae(V),B=v===1;A.length>0&&B&&y.key.length===1&&R(A.slice(0,-1))},allowDefault:!0,check:()=>!m&&T&&S.matches(":focus-within"),element:()=>S},[v]),E(()=>{!C&&!d&&M("")},[C,d]),E(()=>{S.toggleAttribute("opened",!!C)},[C]);const F=us({onText:M,onChange:R,value:V,limit:v,min:o,keepQuery:d,keepOpened:h,setOpened:O,onSelect:n,valueProperty:u}),[,,se]=Fi(j);return{limit:v,opened:C,query:N,textual:b,value:V,source$:j,loading:se==="pending",items:I(()=>{if(!C||K)return Ks;const y=p?D:[...V,...jt(V,tt(u))(D)];return g?y:Oo(y,N,b)},[D,C,N,b,T,V,p,u,g,K]),onToggle:x(y=>{m||O(y.newState==="open")},[m]),onText:x(y=>{m||(M(y.target.value),O(!0))},[m,M,e,O]),onSelect:x(y=>{if(m)return;F.onSelect?.(y,F);const{onChange:A,onText:B,limit:ie,min:Lt,value:At,keepQuery:Rt,keepOpened:kt,setOpened:Nt,valueProperty:Pe}=F;Rt||B(""),kt||Nt(!1);const ce=ae(At),L=tt(Pe),Ye=ce.some(Ue=>L(Ue)===L(y));Ye&&ce.length===Lt||A((Ye?jt(y,L)(ce):[...ce,y]).slice(-ie))},[m,F]),onDeselect:x(y=>{m||F.onChange(jt(y,tt(F.valueProperty))(F.value))},[m,F]),defaultIndex:N!==void 0&&N?.length>0?0:f}},Ro=t=>{const e=t.shadowRoot.querySelectorAll(".chip"),s=t.shadowRoot.querySelector(".badge");s.hidden=!0;for(const a of e)a.hidden=!1;const n=t.shadowRoot.querySelector("cosmoz-input").shadowRoot?.querySelector(".control")?.getBoundingClientRect();let r;for(r=0;r<e.length;r++){const l=e[r].getBoundingClientRect();if(!(l.x+l.width<=n.x+n.width-24))break}const o=e.length-r;for(s.querySelector("span").textContent="+"+o.toString(),s.hidden=o<1;r<e.length;r++)e[r].hidden=!0},ko=({value:t,opened:e,wrap:s,limit:i})=>{const n=Se(),r=!(s||i===1),o=I(()=>zo(()=>Ro(n)),[]),[a,l]=Q(0);nt(()=>{if(!r)return;const c=n.shadowRoot.querySelector("cosmoz-input"),u=new ResizeObserver(h=>{l(h[0].contentRect.width)});return u.observe(c),()=>u.disconnect()},[r]),nt(()=>r?o():void 0,[r,a,e,t])},No=["input","control","label","line","error","wrap"].map(t=>`${t}: input-${t}`).join(),Io=({opened:t,isSingle:e,showSingle:s,hasResultsOrQuery:i})=>!t||e&&!s?!1:i,Mo=t=>{const{opened:e,invalid:s,errorMessage:i,label:n,placeholder:r,disabled:o,noLabelFloat:a,alwaysFloatLabel:l,textual:c,text:u,onText:h,onToggle:d,onDeselect:p,value:f,limit:g,min:m,showSingle:_,items:v,source$:b,loading:S,chipRenderer:C}=t,O=g===1,T=O&&f?.[0]!=null,N=S||v.length>0||u!=null&&u.length>0;return w`<cosmoz-dropdown-next
		...
		>
			<cosmoz-input
				...
				?readonly=${T}
				?disabled=${o}
				?invalid=${ve([b,s],()=>De(b.then(()=>s,()=>!0),s))}
				.errorMessage=${ve([b,i],()=>De(b.then(()=>i,M=>M.message),i))}
				.value=${xt(u)}
				@value-changed=${h}
				autocomplete="off"
				exportparts=${No}
...
</style>`;customElements.define("cz-spinner",X(Xo));const Ko=te(class extends ee{constructor(t,e){super(t,e),this.dispatchEvent=(...s)=>{e.host.dispatchEvent.apply(e.host,s)}}update(){return this.dispatchEvent}}),Vt=(t,e=.08,s=.001)=>{const[i,n]=Q(null);return E(()=>{if(i==null){n(t);return}if(e>=1){n(t);return}const r=i;window.requestAnimationFrame(()=>{const o=t-r;n(Math.abs(o)<s?t:i+o*e)})},[i,n,t,e,s]),i},ht="dragging",qt="init",Jo={status:qt,deltaX:0,deltaY:0,lastX:0,lastY:0,timestamp:0},Wo=(t,e)=>{switch(t.status){case qt:switch(e.type){case"start":return{...t,status:ht,lastX:e.x,lastY:e.y,timestamp:e.timestamp}}break;case ht:switch(e.type){case"stop":return{...t,status:qt,deltaX:0,deltaY:0,timestamp:0};case"drag":return{...t,deltaX:e.x-t.lastX,deltaY:e.y-t.lastY,lastX:e.x,lastY:e.y,timestamp:e.timestamp}}}return t},Go=()=>{const t=Se(),[e,s]=He(Wo,Jo),i=x(o=>{o.stopPropagation(),s({type:"start",x:o.pageX,y:o.pageY,timestamp:o.timeStamp})},[s]),n=x(o=>s({type:"drag",x:o.pageX,y:o.pageY,timestamp:o.timeStamp}),[s]),r=x(()=>s({type:"stop"}),[s]);return E(()=>{if(e.status!==ht)return;const o={passive:!0};return t.ownerDocument.addEventListener("mousemove",n,o),t.ownerDocument.addEventListener("mouseup",r,o),()=>{t.ownerDocument.removeEventListener("mousemove",n,o),t.ownerDocument.removeEventListener("mouseup",r,o)}},[e.status,r,n]),[e.status,e.deltaX,e.deltaY,e.timestamp,i]},Fe=(t,e,s)=>Math.max(e,Math.min(s,t)),ds=(t,e,s,i)=>s/i<t/e?s/t:i/e,qo=(t,e,s,i)=>s/i>t/e?s/t:i/e,Zo=t=>t.reduce((s,i)=>[s[0]+i[0],s[1]+i[1]],[0,0]).map(s=>s/t.length),Qo=(t,e,s,i,n)=>{const r=ds(t,e,s,i),o=r*n,a=t*o,l=e*o,c=a<s?(-s+a)/2:(s-a)/2,u=a<s?(s-a)/2:(-s+a)/2,h=l<i?(-i+l)/2:(i-l)/2,d=l<i?(i-l)/2:(-i+l)/2;return{x:[c,u],y:[h,d]}},Zt="init",dt="dragging",ea={status:Zt,deltaX:0,deltaY:0,lastX:0,lastY:0,timestamp:0},ta=(t,e)=>{switch(t.status){case Zt:switch(e.type){case"start":return{...t,status:dt,lastX:e.x,lastY:e.y,timestamp:e.timestamp}}break;case dt:switch(e.type){case"stop":return{...t,status:Zt,deltaX:0,deltaY:0,timestamp:0};case"drag":return{...t,deltaX:e.x-t.lastX,deltaY:e.y-t.lastY,lastX:e.x,lastY:e.y,timestamp:e.timestamp};case"one-little-finger":return{...t,lastX:e.x,lastY:e.y}}}return t},Ge=t=>Zo(Array.from(t.touches).map(e=>[e.pageX,e.pageY])),sa=()=>{const[t,e]=He(ta,ea),s=x(o=>{if(o.touches.length>1)return;const[a,l]=Ge(o);e({type:"start",x:a,y:l,timestamp:o.timeStamp})},[e]),i=x(o=>{const[a,l]=Ge(o);e({type:"drag",x:a,y:l,timestamp:o.timeStamp})},[e]),n=x(o=>{if(o.touches.length===0){e({type:"stop"});return}const[a,l]=Ge(o);e({type:"one-little-finger",x:a,y:l})},[e]),r=x(o=>{const[a,l]=Ge(o);e({type:"one-little-finger",x:a,y:l})},[e]);return E(()=>{if(t.status!==dt)return;const o={passive:!0};return document.addEventListener("touchstart",r,o),document.addEventListener("touchmove",i,o),document.addEventListener("touchend",n,o),()=>{document.removeEventListener("touchstart",r,o),document.removeEventListener("touchmove",i,o),document.removeEventListener("touchend",n,o)}},[t.status,r,i,n]),[t.status,t.deltaX,t.deltaY,t.timestamp,s]},ia=(t,e)=>{"ResizeObserver"in window&&E(()=>{if(e==null)return;const s=new ResizeObserver(([{contentRect:i}])=>t(i));return s.observe(e),t(e.getBoundingClientRect()),()=>s.unobserve(e)},[t,e])},Ki="init",pt="pinching",Ji={status:Ki,lastDistance:0,delta:0,centerX:0,centerY:0},na=(t,e)=>{switch(t.status){case Ki:switch(e.type){case"start":return{...t,status:pt,lastDistance:e.initialDistance,delta:0,centerX:e.centerX,centerY:e.centerY}}break;case pt:switch(e.type){case"stop":return{...Ji,centerX:t.centerX,centerY:t.centerY};case"pinch":return{...t,delta:e.distance-t.lastDistance,lastDistance:e.distance,centerX:e.centerX,centerY:e.centerY}}}return t},Js=(t,e)=>Math.hypot(e.pageX-t.pageX,e.pageY-t.pageY),Ws=(t,e)=>[(t.pageX+e.pageX)/2,(t.pageY+e.pageY)/2],ra=()=>{const[t,e]=He(na,Ji),s=x(r=>{if(r.touches.length<2)return;const[o,a]=Ws(r.touches[0],r.touches[1]);e({type:"start",initialDistance:Js(r.touches[0],r.touches[1]),centerX:o,centerY:a})},[e]),i=x(r=>{if(r.touches.length<2)return;const[o,a]=Ws(r.touches[0],r.touches[1]);e({type:"pinch",distance:Js(r.touches[0],r.touches[1]),centerX:o,centerY:a})},[e]),n=x(r=>{r.touches.length>2||e({type:"stop"})},[e]);return E(()=>{if(t.status!==pt)return;const r={passive:!0};return document.addEventListener("touchmove",i,r),document.addEventListener("touchend",n,r),()=>{document.removeEventListener("touchmove",i,r),document.removeEventListener("touchend",n,r)}},[t.status,n,i]),[t.status,t.delta,s,t.centerX,t.centerY]},Wi="empty",Ot="loading",Gi="loaded",ps="error",oa={status:Wi,iw:100,ih:100,cw:100,ch:100,zoom:1,panX:0,panY:0},aa=1.1,la=t=>aa/t,ca=t=>2*t,qi=(t,e,s,i)=>{const n=ds(t,e,s,i),r=qo(t*n,e*n,s,i);return Math.max(la(n),ca(r))},ua=(t,e,s,i,n)=>Fe(t,1,qi(e,s,i,n)),Gs=.2,qs=(t,e,s,i)=>{if(s==null||i==null)return{panX:t.panX,panY:t.panY};const n=e/t.zoom;return{panX:s-(s-t.panX)*n,panY:i-(i-t.panY)*n}},Zs=t=>{const e=Qo(t.iw,t.ih,t.cw,t.ch,t.zoom);return{...t,panX:Fe(t.panX,e.x[0],e.x[1]),panY:Fe(t.panY,e.y[0],e.y[1])}},ha=(t,e)=>{switch(e.type){case"load":return{...t,status:Ot};default:return t}},da=(t,e)=>{switch(e.type){case"loaded":return{...t,status:Gi,...e.dimensions};case"error":return{...t,status:ps};default:return t}},pa=(t,e)=>{switch(e.type){case"load":return{...t,status:Ot,panX:0,panY:0};case"zoom":{const s=ua(e.zoom,t.iw,t.ih,t.cw,t.ch),i=qs(t,s,e.originX,e.originY);return Zs({...t,zoom:s,...i})}case"zoomBy":{const s=qi(t.iw,t.ih,t.cw,t.ch),i=e.bounded?Fe(t.zoom+e.delta,1,s):Fe(t.zoom+e.delta,1-Gs,s*(1+Gs)),n=qs(t,i,e.originX,e.originY);return{...t,zoom:i,...n}}case"pan":return{...t,panX:t.panX+e.dx,panY:t.panY+e.dy};case"panEnd":return Zs(t);default:return t}},fa=(t,e)=>{switch(e.type){case"load":return{...t,status:Ot};default:return t}},ga=(t,e)=>{if(e.type==="resize")return{...t,cw:e.rect.width,ch:e.rect.height};switch(t.status){case Wi:return ha(t,e);case Ot:return da(t,e);case Gi:return pa(t,e);case ps:return fa(t,e);default:return t}},ma=(t,e,s,i)=>{const{iw:n=100,ih:r=100,cw:o=100,ch:a=100}=t,l=ds(n,r,o,a),c=l*e;return{position:"absolute",top:"50%",left:"50%",transform:["translate(-50%, -50%)",`translate(${s}px, ${i}px)`,`scale(${c})`].join(" ")}},Bt=(t,e,s)=>{const i=s.current?.getBoundingClientRect();return i?{originX:t-i.left-i.width/2,originY:e-i.top-i.height/2}:{}},_a=(t=.3,e=.08)=>{const[s,i]=He(ga,oa),n=x(()=>i({type:"load"}),[i]),r=x(y=>i({type:"loaded",dimensions:y}),[i]),o=x(()=>i({type:"error"}),[i]),a=x((y,A=!0,B,ie)=>i({type:"zoomBy",delta:y,bounded:A,originX:B,originY:ie}),[i]),l=x(y=>i({type:"zoom",zoom:y}),[i]),c=le(),u=x(y=>y&&i({type:"resize",rect:y}),[i]),h=x(()=>u(c.current&&c.current.getBoundingClientRect()),[u,c]);ia(u,c.current);const d=x(y=>r({iw:y.target.naturalWidth,ih:y.target.naturalHeight}),[r]),p=x(y=>{y.preventDefault();const{originX:A,originY:B}=Bt(y.clientX,y.clientY,c);a(-Math.sign(y.deltaY)*.8,!0,A,B)},[a,c]),[f,g,m,_,v]=ra(),b=f===pt;E(()=>{if(g===0)return;const{originX:y,originY:A}=Bt(_,v,c);a(g*.01*s.zoom,!1,y,A)},[g,a]),E(()=>{if(b)return;const{originX:y,originY:A}=Bt(_,v,c);a(0,!0,y,A)},[b,a]);const[S,C,O,T,N]=Go(),[M,R,D,me,K]=sa(),j=S===ht||M===dt;I(()=>{(C!==0||O!==0)&&i({type:"pan",dx:C,dy:O})},[T]),I(()=>{(R!==0||D!==0)&&i({type:"pan",dx:R,dy:D})},[me]),E(()=>{j||i({type:"panEnd"})},[j]);const V=Vt(s.panX,j?.9:t),F=Vt(s.panY,j?.9:t),se=Vt(s.zoom,b?.8:e);return{...s,load:n,loaded:r,error:o,zoomBy:a,zoomTo:l,resize:h,startMousePan:N,startTouchPan:K,startPinch:m,onImageLoad:d,onWheel:p,containerRef:c,style:ma(s,se,V,F)}},ya=({src:t,disabled:e,panStiffness:s,zoomStiffness:i})=>{const{status:n,zoom:r,load:o,error:a,zoomTo:l,resize:c,startMousePan:u,startTouchPan:h,startPinch:d,onImageLoad:p,onWheel:f,style:g,containerRef:m}=_a(s,i);if(E(o,[t]),ls({zoomTo:l,resize:c,zoom:r},[l,c,r]),!t)return G;const _=Ko();E(()=>_(new CustomEvent("zoom-changed",{detail:{value:r}})),[_,r]),E(()=>_(new CustomEvent("status-changed",{detail:{value:n}})),[_,n]);const v=x(b=>{h(b),d(b)},[h,d]);return w`
		<style>
			:host {
				display: block;
			}
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const xa=!window.ShadyDOM||!window.ShadyDOM.inUse;!window.ShadyCSS||window.ShadyCSS.nativeCss;const Sa=xa&&"adoptedStyleSheets"in Document.prototype&&"replaceSync"in CSSStyleSheet.prototype&&(()=>{try{const t=new CSSStyleSheet;t.replaceSync("");const e=document.createElement("div");return e.attachShadow({mode:"open"}),e.shadowRoot.adoptedStyleSheets=[t],e.shadowRoot.adoptedStyleSheets[0]===t}catch{return!1}})();let Pa=window.Polymer&&window.Polymer.rootPath||gs(document.baseURI||window.location.href),ft=window.Polymer&&window.Polymer.sanitizeDOMValue||void 0;window.Polymer&&window.Polymer.setPassiveTouchGestures;let Qt=window.Polymer&&window.Polymer.strictTemplatePolicy||!1,Ca=window.Polymer&&window.Polymer.allowTemplateFromDomModule||!1,Ea=window.Polymer&&window.Polymer.legacyOptimizations||!1,Oa=window.Polymer&&window.Polymer.legacyWarnings||!1,$a=window.Polymer&&window.Polymer.syncInitialRender||!1,es=window.Polymer&&window.Polymer.legacyUndefined||!1,Ta=window.Polymer&&window.Polymer.orderedComputed||!1,Qs=window.Polymer&&window.Polymer.removeNestedTemplates||!1,za=window.Polymer&&window.Polymer.fastDomIf||!1;window.Polymer&&window.Polymer.suppressTemplateNotifications;window.Polymer&&window.Polymer.legacyNoObservedAttributes;let La=window.Polymer&&window.Polymer.useAdoptedStyleSheetsWithBuiltCSS||!1;/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let ms={},Zi={};function ei(t,e){ms[t]=Zi[t.toLowerCase()]=e}function ti(t){return ms[t]||Zi[t.toLowerCase()]}function Ra(t){t.querySelector("style")&&console.warn("dom-module %s has style outside template",t.id)}class je extends HTMLElement{static get observedAttributes(){return["id"]}static import(e,s){if(e){let i=ti(e);return i&&s?i.querySelector(s):i}return null}attributeChangedCallback(e,s,i,n){s!==i&&this.register()}get assetpath(){if(!this.__assetpath){const e=window.HTMLImports&&HTMLImports.importForElement?HTMLImports.importForElement(this)||document:this.ownerDocument,s=Ne(this.getAttribute("assetpath")||"",e.baseURI);this.__assetpath=gs(s)}return this.__assetpath}register(e){if(e=e||this.id,e){if(Qt&&ti(e)!==void 0)throw ei(e,null),new Error(`strictTemplatePolicy: dom-module ${e} re-registered`);this.id=e,ei(e,this),Ra(this)}}}je.prototype.modules=ms;customElements.define("dom-module",je);/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let Ba=0,rn=0,be=[],Ha=0,ss=!1,on=document.createTextNode("");new window.MutationObserver(Ya).observe(on,{characterData:!0});function Ya(){ss=!1;const t=be.length;for(let e=0;e<t;e++){let s=be[e];if(s)try{s()}catch(i){setTimeout(()=>{throw i})}}be.splice(0,t),rn+=t}const Ua={run(t){return ss||(ss=!0,on.textContent=Ha++),be.push(t),Ba++},cancel(t){const e=t-rn;if(e>=0){if(!be[e])throw new Error("invalid async handle: "+t);be[e]=null}}};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
`,sc=Symbol("memo"),mn=t=>{let e=sc,s;return function(i){if(e===i)return s;const n=t(i);return s=n,e=i,n}},ic=(t,e)=>{const s=t.width/t.height,i=e.width/e.height;return s>i?{width:e.width,height:t.height*(e.width/t.width)}:{width:t.width*(e.height/t.height),height:e.height}},nc=async(t,e)=>{const s={credentials:"include"},[{jsPDF:i},...n]=await Promise.all([rs(()=>import("./jspdf.es-C8lXQ5JU.js").then(a=>a.j),__vite__mapDeps([0,1]),import.meta.url),...t.map(async a=>{const l=await Promise.resolve(cs(a)),c=await fetch(l,s);return c.ok?{url:l,data:new Uint8Array(await c.arrayBuffer())}:void 0})]),r=n.filter(Boolean);if(r.length<1)return;const o=new i;return r.filter(Boolean).forEach(({url:a,data:l},c)=>{const{internal:{pageSize:h}}=o,{width:d,height:p}=ic(o.getImageProperties(l),{width:h.getWidth()-4,height:h.getHeight()-4});c>0&&o.addPage(),o.addImage(l,a.split(".").pop().toUpperCase(),2,2,d,p)}),o.output("blob")},_n=(t,e)=>{const s=URL.createObjectURL(t),i=document.body.appendChild(document.createElement("a"));i.href=s,i.download=`${e}.pdf`,i.click(),document.body.removeChild(i),URL.revokeObjectURL(s)},rc=async(t,e,s)=>{const i=await nc(t);if(i)return _n(i,e),i},oc=async(t,e,s={})=>{const{httpHeaders:i,withCredentials:n=!0}=s,r=await fetch(t,{credentials:n?"include":"omit",headers:i});if(!r.ok)return;const o=await r.blob();return _n(o,e),o},ac=t=>Object.entries(t).map(([e,s])=>e+"="+s).join(",");let ns=!1;const lc=({source:t,attachmentIndex:e,index:s,syncImageIndex:i,syncAttachmentIndex:n,title:r,loop:o,detachedShowZoom:a,onDetach:l,onClose:c})=>{const u=window.open(void 0,"czimgviewer",ac({height:700,width:800}));bt(w`<style>
			...
			<cosmoz-image-viewer
				...
				?loop=${o}
				@close=${()=>u.close()}
			></cosmoz-image-viewer>`,u.document.body),u._onClose?.(),l(),ns=!0,u._onClose=c,u.addEventListener("beforeunload",c),u.addEventListener("beforeunload",()=>ns=!1),u.document.title=r??W("Cosmoz image viewer")},cc=t=>new Promise(e=>{const s=setInterval(()=>{t()&&(e(),clearInterval(s))},100)}),uc=({images:t})=>{const e=window.open(void 0,"czimgviewerprint");bt(w`<style>
				img {
					display: block;
			...
			${t.map(s=>w`<img src="${De(Promise.resolve(cs(s)))}" />`)}`,e.document.body),cc(()=>Array.from(e.document.querySelectorAll("img")).every(s=>s.src&&s.complete)).then(()=>e.print()).then(()=>e.close())},mi=[],hc=t=>{const e=I(()=>typeof t=="function"?Promise.resolve(t()):void 0,[t]),[s,i,n]=Fi(e);return typeof t!="function"?{attachments:t??mi,loading:!1,error:void 0}:{attachments:s??mi,loading:n==="pending",error:i}},dc=50,pc=300,fc=(t,{onSwipeLeft:e,onSwipeRight:s,enabled:i})=>{const n=le(null);E(()=>{if(!i)return;const r=a=>{if(a.touches.length!==1)return;const l=a.touches[0];n.current={x:l.clientX,y:l.clientY,t:Date.now()}},o=a=>{if(!n.current)return;const l=a.changedTouches[0],c=l.clientX-n.current.x,u=l.clientY-n.current.y,h=Date.now()-n.current.t;n.current=null,!(h>pc)&&(Math.abs(c)<dc||Math.abs(c)<Math.abs(u)||(c<0?e?.():s?.()))};return t.addEventListener("touchstart",r,{passive:!0}),t.addEventListener("touchend",o,{passive:!0}),()=>{t.removeEventListener("touchstart",r),t.removeEventListener("touchend",o)}},[t,e,s,i])},yn=t=>{if(!t.currentTarget.parentElement)return;t.currentTarget.parentElement.querySelector(".error").removeAttribute("hidden"),t.currentTarget.setAttribute("hidden",!0)},gc=t=>t.detail.value==="error"&&yn(t),mc=({src$:t,showZoom:e,isZoomed:s,_onZoomChanged:i})=>{const n=ve(t,()=>De(t));return[e?w`<haunted-pan-zoom
						.src=${n}
						?disabled=${!s}
						@zoom-changed=${i}
						@status-changed=${gc}
					></haunted-pan-zoom>`:w`<img
						.src=${n}
						style="width:100%"
						@error=${yn}
					/>`,ve(t,()=>De(t.then(()=>G),w`<cz-spinner></cz-spinner>`))]},_c=t=>w`<div>
			<div hidden class="error">
				<h2>An error occurred while loading the image.</h2>
				<div class="desc">${t.image}</div>
			</div>
			${mc(t)}
		</div>`,yt=[],Xt=(t,e,s)=>Math.max(e,Math.min(s,t)),yc=(t,e,s)=>{const[i,n]=Q(yt),r=I(()=>mn(o=>rs(async()=>{const{loadPdfThunks:a}=await import("./pdf-loader-BSiQZefA.js");return{loadPdfThunks:a}},__vite__mapDeps([2,1]),import.meta.url).then(({loadPdfThunks:a})=>a(o,e))),[e]);return E(()=>{if(!t){n(yt);return}let o=!1;return r(t).then(a=>{o||n(a)}),()=>{o=!0}},[t,r]),t?i:s},_i=(t,e,s,i)=>{const n=t.length;for(let r=1;r<=n;r++){const o=(e+r*s+n)%n;if(!i&&s>0&&o<=e||!i&&s<0&&o>=e)return;const a=t[o];if((a.images?.length??0)>0||a.pdf)return o}},bc=t=>{const{showZoom:e,title:s,loop:i,detachedShowZoom:n}=t,{attachments:r,loading:o,error:a}=hc(t.source),[l,c]=Ie("currentAttachmentIndex",0),u=r.length>0?Xt(l??0,0,r.length-1):0,h=r[u],d=h?[h]:yt,p=le(We),f=x(L=>{const Ye=L.detail?.[0],Ue=r.indexOf(Ye);Ue>=0&&(p.current=We,c(Ue))},[r]),g=h?.pdf,m=h?.pdfOptions,_=h?.downloadFileName??"archive",v=h?.images??yt,b=yc(g,m,v),[S,C]=Q(!1),O=L=>C(L.detail.value>1),T=I(()=>mn(L=>Promise.resolve(cs(L))),[]),[N,M]=Ie("currentImageIndex",0),R=b.length>0?Xt(N??0,0,b.length-1):0,D=b[R],me=I(()=>D==null?{id:Math.random(),content:G,animation:We}:{id:D,render:()=>_c({src$:T(D),showZoom:e,isZoomed:S,_onZoomChanged:O,image:D}),animation:p.current},[D,e,S,O]),K=le(!1),j=!i&&u===0&&R<=0,V=!i&&u===r.length-1&&R>=b.length-1,F=x(()=>{if(p.current=We,R<b.length-1)return M(R+1);const L=_i(r,u,1,i);L!=null&&(c(L),M(0))},[R,b.length,r,u,i]),se=x(()=>{if(p.current=Uo,R>0)return M(R-1);const L=_i(r,u,-1,i);L!=null&&(K.current=!0,c(L))},[R,r,u,i]);fc(t,{onSwipeLeft:F,onSwipeRight:se,enabled:!S});const[y,A]=Q(!1),[B,ie]=Q(!1),Lt=()=>ie(!0),At=()=>ie(!1),Rt=L=>A(L.detail.value),kt=L=>M(L.detail.value),Nt=L=>c(L.detail.value),Pe=x(()=>lc({source:r,attachmentIndex:u,index:R,syncImageIndex:kt,syncAttachmentIndex:Nt,title:s,loop:i,detachedShowZoom:n,onDetach:()=>A(!0),onClose:()=>A(!1)}),[r,u,R,s,i]),ce=x(()=>{ns&&Pe()},[Pe]);return E(()=>{if(b.length===0)return;if(K.current){K.current=!1,M(b.length-1);return}const L=N??0;L>=b.length&&M(Xt(L,0,b.length-1))},[b]),E(()=>{const L=l??0;r.length>0&&L>=r.length&&c(0)},[r]),Jn("detached",y,[y]),E(()=>{t.toggleAttribute("hidden",y)},[y]),ls({syncState:ce},[ce]),{host:t,isZoomed:S,currentSlide:me,nextImage:F,previousImage:se,first:j,last:V,total:b.length,currentImageIndex:R,selectedImageNumber:R+1,onDownloadPdf:g?()=>oc(g,_,m):()=>rc(b,_),isFullscreen:B,openFullscreen:Lt,closeFullscreen:At,onPrintPdf:()=>uc({images:b}),detached:y,detach:Pe,syncDetachedState:Rt,setAttachmentIndex:c,setImageIndex:M,loading:o,error:a,attachments:r,selected:h,selectedIndex:u,value:d,onSelect:f,images:b}},vc=w`<svg
	viewBox="0 0 24 24"
...
>
	...
	></path>
		...
		${m?G:w`
					...
					${k(!S&&!C,()=>w`
							${k(re(t.showPageNumber,r),()=>w` <div class="counter">
										${c}/${r}
									</div>`)}

							<div class="actions">
								${k(re(t.showNav,r,2)||O.length>1,()=>w`
										<button
											class="nav"
											name="prev"
											?disabled=${o}
									...
									`)}
								${k(O.length>1,()=>w`<cosmoz-autocomplete
											text-property="title"
											limit="1"
											.min=${1}
											show-single
								...
								${k(re(t.showFullscreen,r),()=>w`<button
											class="nav"
											@click="${d}"
