const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./jspdf.es-CKFOE4aL.js","./preload-helper-PPVm8Dsz.js","./popout-entry-D5AyJVvm.js","./iframe-kBbHAsvE.js","./iframe-Bv8SCm1X.css","./pdf-loader-B_xPwwqY.js"])))=>i.map(i=>d[i]);
import{r as ai,D as Jt,A as J,b as v,E as V,p as li,n as _n,M as yn,u as ne,v as ve,h as Je,j as bn}from"./iframe-kBbHAsvE.js";import{_ as ft}from"./preload-helper-PPVm8Dsz.js";let qe,ci=0;function us(t){qe=t}function ds(){qe=null,ci=0}function vn(){return ci++}const $t=Symbol("haunted.phase"),We=Symbol("haunted.hook"),hs=Symbol("haunted.update"),ps=Symbol("haunted.commit"),oe=Symbol("haunted.effects"),Oe=Symbol("haunted.layoutEffects"),Dt="haunted.context";class wn{update;host;virtual;[We];[oe];[Oe];constructor(e,s){this.update=e,this.host=s,this[We]=new Map,this[oe]=[],this[Oe]=[]}run(e){us(this);let s=e();return ds(),s}_runEffects(e){let s=this[e];us(this);for(let i of s)i.call(this);ds()}runEffects(){this._runEffects(oe)}runLayoutEffects(){this._runEffects(Oe)}teardown(){this[We].forEach(s=>{typeof s.teardown=="function"&&s.teardown(!0)})}}const xn=Promise.resolve().then.bind(Promise.resolve());function ui(){let t=[],e;function s(){e=null;let i=t;t=[];for(var n=0,r=i.length;n<r;n++)i[n]()}return function(i){t.push(i),e==null&&(e=xn(s))}}const Sn=ui(),fs=ui();class Pn{renderer;host;state;[$t];_updateQueued;_active;constructor(e,s){this.renderer=e,this.host=s,this.state=new wn(this.update.bind(this),s),this[$t]=null,this._updateQueued=!1,this._active=!1}update(){this._active&&(this._updateQueued||(Sn(()=>{let e=this.handlePhase(hs);fs(()=>{this.handlePhase(ps,e),fs(()=>{this.handlePhase(oe)})}),this._updateQueued=!1}),this._updateQueued=!0))}handlePhase(e,s){switch(this[$t]=e,e){case ps:this.commit(s),this.runEffects(Oe);return;case hs:return this.render();case oe:return this.runEffects(oe)}}render(){return this.state.run(()=>this.renderer.call(this.host,this.host))}runEffects(e){this.state._runEffects(e)}teardown(){this.state.teardown()}pause(){this._active=!1}resume(){this._active=!0}}const Wt=(...t)=>{const e=new CSSStyleSheet;return e.replaceSync(t.join("")),e},Cn=t=>t?.map(e=>typeof e=="string"?Wt(e):e),En=(t,...e)=>t.flatMap((s,i)=>[s,e[i]||""]).join(""),ce=En,On=(t="")=>t.replace(/-+([a-z])?/g,(e,s)=>s?s.toUpperCase():"");function $n(t){class e extends Pn{frag;renderResult;constructor(n,r,o){super(n,o||r),this.frag=r}commit(n){this.renderResult=t(n,this.frag)}}function s(i,n,r){const o=(r||n||{}).baseElement||HTMLElement,{observedAttributes:a=[],useShadowDOM:l=!0,shadowRootInit:c={},styleSheets:u}=r||n||{},d=Cn(i.styleSheets||u);class h extends o{_scheduler;static get observedAttributes(){return i.observedAttributes||a||[]}constructor(){if(super(),l===!1)this._scheduler=new e(i,this);else{const m=this.attachShadow({mode:"open",...c});d&&(m.adoptedStyleSheets=d),this._scheduler=new e(i,m,this)}}connectedCallback(){this._scheduler.resume(),this._scheduler.update(),this._scheduler.renderResult?.setConnected(!0)}disconnectedCallback(){this._scheduler.pause(),this._scheduler.teardown(),this._scheduler.renderResult?.setConnected(!1)}attributeChangedCallback(m,y,_){if(y===_)return;let P=_===""?!0:_;Reflect.set(this,On(m),P)}}function p(g){let m=g,y=!1;return Object.freeze({enumerable:!0,configurable:!0,get(){return m},set(_){y&&m===_||(y=!0,m=_,this._scheduler&&this._scheduler.update())}})}const f=new Proxy(o.prototype,{getPrototypeOf(g){return g},set(g,m,y,_){let P;return m in g?(P=Object.getOwnPropertyDescriptor(g,m),P&&P.set?(P.set.call(_,y),!0):(Reflect.set(g,m,y,_),!0)):(typeof m=="symbol"||m[0]==="_"?P={enumerable:!0,configurable:!0,writable:!0,value:y}:P=p(y),Object.defineProperty(_,m,P),P.set&&P.set.call(_,y),!0)}});return Object.setPrototypeOf(h.prototype,f),h}return s}class q{id;state;constructor(e,s){this.id=e,this.state=s}}function zn(t,...e){let s=vn(),i=qe[We],n=i.get(s);return n||(n=new t(s,qe,...e),i.set(s,n)),n.update(...e)}function Q(t){return zn.bind(null,t)}function di(t){return Q(class extends q{callback;lastValues;values;_teardown;constructor(e,s,i,n){super(e,s),t(s,this)}update(e,s){this.callback=e,this.values=s}call(){const e=!this.values||this.hasChanged();this.lastValues=this.values,e&&this.run()}run(){this.teardown(),this._teardown=this.callback.call(this.state)}teardown(e){typeof this._teardown=="function"&&(this._teardown(),this._teardown=void 0),e&&(this.lastValues=this.values=void 0)}hasChanged(){return!this.lastValues||this.values.some((e,s)=>this.lastValues[s]!==e)}})}function hi(t,e){t[oe].push(e)}const z=di(hi),Tn=t=>t instanceof Element?t:t.startNode||t.endNode||t.parentNode,pi=Q(class extends q{Context;value;_ranEffect;_unsubscribe;constructor(t,e,s){super(t,e),this._updater=this._updater.bind(this),this._ranEffect=!1,this._unsubscribe=null,hi(e,this)}update(t){return this.Context!==t&&(this._subscribe(t),this.Context=t),this.value}call(){this._ranEffect||(this._ranEffect=!0,this._unsubscribe&&this._unsubscribe(),this._subscribe(this.Context),this.state.update())}_updater(t){this.value=t,this.state.update()}_subscribe(t){const e={Context:t,callback:this._updater};Tn(this.state.host).dispatchEvent(new CustomEvent(Dt,{detail:e,bubbles:!0,cancelable:!0,composed:!0}));const{unsubscribe:i=null,value:n}=e;this.value=i?n:t.defaultValue,this._unsubscribe=i}teardown(){this._unsubscribe&&this._unsubscribe()}});function Ln(t){return e=>{const s={Provider:class extends HTMLElement{listeners;_value;constructor(){super(),this.style.display="contents",this.listeners=new Set,this.addEventListener(Dt,this)}disconnectedCallback(){this.removeEventListener(Dt,this)}handleEvent(i){const{detail:n}=i;n.Context===s&&(n.value=this.value,n.unsubscribe=this.unsubscribe.bind(this,n.callback),this.listeners.add(n.callback),i.stopPropagation())}unsubscribe(i){this.listeners.delete(i)}set value(i){this._value=i;for(let n of this.listeners)n(i)}get value(){return this._value}},Consumer:t(function({render:i}){const n=pi(s);return i(n)},{useShadowDOM:!1}),defaultValue:e};return s}}const R=Q(class extends q{value;values;constructor(t,e,s,i){super(t,e),this.value=s(),this.values=i}update(t,e){return this.hasChanged(e)&&(this.values=e,this.value=t()),this.value}hasChanged(t=[]){return t.some((e,s)=>this.values[s]!==e)}}),x=(t,e)=>R(()=>t,e);function An(t,e){t[Oe].push(e)}const Qe=di(An),ee=Q(class extends q{args;constructor(t,e,s){super(t,e),this.updater=this.updater.bind(this),typeof s=="function"&&(s=s()),this.makeArgs(s)}update(){return this.args}updater(t){const[e]=this.args;typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&(this.makeArgs(t),this.state.update())}makeArgs(t){this.args=Object.freeze([t,this.updater])}}),fi=Q(class extends q{reducer;currentState;constructor(t,e,s,i,n){super(t,e),this.dispatch=this.dispatch.bind(this),this.currentState=n!==void 0?n(i):i}update(t){return this.reducer=t,[this.currentState,this.dispatch]}dispatch(t){this.currentState=this.reducer(this.currentState,t),this.state.update()}}),Rn=/([A-Z])/gu,Fe=Q(class extends q{property;eventName;constructor(t,e,s,i){if(super(t,e),this.state.virtual)throw new Error("Can't be used with virtual components.");this.updater=this.updater.bind(this),this.property=s,this.eventName=s.replace(Rn,"-$1").toLowerCase()+"-changed",this.state.host[this.property]==null&&(typeof i=="function"&&(i=i()),i!=null&&this.updateProp(i))}update(t,e){return[this.state.host[this.property],this.updater]}updater(t){const e=this.state.host[this.property];typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&this.updateProp(t)}updateProp(t){this.notify(t).defaultPrevented||(this.state.host[this.property]=t)}notify(t){const e=new CustomEvent(this.eventName,{detail:{value:t,path:this.property},cancelable:!0});return this.state.host.dispatchEvent(e),e}}),gs=t=>e=>{e.preventDefault(),t(e.detail.value)};function kn(t){let e=t;return{get current(){return e},set current(s){e=s},get value(){return e},set value(s){e=s}}}function te(t){return R(()=>kn(t),[])}Q(class extends q{update(){return this.state.host}});function Nn({render:t}){const e=$n(t),s=Ln(e);return{component:e,createContext:s}}const G={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},se=t=>(...e)=>({_$litDirective$:t,values:e});let ye=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,s,i){this._$Ct=e,this._$AM=s,this._$Ci=i}_$AS(e,s){return this.update(e,s)}update(e,s){return this.render(...s)}};const $e=(t,e)=>{const s=t._$AN;if(s===void 0)return!1;for(const i of s)i._$AO?.(e,!1),$e(i,e);return!0},et=t=>{let e,s;do{if((e=t._$AM)===void 0)break;s=e._$AN,s.delete(t),t=e}while(s?.size===0)},gi=t=>{for(let e;e=t._$AM;t=e){let s=e._$AN;if(s===void 0)e._$AN=s=new Set;else if(s.has(t))break;s.add(t),Dn(e)}};function In(t){this._$AN!==void 0?(et(this),this._$AM=t,gi(this)):this._$AM=t}function Mn(t,e=!1,s=0){const i=this._$AH,n=this._$AN;if(n!==void 0&&n.size!==0)if(e)if(Array.isArray(i))for(let r=s;r<i.length;r++)$e(i[r],!1),et(i[r]);else i!=null&&($e(i,!1),et(i));else $e(this,t)}const Dn=t=>{t.type==G.CHILD&&(t._$AP??=Mn,t._$AQ??=In)};class gt extends ye{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,s,i){super._$AT(e,s,i),gi(this),this.isConnected=e._$AU}_$AO(e,s=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),s&&($e(this,e),et(this))}setValue(e){if(ai(this._$Ct))this._$Ct._$AI(e,this);else{const s=[...this._$Ct._$AH];s[this._$Ci]=e,this._$Ct._$AI(s,this,0)}}disconnected(){}reconnected(){}}const{component:B,createContext:Fn}=Nn({render:Jt}),mt=(t,...e)=>t.flatMap((s,i)=>[s,e[i]??""]).join(""),Gt=(...t)=>{const e=new CSSStyleSheet;return e.replaceSync(t.join("")),e},zt=new WeakMap,be=se(class extends gt{render(t){return J}update(t,[e]){const s=e!==this.G;return s&&this.G!==void 0&&this.rt(void 0),(s||this.lt!==this.ct)&&(this.G=e,this.ht=t.options?.host,this.rt(this.ct=t.element)),J}rt(t){if(this.isConnected||(t=void 0),typeof this.G=="function"){const e=this.ht??globalThis;let s=zt.get(e);s===void 0&&(s=new WeakMap,zt.set(e,s)),s.get(this.G)!==void 0&&this.G.call(this.ht,void 0),s.set(this.G,t),t!==void 0&&this.G.call(this.ht,t)}else this.G.value=t}get lt(){return typeof this.G=="function"?zt.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),jn=({host:t,popoverRef:e,disabled:s,openOnHover:i,openOnFocus:n,open:r,close:o})=>{const a=te(),l=()=>clearTimeout(a.current),c=()=>{clearTimeout(a.current),a.current=setTimeout(()=>{const d=e.current;i&&(t.matches(":hover")||d?.matches(":hover"))||t.matches(":focus-within")||d?.matches(":focus-within")||o()},100)},u=()=>{s||(l(),r())};return z(()=>{if(!(!i||s))return t.addEventListener("pointerenter",u),t.addEventListener("pointerleave",c),()=>{l(),t.removeEventListener("pointerenter",u),t.removeEventListener("pointerleave",c)}},[i,s,t]),z(()=>{if(!(!n||s))return t.addEventListener("focusin",u),t.addEventListener("focusout",c),()=>{l(),t.removeEventListener("focusin",u),t.removeEventListener("focusout",c)}},[n,s,t]),{scheduleClose:c,cancelClose:l}},Vn=t=>{if(t.newState!=="open")return;const i=t.target.querySelector("slot:not([name])")?.assignedElements({flatten:!0})??[];for(const n of i){const r=n.matches("[autofocus]")?n:n.querySelector("[autofocus]");if(r instanceof HTMLElement){r.focus();break}}},Bn=ce`
	:host {
...
`,Hn=t=>{const{placement:e="bottom span-right",disabled:s,openOnHover:i,openOnFocus:n}=t,r=te(),[o,a]=Fe("opened",!1),l=x(()=>{s||(a(!0),r.current?.showPopover())},[s]),c=x(()=>{a(!1),r.current?.hidePopover()},[]),u=x(()=>{if(s)return;r.current?.matches(":popover-open")?c():l()},[s]);z(()=>{const g=r.current;g&&(o?g.showPopover():g.hidePopover())},[o]),z(()=>{t.toggleAttribute("opened",!!o)},[o]);const{scheduleClose:d,cancelClose:h}=jn({host:t,popoverRef:r,disabled:s,openOnHover:i,openOnFocus:n,open:l,close:c}),p=n?l:u,f=x(g=>{Vn(g),a(g.newState==="open"),t.dispatchEvent(new ToggleEvent("dropdown-toggle",{newState:g.newState,oldState:g.oldState,composed:!0}))},[]);return v`
	...
	`};customElements.define("cosmoz-dropdown-next",B(Hn,{styleSheets:[Bn],observedAttributes:["placement","disabled","open-on-hover","open-on-focus"],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const X=t=>t??J;const _t=se(class extends ye{constructor(t){if(super(t),t.type!==G.PROPERTY&&t.type!==G.ATTRIBUTE&&t.type!==G.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!ai(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===V||e===J)return e;const s=t.element,i=t.name;if(t.type===G.PROPERTY){if(e===s[i])return V}else if(t.type===G.BOOLEAN_ATTRIBUTE){if(!!e===s.hasAttribute(i))return V}else if(t.type===G.ATTRIBUTE&&s.getAttribute(i)===e+"")return V;return li(t),e}});function A(t,e,s){return t?e(t):s?.(t)}const mi=(t,{label:e,invalid:s,errorMessage:i})=>v`
	...
	`,_i=["autocomplete","readonly","disabled","maxlength","invalid","no-label-float","always-float-label"],ms=mt`
	.wrap {
...
`,Un=t=>R(()=>{if(t==null)return;const e=new RegExp(t,"u");return s=>{!s.defaultPrevented&&s.data&&!e.test(s.data)&&s.preventDefault()}},[t]),Zt=Q(class extends q{values;constructor(t,e,s,i){super(t,e),Object.assign(e.host,s),this.values=i}update(t,e){this.hasChanged(e)&&(this.values=e,Object.assign(this.state.host,t))}hasChanged(t=[]){return t.some((e,s)=>this.values[s]!==e)}}),je=Q(class extends q{update(){return this.state.host}}),Yn=/([A-Z])/gu,Ft=(t,e,s)=>{t[e]=s,t.dispatchEvent(new CustomEvent(e.replace(Yn,"-$1").toLowerCase()+"-changed",{detail:{value:s}}))},Xn=(t,e,s=[e])=>{const i=je();z(()=>{Ft(i,t,e)},s)},bi=t=>{const e=te(void 0),s=x(l=>e.current=l,[]),i=t.shadowRoot,n=x(l=>t.dispatchEvent(new Event(l.type,{bubbles:l.bubbles})),[]),r=x(l=>Ft(t,"value",l.target.value),[]),o=x(l=>Ft(t,"focused",l.type==="focus"),[]),a=x(()=>{const l=e.current?.checkValidity();return t.toggleAttribute("invalid",!l),l},[]);return Zt({validate:a},[a]),z(()=>{const l=c=>{c.composedPath()[0]?.closest?.("input, textarea")||(c.preventDefault(),e.current?.focus())};return i.addEventListener("mousedown",l),()=>i.removeEventListener("mousedown",l)},[]),{onChange:n,onFocus:o,onInput:r,onRef:s}},Kn=({placeholder:t,noLabelFloat:e,label:s})=>(e?s:void 0)||t||" ",Jn=["type","pattern","allowed-pattern","min","max","step","autosize","label","placeholder",..._i],Wn=t=>{const{type:e="text",pattern:s,allowedPattern:i,autocomplete:n,value:r,readonly:o,disabled:a,min:l,max:c,step:u,maxlength:d}=t,{onChange:h,onFocus:p,onInput:f,onRef:g}=bi(t),m=Un(i);return mi(v`
			<input
				${be(g)}
				...
				step=${X(u)}
			/>
		`,t)};customElements.define("cosmoz-input",B(Wn,{observedAttributes:Jn,styleSheets:[Wt(yi)],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const _s=t=>{t.style.height="",t.style.height=`${t.scrollHeight}px`},Gn=(t,e=0)=>{if(e>0){const s=t.getAttribute("rows")??"",i=t.style.height;t.style.height="",t.setAttribute("rows",e),t.style.maxHeight=t.getBoundingClientRect().height+"px",t.style.height=i,t.setAttribute("rows",s)}},Zn=t=>{const{value:e,maxRows:s}=t,i=R(()=>()=>t.shadowRoot.querySelector("#input"),[]);z(()=>Gn(i(),s),[s,i]),z(()=>_s(i()),[i,e]),z(()=>{const n=i(),r=new ResizeObserver(()=>requestAnimationFrame(()=>_s(n)));return r.observe(n),()=>r.unobserve(n)},[i])},qn=["rows","placeholder",..._i],Qn=t=>{const{autocomplete:e,value:s,placeholder:i,readonly:n,disabled:r,rows:o,cols:a,maxlength:l}=t,{onChange:c,onFocus:u,onInput:d,onRef:h}=bi(t);return Zn(t),mi(v`
			<textarea id="input" part="input"
				...
				@change=${c} @focus=${u} @blur=${u}>`,t)};customElements.define("cosmoz-textarea",B(Qn,{observedAttributes:qn,styleSheets:[Wt(yi)],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const er=t=>{const{label:e,value:s,disabled:i,error:n}=t,r=x(o=>t.dispatchEvent(new CustomEvent("change",{detail:o.target.checked})),[]);return v`<input
			id="toggle"
			class="toggle"
			part="toggle"
			type="checkbox"
		...
		<slot name="suffix"></slot>
		${A(n,o=>v`<div class="failure">${o}</div>`)} `},tr=ce`
	.toggle {
		appearance: none;
		width: 35px;
		height: 18px;
...
`,Zr=({index:t,itemHeight:e,auto:s})=>ce`
	${A(!s,()=>ce`
			.item {
				line-height: ${e}px;
				height: ${e}px;
...
`,qr=t=>{const e=t==="auto",[s,i]=ee(e?40:t);return[s,n=>e?i(n):void 0]},Pi=Fn(()=>Si);customElements.define("cosmoz-keybinding-provider",Pi.Provider);const Qt=t=>{const e=R(()=>({}),[]);return R(()=>Object.assign(e,t),[e,...Object.values(t)])},Te=(t,e)=>{const s=pi(Pi),i=Qt(t);z(()=>s(i),e)},Qr=Symbol("listbox.navigate.up"),eo=Symbol("listbox.navigate.down"),to=Symbol("listbox.select"),so=({onUp:t,onDown:e,onEnter:s})=>{const i=je();Te({activity:Qr,callback:t,element:()=>i},[]),Te({activity:eo,callback:e,element:()=>i},[]),Te({activity:to,callback:s,element:()=>i},[])},io=({items:t,onSelect:e,defaultIndex:s=0})=>{const[i,n]=ee({index:s}),{index:r}=i,{length:o}=t;return z(()=>{n({index:i.index<0?s:Math.min(i.index,t.length-1),scroll:!0})},[t,s]),so({onUp:x(()=>n(a=>({index:a.index>0?a.index-1:o-1,scroll:!0})),[o]),onDown:x(()=>n(a=>({index:a.index<o-1?a.index+1:0,scroll:!0})),[o]),onEnter:x(()=>r>-1&&r<o&&e?.(t[r],r),[r,t,e])}),{position:i,highlight:x(a=>n({index:a}),[]),select:x(a=>e?.(a),[e])}},no=t=>typeof t=="object"&&t!==null&&Symbol.iterator in t;function re(t){return t==null?[]:Array.isArray(t)?t:typeof t=="string"?[t]:no(t)?Array.from(t):[t]}const At=(t,e=rt)=>s=>{const i=re(t).map(e);return re(s).filter(n=>!i.includes(e(n)))},ro=(t,e)=>e?s=>s!=null&&re(t).find(i=>i[e]===s[e]):s=>s!=null&&re(t).includes(s),oo=(t,e)=>{if(!e||!t)return t;const s=t.toLowerCase().indexOf(e.toLowerCase());if(s<0)return t;const i=s+e.length;return[t.slice(0,s),v`<mark>${t.slice(s,i)}</mark>`,t.slice(i)]},ao=(t=rt)=>(e,s,{highlight:i,select:n,textual:r=rt,query:o,isSelected:a})=>{const l=r(e),c=oo(l,o),u=t(c,e,s);return v`<div
				class="item"
				role="option"
				part="option"
				?aria-selected=${a(e)}
			...
			<div class="sizer" virtualizer-sizer>${u}</div>`},lo=({itemRenderer:t=ao(),...e})=>{const s=Qt(e);return x((i,n)=>t(i,n,s),[s,t])},co=["query","items","onSelect","textual","anchor","itemHeight","itemLimit","itemRenderer","defaultIndex","value","valueProperty","loading"],uo=({value:t,valueProperty:e,items:s,onSelect:i,defaultIndex:n,query:r,textual:o,itemRenderer:a,itemHeight:l=40,itemLimit:c=5})=>{const u=R(()=>ro(t,e),[t,e]),d=R(()=>s.slice(),[s,u]),{position:h,highlight:p,select:f}=io({items:d,onSelect:i,defaultIndex:isNaN(n)?void 0:Number(n)}),[g,m]=qr(l);return{position:h,items:d,height:Math.min(c,d.length)*g,highlight:p,select:f,itemHeight:g,setItemHeight:m,renderItem:lo({itemRenderer:a,items:d,position:h,highlight:p,select:f,textual:o,query:r,isSelected:u})}},Ns=Si,ho=t=>{const e=te(void 0),{position:s,items:i,renderItem:n,height:r,itemHeight:o,setItemHeight:a}=uo(t);return z(()=>{const l=e.current?.[Vt];l&&l.layoutComplete.then(()=>{t.dispatchEvent(new CustomEvent("layout-complete"));const{averageChildSize:c,averageMarginSize:u}=l._layout._metricsCache;return a(c+u*2)},Ns)},[i]),z(()=>{if(!s.scroll)return;const l=e.current?.[Vt];if(l){if(!l?._layout){l.layoutComplete.then(()=>l.element(s.index)?.scrollIntoView({block:"nearest"}),Ns);return}l.element(s.index)?.scrollIntoView({block:"nearest"})}},[s]),Xr(Zr({...s,itemHeight:o,auto:t.itemHeight==="auto"})),v`<div
			class="items"
		...
		<slot></slot>`};customElements.define("cosmoz-listbox",B(ho,{styleSheets:[Gt(Gr)]}));const po=({multi:t,...e},s)=>v`<cosmoz-listbox
		part="listbox"
		?multi=${t}
		...=${Hr(Jr(co)(e))}
		>${s}</cosmoz-listbox
...
`;customElements.define("cosmoz-autocomplete-chip",B(mo,{observedAttributes:["disabled"],styleSheets:[Gt(fo)]}));const _o=({content:t,onClear:e,disabled:s,hidden:i,className:n="chip",slot:r})=>v`<cosmoz-autocomplete-chip
		class=${X(n)}
		slot=${X(r)}
		part="chip"
	...
	>`,yo=({value:t,min:e=0,onDeselect:s,textual:i,disabled:n,chipRenderer:r=_o})=>[...t.filter(Boolean).map(o=>r({item:o,content:i(o),onClear:t.length>e&&(()=>s(o)),disabled:n,slot:"control"})),r({item:null,content:v`<span></span>`,className:"badge",disabled:!0,slot:"control",hidden:!0})],bo=ce`
	:host {
		display: inline-block;
		vertical-align: middle;
...
`;customElements.define("cosmoz-autocomplete-skeleton-span",B(()=>J,{styleSheets:[bo]}));const vo=mt`
	:host {
		display: block;
		position: relative;
		min-width: 35px;
...
`,es=(t,e=()=>({}))=>{const s={type:t,toString(){return t}};return Object.assign((...n)=>Object.assign(e(...n),s),s)},Is=t=>t.type||t.toString(),Ms=t=>Array.isArray(t)?t:[t],wo=(t,e)=>{const s=Ms(e),i=(s.every(Array.isArray)?s:[s]).map(([n,r])=>({actions:Ms(n).map(Is),handle:r}));return(n=t,r)=>{const o=i.find(a=>a.actions.includes(Is(r)));return o?o.handle(n,r):n}},ae={pending:"pending",rejected:"rejected",resolved:"resolved"},Ci={error:void 0,result:void 0,state:ae.pending},Ei=es(ae.pending),Oi=es(ae.resolved,t=>({result:t})),$i=es(ae.rejected,t=>({error:t})),xo=wo(Ci,[[Ei,()=>({error:void 0,result:void 0,state:ae.pending})],[Oi,(t,{result:e})=>({error:void 0,result:e,state:ae.resolved})],[$i,(t,{error:e})=>({error:e,result:void 0,state:ae.rejected})]]),zi=t=>{const[{error:e,result:s,state:i},n]=fi(xo,Ci);return z(()=>{if(!t)return;let r=!1;return n(Ei()),t.then(o=>!r&&n(Oi(o)),o=>!r&&n($i(o))),()=>{r=!0}},[t]),[s,e,i]},So=Symbol("autocomplete.deselect.last"),Po=Symbol("autocomplete.search.when.selected"),Ds=t=>t.normalize("NFD").replace(/[\u0300-\u036f]/gu,""),Co=(t,e,s)=>{if(!e)return t;const i=Ds(e.toLowerCase()),n=[];for(const r of t){const a=Ds(s(r).toLowerCase()).indexOf(i);a<0||n.push({item:r,index:a})}return n.sort((r,o)=>r.index-o.index).map(({item:r})=>r)},Eo=t=>t===!1||t==null?[]:t,Oo=(t,e,s)=>t.dispatchEvent(new CustomEvent(e,{detail:s})),Fs=[],$o=t=>(...e)=>{let s;const i=()=>{s&&cancelAnimationFrame(s)};return i(),s=requestAnimationFrame(()=>{s=void 0,t(...e)}),i},zo=(t,e,s)=>x(i=>{e?.(i),t.dispatchEvent(new CustomEvent(s,{detail:i}))},[e]),To=({value:t,text:e,onChange:s,onText:i,onSelect:n,limit:r,min:o,source:a,textProperty:l,textual:c,valueProperty:u,keepOpened:d,keepQuery:h,preserveOrder:p,defaultIndex:f,externalSearch:g,disabled:m,lazyOpen:y})=>{const _=r!=null?Number(r):void 0,P=R(()=>(c??Kr)(l),[c,l]),S=je(),[C,b]=Fe("opened",!1),E=!e,T=R(()=>e?.trim(),[e]),N=zo(S,i,"text"),H=x(O=>{s?.(O,()=>b(!1)),Oo(S,"value",O)},[s]),[M,ie]=ee([]),W=!!(y&&!T),U=R(()=>W?Promise.resolve([]):Promise.resolve(typeof a=="function"?a({query:T,active:C}):a).then(Eo),[a,C,T,W]),k=R(()=>re(t),[t]);z(()=>U.then(ie),[U]),Te({activity:So,callback:()=>{const O=re(k);O.length>0&&H(O.slice(0,-1))},check:()=>!m&&E&&S.matches(":focus-within"),element:()=>S},[]),Te({activity:Po,callback:O=>{const D=re(k),K=_===1;D.length>0&&K&&O.key.length===1&&H(D.slice(0,-1))},allowDefault:!0,check:()=>!m&&E&&S.matches(":focus-within"),element:()=>S},[_]),z(()=>{!C&&!h&&N("")},[C,h]),z(()=>{S.toggleAttribute("opened",!!C)},[C]);const I=Qt({onText:N,onChange:H,value:k,limit:_,min:o,keepQuery:h,keepOpened:d,setOpened:b,onSelect:n,valueProperty:u}),[,,he]=zi(U);return{limit:_,opened:C,query:T,textual:P,value:k,source$:U,loading:he==="pending",items:R(()=>{if(!C||W)return Fs;const O=p?M:[...k,...At(k,Ge(u))(M)];return g?O:Co(O,T,P)},[M,C,T,P,E,k,p,u,g,W]),onToggle:x(O=>{m||b(O.newState==="open")},[m]),onText:x(O=>{m||(N(O.target.value),b(!0))},[m,N,e,b]),onSelect:x(O=>{if(m)return;I.onSelect?.(O,I);const{onChange:D,onText:K,limit:pe,min:un,value:dn,keepQuery:hn,keepOpened:pn,setOpened:fn,valueProperty:gn}=I;hn||K(""),pn||fn(!1);const Be=re(dn),Ot=Ge(gn),cs=Be.some(mn=>Ot(mn)===Ot(O));cs&&Be.length===un||D((cs?At(O,Ot)(Be):[...Be,O]).slice(-pe))},[m,I]),onDeselect:x(O=>{m||I.onChange(At(O,Ge(I.valueProperty))(I.value))},[m,I]),defaultIndex:T!==void 0&&T?.length>0?0:f}},Lo=t=>{const e=t.shadowRoot.querySelectorAll(".chip"),s=t.shadowRoot.querySelector(".badge");s.hidden=!0;for(const a of e)a.hidden=!1;const n=t.shadowRoot.querySelector("cosmoz-input").shadowRoot?.querySelector(".control")?.getBoundingClientRect();let r;for(r=0;r<e.length;r++){const l=e[r].getBoundingClientRect();if(!(l.x+l.width<=n.x+n.width-24))break}const o=e.length-r;for(s.querySelector("span").textContent="+"+o.toString(),s.hidden=o<1;r<e.length;r++)e[r].hidden=!0},Ao=({value:t,opened:e,wrap:s,limit:i})=>{const n=je(),r=!(s||i===1),o=R(()=>$o(()=>Lo(n)),[]),[a,l]=ee(0);Qe(()=>{if(!r)return;const c=n.shadowRoot.querySelector("cosmoz-input"),u=new ResizeObserver(d=>{l(d[0].contentRect.width)});return u.observe(c),()=>u.disconnect()},[r]),Qe(()=>r?o():void 0,[r,a,e,t])},Ro=["input","control","label","line","error","wrap"].map(t=>`${t}: input-${t}`).join(),ko=({opened:t,isSingle:e,showSingle:s,hasResultsOrQuery:i})=>!t||e&&!s?!1:i,No=t=>{const{opened:e,invalid:s,errorMessage:i,label:n,placeholder:r,disabled:o,noLabelFloat:a,alwaysFloatLabel:l,textual:c,text:u,onText:d,onToggle:h,onDeselect:p,value:f,limit:g,min:m,showSingle:y,items:_,source$:P,loading:S,chipRenderer:C}=t,b=g===1,E=b&&f?.[0]!=null,T=S||_.length>0||u!=null&&u.length>0;return v`<cosmoz-dropdown-next
			open-on-focus
			?disabled=${o}
			.opened=${e}
			@dropdown-toggle=${h}
		...
		>
			...
			>
				...
				${yo({value:f,min:m,onDeselect:p,textual:c,disabled:o,chipRenderer:C})}
			</cosmoz-input>

			${A(ko({opened:e,isSingle:E,showSingle:y,hasResultsOrQuery:T}),()=>po({...t,items:_,multi:!b},A(S,()=>v`<cosmoz-autocomplete-skeleton-span></cosmoz-autocomplete-skeleton-span>`,()=>A(u!=null&&u.length>0&&_.length===0,()=>v`<slot name="no-result">
											<p class="no-result">${Er("No results found")}</p>
										</slot>`))))}
		</cosmoz-dropdown-next>`},Ti=t=>{const e={...t,...To(t)};return Ao(e),No(e)},Li=["disabled","invalid","no-label-float","always-float-label","text-property","value-property","limit","min","show-single","preserve-order","keep-opened","keep-query","default-index","external-search","item-height","item-limit","wrap","lazy-open"],Io=t=>{const{onChange:e,onText:s,...i}=t,[n,r]=Fe("value");return z(()=>{t.onChange!=null&&console.warn("onChange is deprecated; use value-changed and lift instead")},[]),Ti({...i,value:n,onChange:x((o,...a)=>{r(o),e?.(o,...a)},[e]),onText:x(o=>{t.text=o,s?.(o)},[s])})},Ai=[Gt(vo)],Ri={mode:"open",delegatesFocus:!0};customElements.define("cosmoz-autocomplete-ui",B(Ti,{observedAttributes:Li,styleSheets:Ai,shadowRootInit:Ri}));customElements.define("cosmoz-autocomplete",B(Io,{observedAttributes:Li,styleSheets:Ai,shadowRootInit:Ri}));const ki="important",Mo=" !"+ki,Ni=se(class extends ye{constructor(t){if(super(t),t.type!==G.ATTRIBUTE||t.name!=="style"||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,s)=>{const i=t[s];return i==null?e:e+`${s=s.includes("-")?s:s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`},"")}update(t,[e]){const{style:s}=t.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const i of this.ft)e[i]==null&&(this.ft.delete(i),i.includes("-")?s.removeProperty(i):s[i]=null);for(const i in e){const n=e[i];if(n!=null){this.ft.add(i);const r=typeof n=="string"&&n.endsWith(Mo);i.includes("-")||r?s.setProperty(i,r?n.slice(0,-11):n,r?ki:""):s[i]=n}}return V}});class Do extends Promise{constructor(e){const s={};super((i,n)=>Object.assign(s,{resolve:i,reject:n})),Object.assign(this,s),e?.(s.resolve,s.reject)}resolve=()=>{}}const Ii={host:{position:"relative",display:"flex",overflow:"hidden"},slide:{position:"static",width:"100%",height:"100%"}},Fo=t=>{const{slide:e}=t,[s,i]=ee([]);return Qe(()=>{Object.assign(t.style,Ii.host)},[]),z(()=>{if(e==null)return;const n={animationEnd$:new Do,...e};i((r=[])=>{const o=r.findIndex(({id:a,out:l})=>a===n.id&&l!==!0);return o!==-1?[...r.slice(0,o),n,...r.slice(o+1,r.length)]:[...r,n]})},[e]),Qe(async()=>{if(s.filter(l=>!l.out).length<2){const l=s[0];l&&requestAnimationFrame(()=>requestAnimationFrame(()=>l.animationEnd$.resolve()));return}const n=s[s.length-1],r=s[s.length-2],o=n.el,a=r.el;r.out=!0,o&&a&&await n.animation?.(o,a),i((l=[])=>l.filter(c=>c!==r))},[s]),{slides:s}},jo=t=>v`<div
		${be(e=>Object.assign(t,{el:e}))}
		class="slide"
		style=${Ni(Ii.slide)}
	>
		${_e([t],()=>t.content??t.render?.(t))}
	</div>`,Vo=({slides:t})=>_e([t],()=>xi(t,({id:e})=>e,jo)),Bo=t=>Vo(Fo(t));customElements.define("cosmoz-slider",B(Bo,{useShadowDOM:!1}));const ot=(t,e)=>{const s=t.animate([{position:"absolute",transform:"translateX(100%)"},{transform:"translateX(0%)"}],{duration:200,fill:"none",easing:"ease-in-out"}),i=e.animate([{},{position:"absolute",transform:"translateX(-100%)"}],{duration:200,fill:"none",easing:"ease-in-out"});return Promise.all([s.finished,i.finished])},Ho=(t,e)=>{const s=t.animate([{position:"absolute",transform:"translateX(-100%)"},{transform:"translateX(0%)"}],{duration:200,fill:"none",easing:"ease-in-out"}),i=e.animate([{},{position:"absolute",transform:"translateX(100%)"}],{duration:200,fill:"none",easing:"ease-in-out"});return Promise.all([s.finished,i.finished])},Uo=()=>v`<style>
	@keyframes rotating {
		100% {
...
</style>`;customElements.define("cz-spinner",B(Uo));const Yo=Q(class extends q{constructor(t,e){super(t,e),this.dispatchEvent=(...s)=>{e.host.dispatchEvent.apply(e.host,s)}}update(){return this.dispatchEvent}}),at=(t,e,s)=>Math.max(e,Math.min(s,t)),lt=at,ts=(t,e,s,i)=>s/i<t/e?s/t:i/e,Xo=(t,e,s,i)=>s/i>t/e?s/t:i/e,Mi=(t,e,s,i,n)=>{const r=ts(t,e,s,i),o=r*n,a=t*o,l=e*o,c=a<s?(-s+a)/2:(s-a)/2,u=a<s?(s-a)/2:(-s+a)/2,d=l<i?(-i+l)/2:(i-l)/2,h=l<i?(i-l)/2:(-i+l)/2;return{x:[c,u],y:[d,h]}},Di="empty",xt="loading",Fi="loaded",ss="error",Ve="idle",St="panning",Le="pinching",Ko=1.1,Jo=t=>Ko/t,Wo=t=>2*t,is=(t,e,s,i)=>{const n=ts(t,e,s,i),r=Xo(t*n,e*n,s,i);return Math.max(Jo(n),Wo(r))},Go={status:Di,interaction:Ve,iw:100,ih:100,cw:100,ch:100,zoom:1,panX:0,panY:0,pointers:{}},ji=(t,e)=>{const s={...t};return delete s[e],s},js=t=>{const e=Object.keys(t);if(e.length<2)return null;const s=t[e[0]],i=t[e[1]];return{midX:(s.x+i.x)/2,midY:(s.y+i.y)/2,distance:Math.hypot(i.x-s.x,i.y-s.y)}},Ne=t=>{const e=Mi(t.iw,t.ih,t.cw,t.ch,t.zoom);return{...t,panX:lt(t.panX,e.x[0],e.x[1]),panY:lt(t.panY,e.y[0],e.y[1])}},Bt=(t,e,s,i=2)=>t<e?e-(e-t)/i:t>s?s+(t-s)/i:t,Vi=t=>{const e=Mi(t.iw,t.ih,t.cw,t.ch,t.zoom);return{...t,panX:Bt(t.panX,e.x[0],e.x[1]),panY:Bt(t.panY,e.y[0],e.y[1])}},Bi=(t,{dPanX:e=0,dPanY:s=0,scaleDiff:i=1,originX:n=0,originY:r=0})=>{const o=t.zoom*i;return{...t,zoom:o,panX:e+n+(t.panX-n)*i,panY:s+r+(t.panY-r)*i}},ns=(t,e,s)=>{const i=is(t.iw,t.ih,t.cw,t.ch),n=lt(t.zoom,1,i);if(n===t.zoom)return t;const r=n/t.zoom;return{...t,zoom:n,panX:e+(t.panX-e)*r,panY:s+(t.panY-s)*r}},Zo=(t,e)=>e.type==="load"?{...t,status:xt}:t,qo=(t,e)=>{switch(e.type){case"loaded":return{...t,status:Fi,...e.dimensions,panX:0,panY:0,zoom:1};case"error":return{...t,status:ss};default:return t}},Qo=(t,e)=>e.type==="load"?{...t,status:xt}:t,ea=(t,e)=>e.type==="pointerdown"?{...t,interaction:St,pointers:{...t.pointers,[e.id]:{x:e.x,y:e.y}}}:t,ta=(t,e)=>{switch(e.type){case"pointerdown":{const s={...t.pointers,[e.id]:{x:e.x,y:e.y}};return{...t,interaction:Le,pointers:s}}case"pointermove":{const s=t.pointers[e.id];if(!s)return t;const i=e.x-s.x,n=e.y-s.y;return Vi({...t,panX:t.panX+i,panY:t.panY+n,pointers:{...t.pointers,[e.id]:{x:e.x,y:e.y}}})}case"pointerup":{const s=ji(t.pointers,e.id);if(Object.keys(s).length===0){const i=ns({...t,pointers:s},e.settleOriginX??0,e.settleOriginY??0);return Ne({...i,interaction:Ve})}return{...t,pointers:s}}default:return t}},sa=(t,e)=>{switch(e.type){case"pointermove":{if(!t.pointers[e.id])return t;const i=js(t.pointers),n={...t.pointers,[e.id]:{x:e.x,y:e.y}},r=js(n);if(!i||!r)return{...t,pointers:n};const o=i.distance?r.distance/i.distance:1,a=r.midX-i.midX,l=r.midY-i.midY,c=e.containerOriginX+(r.midX-e.x),u=e.containerOriginY+(r.midY-e.y),d=Bi({...t,pointers:n},{dPanX:a,dPanY:l,scaleDiff:o,originX:c,originY:u}),h=is(t.iw,t.ih,t.cw,t.ch),p=Bt(d.zoom,1,h),f=p/d.zoom,g=c+(d.panX-c)*f,m=u+(d.panY-u)*f;return Vi({...d,zoom:p,panX:g,panY:m})}case"pointerup":{const s=ji(t.pointers,e.id);if(Object.keys(s).length<=1){const i=Ne(ns({...t,pointers:s},e.settleOriginX??0,e.settleOriginY??0));return Object.keys(s).length===1?{...i,interaction:St}:{...i,interaction:Ve}}return{...t,pointers:s}}default:return t}},ia=(t,e)=>{switch(t.interaction){case Ve:return ea(t,e);case St:return ta(t,e);case Le:return sa(t,e);default:return t}},na=(t,e)=>{switch(e.type){case"load":return{...t,status:xt,interaction:Ve,panX:0,panY:0,zoom:1,pointers:{}};case"zoom":{const s=is(t.iw,t.ih,t.cw,t.ch),i=lt(e.zoom,1,s);return Ne({...t,zoom:i})}case"wheel":{const{delta:s,originX:i,originY:n}=e,r=1+s,o=Bi(t,{scaleDiff:r,originX:i,originY:n});return Ne(ns(o,i,n))}case"pointerdown":case"pointermove":case"pointerup":return ia(t,e);default:return t}},ra=(t,e)=>{if(e.type==="resize")return Ne({...t,cw:e.rect.width,ch:e.rect.height});switch(t.status){case Di:return Zo(t,e);case xt:return qo(t,e);case Fi:return na(t,e);case ss:return Qo(t,e);default:return t}},oa=(t,e)=>{"ResizeObserver"in window&&z(()=>{if(e==null)return;const s=new ResizeObserver(([{contentRect:i}])=>t(i));return s.observe(e),t(e.getBoundingClientRect()),()=>s.unobserve(e)},[t,e])},Rt=(t,e=.08,s=.001)=>{const[i,n]=ee(null);return z(()=>{if(i==null){n(t);return}if(e>=1){n(t);return}const r=i;window.requestAnimationFrame(()=>{const o=t-r;n(Math.abs(o)<s?t:i+o*e)})},[i,n,t,e,s]),i},aa=(t,e,s,i)=>{const{iw:n=100,ih:r=100,cw:o=100,ch:a=100}=t,l=ts(n,r,o,a),c=l*e;return{position:"absolute",top:"50%",left:"50%",transform:["translate(-50%, -50%)",`translate(${s}px, ${i}px)`,`scale(${c})`].join(" ")}},kt=(t,e,s)=>{const i=s.current?.getBoundingClientRect();return i?{originX:t-i.left-i.width/2,originY:e-i.top-i.height/2}:{originX:0,originY:0}},la=(t=.08)=>{const[e,s]=fi(ra,Go),i=te(),n=x(()=>s({type:"load"}),[s]),r=x(b=>s({type:"loaded",dimensions:b}),[s]),o=x(()=>s({type:"error"}),[s]),a=x(b=>s({type:"zoom",zoom:b}),[s]),l=x(b=>b&&s({type:"resize",rect:b}),[s]),c=x(()=>l(i.current&&i.current.getBoundingClientRect()),[l]);oa(l,i.current);const u=x(b=>r({iw:b.target.naturalWidth,ih:b.target.naturalHeight}),[r]),d=x(b=>{i.current?.setPointerCapture(b.pointerId),s({type:"pointerdown",id:b.pointerId,x:b.clientX,y:b.clientY})},[s]),h=x(b=>{const{originX:E,originY:T}=kt(b.clientX,b.clientY,i);s({type:"pointermove",id:b.pointerId,x:b.clientX,y:b.clientY,containerOriginX:E,containerOriginY:T})},[s]),p=te({x:0,y:0});z(()=>{if(e.interaction!==Le)return;const b=Object.keys(e.pointers);if(b.length>=2){const E=e.pointers[b[0]],T=e.pointers[b[1]],N=(E.x+T.x)/2,H=(E.y+T.y)/2,{originX:M,originY:ie}=kt(N,H,i);p.current={x:M,y:ie}}},[e.pointers,e.interaction]);const f=x(b=>{try{i.current?.releasePointerCapture(b.pointerId)}catch{}s({type:"pointerup",id:b.pointerId,settleOriginX:p.current.x,settleOriginY:p.current.y})},[s]),g=x(b=>{b.preventDefault();const{originX:E,originY:T}=kt(b.clientX,b.clientY,i);s({type:"wheel",delta:-Math.sign(b.deltaY)*.8,originX:E,originY:T})},[s]),m=e.interaction===Le,y=e.interaction===St||e.interaction===Le;let _=t;m?_=.8:y&&(_=.9);const P=Rt(e.zoom,_),S=Rt(e.panX,_),C=Rt(e.panY,_);return{...e,load:n,loaded:r,error:o,zoomTo:a,resize:c,onPointerDown:d,onPointerMove:h,onPointerUp:f,onImageLoad:u,onWheel:g,containerRef:i,style:aa(e,P,S,C)}},ca=({src:t,disabled:e,zoomStiffness:s})=>{const{status:i,zoom:n,load:r,error:o,zoomTo:a,resize:l,onPointerDown:c,onPointerMove:u,onPointerUp:d,onImageLoad:h,onWheel:p,style:f,containerRef:g}=la(s);if(z(r,[t]),Zt({zoomTo:a,resize:l,zoom:n},[a,l,n]),!t)return J;const m=Yo();return z(()=>m(new CustomEvent("zoom-changed",{detail:{value:n}})),[m,n]),z(()=>m(new CustomEvent("status-changed",{detail:{value:i}})),[m,i]),v`
		<style>
			:host {
				display: block;
			}
...
`,Kl=(t,e)=>{const s=t.width/t.height,i=e.width/e.height;return s>i?{width:e.width,height:t.height*(e.width/t.width)}:{width:t.width*(e.height/t.height),height:e.height}},Jl=async(t,e)=>{const s={credentials:"include"},[{jsPDF:i},...n]=await Promise.all([ft(()=>import("./jspdf.es-CKFOE4aL.js").then(a=>a.j),__vite__mapDeps([0,1]),import.meta.url),...t.map(async a=>{const l=await Promise.resolve(qt(a)),c=await fetch(l,s);return c.ok?{url:l,data:new Uint8Array(await c.arrayBuffer())}:void 0})]),r=n.filter(Boolean);if(r.length<1)return;const o=new i({compress:!0});return r.filter(Boolean).forEach(({url:a,data:l},c)=>{const{internal:{pageSize:d}}=o,{width:h,height:p}=Kl(o.getImageProperties(l),{width:d.getWidth()-4,height:d.getHeight()-4});c>0&&o.addPage(),o.addImage(l,a.split(".").pop().toUpperCase(),2,2,h,p)}),o.output("blob")},an=(t,e)=>{const s=URL.createObjectURL(t),i=document.body.appendChild(document.createElement("a"));i.href=s,i.download=`${e}.pdf`,i.click(),document.body.removeChild(i),URL.revokeObjectURL(s)},Wl=async(t,e,s)=>{const i=await Jl(t);if(i)return an(i,e),i},Gl=async(t,e,s={})=>{const{httpHeaders:i,withCredentials:n=!0}=s,r=await fetch(t,{credentials:n?"include":"omit",headers:i});if(!r.ok)return;const o=await r.blob();return an(o,e),o};let Zl;const ql=async()=>Zl??=(await ft(async()=>{const{url:t}=await import("./popout-entry-D5AyJVvm.js");return{url:t}},__vite__mapDeps([2,1,3,4]),import.meta.url)).url,Ql=t=>Object.entries(t).map(([e,s])=>e+"="+s).join(",");let pt=null;const ln=()=>pt!=null&&!pt.closed,ec=(t,{entryUrl:e,state:s,sync:i,title:n,onDetach:r,onClose:o})=>{t.__popoutState=s,t.__popoutSync=i,t.__popoutReady=r,t._onClose=o;const a=t.document;a.open(),a.write(`<!DOCTYPE html>
<html>
<head>
...
<body>
	<script type="module" src="${e}"><\/script>
...
</html>`),a.close(),pt=t,t.addEventListener("beforeunload",()=>t._onClose?.()),t.addEventListener("beforeunload",()=>pt=null)},tc=async({source:t,fileIndex:e,index:s,syncImageIndex:i,syncFileIndex:n,title:r,loop:o,detachedShowZoom:a,onDetach:l,onClose:c})=>{const u=window.open(void 0,"czimgviewer",Ql({height:700,width:800})),d=globalThis["pdfjs-dist/build/pdf"]?.GlobalWorkerOptions?.workerSrc??globalThis.pdfjsLib?.GlobalWorkerOptions?.workerSrc,h={source:t,fileIndex:e,index:s,detachedShowZoom:a,loop:o,title:r,pdfWorkerSrc:d},p={imageIndex:g=>i({detail:{value:g}}),fileIndex:g=>n({detail:{value:g}})};if(ln()&&u.__popoutUpdate){u._onClose?.(),u.__popoutUpdate(h),u.__popoutSync=p,u._onClose=c,l();return}const f=await ql();ec(u,{entryUrl:f,state:h,sync:p,title:r,onDetach:l,onClose:c})},sc=t=>new Promise(e=>{const s=setInterval(()=>{t()&&(e(),clearInterval(s))},100)}),ic=({images:t})=>{const e=window.open(void 0,"czimgviewerprint");Jt(v`<style>
				img {
					display: block;
			...
			${t.map(s=>v`<img src="${ke(Promise.resolve(qt(s)))}" />`)}`,e.document.body),sc(()=>Array.from(e.document.querySelectorAll("img")).every(s=>s.src&&s.complete)).then(()=>e.print()).then(()=>e.close())},nc=({files:t,safeFileIndex:e,imageIndex:s,title:i,loop:n,detachedShowZoom:r,setImageIndex:o,setFileIndex:a})=>{const[l,c]=ee(!1),u=x(p=>o(p.detail.value),[o]),d=x(p=>a(p.detail.value),[a]),h=x(()=>tc({source:t,fileIndex:e,index:s,syncImageIndex:u,syncFileIndex:d,title:i,loop:n,detachedShowZoom:r,onDetach:()=>c(!0),onClose:()=>c(!1)}),[t,e,s,i,n,r]);return{detached:l,detach:h,syncDetachedState:p=>c(p.detail.value)}},ni=[],rc=({source:t,images:e,pdf:s,pdfOptions:i})=>t??(e!=null||s!=null?[{images:e??ni,pdf:s,pdfOptions:i}]:ni),ri=[],oc=t=>{const e=R(()=>typeof t=="function"?Promise.resolve(t()):void 0,[t]),[s,i,n]=zi(e);return typeof t!="function"?{files:t??ri,loading:!1,error:void 0}:{files:s??ri,loading:n==="pending",error:i}},ac=[],lc=t=>{const e=R(()=>rc({source:t.source,images:t.images,pdf:t.pdf,pdfOptions:t.pdfOptions}),[t.source,t.images,t.pdf,t.pdfOptions]),{files:s,loading:i,error:n}=oc(e),[r,o]=Fe("currentFileIndex",0),a=s.length>0?at(r??0,0,s.length-1):0,l=s[a],c=l?[l]:ac,u=te(ot),d=x(h=>{const p=h.detail?.[0],f=s.indexOf(p);f>=0&&(u.current=ot,o(f))},[s]);return z(()=>{const h=r??0;s.length>0&&h>=s.length&&o(0)},[s]),{files:s,loading:i,error:n,fileIndex:r,setFileIndex:o,safeFileIndex:a,selectedFile:l,value:c,onSelect:d,directionRef:u}},cc=()=>{const[t,e]=ee(!1);return{isFullscreen:t,openFullscreen:()=>e(!0),closeFullscreen:()=>e(!1)}},oi=(t,e,s,i)=>{const n=t.length;let r=1;for(;r<=n;){const o=(e+r*s+n)%n;if(!i&&(s>0&&o<=e||s<0&&o>=e))return null;const a=t[o];if(a.images?.length||a.pdf)return o;r++}return null},Pe=[],uc=t=>{const[e,s]=ee({images:Pe,loading:!1,error:void 0});return z(()=>{if(!t){s({images:Pe,loading:!1,error:void 0});return}const i=t.pdf,n=t.images??Pe;if(!i){s({images:n,loading:!1,error:void 0});return}s({images:Pe,loading:!0,error:void 0});let r=!1;return ft(async()=>{const{loadPdfThunks:o}=await import("./pdf-loader-B_xPwwqY.js");return{loadPdfThunks:o}},__vite__mapDeps([5,1]),import.meta.url).then(({loadPdfThunks:o})=>o(i,t.pdfOptions)).then(o=>{r||s({images:o,loading:!1,error:void 0})}).catch(o=>{r||s({images:Pe,loading:!1,error:o})}),()=>{r=!0}},[t]),e},dc=({files:t,safeFileIndex:e,loop:s,setFileIndex:i,directionRef:n})=>{const[r,o]=Fe("currentImageIndex",0),a=t[e],{images:l,loading:c,error:u}=uc(a),d=l.length>0?at(r??0,0,l.length-1):0,h=l[d],p=!s&&e===0&&d<=0,f=!s&&e===t.length-1&&d>=l.length-1,g=te(!1),m=x(()=>{if(n.current=ot,d<l.length-1)return o(d+1);const _=oi(t,e,1,s);_!=null&&(i(_),o(0))},[d,l.length,t,e,s]),y=x(()=>{if(n.current=Ho,d>0)return o(d-1);const _=oi(t,e,-1,s);_!=null&&(g.current=!0,i(_))},[d,t,e,s]);return z(()=>{if(l.length===0)return;if(g.current){g.current=!1,o(l.length-1);return}const _=r??0;_>=l.length&&o(at(_,0,l.length-1))},[l]),{imageIndex:r,setImageIndex:o,nextImage:m,previousImage:y,first:p,last:f,index:d,image:h,images:l,contentLoading:c,contentError:u,gotoLastRef:g,downloadFileName:a?.downloadFileName??"archive"}},hc=Symbol("memo"),pc=t=>{let e=hc,s;return function(i){if(e===i)return s;const n=t(i);return s=n,e=i,n}},cn=t=>{if(!t.currentTarget.parentElement)return;t.currentTarget.parentElement.querySelector(".error").removeAttribute("hidden"),t.currentTarget.setAttribute("hidden",!0)},fc=t=>t.detail.value==="error"&&cn(t),gc=({src$:t,showZoom:e,isZoomed:s})=>{const i=_e(t,()=>ke(t));return[e?v`<haunted-pan-zoom
					.src=${i}
					?disabled=${!s}
					@status-changed=${fc}
				></haunted-pan-zoom>`:v`<img .src=${i} style="width:100%" @error=${cn} />`,_e(t,()=>ke(t.then(()=>J),v`<cz-spinner></cz-spinner>`))]},mc=t=>v`<div>
		<div hidden class="error">
			<h2>An error occurred while loading the image.</h2>
			<div class="desc">${t.image}</div>
		</div>
		${gc(t)}
	</div>`,_c=({image:t,showZoom:e,isZoomed:s,directionRef:i})=>{const n=R(()=>pc(r=>Promise.resolve(qt(r))),[]);return R(()=>t==null?{id:Math.random(),content:J,animation:ot}:{id:t,render:()=>mc({src$:n(t),showZoom:e,isZoomed:s,image:t}),animation:i.current},[t,e,s])},yc=50,bc=300,vc=(t,{onSwipeLeft:e,onSwipeRight:s,enabled:i})=>{const n=te(null);z(()=>{if(!i)return;const r=a=>{if(a.touches.length!==1)return;const l=a.touches[0];n.current={x:l.clientX,y:l.clientY,t:Date.now()}},o=a=>{if(!n.current)return;const l=a.changedTouches[0],c=l.clientX-n.current.x,u=l.clientY-n.current.y,d=Date.now()-n.current.t;n.current=null,!(d>bc)&&(Math.abs(c)<yc||Math.abs(c)<Math.abs(u)||(c<0?e?.():s?.()))};return t.addEventListener("touchstart",r,{passive:!0}),t.addEventListener("touchend",o,{passive:!0}),()=>{t.removeEventListener("touchstart",r),t.removeEventListener("touchend",o)}},[t,e,s,i])},wc=()=>{const[t,e]=ee(!1),s=x(()=>(e(i=>!i),t?1:1.5),[t]);return{isZoomed:t,toggleZoom:s}},xc=t=>{const{showZoom:e,title:s,loop:i,detachedShowZoom:n}=t,{files:r,loading:o,error:a,setFileIndex:l,safeFileIndex:c,selectedFile:u,value:d,onSelect:h,directionRef:p}=lc(t),{setImageIndex:f,nextImage:g,previousImage:m,first:y,last:_,index:P,image:S,images:C,contentLoading:b,contentError:E,downloadFileName:T}=dc({files:r,safeFileIndex:c,loop:i,setFileIndex:l,directionRef:p}),{isZoomed:N,toggleZoom:H}=wc();vc(t,{enabled:!N,onSwipeLeft:g,onSwipeRight:m});const M=_c({image:S,showZoom:e,isZoomed:N,directionRef:p}),{isFullscreen:ie,openFullscreen:W,closeFullscreen:U}=cc(),{detached:k,detach:I,syncDetachedState:he}=nc({files:r,safeFileIndex:c,imageIndex:P,title:s,loop:i,detachedShowZoom:n,setImageIndex:f,setFileIndex:l}),O=x(()=>{ln()&&I()},[I]);Xn("detached",k,[k]),z(()=>{t.toggleAttribute("hidden",k)},[k]),Zt({syncState:O},[O]);const D=r.length>1||C.length>=2,K=R(()=>u?.pdf?()=>Gl(u.pdf,T,u.pdfOptions):()=>Wl(C,T),[u,T,C]),pe=x(()=>ic({images:C}),[C]);return{host:t,isZoomed:N,toggleZoom:H,currentSlide:M,nextImage:g,previousImage:m,first:y,last:_,total:C.length,hasNav:D,currentImageIndex:P,selectedImageNumber:P+1,onDownloadPdf:K,isFullscreen:ie,openFullscreen:W,closeFullscreen:U,onPrintPdf:pe,detached:k,detach:I,syncDetachedState:he,setFileIndex:l,setImageIndex:f,loading:o||b,error:a,contentError:E,files:r,selectedFile:u,selectedIndex:c,value:d,onSelect:h,images:C}},Sc=v`<svg
	viewBox="0 0 24 24"
