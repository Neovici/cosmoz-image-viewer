...
>
	...
	${A(p,()=>Ul(v`<cosmoz-image-viewer
				...
				?loop=${t.loop}
			></cosmoz-image-viewer>`))}
`,kc=t=>Rc(xc(t));customElements.define("cosmoz-image-viewer",B(kc,{observedAttributes:["download-file-name","pdf","show-close","show-detach","show-fullscreen","show-nav","show-page-number","show-zoom","detached-show-zoom","loop","title"],styleSheets:[Yl]}));
