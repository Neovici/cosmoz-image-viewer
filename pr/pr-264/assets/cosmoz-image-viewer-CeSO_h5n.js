...
import{r as pi,D as yt,A as Z,b,E as H,p as fi,n as mn,M as _n,u as re,v as Pe,h as et,j as yn}from"./iframe-LHAh945o.js";import{_ as ns}from"./preload-helper-PPVm8Dsz.js";let nt,gi=0;function _s(t){nt=t}function ys(){nt=null,gi=0}function bn(){return gi++}const It=Symbol("haunted.phase"),tt=Symbol("haunted.hook"),bs=Symbol("haunted.update"),vs=Symbol("haunted.commit"),ue=Symbol("haunted.effects"),Te=Symbol("haunted.layoutEffects"),Kt="haunted.context";class vn{update;host;virtual;[tt];[ue];[Te];constructor(e,s){this.update=e,this.host=s,this[tt]=new Map,this[ue]=[],this[Te]=[]}run(e){_s(this);let s=e();return ys(),s}_runEffects(e){let s=this[e];_s(this);for(let i of s)i.call(this);ys()}runEffects(){this._runEffects(ue)}runLayoutEffects(){this._runEffects(Te)}teardown(){this[tt].forEach(s=>{typeof s.teardown=="function"&&s.teardown(!0)})}}const wn=Promise.resolve().then.bind(Promise.resolve());function mi(){let t=[],e;function s(){e=null;let i=t;t=[];for(var n=0,r=i.length;n<r;n++)i[n]()}return function(i){t.push(i),e==null&&(e=wn(s))}}const xn=mi(),ws=mi();class Sn{renderer;host;state;[It];_updateQueued;_active;constructor(e,s){this.renderer=e,this.host=s,this.state=new vn(this.update.bind(this),s),this[It]=null,this._updateQueued=!1,this._active=!1}update(){this._active&&(this._updateQueued||(xn(()=>{let e=this.handlePhase(bs);ws(()=>{this.handlePhase(vs,e),ws(()=>{this.handlePhase(ue)})}),this._updateQueued=!1}),this._updateQueued=!0))}handlePhase(e,s){switch(this[It]=e,e){case vs:this.commit(s),this.runEffects(Te);return;case bs:return this.render();case ue:return this.runEffects(ue)}}render(){return this.state.run(()=>this.renderer.call(this.host,this.host))}runEffects(e){this.state._runEffects(e)}teardown(){this.state.teardown()}pause(){this._active=!1}resume(){this._active=!0}}const rs=(...t)=>{const e=new CSSStyleSheet;return e.replaceSync(t.join("")),e},Pn=t=>t?.map(e=>typeof e=="string"?rs(e):e),Cn=(t,...e)=>t.flatMap((s,i)=>[s,e[i]||""]).join(""),pe=Cn,En=(t="")=>t.replace(/-+([a-z])?/g,(e,s)=>s?s.toUpperCase():"");function On(t){class e extends Sn{frag;renderResult;constructor(n,r,o){super(n,o||r),this.frag=r}commit(n){this.renderResult=t(n,this.frag)}}function s(i,n,r){const o=(r||n||{}).baseElement||HTMLElement,{observedAttributes:a=[],useShadowDOM:l=!0,shadowRootInit:c={},styleSheets:u}=r||n||{},d=Pn(i.styleSheets||u);class h extends o{_scheduler;static get observedAttributes(){return i.observedAttributes||a||[]}constructor(){if(super(),l===!1)this._scheduler=new e(i,this);else{const m=this.attachShadow({mode:"open",...c});d&&(m.adoptedStyleSheets=d),this._scheduler=new e(i,m,this)}}connectedCallback(){this._scheduler.resume(),this._scheduler.update(),this._scheduler.renderResult?.setConnected(!0)}disconnectedCallback(){this._scheduler.pause(),this._scheduler.teardown(),this._scheduler.renderResult?.setConnected(!1)}attributeChangedCallback(m,_,v){if(_===v)return;let w=v===""?!0:v;Reflect.set(this,En(m),w)}}function p(g){let m=g,_=!1;return Object.freeze({enumerable:!0,configurable:!0,get(){return m},set(v){_&&m===v||(_=!0,m=v,this._scheduler&&this._scheduler.update())}})}const f=new Proxy(o.prototype,{getPrototypeOf(g){return g},set(g,m,_,v){let w;return m in g?(w=Object.getOwnPropertyDescriptor(g,m),w&&w.set?(w.set.call(v,_),!0):(Reflect.set(g,m,_,v),!0)):(typeof m=="symbol"||m[0]==="_"?w={enumerable:!0,configurable:!0,writable:!0,value:_}:w=p(_),Object.defineProperty(v,m,w),w.set&&w.set.call(v,_),!0)}});return Object.setPrototypeOf(h.prototype,f),h}return s}class ee{id;state;constructor(e,s){this.id=e,this.state=s}}function $n(t,...e){let s=bn(),i=nt[tt],n=i.get(s);return n||(n=new t(s,nt,...e),i.set(s,n)),n.update(...e)}function te(t){return $n.bind(null,t)}function _i(t){return te(class extends ee{callback;lastValues;values;_teardown;constructor(e,s,i,n){super(e,s),t(s,this)}update(e,s){this.callback=e,this.values=s}call(){const e=!this.values||this.hasChanged();this.lastValues=this.values,e&&this.run()}run(){this.teardown(),this._teardown=this.callback.call(this.state)}teardown(e){typeof this._teardown=="function"&&(this._teardown(),this._teardown=void 0),e&&(this.lastValues=this.values=void 0)}hasChanged(){return!this.lastValues||this.values.some((e,s)=>this.lastValues[s]!==e)}})}function yi(t,e){t[ue].push(e)}const z=_i(yi),zn=t=>t instanceof Element?t:t.startNode||t.endNode||t.parentNode,bi=te(class extends ee{Context;value;_ranEffect;_unsubscribe;constructor(t,e,s){super(t,e),this._updater=this._updater.bind(this),this._ranEffect=!1,this._unsubscribe=null,yi(e,this)}update(t){return this.Context!==t&&(this._subscribe(t),this.Context=t),this.value}call(){this._ranEffect||(this._ranEffect=!0,this._unsubscribe&&this._unsubscribe(),this._subscribe(this.Context),this.state.update())}_updater(t){this.value=t,this.state.update()}_subscribe(t){const e={Context:t,callback:this._updater};zn(this.state.host).dispatchEvent(new CustomEvent(Kt,{detail:e,bubbles:!0,cancelable:!0,composed:!0}));const{unsubscribe:i=null,value:n}=e;this.value=i?n:t.defaultValue,this._unsubscribe=i}teardown(){this._unsubscribe&&this._unsubscribe()}});function Tn(t){return e=>{const s={Provider:class extends HTMLElement{listeners;_value;constructor(){super(),this.style.display="contents",this.listeners=new Set,this.addEventListener(Kt,this)}disconnectedCallback(){this.removeEventListener(Kt,this)}handleEvent(i){const{detail:n}=i;n.Context===s&&(n.value=this.value,n.unsubscribe=this.unsubscribe.bind(this,n.callback),this.listeners.add(n.callback),i.stopPropagation())}unsubscribe(i){this.listeners.delete(i)}set value(i){this._value=i;for(let n of this.listeners)n(i)}get value(){return this._value}},Consumer:t(function({render:i}){const n=bi(s);return i(n)},{useShadowDOM:!1}),defaultValue:e};return s}}const I=te(class extends ee{value;values;constructor(t,e,s,i){super(t,e),this.value=s(),this.values=i}update(t,e){return this.hasChanged(e)&&(this.values=e,this.value=t()),this.value}hasChanged(t=[]){return t.some((e,s)=>this.values[s]!==e)}}),C=(t,e)=>I(()=>t,e);function An(t,e){t[Te].push(e)}const rt=_i(An),Q=te(class extends ee{args;constructor(t,e,s){super(t,e),this.updater=this.updater.bind(this),typeof s=="function"&&(s=s()),this.makeArgs(s)}update(){return this.args}updater(t){const[e]=this.args;typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&(this.makeArgs(t),this.state.update())}makeArgs(t){this.args=Object.freeze([t,this.updater])}}),vi=te(class extends ee{reducer;currentState;constructor(t,e,s,i,n){super(t,e),this.dispatch=this.dispatch.bind(this),this.currentState=n!==void 0?n(i):i}update(t){return this.reducer=t,[this.currentState,this.dispatch]}dispatch(t){this.currentState=this.reducer(this.currentState,t),this.state.update()}}),Ln=/([A-Z])/gu,Ie=te(class extends ee{property;eventName;constructor(t,e,s,i){if(super(t,e),this.state.virtual)throw new Error("Can't be used with virtual components.");this.updater=this.updater.bind(this),this.property=s,this.eventName=s.replace(Ln,"-$1").toLowerCase()+"-changed",this.state.host[this.property]==null&&(typeof i=="function"&&(i=i()),i!=null&&this.updateProp(i))}update(t,e){return[this.state.host[this.property],this.updater]}updater(t){const e=this.state.host[this.property];typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&this.updateProp(t)}updateProp(t){this.notify(t).defaultPrevented||(this.state.host[this.property]=t)}notify(t){const e=new CustomEvent(this.eventName,{detail:{value:t,path:this.property},cancelable:!0});return this.state.host.dispatchEvent(e),e}}),xs=t=>e=>{e.preventDefault(),t(e.detail.value)};function Rn(t){let e=t;return{get current(){return e},set current(s){e=s},get value(){return e},set value(s){e=s}}}function se(t){return I(()=>Rn(t),[])}te(class extends ee{update(){return this.state.host}});function kn({render:t}){const e=On(t),s=Tn(e);return{component:e,createContext:s}}/**
 * @license
...
`,Hn=t=>I(()=>{if(t==null)return;const e=new RegExp(t,"u");return s=>{!s.defaultPrevented&&s.data&&!e.test(s.data)&&s.preventDefault()}},[t]),as=te(class extends ee{values;constructor(t,e,s,i){super(t,e),Object.assign(e.host,s),this.values=i}update(t,e){this.hasChanged(e)&&(this.values=e,Object.assign(this.state.host,t))}hasChanged(t=[]){return t.some((e,s)=>this.values[s]!==e)}}),Ue=te(class extends ee{update(){return this.state.host}}),Un=/([A-Z])/gu,Jt=(t,e,s)=>{t[e]=s,t.dispatchEvent(new CustomEvent(e.replace(Un,"-$1").toLowerCase()+"-changed",{detail:{value:s}}))},Yn=(t,e,s=[e])=>{const i=Ue();z(()=>{Jt(i,t,e)},s)},Ci=t=>{const e=se(void 0),s=C(l=>e.current=l,[]),i=t.shadowRoot,n=C(l=>t.dispatchEvent(new Event(l.type,{bubbles:l.bubbles})),[]),r=C(l=>Jt(t,"value",l.target.value),[]),o=C(l=>Jt(t,"focused",l.type==="focus"),[]),a=C(()=>{const l=e.current?.checkValidity();return t.toggleAttribute("invalid",!l),l},[]);return as({validate:a},[a]),z(()=>{const l=c=>{c.composedPath()[0]?.closest?.("input, textarea")||(c.preventDefault(),e.current?.focus())};return i.addEventListener("mousedown",l),()=>i.removeEventListener("mousedown",l)},[]),{onChange:n,onFocus:o,onInput:r,onRef:s}},Xn=({placeholder:t,noLabelFloat:e,label:s})=>(e?s:void 0)||t||" ",Kn=["type","pattern","allowed-pattern","min","max","step","autosize","label","placeholder",...Si],Jn=t=>{const{type:e="text",pattern:s,allowedPattern:i,autocomplete:n,value:r,readonly:o,disabled:a,min:l,max:c,step:u,maxlength:d}=t,{onChange:h,onFocus:p,onInput:f,onRef:g}=Ci(t),m=Hn(i);return xi(b`
			<input
				...
				step=${K(u)}
			/>
		`,t)};customElements.define("cosmoz-input",U(Jn,{observedAttributes:Kn,styleSheets:[rs(Pi)],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const Ps=t=>{t.style.height="",t.style.height=`${t.scrollHeight}px`},Wn=(t,e=0)=>{if(e>0){const s=t.getAttribute("rows")??"",i=t.style.height;t.style.height="",t.setAttribute("rows",e),t.style.maxHeight=t.getBoundingClientRect().height+"px",t.style.height=i,t.setAttribute("rows",s)}},Zn=t=>{const{value:e,maxRows:s}=t,i=I(()=>()=>t.shadowRoot.querySelector("#input"),[]);z(()=>Wn(i(),s),[s,i]),z(()=>Ps(i()),[i,e]),z(()=>{const n=i(),r=new ResizeObserver(()=>requestAnimationFrame(()=>Ps(n)));return r.observe(n),()=>r.unobserve(n)},[i])},Gn=["rows","placeholder",...Si],qn=t=>{const{autocomplete:e,value:s,placeholder:i,readonly:n,disabled:r,rows:o,cols:a,maxlength:l}=t,{onChange:c,onFocus:u,onInput:d,onRef:h}=Ci(t);return Zn(t),xi(b`
			<textarea id="input" part="input"
				...
				@change=${c} @focus=${u} @blur=${u}>`,t)};customElements.define("cosmoz-textarea",U(qn,{observedAttributes:Gn,styleSheets:[rs(Pi)],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const Qn=t=>{const{label:e,value:s,disabled:i,error:n}=t,r=C(o=>t.dispatchEvent(new CustomEvent("change",{detail:o.target.checked})),[]);return b`<input
			id="toggle"
			class="toggle"
			part="toggle"
			type="checkbox"
		...
		<slot name="suffix"></slot>
		${k(n,o=>b`<div class="failure">${o}</div>`)} `},er=pe`
	.toggle {
		appearance: none;
		width: 35px;
		height: 18px;
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Is=t=>!mn(t)&&typeof t.then=="function",Ms=1073741823;let zr=class extends bt{constructor(){super(...arguments),this._$Cwt=Ms,this._$Cbt=[],this._$CK=new Or(this),this._$CX=new $r}render(...e){return e.find(s=>!Is(s))??H}update(e,s){const i=this._$Cbt;let n=i.length;this._$Cbt=s;const r=this._$CK,o=this._$CX;this.isConnected||this.disconnected();for(let a=0;a<s.length&&!(a>this._$Cwt);a++){const l=s[a];if(!Is(l))return this._$Cwt=a,l;a<n&&l===i[a]||(this._$Cwt=Ms,n=0,Promise.resolve(l).then(async c=>{for(;o.get();)await o.get();const u=r.deref();if(u!==void 0){const d=u._$Cbt.indexOf(l);d>-1&&d<u._$Cwt&&(u._$Cwt=d,u.setValue(c))}}))}return H}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}};const De=ie(zr);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ds=(t,e,s)=>{const i=new Map;for(let n=e;n<=s;n++)i.set(t[n],n);return i},$i=ie(class extends we{constructor(t){if(super(t),t.type!==G.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const n=[],r=[];let o=0;for(const a of t)n[o]=i?i(a,o):o,r[o]=s(a,o),o++;return{values:r,keys:n}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const n=_n(t),{values:r,keys:o}=this.dt(e,s,i);if(!Array.isArray(n))return this.ut=o,r;const a=this.ut??=[],l=[];let c,u,d=0,h=n.length-1,p=0,f=r.length-1;for(;d<=h&&p<=f;)if(n[d]===null)d++;else if(n[h]===null)h--;else if(a[d]===o[p])l[p]=re(n[d],r[p]),d++,p++;else if(a[h]===o[f])l[f]=re(n[h],r[f]),h--,f--;else if(a[d]===o[f])l[f]=re(n[d],r[f]),Pe(t,l[f+1],n[d]),d++,f--;else if(a[h]===o[p])l[p]=re(n[h],r[p]),Pe(t,n[d],n[h]),h--,p++;else if(c===void 0&&(c=Ds(o,p,f),u=Ds(a,d,h)),c.has(a[d]))if(c.has(a[h])){const g=u.get(o[p]),m=g!==void 0?n[g]:null;if(m===null){const _=Pe(t,n[d]);re(_,r[p]),l[p]=_}else l[p]=re(m,r[p]),Pe(t,n[d],m),n[g]=null;p++}else et(n[h]),h--;else et(n[d]),d++;for(;p<=f;){const g=Pe(t,l[f+1]);re(g,r[p]),l[p++]=g}for(;d<=h;){const g=n[d++];g!==null&&et(g)}return this.ut=o,fi(t,l),H}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,Gr=t=>{const e=t==="auto",[s,i]=Q(e?40:t);return[s,n=>e?i(n):void 0]},Ti=Dn(()=>zi);customElements.define("cosmoz-keybinding-provider",Ti.Provider);const cs=t=>{const e=I(()=>({}),[]);return I(()=>Object.assign(e,t),[e,...Object.values(t)])},Re=(t,e)=>{const s=bi(Ti),i=cs(t);z(()=>s(i),e)},qr=Symbol("listbox.navigate.up"),Qr=Symbol("listbox.navigate.down"),eo=Symbol("listbox.select"),to=({onUp:t,onDown:e,onEnter:s})=>{const i=Ue();Re({activity:qr,callback:t,element:()=>i},[]),Re({activity:Qr,callback:e,element:()=>i},[]),Re({activity:eo,callback:s,element:()=>i},[])},so=({items:t,onSelect:e,defaultIndex:s=0})=>{const[i,n]=Q({index:s}),{index:r}=i,{length:o}=t;return z(()=>{n({index:i.index<0?s:Math.min(i.index,t.length-1),scroll:!0})},[t,s]),to({onUp:C(()=>n(a=>({index:a.index>0?a.index-1:o-1,scroll:!0})),[o]),onDown:C(()=>n(a=>({index:a.index<o-1?a.index+1:0,scroll:!0})),[o]),onEnter:C(()=>r>-1&&r<o&&e?.(t[r],r),[r,t,e])}),{position:i,highlight:C(a=>n({index:a}),[]),select:C(a=>e?.(a),[e])}},io=t=>typeof t=="object"&&t!==null&&Symbol.iterator in t;function oe(t){return t==null?[]:Array.isArray(t)?t:typeof t=="string"?[t]:io(t)?Array.from(t):[t]}const jt=(t,e=dt)=>s=>{const i=oe(t).map(e);return oe(s).filter(n=>!i.includes(e(n)))},no=(t,e)=>e?s=>s!=null&&oe(t).find(i=>i[e]===s[e]):s=>s!=null&&oe(t).includes(s),ro=(t,e)=>{if(!e||!t)return t;const s=t.toLowerCase().indexOf(e.toLowerCase());if(s<0)return t;const i=s+e.length;return[t.slice(0,s),b`<mark>${t.slice(s,i)}</mark>`,t.slice(i)]},oo=(t=dt)=>(e,s,{highlight:i,select:n,textual:r=dt,query:o,isSelected:a})=>{const l=r(e),c=ro(l,o),u=t(c,e,s);return b`<div
				class="item"
				role="option"
				part="option"
				?aria-selected=${a(e)}
			...
			<div class="sizer" virtualizer-sizer>${u}</div>`},ao=({itemRenderer:t=oo(),...e})=>{const s=cs(e);return C((i,n)=>t(i,n,s),[s,t])},lo=["query","items","onSelect","textual","anchor","itemHeight","itemLimit","itemRenderer","defaultIndex","value","valueProperty","loading"],co=({value:t,valueProperty:e,items:s,onSelect:i,defaultIndex:n,query:r,textual:o,itemRenderer:a,itemHeight:l=40,itemLimit:c=5})=>{const u=I(()=>no(t,e),[t,e]),d=I(()=>s.slice(),[s,u]),{position:h,highlight:p,select:f}=so({items:d,onSelect:i,defaultIndex:isNaN(n)?void 0:Number(n)}),[g,m]=Gr(l);return{position:h,items:d,height:Math.min(c,d.length)*g,highlight:p,select:f,itemHeight:g,setItemHeight:m,renderItem:ao({itemRenderer:a,items:d,position:h,highlight:p,select:f,textual:o,query:r,isSelected:u})}},Bs=zi,uo=t=>{const e=se(void 0),{position:s,items:i,renderItem:n,height:r,itemHeight:o,setItemHeight:a}=co(t);return z(()=>{const l=e.current?.[Zt];l&&l.layoutComplete.then(()=>{t.dispatchEvent(new CustomEvent("layout-complete"));const{averageChildSize:c,averageMarginSize:u}=l._layout._metricsCache;return a(c+u*2)},Bs)},[i]),z(()=>{if(!s.scroll)return;const l=e.current?.[Zt];if(l){if(!l?._layout){l.layoutComplete.then(()=>l.element(s.index)?.scrollIntoView({block:"nearest"}),Bs);return}l.element(s.index)?.scrollIntoView({block:"nearest"})}},[s]),Yr(Zr({...s,itemHeight:o,auto:t.itemHeight==="auto"})),b`<div
			class="items"
		...
		<slot></slot>`};customElements.define("cosmoz-listbox",U(uo,{styleSheets:[os(Wr)]}));const ho=({multi:t,...e},s)=>b`<cosmoz-listbox
		part="listbox"
		?multi=${t}
		...=${Br(Kr(lo)(e))}
		>${s}</cosmoz-listbox
...
`;customElements.define("cosmoz-autocomplete-chip",U(go,{observedAttributes:["disabled"],styleSheets:[os(po)]}));const mo=({content:t,onClear:e,disabled:s,hidden:i,className:n="chip",slot:r})=>b`<cosmoz-autocomplete-chip
		class=${K(n)}
		slot=${K(r)}
		part="chip"
	...
	>`,_o=({value:t,min:e=0,onDeselect:s,textual:i,disabled:n,chipRenderer:r=mo})=>[...t.filter(Boolean).map(o=>r({item:o,content:i(o),onClear:t.length>e&&(()=>s(o)),disabled:n,slot:"control"})),r({item:null,content:b`<span></span>`,className:"badge",disabled:!0,slot:"control",hidden:!0})],yo=pe`
	:host {
		display: inline-block;
		vertical-align: middle;
...
`;customElements.define("cosmoz-autocomplete-skeleton-span",U(()=>Z,{styleSheets:[yo]}));const bo=vt`
	:host {
		display: block;
		position: relative;
		min-width: 35px;
...
`,us=(t,e=()=>({}))=>{const s={type:t,toString(){return t}};return Object.assign((...n)=>Object.assign(e(...n),s),s)},Hs=t=>t.type||t.toString(),Us=t=>Array.isArray(t)?t:[t],vo=(t,e)=>{const s=Us(e),i=(s.every(Array.isArray)?s:[s]).map(([n,r])=>({actions:Us(n).map(Hs),handle:r}));return(n=t,r)=>{const o=i.find(a=>a.actions.includes(Hs(r)));return o?o.handle(n,r):n}},de={pending:"pending",rejected:"rejected",resolved:"resolved"},Ai={error:void 0,result:void 0,state:de.pending},Li=us(de.pending),Ri=us(de.resolved,t=>({result:t})),ki=us(de.rejected,t=>({error:t})),wo=vo(Ai,[[Li,()=>({error:void 0,result:void 0,state:de.pending})],[Ri,(t,{result:e})=>({error:void 0,result:e,state:de.resolved})],[ki,(t,{error:e})=>({error:e,result:void 0,state:de.rejected})]]),Ni=t=>{const[{error:e,result:s,state:i},n]=vi(wo,Ai);return z(()=>{if(!t)return;let r=!1;return n(Li()),t.then(o=>!r&&n(Ri(o)),o=>!r&&n(ki(o))),()=>{r=!0}},[t]),[s,e,i]},xo=Symbol("autocomplete.deselect.last"),So=Symbol("autocomplete.search.when.selected"),Ys=t=>t.normalize("NFD").replace(/[\u0300-\u036f]/gu,""),Po=(t,e,s)=>{if(!e)return t;const i=Ys(e.toLowerCase()),n=[];for(const r of t){const a=Ys(s(r).toLowerCase()).indexOf(i);a<0||n.push({item:r,index:a})}return n.sort((r,o)=>r.index-o.index).map(({item:r})=>r)},Co=t=>t===!1||t==null?[]:t,Eo=(t,e,s)=>t.dispatchEvent(new CustomEvent(e,{detail:s})),Xs=[],Oo=t=>(...e)=>{let s;const i=()=>{s&&cancelAnimationFrame(s)};return i(),s=requestAnimationFrame(()=>{s=void 0,t(...e)}),i},$o=(t,e,s)=>C(i=>{e?.(i),t.dispatchEvent(new CustomEvent(s,{detail:i}))},[e]),zo=({value:t,text:e,onChange:s,onText:i,onSelect:n,limit:r,min:o,source:a,textProperty:l,textual:c,valueProperty:u,keepOpened:d,keepQuery:h,preserveOrder:p,defaultIndex:f,externalSearch:g,disabled:m,lazyOpen:_})=>{const v=r!=null?Number(r):void 0,w=I(()=>(c??Xr)(l),[c,l]),x=Ue(),[E,$]=Ie("opened",!1),y=!e,A=I(()=>e?.trim(),[e]),R=$o(x,i,"text"),N=C(P=>{s?.(P,()=>$(!1)),Eo(x,"value",P)},[s]),[M,me]=Q([]),Y=!!(_&&!A),X=I(()=>Y?Promise.resolve([]):Promise.resolve(typeof a=="function"?a({query:A,active:E}):a).then(Co),[a,E,A,Y]),j=I(()=>oe(t),[t]);z(()=>X.then(me),[X]),Re({activity:xo,callback:()=>{const P=oe(j);P.length>0&&N(P.slice(0,-1))},check:()=>!m&&y&&x.matches(":focus-within"),element:()=>x},[]),Re({activity:So,callback:P=>{const F=oe(j),J=v===1;F.length>0&&J&&P.key.length===1&&N(F.slice(0,-1))},allowDefault:!0,check:()=>!m&&y&&x.matches(":focus-within"),element:()=>x},[v]),z(()=>{!E&&!h&&R("")},[E,h]),z(()=>{x.toggleAttribute("opened",!!E)},[E]);const D=cs({onText:R,onChange:N,value:j,limit:v,min:o,keepQuery:h,keepOpened:d,setOpened:$,onSelect:n,valueProperty:u}),[,,ae]=Ni(X);return{limit:v,opened:E,query:A,textual:w,value:j,source$:X,loading:ae==="pending",items:I(()=>{if(!E||Y)return Xs;const P=p?M:[...j,...jt(j,st(u))(M)];return g?P:Po(P,A,w)},[M,E,A,w,y,j,p,u,g,Y]),onToggle:C(P=>{m||$(P.newState==="open")},[m]),onText:C(P=>{m||(R(P.target.value),$(!0))},[m,R,e,$]),onSelect:C(P=>{if(m)return;D.onSelect?.(P,D);const{onChange:F,onText:J,limit:le,min:At,value:Lt,keepQuery:Rt,keepOpened:kt,setOpened:Nt,valueProperty:Se}=D;Rt||J(""),kt||Nt(!1);const ce=oe(Lt),L=st(Se),Xe=ce.some(Ke=>L(Ke)===L(P));Xe&&ce.length===At||F((Xe?jt(P,L)(ce):[...ce,P]).slice(-le))},[m,D]),onDeselect:C(P=>{m||D.onChange(jt(P,st(D.valueProperty))(D.value))},[m,D]),defaultIndex:A!==void 0&&A?.length>0?0:f}},To=t=>{const e=t.shadowRoot.querySelectorAll(".chip"),s=t.shadowRoot.querySelector(".badge");s.hidden=!0;for(const a of e)a.hidden=!1;const n=t.shadowRoot.querySelector("cosmoz-input").shadowRoot?.querySelector(".control")?.getBoundingClientRect();let r;for(r=0;r<e.length;r++){const l=e[r].getBoundingClientRect();if(!(l.x+l.width<=n.x+n.width-24))break}const o=e.length-r;for(s.querySelector("span").textContent="+"+o.toString(),s.hidden=o<1;r<e.length;r++)e[r].hidden=!0},Ao=({value:t,opened:e,wrap:s,limit:i})=>{const n=Ue(),r=!(s||i===1),o=I(()=>Oo(()=>To(n)),[]),[a,l]=Q(0);rt(()=>{if(!r)return;const c=n.shadowRoot.querySelector("cosmoz-input"),u=new ResizeObserver(d=>{l(d[0].contentRect.width)});return u.observe(c),()=>u.disconnect()},[r]),rt(()=>r?o():void 0,[r,a,e,t])},Lo=["input","control","label","line","error","wrap"].map(t=>`${t}: input-${t}`).join(),Ro=({opened:t,isSingle:e,showSingle:s,hasResultsOrQuery:i})=>!t||e&&!s?!1:i,ko=t=>{const{opened:e,invalid:s,errorMessage:i,label:n,placeholder:r,disabled:o,noLabelFloat:a,alwaysFloatLabel:l,textual:c,text:u,onText:d,onToggle:h,onDeselect:p,value:f,limit:g,min:m,showSingle:_,items:v,source$:w,loading:x,chipRenderer:E}=t,$=g===1,y=$&&f?.[0]!=null,A=x||v.length>0||u!=null&&u.length>0;return b`<cosmoz-dropdown-next
			open-on-focus
			?disabled=${o}
			.opened=${e}
			@dropdown-toggle=${h}
...
</style>`;customElements.define("cz-spinner",U(Ho));const Uo=te(class extends ee{constructor(t,e){super(t,e),this.dispatchEvent=(...s)=>{e.host.dispatchEvent.apply(e.host,s)}}update(){return this.dispatchEvent}}),Vt=(t,e=.08,s=.001)=>{const[i,n]=Q(null);return z(()=>{if(i==null){n(t);return}if(e>=1){n(t);return}const r=i;window.requestAnimationFrame(()=>{const o=t-r;n(Math.abs(o)<s?t:i+o*e)})},[i,n,t,e,s]),i},Yo=(t,e)=>{"ResizeObserver"in window&&z(()=>{if(e==null)return;const s=new ResizeObserver(([{contentRect:i}])=>t(i));return s.observe(e),t(e.getBoundingClientRect()),()=>s.unobserve(e)},[t,e])},Fe=(t,e,s)=>Math.max(e,Math.min(s,t)),ds=(t,e,s,i)=>s/i<t/e?s/t:i/e,Xo=(t,e,s,i)=>s/i>t/e?s/t:i/e,Hi=(t,e,s,i,n)=>{const r=ds(t,e,s,i),o=r*n,a=t*o,l=e*o,c=a<s?(-s+a)/2:(s-a)/2,u=a<s?(s-a)/2:(-s+a)/2,d=l<i?(-i+l)/2:(i-l)/2,h=l<i?(i-l)/2:(-i+l)/2;return{x:[c,u],y:[d,h]}},Ui="empty",Et="loading",Yi="loaded",hs="error",Ye="idle",Ot="panning",ke="pinching",Ko=1.1,Jo=t=>Ko/t,Wo=t=>2*t,ht=(t,e,s,i)=>{const n=ds(t,e,s,i),r=Xo(t*n,e*n,s,i);return Math.max(Jo(n),Wo(r))},Zo={status:Ui,interaction:Ye,iw:100,ih:100,cw:100,ch:100,zoom:1,panX:0,panY:0,pointers:{}},Xi=(t,e)=>{const s={...t};return delete s[e],s},Ks=t=>{const e=Object.keys(t);if(e.length<2)return null;const s=t[e[0]],i=t[e[1]];return{midX:(s.x+i.x)/2,midY:(s.y+i.y)/2,distance:Math.hypot(i.x-s.x,i.y-s.y)}},je=t=>{const e=Hi(t.iw,t.ih,t.cw,t.ch,t.zoom);return{...t,panX:Fe(t.panX,e.x[0],e.x[1]),panY:Fe(t.panY,e.y[0],e.y[1])}},Gt=(t,e,s,i=2)=>t<e?e-(e-t)/i:t>s?s+(t-s)/i:t,Go=t=>{const e=Hi(t.iw,t.ih,t.cw,t.ch,t.zoom);return{...t,panX:Gt(t.panX,e.x[0],e.x[1]),panY:Gt(t.panY,e.y[0],e.y[1])}},Ki=(t,{dPanX:e=0,dPanY:s=0,scaleDiff:i=1,originX:n=0,originY:r=0})=>{const o=t.zoom*i;return{...t,zoom:o,panX:e+n+(t.panX-n)*i,panY:s+r+(t.panY-r)*i}},Ji=(t,e,s)=>{const i=ht(t.iw,t.ih,t.cw,t.ch),n=Fe(t.zoom,1,i);if(n===t.zoom)return t;const r=n/t.zoom;return{...t,zoom:n,panX:e+(t.panX-e)*r,panY:s+(t.panY-s)*r}},qo=(t,e)=>{switch(e.type){case"load":return{...t,status:Et};default:return t}},Qo=(t,e)=>{switch(e.type){case"loaded":return{...t,status:Yi,...e.dimensions,panX:0,panY:0,zoom:1};case"error":return{...t,status:hs};default:return t}},ea=(t,e)=>{switch(e.type){case"load":return{...t,status:Et};default:return t}},ta=(t,e)=>{switch(e.type){case"pointerdown":return{...t,interaction:Ot,pointers:{...t.pointers,[e.id]:{x:e.x,y:e.y}}};default:return t}},sa=(t,e)=>{switch(e.type){case"pointerdown":{const s={...t.pointers,[e.id]:{x:e.x,y:e.y}};return{...t,interaction:ke,pointers:s}}case"pointermove":{const s=t.pointers[e.id];if(!s)return t;const i=e.x-s.x,n=e.y-s.y;return Go({...t,panX:t.panX+i,panY:t.panY+n,pointers:{...t.pointers,[e.id]:{x:e.x,y:e.y}}})}case"pointerup":{const s=Xi(t.pointers,e.id);if(Object.keys(s).length===0){const i=Ji({...t,pointers:s},e.settleOriginX??0,e.settleOriginY??0);return je({...i,interaction:Ye})}return{...t,pointers:s}}default:return t}},ia=(t,e)=>{switch(e.type){case"pointermove":{if(!t.pointers[e.id])return t;const i=Ks(t.pointers),n={...t.pointers,[e.id]:{x:e.x,y:e.y}},r=Ks(n);if(!i||!r)return{...t,pointers:n};const o=i.distance?r.distance/i.distance:1,a=r.midX-i.midX,l=r.midY-i.midY,c=e.containerOriginX+(r.midX-e.x),u=e.containerOriginY+(r.midY-e.y),d=Ki({...t,pointers:n},{dPanX:a,dPanY:l,scaleDiff:o,originX:c,originY:u}),h=ht(t.iw,t.ih,t.cw,t.ch),p=Gt(d.zoom,1,h),f=p/d.zoom,g=c+(d.panX-c)*f,m=u+(d.panY-u)*f;return{...d,zoom:p,panX:g,panY:m}}case"pointerup":{const s=Xi(t.pointers,e.id);if(Object.keys(s).length<=1){const i=je(Ji({...t,pointers:s},e.settleOriginX??0,e.settleOriginY??0));return Object.keys(s).length===1?{...i,interaction:Ot}:{...i,interaction:Ye}}return{...t,pointers:s}}default:return t}},na=(t,e)=>{switch(t.interaction){case Ye:return ta(t,e);case Ot:return sa(t,e);case ke:return ia(t,e);default:return t}},ra=(t,e)=>{switch(e.type){case"load":return{...t,status:Et,interaction:Ye,panX:0,panY:0,zoom:1,pointers:{}};case"zoom":{const s=ht(t.iw,t.ih,t.cw,t.ch),i=Fe(e.zoom,1,s);return je({...t,zoom:i})}case"wheel":{const{delta:s,originX:i,originY:n}=e,r=1+s,o=Ki(t,{scaleDiff:r,originX:i,originY:n}),a=ht(o.iw,o.ih,o.cw,o.ch);return je({...o,zoom:Fe(o.zoom,1,a)})}case"pointerdown":case"pointermove":case"pointerup":return na(t,e);default:return t}},oa=(t,e)=>{if(e.type==="resize")return je({...t,cw:e.rect.width,ch:e.rect.height});switch(t.status){case Ui:return qo(t,e);case Et:return Qo(t,e);case Yi:return ra(t,e);case hs:return ea(t,e);default:return t}},aa=(t,e,s,i)=>{const{iw:n=100,ih:r=100,cw:o=100,ch:a=100}=t,l=ds(n,r,o,a),c=l*e;return{position:"absolute",top:"50%",left:"50%",transform:["translate(-50%, -50%)",`translate(${s}px, ${i}px)`,`scale(${c})`].join(" ")}},Bt=(t,e,s)=>{const i=s.current?.getBoundingClientRect();return i?{originX:t-i.left-i.width/2,originY:e-i.top-i.height/2}:{originX:0,originY:0}},la=(t,e=.08)=>{const[s,i]=vi(oa,Zo),n=se(),r=C(()=>i({type:"load"}),[i]),o=C(y=>i({type:"loaded",dimensions:y}),[i]),a=C(()=>i({type:"error"}),[i]),l=C(y=>i({type:"zoom",zoom:y}),[i]),c=C(y=>y&&i({type:"resize",rect:y}),[i]),u=C(()=>c(n.current&&n.current.getBoundingClientRect()),[c]);Yo(c,n.current);const d=C(y=>o({iw:y.target.naturalWidth,ih:y.target.naturalHeight}),[o]),h=C(y=>{n.current?.setPointerCapture(y.pointerId),i({type:"pointerdown",id:y.pointerId,x:y.clientX,y:y.clientY})},[i]),p=C(y=>{const{originX:A,originY:R}=Bt(y.clientX,y.clientY,n);i({type:"pointermove",id:y.pointerId,x:y.clientX,y:y.clientY,containerOriginX:A,containerOriginY:R})},[i]),f=se({x:0,y:0});I(()=>{if(s.interaction!==ke)return;const y=Object.keys(s.pointers);if(y.length>=2){const A=s.pointers[y[0]],R=s.pointers[y[1]],N=(A.x+R.x)/2,M=(A.y+R.y)/2,{originX:me,originY:Y}=Bt(N,M,n);f.current={x:me,y:Y}}},[s.pointers,s.interaction]);const g=C(y=>{try{n.current?.releasePointerCapture(y.pointerId)}catch{}i({type:"pointerup",id:y.pointerId,settleOriginX:f.current.x,settleOriginY:f.current.y})},[i]),m=C(y=>{y.preventDefault();const{originX:A,originY:R}=Bt(y.clientX,y.clientY,n);i({type:"wheel",delta:-Math.sign(y.deltaY)*.8,originX:A,originY:R})},[i]),_=s.interaction===ke,v=s.interaction===Ot||s.interaction===ke;let w=e;_?w=.8:v&&(w=.9);const x=Vt(s.zoom,w),E=Vt(s.panX,w),$=Vt(s.panY,w);return{...s,load:r,loaded:o,error:a,zoomTo:l,resize:u,onPointerDown:h,onPointerMove:p,onPointerUp:g,onImageLoad:d,onWheel:m,containerRef:n,style:aa(s,x,E,$)}},ca=({src:t,disabled:e,panStiffness:s,zoomStiffness:i})=>{const{status:n,zoom:r,load:o,error:a,zoomTo:l,resize:c,onPointerDown:u,onPointerMove:d,onPointerUp:h,onImageLoad:p,onWheel:f,style:g,containerRef:m}=la(s,i);if(z(o,[t]),as({zoomTo:l,resize:c,zoom:r},[l,c,r]),!t)return Z;const _=Uo();return z(()=>_(new CustomEvent("zoom-changed",{detail:{value:r}})),[_,r]),z(()=>_(new CustomEvent("status-changed",{detail:{value:n}})),[_,n]),b`
		<style>
			:host {
				display: block;
			}
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const pa=!window.ShadyDOM||!window.ShadyDOM.inUse;!window.ShadyCSS||window.ShadyCSS.nativeCss;const fa=pa&&"adoptedStyleSheets"in Document.prototype&&"replaceSync"in CSSStyleSheet.prototype&&(()=>{try{const t=new CSSStyleSheet;t.replaceSync("");const e=document.createElement("div");return e.attachShadow({mode:"open"}),e.shadowRoot.adoptedStyleSheets=[t],e.shadowRoot.adoptedStyleSheets[0]===t}catch{return!1}})();let ga=window.Polymer&&window.Polymer.rootPath||fs(document.baseURI||window.location.href),pt=window.Polymer&&window.Polymer.sanitizeDOMValue||void 0;window.Polymer&&window.Polymer.setPassiveTouchGestures;let qt=window.Polymer&&window.Polymer.strictTemplatePolicy||!1,ma=window.Polymer&&window.Polymer.allowTemplateFromDomModule||!1,_a=window.Polymer&&window.Polymer.legacyOptimizations||!1,ya=window.Polymer&&window.Polymer.legacyWarnings||!1,ba=window.Polymer&&window.Polymer.syncInitialRender||!1,Qt=window.Polymer&&window.Polymer.legacyUndefined||!1,va=window.Polymer&&window.Polymer.orderedComputed||!1,Js=window.Polymer&&window.Polymer.removeNestedTemplates||!1,wa=window.Polymer&&window.Polymer.fastDomIf||!1;window.Polymer&&window.Polymer.suppressTemplateNotifications;window.Polymer&&window.Polymer.legacyNoObservedAttributes;let xa=window.Polymer&&window.Polymer.useAdoptedStyleSheetsWithBuiltCSS||!1;/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let gs={},Wi={};function Ws(t,e){gs[t]=Wi[t.toLowerCase()]=e}function Zs(t){return gs[t]||Wi[t.toLowerCase()]}function Pa(t){t.querySelector("style")&&console.warn("dom-module %s has style outside template",t.id)}class Ve extends HTMLElement{static get observedAttributes(){return["id"]}static import(e,s){if(e){let i=Zs(e);return i&&s?i.querySelector(s):i}return null}attributeChangedCallback(e,s,i,n){s!==i&&this.register()}get assetpath(){if(!this.__assetpath){const e=window.HTMLImports&&HTMLImports.importForElement?HTMLImports.importForElement(this)||document:this.ownerDocument,s=Ne(this.getAttribute("assetpath")||"",e.baseURI);this.__assetpath=fs(s)}return this.__assetpath}register(e){if(e=e||this.id,e){if(qt&&Zs(e)!==void 0)throw Ws(e,null),new Error(`strictTemplatePolicy: dom-module ${e} re-registered`);this.id=e,Ws(e,this),Pa(this)}}}Ve.prototype.modules=gs;customElements.define("dom-module",Ve);/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const Ca="link[rel=import][type~=css]",Ea="include",Gs="shady-unscoped";function Zi(t){return Ve.import(t)}function qs(t){let e=t.body?t.body:t;const s=ps(e.textContent,t.baseURI),i=document.createElement("style");return i.textContent=s,i}function Oa(t){const e=t.trim().split(/\s+/),s=[];for(let i=0;i<e.length;i++)s.push(...$a(e[i]));return s}function $a(t){const e=Zi(t);if(!e)return console.warn("Could not find style data in module named",t),[];if(e._styles===void 0){const s=[];s.push(...qi(e));const i=e.querySelector("template");i&&s.push(...Gi(i,e.assetpath)),e._styles=s}return e._styles}function Gi(t,e){if(!t._styles){const s=[],i=t.content.querySelectorAll("style");for(let n=0;n<i.length;n++){let r=i[n],o=r.getAttribute(Ea);o&&s.push(...Oa(o).filter(function(a,l,c){return c.indexOf(a)===l})),e&&(r.textContent=ps(r.textContent,e)),s.push(r)}t._styles=s}return t._styles}function za(t){let e=Zi(t);return e?qi(e):[]}function qi(t){const e=[],s=t.querySelectorAll(Ca);for(let i=0;i<s.length;i++){let n=s[i];if(n.import){const r=n.import,o=n.hasAttribute(Gs);if(o&&!r._unscopedStyle){const a=qs(r);a.setAttribute(Gs,""),r._unscopedStyle=a}else r._style||(r._style=qs(r));e.push(o?r._unscopedStyle:r._style)}}return e}/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/function es(t){return t.indexOf(".")>=0}function ge(t){let e=t.indexOf(".");return e===-1?t:t.slice(0,e)}function Ta(t,e){return t.indexOf(e+".")===0}function ft(t,e){return e.indexOf(t+".")===0}function gt(t,e,s){return e+s.slice(t.length)}function $e(t){if(Array.isArray(t)){let e=[];for(let s=0;s<t.length;s++){let i=t[s].toString().split(".");for(let n=0;n<i.length;n++)e.push(i[n])}return e.join(".")}else return t}function Qi(t){return Array.isArray(t)?$e(t).split("."):t.toString().split(".")}function V(t,e,s){let i=t,n=Qi(e);for(let r=0;r<n.length;r++){if(!i)return;let o=n[r];i=i[o]}return s&&(s.path=n.join(".")),i}function Qs(t,e,s){let i=t,n=Qi(e),r=n[n.length-1];if(n.length>1){for(let o=0;o<n.length-1;o++){let a=n[o];if(i=i[a],!i)return}i[r]=s}else i[e]=s;return n.join(".")}/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const mt={},Aa=/-[a-z]/g,La=/([A-Z])/g;function en(t){return mt[t]||(mt[t]=t.indexOf("-")<0?t:t.replace(Aa,e=>e[1].toUpperCase()))}function $t(t){return mt[t]||(mt[t]=t.replace(La,"-$1").toLowerCase())}/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let Ra=0,tn=0,be=[],ka=0,ts=!1,sn=document.createTextNode("");new window.MutationObserver(Na).observe(sn,{characterData:!0});function Na(){ts=!1;const t=be.length;for(let e=0;e<t;e++){let s=be[e];if(s)try{s()}catch(i){setTimeout(()=>{throw i})}}be.splice(0,t),tn+=t}const Ia={run(t){return ts||(ts=!0,sn.textContent=ka++),be.push(t),Ra++},cancel(t){const e=t-tn;if(e>=0){if(!be[e])throw new Error("invalid async handle: "+t);be[e]=null}}};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const rn={};let Qe=HTMLElement.prototype;for(;Qe;){let t=Object.getOwnPropertyNames(Qe);for(let e=0;e<t.length;e++)rn[t[e]]=!0;Qe=Object.getPrototypeOf(Qe)}const Da=window.trustedTypes?t=>trustedTypes.isHTML(t)||trustedTypes.isScript(t)||trustedTypes.isScriptURL(t):()=>!1;function Fa(t,e){if(!rn[e]){let s=t[e];s!==void 0&&(t.__data?t._setPendingProperty(e,s):(t.__dataProto?t.hasOwnProperty(JSCompiler_renameProperty("__dataProto",t))||(t.__dataProto=Object.create(t.__dataProto)):t.__dataProto={},t.__dataProto[e]=s))}}const ja=fe(t=>{const e=nn(t);class s extends e{static createPropertiesForAttributes(){let n=this.observedAttributes;for(let r=0;r<n.length;r++)this.prototype._createPropertyAccessor(en(n[r]))}static attributeNameForProperty(n){return $t(n)}_initializeProperties(){this.__dataProto&&(this._initializeProtoProperties(this.__dataProto),this.__dataProto=null),super._initializeProperties()}_initializeProtoProperties(n){for(let r in n)this._setProperty(r,n[r])}_ensureAttribute(n,r){const o=this;o.hasAttribute(n)||this._valueToNodeAttribute(o,r,n)}_serializeValue(n){switch(typeof n){case"object":if(n instanceof Date)return n.toString();if(n){if(Da(n))return n;try{return JSON.stringify(n)}catch{return""}}default:return super._serializeValue(n)}}_deserializeValue(n,r){let o;switch(r){case Object:try{o=JSON.parse(n)}catch{o=n}break;case Array:try{o=JSON.parse(n)}catch{o=null,console.warn(`Polymer::Attributes: couldn't decode Array as JSON: ${n}`)}break;case Date:o=isNaN(n)?String(n):Number(n),o=new Date(o);break;default:o=super._deserializeValue(n,r);break}return o}_definePropertyAccessor(n,r){Fa(this,n),super._definePropertyAccessor(n,r)}_hasAccessor(n){return this.__dataHasAccessor&&this.__dataHasAccessor[n]}_isPropertyPending(n){return!!(this.__dataPending&&n in this.__dataPending)}}return s});/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const Il=Nl(HTMLElement),it=[],zt=()=>{T.isInitialized||T.init({lng:"en",resStore:{en:{}},fallbackLng:!1})},Tt=t=>t.reduce((e,s,i)=>(e.count===void 0&&typeof s=="number"&&(e.count=s),typeof s=="object"?{...e,...s}:(e[i]=s,e)),{}),W=function(t){zt();const e=Tt([...arguments].slice(1));return delete e.count,T.t(t,e)},Ml=function(t,e){zt();const s=Tt([...arguments].slice(2)),i=s.count;let n;delete s.count;const r=T.services.pluralResolver.getSuffix(T.language,i);return r?(s.defaultValue=e,n=t+r):(n=t,s.defaultValue=t),T.t(n,s)},Dl=function(t,e){zt();const s=Tt([...arguments].slice(2));return s.context=t,delete s.count,T.t(e,s)},Fl=function(t,e,s){zt();const i=Tt([...arguments].slice(3)),n=i.count,r=t?"_"+t:"";let o=e;delete i.count;const a=T.services.pluralResolver.getSuffix(T.language,n);return a?(i.defaultValue=s,o=e+r+a):(o=e,i.context=t),T.t(o,i)},jl=(t,e,s)=>{T.init({resources:{}}),T.addResourceBundle(t,e,s)};fe(t=>class extends t{static get properties(){return{t:{type:Object,value(){return{}}}}}_filterT(e){return e.filter(s=>s!==this.t)}_(){return W.apply(null,this._filterT([...arguments]))}connectedCallback(){super.connectedCallback(),it.push(this)}disconnectedCallback(){super.disconnectedCallback();const e=it.indexOf(this);e>=0&&it.splice(e,1)}gettext(){return W.apply(null,this._filterT([...arguments]))}ngettext(){return Ml.apply(null,this._filterT([...arguments]))}pgettext(){return Dl.apply(null,this._filterT([...arguments]))}npgettext(){return Fl.apply(null,this._filterT([...arguments]))}});class Vl extends Il{static get properties(){return{compatibilityJSON:{type:String,value:"v3"},domain:{type:String,value:"messages"},interpolationPrefix:{type:String,value:"__"},interpolationSuffix:{type:String,value:"__"},language:{type:String,value:"en"},namespace:{type:String,value:"translation"},translations:{type:Object,observer(e){e!=null&&(jl(this.language,this.namespace,e),it.forEach(s=>s.set("t",{})))}},keySeparator:{type:String,value:"."},nsSeparator:{type:String,value:":"}}}ready(){super.ready(),T.init({compatibilityJSON:this.compatibilityJSON,interpolation:{escapeValue:!1,prefix:this.interpolationPrefix,suffix:this.interpolationSuffix},keySeparator:this.keySeparator,lng:this.language,nsSeparator:this.nsSeparator,resStore:{}})}}customElements.define("cosmoz-i18next",Vl);const ui=()=>document.createComment(""),Bl=yt(Z,new DocumentFragment).constructor;class Hl extends HTMLElement{onDisconnect;disconnectedCallback(){this.onDisconnect?.()}}customElements.define("disconnect-observer",Hl);class Ul extends bt{_op;_outlet;_content;render(e,s=document.body){return b`<disconnect-observer
			.onDisconnect=${()=>{this.isConnected=!1,this.disconnected()}}
		></disconnect-observer>`}update(e,[s,i=document.body]){return this.updateOutlet(i,s),this.render(s,i)}updateOutlet(e,s){this._outlet!==e&&this.clearOutlet(),this._outlet=e;const i=this._op??=new Bl(e.appendChild(ui()),e.appendChild(ui()));re(i,this._content=s)}clearOutlet(){const e=this._op;e&&(yn(e),et(e),this._op=void 0)}disconnected(){this.clearOutlet()}reconnected(){this._outlet&&this._content&&this.updateOutlet(this._outlet,this._content)}}const Yl=ie(Ul),Xl=`:host {
    display: flex;
...
`,Kl=Symbol("memo"),pn=t=>{let e=Kl,s;return function(i){if(e===i)return s;const n=t(i);return s=n,e=i,n}},Jl=(t,e)=>{const s=t.width/t.height,i=e.width/e.height;return s>i?{width:e.width,height:t.height*(e.width/t.width)}:{width:t.width*(e.height/t.height),height:e.height}},Wl=async(t,e)=>{const s={credentials:"include"},[{jsPDF:i},...n]=await Promise.all([ns(()=>import("./jspdf.es-C8lXQ5JU.js").then(a=>a.j),__vite__mapDeps([0,1]),import.meta.url),...t.map(async a=>{const l=await Promise.resolve(ls(a)),c=await fetch(l,s);return c.ok?{url:l,data:new Uint8Array(await c.arrayBuffer())}:void 0})]),r=n.filter(Boolean);if(r.length<1)return;const o=new i;return r.filter(Boolean).forEach(({url:a,data:l},c)=>{const{internal:{pageSize:d}}=o,{width:h,height:p}=Jl(o.getImageProperties(l),{width:d.getWidth()-4,height:d.getHeight()-4});c>0&&o.addPage(),o.addImage(l,a.split(".").pop().toUpperCase(),2,2,h,p)}),o.output("blob")},fn=(t,e)=>{const s=URL.createObjectURL(t),i=document.body.appendChild(document.createElement("a"));i.href=s,i.download=`${e}.pdf`,i.click(),document.body.removeChild(i),URL.revokeObjectURL(s)},Zl=async(t,e,s)=>{const i=await Wl(t);if(i)return fn(i,e),i},Gl=async(t,e,s={})=>{const{httpHeaders:i,withCredentials:n=!0}=s,r=await fetch(t,{credentials:n?"include":"omit",headers:i});if(!r.ok)return;const o=await r.blob();return fn(o,e),o},ql=t=>Object.entries(t).map(([e,s])=>e+"="+s).join(",");let is=!1;const Ql=({source:t,attachmentIndex:e,index:s,syncImageIndex:i,syncAttachmentIndex:n,title:r,loop:o,detachedShowZoom:a,onDetach:l,onClose:c})=>{const u=window.open(void 0,"czimgviewer",ql({height:700,width:800}));yt(b`<style>
			...
			<cosmoz-image-viewer
				...
				?loop=${o}
				@close=${()=>u.close()}
			></cosmoz-image-viewer>`,u.document.body),u._onClose?.(),l(),is=!0,u._onClose=c,u.addEventListener("beforeunload",c),u.addEventListener("beforeunload",()=>is=!1),u.document.title=r??W("Cosmoz image viewer")},ec=t=>new Promise(e=>{const s=setInterval(()=>{t()&&(e(),clearInterval(s))},100)}),tc=({images:t})=>{const e=window.open(void 0,"czimgviewerprint");yt(b`<style>
				img {
					display: block;
			...
			${t.map(s=>b`<img src="${De(Promise.resolve(ls(s)))}" />`)}`,e.document.body),ec(()=>Array.from(e.document.querySelectorAll("img")).every(s=>s.src&&s.complete)).then(()=>e.print()).then(()=>e.close())},di=[],sc=t=>{const e=I(()=>typeof t=="function"?Promise.resolve(t()):void 0,[t]),[s,i,n]=Ni(e);return typeof t!="function"?{attachments:t??di,loading:!1,error:void 0}:{attachments:s??di,loading:n==="pending",error:i}},ic=50,nc=300,rc=(t,{onSwipeLeft:e,onSwipeRight:s,enabled:i})=>{const n=se(null);z(()=>{if(!i)return;const r=a=>{if(a.touches.length!==1)return;const l=a.touches[0];n.current={x:l.clientX,y:l.clientY,t:Date.now()}},o=a=>{if(!n.current)return;const l=a.changedTouches[0],c=l.clientX-n.current.x,u=l.clientY-n.current.y,d=Date.now()-n.current.t;n.current=null,!(d>nc)&&(Math.abs(c)<ic||Math.abs(c)<Math.abs(u)||(c<0?e?.():s?.()))};return t.addEventListener("touchstart",r,{passive:!0}),t.addEventListener("touchend",o,{passive:!0}),()=>{t.removeEventListener("touchstart",r),t.removeEventListener("touchend",o)}},[t,e,s,i])},gn=t=>{if(!t.currentTarget.parentElement)return;t.currentTarget.parentElement.querySelector(".error").removeAttribute("hidden"),t.currentTarget.setAttribute("hidden",!0)},oc=t=>t.detail.value==="error"&&gn(t),ac=({src$:t,showZoom:e,isZoomed:s,_onZoomChanged:i})=>{const n=ve(t,()=>De(t));return[e?b`<haunted-pan-zoom
						.src=${n}
						?disabled=${!s}
						@zoom-changed=${i}
						@status-changed=${oc}
					></haunted-pan-zoom>`:b`<img
						...
						style="width:100%"
						@error=${gn}
					/>`,ve(t,()=>De(t.then(()=>Z),b`<cz-spinner></cz-spinner>`))]},lc=t=>b`<div>
			<div hidden class="error">
				<h2>An error occurred while loading the image.</h2>
				<div class="desc">${t.image}</div>
			</div>
			${ac(t)}
		</div>`,_t=[],Xt=(t,e,s)=>Math.max(e,Math.min(s,t)),cc=(t,e,s)=>{const[i,n]=Q(_t),r=I(()=>pn(o=>ns(async()=>{const{loadPdfThunks:a}=await import("./pdf-loader-BSiQZefA.js");return{loadPdfThunks:a}},__vite__mapDeps([2,1]),import.meta.url).then(({loadPdfThunks:a})=>a(o,e))),[e]);return z(()=>{if(!t){n(_t);return}let o=!1;return r(t).then(a=>{o||n(a)}),()=>{o=!0}},[t,r]),t?i:s},hi=(t,e,s,i)=>{const n=t.length;for(let r=1;r<=n;r++){const o=(e+r*s+n)%n;if(!i&&s>0&&o<=e||!i&&s<0&&o>=e)return;const a=t[o];if((a.images?.length??0)>0||a.pdf)return o}},uc=t=>{const{showZoom:e,title:s,loop:i,detachedShowZoom:n}=t,{attachments:r,loading:o,error:a}=sc(t.source),[l,c]=Ie("currentAttachmentIndex",0),u=r.length>0?Xt(l??0,0,r.length-1):0,d=r[u],h=d?[d]:_t,p=se(Ge),f=C(L=>{const Xe=L.detail?.[0],Ke=r.indexOf(Xe);Ke>=0&&(p.current=Ge,c(Ke))},[r]),g=d?.pdf,m=d?.pdfOptions,_=d?.downloadFileName??"archive",v=d?.images??_t,w=cc(g,m,v),[x,E]=Q(!1),$=L=>E(L.detail.value>1),y=I(()=>pn(L=>Promise.resolve(ls(L))),[]),[A,R]=Ie("currentImageIndex",0),N=w.length>0?Xt(A??0,0,w.length-1):0,M=w[N],me=I(()=>M==null?{id:Math.random(),content:Z,animation:Ge}:{id:M,render:()=>lc({src$:y(M),showZoom:e,isZoomed:x,_onZoomChanged:$,image:M}),animation:p.current},[M,e,x,$]),Y=se(!1),X=!i&&u===0&&N<=0,j=!i&&u===r.length-1&&N>=w.length-1,D=C(()=>{if(p.current=Ge,N<w.length-1)return R(N+1);const L=hi(r,u,1,i);L!=null&&(c(L),R(0))},[N,w.length,r,u,i]),ae=C(()=>{if(p.current=Bo,N>0)return R(N-1);const L=hi(r,u,-1,i);L!=null&&(Y.current=!0,c(L))},[N,r,u,i]);rc(t,{onSwipeLeft:D,onSwipeRight:ae,enabled:!x});const[P,F]=Q(!1),[J,le]=Q(!1),At=()=>le(!0),Lt=()=>le(!1),Rt=L=>F(L.detail.value),kt=L=>R(L.detail.value),Nt=L=>c(L.detail.value),Se=C(()=>Ql({source:r,attachmentIndex:u,index:N,syncImageIndex:kt,syncAttachmentIndex:Nt,title:s,loop:i,detachedShowZoom:n,onDetach:()=>F(!0),onClose:()=>F(!1)}),[r,u,N,s,i]),ce=C(()=>{is&&Se()},[Se]);return z(()=>{if(w.length===0)return;if(Y.current){Y.current=!1,R(w.length-1);return}const L=A??0;L>=w.length&&R(Xt(L,0,w.length-1))},[w]),z(()=>{const L=l??0;r.length>0&&L>=r.length&&c(0)},[r]),Yn("detached",P,[P]),z(()=>{t.toggleAttribute("hidden",P)},[P]),as({syncState:ce},[ce]),{host:t,isZoomed:x,currentSlide:me,nextImage:D,previousImage:ae,first:X,last:j,total:w.length,currentImageIndex:N,selectedImageNumber:N+1,onDownloadPdf:g?()=>Gl(g,_,m):()=>Zl(w,_),isFullscreen:J,openFullscreen:At,closeFullscreen:Lt,onPrintPdf:()=>tc({images:w}),detached:P,detach:Se,syncDetachedState:Rt,setAttachmentIndex:c,setImageIndex:R,loading:o,error:a,attachments:r,selected:d,selectedIndex:u,value:h,onSelect:f,images:w}},dc=b`<svg
	viewBox="0 0 24 24"
