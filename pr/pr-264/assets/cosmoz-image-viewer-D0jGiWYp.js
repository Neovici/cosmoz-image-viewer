...
import{r as fi,D as _t,A as G,b,E as H,p as gi,n as mn,M as _n,u as re,v as Pe,h as Qe,j as yn}from"./iframe-BiJiGX1K.js";import{_ as is}from"./preload-helper-PPVm8Dsz.js";let it,mi=0;function ys(t){it=t}function bs(){it=null,mi=0}function bn(){return mi++}const Nt=Symbol("haunted.phase"),et=Symbol("haunted.hook"),vs=Symbol("haunted.update"),ws=Symbol("haunted.commit"),ue=Symbol("haunted.effects"),Te=Symbol("haunted.layoutEffects"),Xt="haunted.context";class vn{update;host;virtual;[et];[ue];[Te];constructor(e,s){this.update=e,this.host=s,this[et]=new Map,this[ue]=[],this[Te]=[]}run(e){ys(this);let s=e();return bs(),s}_runEffects(e){let s=this[e];ys(this);for(let i of s)i.call(this);bs()}runEffects(){this._runEffects(ue)}runLayoutEffects(){this._runEffects(Te)}teardown(){this[et].forEach(s=>{typeof s.teardown=="function"&&s.teardown(!0)})}}const wn=Promise.resolve().then.bind(Promise.resolve());function _i(){let t=[],e;function s(){e=null;let i=t;t=[];for(var n=0,r=i.length;n<r;n++)i[n]()}return function(i){t.push(i),e==null&&(e=wn(s))}}const xn=_i(),xs=_i();class Sn{renderer;host;state;[Nt];_updateQueued;_active;constructor(e,s){this.renderer=e,this.host=s,this.state=new vn(this.update.bind(this),s),this[Nt]=null,this._updateQueued=!1,this._active=!1}update(){this._active&&(this._updateQueued||(xn(()=>{let e=this.handlePhase(vs);xs(()=>{this.handlePhase(ws,e),xs(()=>{this.handlePhase(ue)})}),this._updateQueued=!1}),this._updateQueued=!0))}handlePhase(e,s){switch(this[Nt]=e,e){case ws:this.commit(s),this.runEffects(Te);return;case vs:return this.render();case ue:return this.runEffects(ue)}}render(){return this.state.run(()=>this.renderer.call(this.host,this.host))}runEffects(e){this.state._runEffects(e)}teardown(){this.state.teardown()}pause(){this._active=!1}resume(){this._active=!0}}const ns=(...t)=>{const e=new CSSStyleSheet;return e.replaceSync(t.join("")),e},Pn=t=>t?.map(e=>typeof e=="string"?ns(e):e),Cn=(t,...e)=>t.flatMap((s,i)=>[s,e[i]||""]).join(""),pe=Cn,En=(t="")=>t.replace(/-+([a-z])?/g,(e,s)=>s?s.toUpperCase():"");function On(t){class e extends Sn{frag;renderResult;constructor(n,r,o){super(n,o||r),this.frag=r}commit(n){this.renderResult=t(n,this.frag)}}function s(i,n,r){const o=(r||n||{}).baseElement||HTMLElement,{observedAttributes:a=[],useShadowDOM:l=!0,shadowRootInit:c={},styleSheets:u}=r||n||{},d=Pn(i.styleSheets||u);class h extends o{_scheduler;static get observedAttributes(){return i.observedAttributes||a||[]}constructor(){if(super(),l===!1)this._scheduler=new e(i,this);else{const m=this.attachShadow({mode:"open",...c});d&&(m.adoptedStyleSheets=d),this._scheduler=new e(i,m,this)}}connectedCallback(){this._scheduler.resume(),this._scheduler.update(),this._scheduler.renderResult?.setConnected(!0)}disconnectedCallback(){this._scheduler.pause(),this._scheduler.teardown(),this._scheduler.renderResult?.setConnected(!1)}attributeChangedCallback(m,_,v){if(_===v)return;let w=v===""?!0:v;Reflect.set(this,En(m),w)}}function p(g){let m=g,_=!1;return Object.freeze({enumerable:!0,configurable:!0,get(){return m},set(v){_&&m===v||(_=!0,m=v,this._scheduler&&this._scheduler.update())}})}const f=new Proxy(o.prototype,{getPrototypeOf(g){return g},set(g,m,_,v){let w;return m in g?(w=Object.getOwnPropertyDescriptor(g,m),w&&w.set?(w.set.call(v,_),!0):(Reflect.set(g,m,_,v),!0)):(typeof m=="symbol"||m[0]==="_"?w={enumerable:!0,configurable:!0,writable:!0,value:_}:w=p(_),Object.defineProperty(v,m,w),w.set&&w.set.call(v,_),!0)}});return Object.setPrototypeOf(h.prototype,f),h}return s}class ee{id;state;constructor(e,s){this.id=e,this.state=s}}function $n(t,...e){let s=bn(),i=it[et],n=i.get(s);return n||(n=new t(s,it,...e),i.set(s,n)),n.update(...e)}function te(t){return $n.bind(null,t)}function yi(t){return te(class extends ee{callback;lastValues;values;_teardown;constructor(e,s,i,n){super(e,s),t(s,this)}update(e,s){this.callback=e,this.values=s}call(){const e=!this.values||this.hasChanged();this.lastValues=this.values,e&&this.run()}run(){this.teardown(),this._teardown=this.callback.call(this.state)}teardown(e){typeof this._teardown=="function"&&(this._teardown(),this._teardown=void 0),e&&(this.lastValues=this.values=void 0)}hasChanged(){return!this.lastValues||this.values.some((e,s)=>this.lastValues[s]!==e)}})}function bi(t,e){t[ue].push(e)}const z=yi(bi),zn=t=>t instanceof Element?t:t.startNode||t.endNode||t.parentNode,vi=te(class extends ee{Context;value;_ranEffect;_unsubscribe;constructor(t,e,s){super(t,e),this._updater=this._updater.bind(this),this._ranEffect=!1,this._unsubscribe=null,bi(e,this)}update(t){return this.Context!==t&&(this._subscribe(t),this.Context=t),this.value}call(){this._ranEffect||(this._ranEffect=!0,this._unsubscribe&&this._unsubscribe(),this._subscribe(this.Context),this.state.update())}_updater(t){this.value=t,this.state.update()}_subscribe(t){const e={Context:t,callback:this._updater};zn(this.state.host).dispatchEvent(new CustomEvent(Xt,{detail:e,bubbles:!0,cancelable:!0,composed:!0}));const{unsubscribe:i=null,value:n}=e;this.value=i?n:t.defaultValue,this._unsubscribe=i}teardown(){this._unsubscribe&&this._unsubscribe()}});function Tn(t){return e=>{const s={Provider:class extends HTMLElement{listeners;_value;constructor(){super(),this.style.display="contents",this.listeners=new Set,this.addEventListener(Xt,this)}disconnectedCallback(){this.removeEventListener(Xt,this)}handleEvent(i){const{detail:n}=i;n.Context===s&&(n.value=this.value,n.unsubscribe=this.unsubscribe.bind(this,n.callback),this.listeners.add(n.callback),i.stopPropagation())}unsubscribe(i){this.listeners.delete(i)}set value(i){this._value=i;for(let n of this.listeners)n(i)}get value(){return this._value}},Consumer:t(function({render:i}){const n=vi(s);return i(n)},{useShadowDOM:!1}),defaultValue:e};return s}}const I=te(class extends ee{value;values;constructor(t,e,s,i){super(t,e),this.value=s(),this.values=i}update(t,e){return this.hasChanged(e)&&(this.values=e,this.value=t()),this.value}hasChanged(t=[]){return t.some((e,s)=>this.values[s]!==e)}}),C=(t,e)=>I(()=>t,e);function An(t,e){t[Te].push(e)}const nt=yi(An),Q=te(class extends ee{args;constructor(t,e,s){super(t,e),this.updater=this.updater.bind(this),typeof s=="function"&&(s=s()),this.makeArgs(s)}update(){return this.args}updater(t){const[e]=this.args;typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&(this.makeArgs(t),this.state.update())}makeArgs(t){this.args=Object.freeze([t,this.updater])}}),wi=te(class extends ee{reducer;currentState;constructor(t,e,s,i,n){super(t,e),this.dispatch=this.dispatch.bind(this),this.currentState=n!==void 0?n(i):i}update(t){return this.reducer=t,[this.currentState,this.dispatch]}dispatch(t){this.currentState=this.reducer(this.currentState,t),this.state.update()}}),Ln=/([A-Z])/gu,Ie=te(class extends ee{property;eventName;constructor(t,e,s,i){if(super(t,e),this.state.virtual)throw new Error("Can't be used with virtual components.");this.updater=this.updater.bind(this),this.property=s,this.eventName=s.replace(Ln,"-$1").toLowerCase()+"-changed",this.state.host[this.property]==null&&(typeof i=="function"&&(i=i()),i!=null&&this.updateProp(i))}update(t,e){return[this.state.host[this.property],this.updater]}updater(t){const e=this.state.host[this.property];typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&this.updateProp(t)}updateProp(t){this.notify(t).defaultPrevented||(this.state.host[this.property]=t)}notify(t){const e=new CustomEvent(this.eventName,{detail:{value:t,path:this.property},cancelable:!0});return this.state.host.dispatchEvent(e),e}}),Ss=t=>e=>{e.preventDefault(),t(e.detail.value)};function Rn(t){let e=t;return{get current(){return e},set current(s){e=s},get value(){return e},set value(s){e=s}}}function se(t){return I(()=>Rn(t),[])}te(class extends ee{update(){return this.state.host}});function kn({render:t}){const e=On(t),s=Tn(e);return{component:e,createContext:s}}/**
 * @license
...
`,Hn=t=>I(()=>{if(t==null)return;const e=new RegExp(t,"u");return s=>{!s.defaultPrevented&&s.data&&!e.test(s.data)&&s.preventDefault()}},[t]),os=te(class extends ee{values;constructor(t,e,s,i){super(t,e),Object.assign(e.host,s),this.values=i}update(t,e){this.hasChanged(e)&&(this.values=e,Object.assign(this.state.host,t))}hasChanged(t=[]){return t.some((e,s)=>this.values[s]!==e)}}),He=te(class extends ee{update(){return this.state.host}}),Un=/([A-Z])/gu,Kt=(t,e,s)=>{t[e]=s,t.dispatchEvent(new CustomEvent(e.replace(Un,"-$1").toLowerCase()+"-changed",{detail:{value:s}}))},Yn=(t,e,s=[e])=>{const i=He();z(()=>{Kt(i,t,e)},s)},Ei=t=>{const e=se(void 0),s=C(l=>e.current=l,[]),i=t.shadowRoot,n=C(l=>t.dispatchEvent(new Event(l.type,{bubbles:l.bubbles})),[]),r=C(l=>Kt(t,"value",l.target.value),[]),o=C(l=>Kt(t,"focused",l.type==="focus"),[]),a=C(()=>{const l=e.current?.checkValidity();return t.toggleAttribute("invalid",!l),l},[]);return os({validate:a},[a]),z(()=>{const l=c=>{c.composedPath()[0]?.closest?.("input, textarea")||(c.preventDefault(),e.current?.focus())};return i.addEventListener("mousedown",l),()=>i.removeEventListener("mousedown",l)},[]),{onChange:n,onFocus:o,onInput:r,onRef:s}},Xn=({placeholder:t,noLabelFloat:e,label:s})=>(e?s:void 0)||t||" ",Kn=["type","pattern","allowed-pattern","min","max","step","autosize","label","placeholder",...Pi],Jn=t=>{const{type:e="text",pattern:s,allowedPattern:i,autocomplete:n,value:r,readonly:o,disabled:a,min:l,max:c,step:u,maxlength:d}=t,{onChange:h,onFocus:p,onInput:f,onRef:g}=Ei(t),m=Hn(i);return Si(b`
			<input
				...
				step=${K(u)}
			/>
		`,t)};customElements.define("cosmoz-input",U(Jn,{observedAttributes:Kn,styleSheets:[ns(Ci)],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const Cs=t=>{t.style.height="",t.style.height=`${t.scrollHeight}px`},Wn=(t,e=0)=>{if(e>0){const s=t.getAttribute("rows")??"",i=t.style.height;t.style.height="",t.setAttribute("rows",e),t.style.maxHeight=t.getBoundingClientRect().height+"px",t.style.height=i,t.setAttribute("rows",s)}},Gn=t=>{const{value:e,maxRows:s}=t,i=I(()=>()=>t.shadowRoot.querySelector("#input"),[]);z(()=>Wn(i(),s),[s,i]),z(()=>Cs(i()),[i,e]),z(()=>{const n=i(),r=new ResizeObserver(()=>requestAnimationFrame(()=>Cs(n)));return r.observe(n),()=>r.unobserve(n)},[i])},Zn=["rows","placeholder",...Pi],qn=t=>{const{autocomplete:e,value:s,placeholder:i,readonly:n,disabled:r,rows:o,cols:a,maxlength:l}=t,{onChange:c,onFocus:u,onInput:d,onRef:h}=Ei(t);return Gn(t),Si(b`
			<textarea id="input" part="input"
				...
				@change=${c} @focus=${u} @blur=${u}>`,t)};customElements.define("cosmoz-textarea",U(qn,{observedAttributes:Zn,styleSheets:[ns(Ci)],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const Qn=t=>{const{label:e,value:s,disabled:i,error:n}=t,r=C(o=>t.dispatchEvent(new CustomEvent("change",{detail:o.target.checked})),[]);return b`<input
			id="toggle"
			class="toggle"
			part="toggle"
			type="checkbox"
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ms=t=>!mn(t)&&typeof t.then=="function",Ds=1073741823;let zr=class extends yt{constructor(){super(...arguments),this._$Cwt=Ds,this._$Cbt=[],this._$CK=new Or(this),this._$CX=new $r}render(...e){return e.find(s=>!Ms(s))??H}update(e,s){const i=this._$Cbt;let n=i.length;this._$Cbt=s;const r=this._$CK,o=this._$CX;this.isConnected||this.disconnected();for(let a=0;a<s.length&&!(a>this._$Cwt);a++){const l=s[a];if(!Ms(l))return this._$Cwt=a,l;a<n&&l===i[a]||(this._$Cwt=Ds,n=0,Promise.resolve(l).then(async c=>{for(;o.get();)await o.get();const u=r.deref();if(u!==void 0){const d=u._$Cbt.indexOf(l);d>-1&&d<u._$Cwt&&(u._$Cwt=d,u.setValue(c))}}))}return H}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}};const De=ie(zr);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Fs=(t,e,s)=>{const i=new Map;for(let n=e;n<=s;n++)i.set(t[n],n);return i},zi=ie(class extends we{constructor(t){if(super(t),t.type!==Z.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const n=[],r=[];let o=0;for(const a of t)n[o]=i?i(a,o):o,r[o]=s(a,o),o++;return{values:r,keys:n}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const n=_n(t),{values:r,keys:o}=this.dt(e,s,i);if(!Array.isArray(n))return this.ut=o,r;const a=this.ut??=[],l=[];let c,u,d=0,h=n.length-1,p=0,f=r.length-1;for(;d<=h&&p<=f;)if(n[d]===null)d++;else if(n[h]===null)h--;else if(a[d]===o[p])l[p]=re(n[d],r[p]),d++,p++;else if(a[h]===o[f])l[f]=re(n[h],r[f]),h--,f--;else if(a[d]===o[f])l[f]=re(n[d],r[f]),Pe(t,l[f+1],n[d]),d++,f--;else if(a[h]===o[p])l[p]=re(n[h],r[p]),Pe(t,n[d],n[h]),h--,p++;else if(c===void 0&&(c=Fs(o,p,f),u=Fs(a,d,h)),c.has(a[d]))if(c.has(a[h])){const g=u.get(o[p]),m=g!==void 0?n[g]:null;if(m===null){const _=Pe(t,n[d]);re(_,r[p]),l[p]=_}else l[p]=re(m,r[p]),Pe(t,n[d],m),n[g]=null;p++}else Qe(n[h]),h--;else Qe(n[d]),d++;for(;p<=f;){const g=Pe(t,l[f+1]);re(g,r[p]),l[p++]=g}for(;d<=h;){const g=n[d++];g!==null&&Qe(g)}return this.ut=o,gi(t,l),H}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,Zr=t=>{const e=t==="auto",[s,i]=Q(e?40:t);return[s,n=>e?i(n):void 0]},Ai=Dn(()=>Ti);customElements.define("cosmoz-keybinding-provider",Ai.Provider);const ls=t=>{const e=I(()=>({}),[]);return I(()=>Object.assign(e,t),[e,...Object.values(t)])},Re=(t,e)=>{const s=vi(Ai),i=ls(t);z(()=>s(i),e)},qr=Symbol("listbox.navigate.up"),Qr=Symbol("listbox.navigate.down"),eo=Symbol("listbox.select"),to=({onUp:t,onDown:e,onEnter:s})=>{const i=He();Re({activity:qr,callback:t,element:()=>i},[]),Re({activity:Qr,callback:e,element:()=>i},[]),Re({activity:eo,callback:s,element:()=>i},[])},so=({items:t,onSelect:e,defaultIndex:s=0})=>{const[i,n]=Q({index:s}),{index:r}=i,{length:o}=t;return z(()=>{n({index:i.index<0?s:Math.min(i.index,t.length-1),scroll:!0})},[t,s]),to({onUp:C(()=>n(a=>({index:a.index>0?a.index-1:o-1,scroll:!0})),[o]),onDown:C(()=>n(a=>({index:a.index<o-1?a.index+1:0,scroll:!0})),[o]),onEnter:C(()=>r>-1&&r<o&&e?.(t[r],r),[r,t,e])}),{position:i,highlight:C(a=>n({index:a}),[]),select:C(a=>e?.(a),[e])}},io=t=>typeof t=="object"&&t!==null&&Symbol.iterator in t;function oe(t){return t==null?[]:Array.isArray(t)?t:typeof t=="string"?[t]:io(t)?Array.from(t):[t]}const Ft=(t,e=ut)=>s=>{const i=oe(t).map(e);return oe(s).filter(n=>!i.includes(e(n)))},no=(t,e)=>e?s=>s!=null&&oe(t).find(i=>i[e]===s[e]):s=>s!=null&&oe(t).includes(s),ro=(t,e)=>{if(!e||!t)return t;const s=t.toLowerCase().indexOf(e.toLowerCase());if(s<0)return t;const i=s+e.length;return[t.slice(0,s),b`<mark>${t.slice(s,i)}</mark>`,t.slice(i)]},oo=(t=ut)=>(e,s,{highlight:i,select:n,textual:r=ut,query:o,isSelected:a})=>{const l=r(e),c=ro(l,o),u=t(c,e,s);return b`<div
				class="item"
				role="option"
				part="option"
				?aria-selected=${a(e)}
			...
			<div class="sizer" virtualizer-sizer>${u}</div>`},ao=({itemRenderer:t=oo(),...e})=>{const s=ls(e);return C((i,n)=>t(i,n,s),[s,t])},lo=["query","items","onSelect","textual","anchor","itemHeight","itemLimit","itemRenderer","defaultIndex","value","valueProperty","loading"],co=({value:t,valueProperty:e,items:s,onSelect:i,defaultIndex:n,query:r,textual:o,itemRenderer:a,itemHeight:l=40,itemLimit:c=5})=>{const u=I(()=>no(t,e),[t,e]),d=I(()=>s.slice(),[s,u]),{position:h,highlight:p,select:f}=so({items:d,onSelect:i,defaultIndex:isNaN(n)?void 0:Number(n)}),[g,m]=Zr(l);return{position:h,items:d,height:Math.min(c,d.length)*g,highlight:p,select:f,itemHeight:g,setItemHeight:m,renderItem:ao({itemRenderer:a,items:d,position:h,highlight:p,select:f,textual:o,query:r,isSelected:u})}},Hs=Ti,uo=t=>{const e=se(void 0),{position:s,items:i,renderItem:n,height:r,itemHeight:o,setItemHeight:a}=co(t);return z(()=>{const l=e.current?.[Wt];l&&l.layoutComplete.then(()=>{t.dispatchEvent(new CustomEvent("layout-complete"));const{averageChildSize:c,averageMarginSize:u}=l._layout._metricsCache;return a(c+u*2)},Hs)},[i]),z(()=>{if(!s.scroll)return;const l=e.current?.[Wt];if(l){if(!l?._layout){l.layoutComplete.then(()=>l.element(s.index)?.scrollIntoView({block:"nearest"}),Hs);return}l.element(s.index)?.scrollIntoView({block:"nearest"})}},[s]),Yr(Gr({...s,itemHeight:o,auto:t.itemHeight==="auto"})),b`<div
			class="items"
		...
		<slot></slot>`};customElements.define("cosmoz-listbox",U(uo,{styleSheets:[rs(Wr)]}));const ho=({multi:t,...e},s)=>b`<cosmoz-listbox
		part="listbox"
		?multi=${t}
		...=${Br(Kr(lo)(e))}
		>${s}</cosmoz-listbox
...
`;customElements.define("cosmoz-autocomplete-chip",U(go,{observedAttributes:["disabled"],styleSheets:[rs(po)]}));const mo=({content:t,onClear:e,disabled:s,hidden:i,className:n="chip",slot:r})=>b`<cosmoz-autocomplete-chip
		class=${K(n)}
		slot=${K(r)}
		part="chip"
...
`;customElements.define("cosmoz-autocomplete-skeleton-span",U(()=>G,{styleSheets:[yo]}));const bo=bt`
	:host {
		display: block;
		position: relative;
		min-width: 35px;
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const Ca="link[rel=import][type~=css]",Ea="include",qs="shady-unscoped";function Gi(t){return je.import(t)}function Qs(t){let e=t.body?t.body:t;const s=fs(e.textContent,t.baseURI),i=document.createElement("style");return i.textContent=s,i}function Oa(t){const e=t.trim().split(/\s+/),s=[];for(let i=0;i<e.length;i++)s.push(...$a(e[i]));return s}function $a(t){const e=Gi(t);if(!e)return console.warn("Could not find style data in module named",t),[];if(e._styles===void 0){const s=[];s.push(...qi(e));const i=e.querySelector("template");i&&s.push(...Zi(i,e.assetpath)),e._styles=s}return e._styles}function Zi(t,e){if(!t._styles){const s=[],i=t.content.querySelectorAll("style");for(let n=0;n<i.length;n++){let r=i[n],o=r.getAttribute(Ea);o&&s.push(...Oa(o).filter(function(a,l,c){return c.indexOf(a)===l})),e&&(r.textContent=fs(r.textContent,e)),s.push(r)}t._styles=s}return t._styles}function za(t){let e=Gi(t);return e?qi(e):[]}function qi(t){const e=[],s=t.querySelectorAll(Ca);for(let i=0;i<s.length;i++){let n=s[i];if(n.import){const r=n.import,o=n.hasAttribute(qs);if(o&&!r._unscopedStyle){const a=Qs(r);a.setAttribute(qs,""),r._unscopedStyle=a}else r._style||(r._style=Qs(r));e.push(o?r._unscopedStyle:r._style)}}return e}/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/function Qt(t){return t.indexOf(".")>=0}function ge(t){let e=t.indexOf(".");return e===-1?t:t.slice(0,e)}function Ta(t,e){return t.indexOf(e+".")===0}function pt(t,e){return e.indexOf(t+".")===0}function ft(t,e,s){return e+s.slice(t.length)}function $e(t){if(Array.isArray(t)){let e=[];for(let s=0;s<t.length;s++){let i=t[s].toString().split(".");for(let n=0;n<i.length;n++)e.push(i[n])}return e.join(".")}else return t}function Qi(t){return Array.isArray(t)?$e(t).split("."):t.toString().split(".")}function V(t,e,s){let i=t,n=Qi(e);for(let r=0;r<n.length;r++){if(!i)return;let o=n[r];i=i[o]}return s&&(s.path=n.join(".")),i}function ei(t,e,s){let i=t,n=Qi(e),r=n[n.length-1];if(n.length>1){for(let o=0;o<n.length-1;o++){let a=n[o];if(i=i[a],!i)return}i[r]=s}else i[e]=s;return n.join(".")}/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const gt={},Aa=/-[a-z]/g,La=/([A-Z])/g;function en(t){return gt[t]||(gt[t]=t.indexOf("-")<0?t:t.replace(Aa,e=>e[1].toUpperCase()))}function Ot(t){return gt[t]||(gt[t]=t.replace(La,"-$1").toLowerCase())}/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let Ra=0,tn=0,be=[],ka=0,es=!1,sn=document.createTextNode("");new window.MutationObserver(Na).observe(sn,{characterData:!0});function Na(){es=!1;const t=be.length;for(let e=0;e<t;e++){let s=be[e];if(s)try{s()}catch(i){setTimeout(()=>{throw i})}}be.splice(0,t),tn+=t}const Ia={run(t){return es||(es=!0,sn.textContent=ka++),be.push(t),Ra++},cancel(t){const e=t-tn;if(e>=0){if(!be[e])throw new Error("invalid async handle: "+t);be[e]=null}}};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
*/const Il=Nl(HTMLElement),st=[],$t=()=>{T.isInitialized||T.init({lng:"en",resStore:{en:{}},fallbackLng:!1})},zt=t=>t.reduce((e,s,i)=>(e.count===void 0&&typeof s=="number"&&(e.count=s),typeof s=="object"?{...e,...s}:(e[i]=s,e)),{}),W=function(t){$t();const e=zt([...arguments].slice(1));return delete e.count,T.t(t,e)},Ml=function(t,e){$t();const s=zt([...arguments].slice(2)),i=s.count;let n;delete s.count;const r=T.services.pluralResolver.getSuffix(T.language,i);return r?(s.defaultValue=e,n=t+r):(n=t,s.defaultValue=t),T.t(n,s)},Dl=function(t,e){$t();const s=zt([...arguments].slice(2));return s.context=t,delete s.count,T.t(e,s)},Fl=function(t,e,s){$t();const i=zt([...arguments].slice(3)),n=i.count,r=t?"_"+t:"";let o=e;delete i.count;const a=T.services.pluralResolver.getSuffix(T.language,n);return a?(i.defaultValue=s,o=e+r+a):(o=e,i.context=t),T.t(o,i)},jl=(t,e,s)=>{T.init({resources:{}}),T.addResourceBundle(t,e,s)};fe(t=>class extends t{static get properties(){return{t:{type:Object,value(){return{}}}}}_filterT(e){return e.filter(s=>s!==this.t)}_(){return W.apply(null,this._filterT([...arguments]))}connectedCallback(){super.connectedCallback(),st.push(this)}disconnectedCallback(){super.disconnectedCallback();const e=st.indexOf(this);e>=0&&st.splice(e,1)}gettext(){return W.apply(null,this._filterT([...arguments]))}ngettext(){return Ml.apply(null,this._filterT([...arguments]))}pgettext(){return Dl.apply(null,this._filterT([...arguments]))}npgettext(){return Fl.apply(null,this._filterT([...arguments]))}});class Vl extends Il{static get properties(){return{compatibilityJSON:{type:String,value:"v3"},domain:{type:String,value:"messages"},interpolationPrefix:{type:String,value:"__"},interpolationSuffix:{type:String,value:"__"},language:{type:String,value:"en"},namespace:{type:String,value:"translation"},translations:{type:Object,observer(e){e!=null&&(jl(this.language,this.namespace,e),st.forEach(s=>s.set("t",{})))}},keySeparator:{type:String,value:"."},nsSeparator:{type:String,value:":"}}}ready(){super.ready(),T.init({compatibilityJSON:this.compatibilityJSON,interpolation:{escapeValue:!1,prefix:this.interpolationPrefix,suffix:this.interpolationSuffix},keySeparator:this.keySeparator,lng:this.language,nsSeparator:this.nsSeparator,resStore:{}})}}customElements.define("cosmoz-i18next",Vl);const di=()=>document.createComment(""),Bl=_t(G,new DocumentFragment).constructor;class Hl extends HTMLElement{onDisconnect;disconnectedCallback(){this.onDisconnect?.()}}customElements.define("disconnect-observer",Hl);class Ul extends yt{_op;_outlet;_content;render(e,s=document.body){return b`<disconnect-observer
		...
		></disconnect-observer>`}update(e,[s,i=document.body]){return this.updateOutlet(i,s),this.render(s,i)}updateOutlet(e,s){this._outlet!==e&&this.clearOutlet(),this._outlet=e;const i=this._op??=new Bl(e.appendChild(di()),e.appendChild(di()));re(i,this._content=s)}clearOutlet(){const e=this._op;e&&(yn(e),Qe(e),this._op=void 0)}disconnected(){this.clearOutlet()}reconnected(){this._outlet&&this._content&&this.updateOutlet(this._outlet,this._content)}}const Yl=ie(Ul),Xl=`:host {
    display: flex;
