...
>
	...
	${k(p,()=>Kl(v`<cosmoz-image-viewer
				fullscreen
				.source=${N}
				.currentAttachmentIndex=${R}
				.currentImageIndex=${u}
				@current-attachment-index-changed=${Ci(w)}
