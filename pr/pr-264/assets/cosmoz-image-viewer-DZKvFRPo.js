const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./jspdf.es-C1K32I9i.js","./iframe-BfyHBkUj.js","./pdf-loader-Bkitx4-u.js"])))=>i.map(i=>d[i]);
import{r as oi,D as dt,A as G,b,E as H,p as ai,n as fn,M as pn,u as re,v as xe,h as Ke,_ as Gt,j as gn}from"./iframe-BfyHBkUj.js";let We,li=0;function us(t){We=t}function ds(){We=null,li=0}function mn(){return li++}const Pt=Symbol("haunted.phase"),Je=Symbol("haunted.hook"),hs=Symbol("haunted.update"),fs=Symbol("haunted.commit"),le=Symbol("haunted.effects"),$e=Symbol("haunted.layoutEffects"),Rt="haunted.context";class _n{update;host;virtual;[Je];[le];[$e];constructor(e,s){this.update=e,this.host=s,this[Je]=new Map,this[le]=[],this[$e]=[]}run(e){us(this);let s=e();return ds(),s}_runEffects(e){let s=this[e];us(this);for(let i of s)i.call(this);ds()}runEffects(){this._runEffects(le)}runLayoutEffects(){this._runEffects($e)}teardown(){this[Je].forEach(s=>{typeof s.teardown=="function"&&s.teardown(!0)})}}const yn=Promise.resolve().then.bind(Promise.resolve());function ci(){let t=[],e;function s(){e=null;let i=t;t=[];for(var n=0,r=i.length;n<r;n++)i[n]()}return function(i){t.push(i),e==null&&(e=yn(s))}}const bn=ci(),ps=ci();class vn{renderer;host;state;[Pt];_updateQueued;_active;constructor(e,s){this.renderer=e,this.host=s,this.state=new _n(this.update.bind(this),s),this[Pt]=null,this._updateQueued=!1,this._active=!1}update(){this._active&&(this._updateQueued||(bn(()=>{let e=this.handlePhase(hs);ps(()=>{this.handlePhase(fs,e),ps(()=>{this.handlePhase(le)})}),this._updateQueued=!1}),this._updateQueued=!0))}handlePhase(e,s){switch(this[Pt]=e,e){case fs:this.commit(s),this.runEffects($e);return;case hs:return this.render();case le:return this.runEffects(le)}}render(){return this.state.run(()=>this.renderer.call(this.host,this.host))}runEffects(e){this.state._runEffects(e)}teardown(){this.state.teardown()}pause(){this._active=!1}resume(){this._active=!0}}const Wt=(...t)=>{const e=new CSSStyleSheet;return e.replaceSync(t.join("")),e},wn=t=>t?.map(e=>typeof e=="string"?Wt(e):e),xn=(t,...e)=>t.flatMap((s,i)=>[s,e[i]||""]).join(""),de=xn,Sn=(t="")=>t.replace(/-+([a-z])?/g,(e,s)=>s?s.toUpperCase():"");function Pn(t){class e extends vn{frag;renderResult;constructor(n,r,o){super(n,o||r),this.frag=r}commit(n){this.renderResult=t(n,this.frag)}}function s(i,n,r){const o=(r||n||{}).baseElement||HTMLElement,{observedAttributes:a=[],useShadowDOM:l=!0,shadowRootInit:c={},styleSheets:u}=r||n||{},d=wn(i.styleSheets||u);class h extends o{_scheduler;static get observedAttributes(){return i.observedAttributes||a||[]}constructor(){if(super(),l===!1)this._scheduler=new e(i,this);else{const m=this.attachShadow({mode:"open",...c});d&&(m.adoptedStyleSheets=d),this._scheduler=new e(i,m,this)}}connectedCallback(){this._scheduler.resume(),this._scheduler.update(),this._scheduler.renderResult?.setConnected(!0)}disconnectedCallback(){this._scheduler.pause(),this._scheduler.teardown(),this._scheduler.renderResult?.setConnected(!1)}attributeChangedCallback(m,_,y){if(_===y)return;let w=y===""?!0:y;Reflect.set(this,Sn(m),w)}}function f(p){let m=p,_=!1;return Object.freeze({enumerable:!0,configurable:!0,get(){return m},set(y){_&&m===y||(_=!0,m=y,this._scheduler&&this._scheduler.update())}})}const g=new Proxy(o.prototype,{getPrototypeOf(p){return p},set(p,m,_,y){let w;return m in p?(w=Object.getOwnPropertyDescriptor(p,m),w&&w.set?(w.set.call(y,_),!0):(Reflect.set(p,m,_,y),!0)):(typeof m=="symbol"||m[0]==="_"?w={enumerable:!0,configurable:!0,writable:!0,value:_}:w=f(_),Object.defineProperty(y,m,w),w.set&&w.set.call(y,_),!0)}});return Object.setPrototypeOf(h.prototype,g),h}return s}class Q{id;state;constructor(e,s){this.id=e,this.state=s}}function Cn(t,...e){let s=mn(),i=We[Je],n=i.get(s);return n||(n=new t(s,We,...e),i.set(s,n)),n.update(...e)}function ee(t){return Cn.bind(null,t)}function ui(t){return ee(class extends Q{callback;lastValues;values;_teardown;constructor(e,s,i,n){super(e,s),t(s,this)}update(e,s){this.callback=e,this.values=s}call(){const e=!this.values||this.hasChanged();this.lastValues=this.values,e&&this.run()}run(){this.teardown(),this._teardown=this.callback.call(this.state)}teardown(e){typeof this._teardown=="function"&&(this._teardown(),this._teardown=void 0),e&&(this.lastValues=this.values=void 0)}hasChanged(){return!this.lastValues||this.values.some((e,s)=>this.lastValues[s]!==e)}})}function di(t,e){t[le].push(e)}const C=ui(di),En=t=>t instanceof Element?t:t.startNode||t.endNode||t.parentNode,hi=ee(class extends Q{Context;value;_ranEffect;_unsubscribe;constructor(t,e,s){super(t,e),this._updater=this._updater.bind(this),this._ranEffect=!1,this._unsubscribe=null,di(e,this)}update(t){return this.Context!==t&&(this._subscribe(t),this.Context=t),this.value}call(){this._ranEffect||(this._ranEffect=!0,this._unsubscribe&&this._unsubscribe(),this._subscribe(this.Context),this.state.update())}_updater(t){this.value=t,this.state.update()}_subscribe(t){const e={Context:t,callback:this._updater};En(this.state.host).dispatchEvent(new CustomEvent(Rt,{detail:e,bubbles:!0,cancelable:!0,composed:!0}));const{unsubscribe:i=null,value:n}=e;this.value=i?n:t.defaultValue,this._unsubscribe=i}teardown(){this._unsubscribe&&this._unsubscribe()}});function On(t){return e=>{const s={Provider:class extends HTMLElement{listeners;_value;constructor(){super(),this.style.display="contents",this.listeners=new Set,this.addEventListener(Rt,this)}disconnectedCallback(){this.removeEventListener(Rt,this)}handleEvent(i){const{detail:n}=i;n.Context===s&&(n.value=this.value,n.unsubscribe=this.unsubscribe.bind(this,n.callback),this.listeners.add(n.callback),i.stopPropagation())}unsubscribe(i){this.listeners.delete(i)}set value(i){this._value=i;for(let n of this.listeners)n(i)}get value(){return this._value}},Consumer:t(function({render:i}){const n=hi(s);return i(n)},{useShadowDOM:!1}),defaultValue:e};return s}}const R=ee(class extends Q{value;values;constructor(t,e,s,i){super(t,e),this.value=s(),this.values=i}update(t,e){return this.hasChanged(e)&&(this.values=e,this.value=t()),this.value}hasChanged(t=[]){return t.some((e,s)=>this.values[s]!==e)}}),v=(t,e)=>R(()=>t,e);function $n(t,e){t[$e].push(e)}const qe=ui($n),V=ee(class extends Q{args;constructor(t,e,s){super(t,e),this.updater=this.updater.bind(this),typeof s=="function"&&(s=s()),this.makeArgs(s)}update(){return this.args}updater(t){const[e]=this.args;typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&(this.makeArgs(t),this.state.update())}makeArgs(t){this.args=Object.freeze([t,this.updater])}}),De=ee(class extends Q{reducer;currentState;constructor(t,e,s,i,n){super(t,e),this.dispatch=this.dispatch.bind(this),this.currentState=n!==void 0?n(i):i}update(t){return this.reducer=t,[this.currentState,this.dispatch]}dispatch(t){this.currentState=this.reducer(this.currentState,t),this.state.update()}}),Tn=/([A-Z])/gu,qt=ee(class extends Q{property;eventName;constructor(t,e,s,i){if(super(t,e),this.state.virtual)throw new Error("Can't be used with virtual components.");this.updater=this.updater.bind(this),this.property=s,this.eventName=s.replace(Tn,"-$1").toLowerCase()+"-changed",this.state.host[this.property]==null&&(typeof i=="function"&&(i=i()),i!=null&&this.updateProp(i))}update(t,e){return[this.state.host[this.property],this.updater]}updater(t){const e=this.state.host[this.property];typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&this.updateProp(t)}updateProp(t){this.notify(t).defaultPrevented||(this.state.host[this.property]=t)}notify(t){const e=new CustomEvent(this.eventName,{detail:{value:t,path:this.property},cancelable:!0});return this.state.host.dispatchEvent(e),e}});function Ln(t){let e=t;return{get current(){return e},set current(s){e=s},get value(){return e},set value(s){e=s}}}function ye(t){return R(()=>Ln(t),[])}ee(class extends Q{update(){return this.state.host}});function zn({render:t}){const e=Pn(t),s=On(e);return{component:e,createContext:s}}/**
 * @license
...
`,Fn=t=>{const{placement:e="bottom span-right",disabled:s,openOnHover:i,openOnFocus:n}=t,r=ye(),[o,a]=qt("opened",!1),l=v(()=>{s||(a(!0),r.current?.showPopover())},[s]),c=v(()=>{a(!1),r.current?.hidePopover()},[]),u=v(()=>{if(s)return;r.current?.matches(":popover-open")?c():l()},[s]);C(()=>{const p=r.current;p&&(o?p.showPopover():p.hidePopover())},[o]),C(()=>{t.toggleAttribute("opened",!!o)},[o]);const{scheduleClose:d,cancelClose:h}=In({host:t,popoverRef:r,disabled:s,openOnHover:i,openOnFocus:n,open:l,close:c}),f=n?l:u,g=v(p=>{Mn(p),a(p.newState==="open"),t.dispatchEvent(new ToggleEvent("dropdown-toggle",{newState:p.newState,oldState:p.oldState,composed:!0}))},[]);return b`
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const pt=te(class extends be{constructor(t){if(super(t),t.type!==q.PROPERTY&&t.type!==q.ATTRIBUTE&&t.type!==q.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!oi(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===H||e===G)return e;const s=t.element,i=t.name;if(t.type===q.PROPERTY){if(e===s[i])return H}else if(t.type===q.BOOLEAN_ATTRIBUTE){if(!!e===s.hasAttribute(i))return H}else if(t.type===q.ATTRIBUTE&&s.getAttribute(i)===e+"")return H;return ai(t),e}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function k(t,e,s){return t?e(t):s?.(t)}const pi=(t,{label:e,invalid:s,errorMessage:i})=>b`
	...
	`,gi=["autocomplete","readonly","disabled","maxlength","invalid","no-label-float","always-float-label"],gs=ft`
	.wrap {
...
`,jn=t=>R(()=>{if(t==null)return;const e=new RegExp(t,"u");return s=>{!s.defaultPrevented&&s.data&&!e.test(s.data)&&s.preventDefault()}},[t]),Qt=ee(class extends Q{values;constructor(t,e,s,i){super(t,e),Object.assign(e.host,s),this.values=i}update(t,e){this.hasChanged(e)&&(this.values=e,Object.assign(this.state.host,t))}hasChanged(t=[]){return t.some((e,s)=>this.values[s]!==e)}}),we=ee(class extends Q{update(){return this.state.host}}),Vn=/([A-Z])/gu,kt=(t,e,s)=>{t[e]=s,t.dispatchEvent(new CustomEvent(e.replace(Vn,"-$1").toLowerCase()+"-changed",{detail:{value:s}}))},ms=(t,e,s=[e])=>{const i=we();C(()=>{kt(i,t,e)},s)},_i=t=>{const e=ye(void 0),s=v(l=>e.current=l,[]),i=t.shadowRoot,n=v(l=>t.dispatchEvent(new Event(l.type,{bubbles:l.bubbles})),[]),r=v(l=>kt(t,"value",l.target.value),[]),o=v(l=>kt(t,"focused",l.type==="focus"),[]),a=v(()=>{const l=e.current?.checkValidity();return t.toggleAttribute("invalid",!l),l},[]);return Qt({validate:a},[a]),C(()=>{const l=c=>{c.composedPath()[0]?.closest?.("input, textarea")||(c.preventDefault(),e.current?.focus())};return i.addEventListener("mousedown",l),()=>i.removeEventListener("mousedown",l)},[]),{onChange:n,onFocus:o,onInput:r,onRef:s}},Bn=({placeholder:t,noLabelFloat:e,label:s})=>(e?s:void 0)||t||" ",Hn=["type","pattern","allowed-pattern","min","max","step","autosize","label","placeholder",...gi],Un=t=>{const{type:e="text",pattern:s,allowedPattern:i,autocomplete:n,value:r,readonly:o,disabled:a,min:l,max:c,step:u,maxlength:d}=t,{onChange:h,onFocus:f,onInput:g,onRef:p}=_i(t),m=jn(i);return pi(b`
		...
		`,t)};customElements.define("cosmoz-input",U(Un,{observedAttributes:Hn,styleSheets:[Wt(mi)],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const _s=t=>{t.style.height="",t.style.height=`${t.scrollHeight}px`},Yn=(t,e=0)=>{if(e>0){const s=t.getAttribute("rows")??"",i=t.style.height;t.style.height="",t.setAttribute("rows",e),t.style.maxHeight=t.getBoundingClientRect().height+"px",t.style.height=i,t.setAttribute("rows",s)}},Kn=t=>{const{value:e,maxRows:s}=t,i=R(()=>()=>t.shadowRoot.querySelector("#input"),[]);C(()=>Yn(i(),s),[s,i]),C(()=>_s(i()),[i,e]),C(()=>{const n=i(),r=new ResizeObserver(()=>requestAnimationFrame(()=>_s(n)));return r.observe(n),()=>r.unobserve(n)},[i])},Jn=["rows","placeholder",...gi],Xn=t=>{const{autocomplete:e,value:s,placeholder:i,readonly:n,disabled:r,rows:o,cols:a,maxlength:l}=t,{onChange:c,onFocus:u,onInput:d,onRef:h}=_i(t);return Kn(t),pi(b`
			<textarea id="input" part="input"
				...
				.value=${pt(s??"")} maxlength=${K(l)} @input=${d}
				@change=${c} @focus=${u} @blur=${u}>`,t)};customElements.define("cosmoz-textarea",U(Xn,{observedAttributes:Jn,styleSheets:[Wt(mi)],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const Gn=t=>{const{label:e,value:s,disabled:i,error:n}=t,r=v(o=>t.dispatchEvent(new CustomEvent("change",{detail:o.target.checked})),[]);return b`<input
			id="toggle"
			class="toggle"
			part="toggle"
			type="checkbox"
		...
		<slot name="suffix"></slot>
		${k(n,o=>b`<div class="failure">${o}</div>`)} `},Wn=de`
	.toggle {
		appearance: none;
		width: 35px;
		height: 18px;
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ts=t=>!fn(t)&&typeof t.then=="function",Ls=1073741823;let Cr=class extends ht{constructor(){super(...arguments),this._$Cwt=Ls,this._$Cbt=[],this._$CK=new Sr(this),this._$CX=new Pr}render(...e){return e.find(s=>!Ts(s))??H}update(e,s){const i=this._$Cbt;let n=i.length;this._$Cbt=s;const r=this._$CK,o=this._$CX;this.isConnected||this.disconnected();for(let a=0;a<s.length&&!(a>this._$Cwt);a++){const l=s[a];if(!Ts(l))return this._$Cwt=a,l;a<n&&l===i[a]||(this._$Cwt=Ls,n=0,Promise.resolve(l).then(async c=>{for(;o.get();)await o.get();const u=r.deref();if(u!==void 0){const d=u._$Cbt.indexOf(l);d>-1&&d<u._$Cwt&&(u._$Cwt=d,u.setValue(c))}}))}return H}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}};const ke=te(Cr);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const zs=(t,e,s)=>{const i=new Map;for(let n=e;n<=s;n++)i.set(t[n],n);return i},vi=te(class extends be{constructor(t){if(super(t),t.type!==q.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const n=[],r=[];let o=0;for(const a of t)n[o]=i?i(a,o):o,r[o]=s(a,o),o++;return{values:r,keys:n}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const n=pn(t),{values:r,keys:o}=this.dt(e,s,i);if(!Array.isArray(n))return this.ut=o,r;const a=this.ut??=[],l=[];let c,u,d=0,h=n.length-1,f=0,g=r.length-1;for(;d<=h&&f<=g;)if(n[d]===null)d++;else if(n[h]===null)h--;else if(a[d]===o[f])l[f]=re(n[d],r[f]),d++,f++;else if(a[h]===o[g])l[g]=re(n[h],r[g]),h--,g--;else if(a[d]===o[g])l[g]=re(n[d],r[g]),xe(t,l[g+1],n[d]),d++,g--;else if(a[h]===o[f])l[f]=re(n[h],r[f]),xe(t,n[d],n[h]),h--,f++;else if(c===void 0&&(c=zs(o,f,g),u=zs(a,d,h)),c.has(a[d]))if(c.has(a[h])){const p=u.get(o[f]),m=p!==void 0?n[p]:null;if(m===null){const _=xe(t,n[d]);re(_,r[f]),l[f]=_}else l[f]=re(m,r[f]),xe(t,n[d],m),n[p]=null;f++}else Ke(n[h]),h--;else Ke(n[d]),d++;for(;f<=g;){const p=xe(t,l[g+1]);re(p,r[f]),l[f++]=p}for(;d<=h;){const p=n[d++];p!==null&&Ke(p)}return this.ut=o,ai(t,l),H}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,Jr=t=>{const e=t==="auto",[s,i]=V(e?40:t);return[s,n=>e?i(n):void 0]},xi=Nn(()=>wi);customElements.define("cosmoz-keybinding-provider",xi.Provider);const ts=t=>{const e=R(()=>({}),[]);return R(()=>Object.assign(e,t),[e,...Object.values(t)])},ze=(t,e)=>{const s=hi(xi),i=ts(t);C(()=>s(i),e)},Xr=Symbol("listbox.navigate.up"),Gr=Symbol("listbox.navigate.down"),Wr=Symbol("listbox.select"),qr=({onUp:t,onDown:e,onEnter:s})=>{const i=we();ze({activity:Xr,callback:t,element:()=>i},[]),ze({activity:Gr,callback:e,element:()=>i},[]),ze({activity:Wr,callback:s,element:()=>i},[])},Zr=({items:t,onSelect:e,defaultIndex:s=0})=>{const[i,n]=V({index:s}),{index:r}=i,{length:o}=t;return C(()=>{n({index:i.index<0?s:Math.min(i.index,t.length-1),scroll:!0})},[t,s]),qr({onUp:v(()=>n(a=>({index:a.index>0?a.index-1:o-1,scroll:!0})),[o]),onDown:v(()=>n(a=>({index:a.index<o-1?a.index+1:0,scroll:!0})),[o]),onEnter:v(()=>r>-1&&r<o&&e?.(t[r],r),[r,t,e])}),{position:i,highlight:v(a=>n({index:a}),[]),select:v(a=>e?.(a),[e])}},Qr=t=>typeof t=="object"&&t!==null&&Symbol.iterator in t;function oe(t){return t==null?[]:Array.isArray(t)?t:typeof t=="string"?[t]:Qr(t)?Array.from(t):[t]}const $t=(t,e=it)=>s=>{const i=oe(t).map(e);return oe(s).filter(n=>!i.includes(e(n)))},eo=(t,e)=>e?s=>s!=null&&oe(t).find(i=>i[e]===s[e]):s=>s!=null&&oe(t).includes(s),to=(t,e)=>{if(!e||!t)return t;const s=t.toLowerCase().indexOf(e.toLowerCase());if(s<0)return t;const i=s+e.length;return[t.slice(0,s),b`<mark>${t.slice(s,i)}</mark>`,t.slice(i)]},so=(t=it)=>(e,s,{highlight:i,select:n,textual:r=it,query:o,isSelected:a})=>{const l=r(e),c=to(l,o),u=t(c,e,s);return b`<div
				class="item"
				role="option"
				part="option"
				?aria-selected=${a(e)}
		...
		<slot></slot>`};customElements.define("cosmoz-listbox",U(oo,{styleSheets:[Zt(Yr)]}));const ao=({multi:t,...e},s)=>b`<cosmoz-listbox
		part="listbox"
		?multi=${t}
		...=${Dr(Hr(no)(e))}
		>${s}</cosmoz-listbox
...
`;customElements.define("cosmoz-autocomplete-chip",U(uo,{observedAttributes:["disabled"],styleSheets:[Zt(lo)]}));const ho=({content:t,onClear:e,disabled:s,hidden:i,className:n="chip",slot:r})=>b`<cosmoz-autocomplete-chip
		class=${K(n)}
		slot=${K(r)}
		part="chip"
	...
	>`,fo=({value:t,min:e=0,onDeselect:s,textual:i,disabled:n,chipRenderer:r=ho})=>[...t.filter(Boolean).map(o=>r({item:o,content:i(o),onClear:t.length>e&&(()=>s(o)),disabled:n,slot:"control"})),r({item:null,content:b`<span></span>`,className:"badge",disabled:!0,slot:"control",hidden:!0})],po=de`
	:host {
		display: inline-block;
		vertical-align: middle;
...
`;customElements.define("cosmoz-autocomplete-skeleton-span",U(()=>G,{styleSheets:[po]}));const go=ft`
	:host {
		display: block;
		position: relative;
		min-width: 35px;
...
`,ss=(t,e=()=>({}))=>{const s={type:t,toString(){return t}};return Object.assign((...n)=>Object.assign(e(...n),s),s)},Is=t=>t.type||t.toString(),Ms=t=>Array.isArray(t)?t:[t],mo=(t,e)=>{const s=Ms(e),i=(s.every(Array.isArray)?s:[s]).map(([n,r])=>({actions:Ms(n).map(Is),handle:r}));return(n=t,r)=>{const o=i.find(a=>a.actions.includes(Is(r)));return o?o.handle(n,r):n}},ce={pending:"pending",rejected:"rejected",resolved:"resolved"},Si={error:void 0,result:void 0,state:ce.pending},Pi=ss(ce.pending),Ci=ss(ce.resolved,t=>({result:t})),Ei=ss(ce.rejected,t=>({error:t})),_o=mo(Si,[[Pi,()=>({error:void 0,result:void 0,state:ce.pending})],[Ci,(t,{result:e})=>({error:void 0,result:e,state:ce.resolved})],[Ei,(t,{error:e})=>({error:e,result:void 0,state:ce.rejected})]]),Oi=t=>{const[{error:e,result:s,state:i},n]=De(_o,Si);return C(()=>{if(!t)return;let r=!1;return n(Pi()),t.then(o=>!r&&n(Ci(o)),o=>!r&&n(Ei(o))),()=>{r=!0}},[t]),[s,e,i]},yo=Symbol("autocomplete.deselect.last"),bo=Symbol("autocomplete.search.when.selected"),Ds=t=>t.normalize("NFD").replace(/[\u0300-\u036f]/gu,""),vo=(t,e,s)=>{if(!e)return t;const i=Ds(e.toLowerCase()),n=[];for(const r of t){const a=Ds(s(r).toLowerCase()).indexOf(i);a<0||n.push({item:r,index:a})}return n.sort((r,o)=>r.index-o.index).map(({item:r})=>r)},wo=t=>t===!1||t==null?[]:t,xo=(t,e,s)=>t.dispatchEvent(new CustomEvent(e,{detail:s})),Fs=[],So=t=>(...e)=>{let s;const i=()=>{s&&cancelAnimationFrame(s)};return i(),s=requestAnimationFrame(()=>{s=void 0,t(...e)}),i},Po=(t,e,s)=>v(i=>{e?.(i),t.dispatchEvent(new CustomEvent(s,{detail:i}))},[e]),Co=({value:t,text:e,onChange:s,onText:i,onSelect:n,limit:r,min:o,source:a,textProperty:l,textual:c,valueProperty:u,keepOpened:d,keepQuery:h,preserveOrder:f,defaultIndex:g,externalSearch:p,disabled:m,lazyOpen:_})=>{const y=r!=null?Number(r):void 0,w=R(()=>(c??Br)(l),[c,l]),x=we(),[E,L]=qt("opened",!1),$=!e,z=R(()=>e?.trim(),[e]),D=Po(x,i,"text"),W=v(P=>{s?.(P,()=>L(!1)),xo(x,"value",P)},[s]),[A,ae]=V([]),se=!!(_&&!z),Y=R(()=>se?Promise.resolve([]):Promise.resolve(typeof a=="function"?a({query:z,active:E}):a).then(wo),[a,E,z,se]),I=R(()=>oe(t),[t]);C(()=>Y.then(ae),[Y]),ze({activity:yo,callback:()=>{const P=oe(I);P.length>0&&W(P.slice(0,-1))},check:()=>!m&&$&&x.matches(":focus-within"),element:()=>x},[]),ze({activity:bo,callback:P=>{const M=oe(I),J=y===1;M.length>0&&J&&P.key.length===1&&W(M.slice(0,-1))},allowDefault:!0,check:()=>!m&&$&&x.matches(":focus-within"),element:()=>x},[y]),C(()=>{!E&&!h&&D("")},[E,h]),C(()=>{x.toggleAttribute("opened",!!E)},[E]);const N=ts({onText:D,onChange:W,value:I,limit:y,min:o,keepQuery:h,keepOpened:d,setOpened:L,onSelect:n,valueProperty:u}),[,,ie]=Oi(Y);return{limit:y,opened:E,query:z,textual:w,value:I,source$:Y,loading:ie==="pending",items:R(()=>{if(!E||se)return Fs;const P=f?A:[...I,...$t(I,Xe(u))(A)];return p?P:vo(P,z,w)},[A,E,z,w,$,I,f,u,p,se]),onToggle:v(P=>{m||L(P.newState==="open")},[m]),onText:v(P=>{m||(D(P.target.value),L(!0))},[m,D,e,L]),onSelect:v(P=>{if(m)return;N.onSelect?.(P,N);const{onChange:M,onText:J,limit:F,min:on,value:an,keepQuery:ln,keepOpened:cn,setOpened:un,valueProperty:dn}=N;ln||J(""),cn||un(!1);const Fe=oe(an),St=Xe(dn),cs=Fe.some(hn=>St(hn)===St(P));cs&&Fe.length===on||M((cs?$t(P,St)(Fe):[...Fe,P]).slice(-F))},[m,N]),onDeselect:v(P=>{m||N.onChange($t(P,Xe(N.valueProperty))(N.value))},[m,N]),defaultIndex:z!==void 0&&z?.length>0?0:g}},Eo=t=>{const e=t.shadowRoot.querySelectorAll(".chip"),s=t.shadowRoot.querySelector(".badge");s.hidden=!0;for(const a of e)a.hidden=!1;const n=t.shadowRoot.querySelector("cosmoz-input").shadowRoot?.querySelector(".control")?.getBoundingClientRect();let r;for(r=0;r<e.length;r++){const l=e[r].getBoundingClientRect();if(!(l.x+l.width<=n.x+n.width-24))break}const o=e.length-r;for(s.querySelector("span").textContent="+"+o.toString(),s.hidden=o<1;r<e.length;r++)e[r].hidden=!0},Oo=({value:t,opened:e,wrap:s,limit:i})=>{const n=we(),r=!(s||i===1),o=R(()=>So(()=>Eo(n)),[]),[a,l]=V(0);qe(()=>{if(!r)return;const c=n.shadowRoot.querySelector("cosmoz-input"),u=new ResizeObserver(d=>{l(d[0].contentRect.width)});return u.observe(c),()=>u.disconnect()},[r]),qe(()=>r?o():void 0,[r,a,e,t])},$o=["input","control","label","line","error","wrap"].map(t=>`${t}: input-${t}`).join(),To=({opened:t,isSingle:e,showSingle:s,hasResultsOrQuery:i})=>!t||e&&!s?!1:i,Lo=t=>{const{opened:e,invalid:s,errorMessage:i,label:n,placeholder:r,disabled:o,noLabelFloat:a,alwaysFloatLabel:l,textual:c,text:u,onText:d,onToggle:h,onDeselect:f,value:g,limit:p,min:m,showSingle:_,items:y,source$:w,loading:x,chipRenderer:E}=t,L=p===1,$=L&&g?.[0]!=null,z=x||y.length>0||u!=null&&u.length>0;return b`<cosmoz-dropdown-next
			open-on-focus
			?disabled=${o}
			.opened=${e}
			@dropdown-toggle=${h}
		...
		>
			<cosmoz-input
				...
				?readonly=${$}
				?disabled=${o}
				?invalid=${_e([w,s],()=>ke(w.then(()=>s,()=>!0),s))}
				.errorMessage=${_e([w,i],()=>ke(w.then(()=>i,D=>D.message),i))}
				.value=${pt(u)}
				@value-changed=${d}
				autocomplete="off"
				exportparts=${$o}
			...
			>
				...
				${fo({value:g,min:m,onDeselect:f,textual:c,disabled:o,chipRenderer:E})}
			</cosmoz-input>

			${k(To({opened:e,isSingle:$,showSingle:_,hasResultsOrQuery:z}),()=>ao({...t,items:y,multi:!L},k(x,()=>b`<cosmoz-autocomplete-skeleton-span></cosmoz-autocomplete-skeleton-span>`,()=>k(u!=null&&u.length>0&&y.length===0,()=>b`<slot name="no-result">
											<p class="no-result">${wr("No results found")}</p>
										</slot>`))))}
		</cosmoz-dropdown-next>`},$i=t=>{const e={...t,...Co(t)};return Oo(e),Lo(e)},Ti=["disabled","invalid","no-label-float","always-float-label","text-property","value-property","limit","min","show-single","preserve-order","keep-opened","keep-query","default-index","external-search","item-height","item-limit","wrap","lazy-open"],zo=t=>{const{onChange:e,onText:s,...i}=t,[n,r]=qt("value");return C(()=>{t.onChange!=null&&console.warn("onChange is deprecated; use value-changed and lift instead")},[]),$i({...i,value:n,onChange:v((o,...a)=>{r(o),e?.(o,...a)},[e]),onText:v(o=>{t.text=o,s?.(o)},[s])})},Li=[Zt(go)],zi={mode:"open",delegatesFocus:!0};customElements.define("cosmoz-autocomplete-ui",U($i,{observedAttributes:Ti,styleSheets:Li,shadowRootInit:zi}));customElements.define("cosmoz-autocomplete",U(zo,{observedAttributes:Ti,styleSheets:Li,shadowRootInit:zi}));/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ai="important",Ao=" !"+Ai,Ri=te(class extends be{constructor(t){if(super(t),t.type!==q.ATTRIBUTE||t.name!=="style"||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,s)=>{const i=t[s];return i==null?e:e+`${s=s.includes("-")?s:s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`},"")}update(t,[e]){const{style:s}=t.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const i of this.ft)e[i]==null&&(this.ft.delete(i),i.includes("-")?s.removeProperty(i):s[i]=null);for(const i in e){const n=e[i];if(n!=null){this.ft.add(i);const r=typeof n=="string"&&n.endsWith(Ao);i.includes("-")||r?s.setProperty(i,r?n.slice(0,-11):n,r?Ai:""):s[i]=n}}return H}});class Ro extends Promise{constructor(e){const s={};super((i,n)=>Object.assign(s,{resolve:i,reject:n})),Object.assign(this,s),e?.(s.resolve,s.reject)}resolve=()=>{}}const ki={host:{position:"relative",display:"flex",overflow:"hidden"},slide:{position:"static",width:"100%",height:"100%"}},ko=t=>{const{slide:e}=t,[s,i]=V([]);return qe(()=>void Object.assign(t.style,ki.host),[]),C(()=>{if(e==null)return;const n={animationEnd$:new Ro,...e};i((r=[])=>{const o=r.findIndex(({id:a,out:l})=>a===n.id&&l!==!0);return o!==-1?[...r.slice(0,o),n,...r.slice(o+1,r.length)]:[...r,n]})},[e]),qe(async()=>{if(s.filter(l=>!l.out).length<2){const l=s[0];l&&requestAnimationFrame(()=>requestAnimationFrame(()=>l.animationEnd$.resolve()));return}const n=s[s.length-1],r=s[s.length-2],o=n.el,a=r.el;r.out=!0,o&&a&&await n.animation?.(o,a),i((l=[])=>l.filter(c=>c!==r))},[s]),{slides:s}},No=t=>b`<div
		${ve(e=>Object.assign(t,{el:e}))}
		class="slide"
		style=${Ri(ki.slide)}
	>
		${_e([t],()=>t.content??t.render?.(t))}
	</div>`,Io=({slides:t})=>_e([t],()=>vi(t,({id:e})=>e,No)),Mo=t=>Io(ko(t));customElements.define("cosmoz-slider",U(Mo,{useShadowDOM:!1}));const Mt=(t,e)=>{const s=t.animate([{position:"absolute",transform:"translateX(100%)"},{transform:"translateX(0%)"}],{duration:200,fill:"none",easing:"ease-in-out"}),i=e.animate([{},{position:"absolute",transform:"translateX(-100%)"}],{duration:200,fill:"none",easing:"ease-in-out"});return Promise.all([s.finished,i.finished])},js=(t,e)=>{const s=t.animate([{position:"absolute",transform:"translateX(-100%)"},{transform:"translateX(0%)"}],{duration:200,fill:"none",easing:"ease-in-out"}),i=e.animate([{},{position:"absolute",transform:"translateX(100%)"}],{duration:200,fill:"none",easing:"ease-in-out"});return Promise.all([s.finished,i.finished])},Do=t=>{const e=ye(void 0);return C(()=>void(e.current=t),[t]),e.current},Fo=t=>t,jo=(t,e,s)=>t.find(i=>s(i)===s(e))??t[0],Vo=()=>({id:Math.random(),content:G,animation:Mt}),Bo=(t,{initial:e,render:s,id:i=Fo,loop:n})=>{const[r,o]=V(()=>e??t[0]),a=R(()=>t.indexOf(r),[t,r]),l=Do(a),c=v(()=>o(()=>n?t[(a-1+t.length)%t.length]:t[Math.max(0,Math.min(t.length-1,a-1))]),[t,a,n]),u=v(()=>o(()=>n?t[(a+1)%t.length]:t[Math.max(0,Math.min(t.length-1,a+1))]),[t,a,n]),d=v(p=>o(()=>t[p]),[t]),h=n?!1:a<=0,f=n?!1:a===t.length-1,g=a>(l??-1)?n&&a===t.length-1&&l===0?js:Mt:n&&a===0&&l===t.length-1?Mt:js;return C(()=>o(p=>p?t.indexOf(p)>=0?p:jo(t,p,i):t[0]),[t]),{index:a,item:r,slide:R(()=>r==null?Vo():{id:i(r),render:p=>s(r,{next:u,prev:c,goto:d,first:h,last:f,...p}),animation:g},[r,s]),prev:c,next:u,goto:d,first:h,last:f}},Ho=()=>b`<style>
	@keyframes rotating {
		100% {
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let Ta=0;const he=function(t){let e=t.__mixinApplications;e||(e=new WeakMap,t.__mixinApplications=e);let s=Ta++;function i(n){let r=n.__mixinSet;if(r&&r[s])return n;let o=e,a=o.get(n);if(!a){a=t(n),o.set(n,a);let l=Object.create(a.__mixinSet||r||null);l[s]=!0,a.__mixinSet=l}return a}return i};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let as={},Fi={};function Us(t,e){as[t]=Fi[t.toLowerCase()]=e}function Ys(t){return as[t]||Fi[t.toLowerCase()]}function La(t){t.querySelector("style")&&console.warn("dom-module %s has style outside template",t.id)}class Ne extends HTMLElement{static get observedAttributes(){return["id"]}static import(e,s){if(e){let i=Ys(e);return i&&s?i.querySelector(s):i}return null}attributeChangedCallback(e,s,i,n){s!==i&&this.register()}get assetpath(){if(!this.__assetpath){const e=window.HTMLImports&&HTMLImports.importForElement?HTMLImports.importForElement(this)||document:this.ownerDocument,s=Ae(this.getAttribute("assetpath")||"",e.baseURI);this.__assetpath=os(s)}return this.__assetpath}register(e){if(e=e||this.id,e){if(Vt&&Ys(e)!==void 0)throw Us(e,null),new Error(`strictTemplatePolicy: dom-module ${e} re-registered`);this.id=e,Us(e,this),La(this)}}}Ne.prototype.modules=as;customElements.define("dom-module",Ne);/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const za="link[rel=import][type~=css]",Aa="include",Ks="shady-unscoped";function ji(t){return Ne.import(t)}function Js(t){let e=t.body?t.body:t;const s=rs(e.textContent,t.baseURI),i=document.createElement("style");return i.textContent=s,i}function Ra(t){const e=t.trim().split(/\s+/),s=[];for(let i=0;i<e.length;i++)s.push(...ka(e[i]));return s}function ka(t){const e=ji(t);if(!e)return console.warn("Could not find style data in module named",t),[];if(e._styles===void 0){const s=[];s.push(...Bi(e));const i=e.querySelector("template");i&&s.push(...Vi(i,e.assetpath)),e._styles=s}return e._styles}function Vi(t,e){if(!t._styles){const s=[],i=t.content.querySelectorAll("style");for(let n=0;n<i.length;n++){let r=i[n],o=r.getAttribute(Aa);o&&s.push(...Ra(o).filter(function(a,l,c){return c.indexOf(a)===l})),e&&(r.textContent=rs(r.textContent,e)),s.push(r)}t._styles=s}return t._styles}function Na(t){let e=ji(t);return e?Bi(e):[]}function Bi(t){const e=[],s=t.querySelectorAll(za);for(let i=0;i<s.length;i++){let n=s[i];if(n.import){const r=n.import,o=n.hasAttribute(Ks);if(o&&!r._unscopedStyle){const a=Js(r);a.setAttribute(Ks,""),r._unscopedStyle=a}else r._style||(r._style=Js(r));e.push(o?r._unscopedStyle:r._style)}}return e}/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
`,Ql=Symbol("memo"),sn=t=>{let e=Ql,s;return function(i){if(e===i)return s;const n=t(i);return s=n,e=i,n}},ec=(t,e)=>{const s=t.width/t.height,i=e.width/e.height;return s>i?{width:e.width,height:t.height*(e.width/t.width)}:{width:t.width*(e.height/t.height),height:e.height}},tc=async(t,e)=>{const s={credentials:"include"},[{jsPDF:i},...n]=await Promise.all([Gt(()=>import("./jspdf.es-C1K32I9i.js").then(a=>a.j),__vite__mapDeps([0,1]),import.meta.url),...t.map(async a=>{const l=await Promise.resolve(es(a)),c=await fetch(l,s);return c.ok?{url:l,data:new Uint8Array(await c.arrayBuffer())}:void 0})]),r=n.filter(Boolean);if(r.length<1)return;const o=new i;return r.filter(Boolean).forEach(({url:a,data:l},c)=>{const{internal:{pageSize:d}}=o,{width:h,height:f}=ec(o.getImageProperties(l),{width:d.getWidth()-4,height:d.getHeight()-4});c>0&&o.addPage(),o.addImage(l,a.split(".").pop().toUpperCase(),2,2,h,f)}),o.output("blob")},nn=(t,e)=>{const s=URL.createObjectURL(t),i=document.body.appendChild(document.createElement("a"));i.href=s,i.download=`${e}.pdf`,i.click(),document.body.removeChild(i),URL.revokeObjectURL(s)},sc=async(t,e,s)=>{const i=await tc(t);if(i)return nn(i,e),i},ic=async(t,e,s={})=>{const{httpHeaders:i,withCredentials:n=!0}=s,r=await fetch(t,{credentials:n?"include":"omit",headers:i});if(!r.ok)return;const o=await r.blob();return nn(o,e),o},nc=t=>Object.entries(t).map(([e,s])=>e+"="+s).join(",");let Kt=!1;const rc=({source:t,index:e,syncImageIndex:s,title:i,loop:n,detachedShowZoom:r,onDetach:o,onClose:a})=>{const l=window.open(void 0,"czimgviewer",nc({height:700,width:800}));dt(b`<style>
			...
			<cosmoz-image-viewer
				...
				?loop=${n}
				@close=${()=>l.close()}
			></cosmoz-image-viewer>`,l.document.body),l._onClose?.(),o(),Kt=!0,l._onClose=a,l.addEventListener("beforeunload",a),l.addEventListener("beforeunload",()=>Kt=!1),l.document.title=i??X("Cosmoz image viewer")},oc=t=>new Promise(e=>{const s=setInterval(()=>{t()&&(e(),clearInterval(s))},100)}),ac=({images:t})=>{const e=window.open(void 0,"czimgviewerprint");dt(b`<style>
				img {
					display: block;
			...
			${t.map(s=>b`<img src="${ke(Promise.resolve(es(s)))}" />`)}`,e.document.body),oc(()=>Array.from(e.document.querySelectorAll("img")).every(s=>s.src&&s.complete)).then(()=>e.print()).then(()=>e.close())},Jt=[],lc=t=>{const e=R(()=>typeof t=="function"?Promise.resolve(t()):void 0,[t]),[s,i,n]=Oi(e);return typeof t!="function"?{attachments:t??Jt,loading:!1,error:void 0}:{attachments:s??Jt,loading:n==="pending",error:i}},cc=t=>{const[e,s]=V(void 0);C(()=>{s(t[0])},[t]);const i=v(n=>{const r=n.detail?.[0];r&&t.includes(r)&&s(r)},[t]);return{selected:e,value:e?[e]:Jt,onSelect:i}},rn=t=>{if(!t.currentTarget.parentElement)return;t.currentTarget.parentElement.querySelector(".error").removeAttribute("hidden"),t.currentTarget.setAttribute("hidden",!0)},uc=t=>t.detail.value==="error"&&rn(t),dc=({src$:t,showZoom:e,isZoomed:s,_onZoomChanged:i})=>{const n=_e(t,()=>ke(t));return[e?b`<haunted-pan-zoom
						class="image-zoom"
						.src=${n}
						?disabled=${!s}
						@zoom-changed=${i}
					...
					></haunted-pan-zoom>`:b`<img
						...
						style="width:100%"
						@error=${rn}
					/>`,_e(t,()=>ke(t.then(()=>G),b`<cz-spinner></cz-spinner>`))]},hc=t=>b`<div>
			<div hidden class="error">
				<h2>An error occurred while loading the image.</h2>
				<div class="desc">${t.image}</div>
			</div>
			${dc(t)}
		</div>`,Xt=[],fc=(t,e,s)=>{const[i,n]=V(Xt),r=R(()=>sn(o=>Gt(async()=>{const{loadPdfThunks:a}=await import("./pdf-loader-Bkitx4-u.js");return{loadPdfThunks:a}},__vite__mapDeps([2,1]),import.meta.url).then(({loadPdfThunks:a})=>a(o,e))),[e]);return C(()=>{if(!t){n(Xt);return}let o=!1;return r(t).then(a=>{o||n(a)}),()=>{o=!0}},[t,r]),t?i:s},pc=t=>{const{showZoom:e,title:s,loop:i,detachedShowZoom:n}=t,{attachments:r,loading:o,error:a}=lc(t.source),{selected:l,value:c,onSelect:u}=cc(r),d=l?.pdf,h=l?.pdfOptions,f=l?.downloadFileName??"archive",g=l?.images??Xt,p=fc(d,h,g),[m,_]=V(!1),y=F=>_(F.detail.value>1),w=R(()=>sn(F=>Promise.resolve(es(F))),[]),{slide:x,next:E,prev:L,goto:$,index:z,first:D,last:W}=Bo(p,{loop:i,initial:p?.[t.currentImageIndex],render:F=>hc({src$:w(F),showZoom:e,isZoomed:m,_onZoomChanged:y})}),[A,ae]=V(!1),se=()=>ae(!0),Y=()=>ae(!1),I=F=>$(F.detail.value),[N,ie]=V(!1),P=v(()=>rc({source:[{title:l?.title,images:p}],index:z,title:s,loop:i,syncImageIndex:I,detachedShowZoom:n,onDetach:()=>ie(!0),onClose:()=>ie(!1)}),[p,z,s,i,l]),M=v(()=>{Kt&&P()},[P]),J=F=>ie(F.detail.value);return ms("currentImageIndex",z,[z]),C(()=>{t.toggleAttribute("hidden",N)},[N]),ms("detached",N,[N]),Qt({syncState:M},[M]),{host:t,isZoomed:m,currentSlide:x,nextImage:E,previousImage:L,first:D,last:W,total:p.length,currentImageIndex:z,selectedImageNumber:z+1,syncImageIndex:I,onDownloadPdf:d?()=>ic(d,f,h):()=>sc(p,f),isFullscreen:A,openFullscreen:se,closeFullscreen:Y,onPrintPdf:()=>ac({images:p}),detached:N,detach:P,syncDetachedState:J,loading:o,error:a,attachments:r,selected:l,value:c,onSelect:u,images:p}},gc=b`<svg
	viewBox="0 0 24 24"
...
>
	...
	></path>
				...
				${k(!w&&!x,()=>b`
						...
						${k(h,()=>ql(b`<cosmoz-image-viewer
									fullscreen
									.source=${[{title:L?.title,images:D}]}
									show-nav
									show-zoom
									show-close
									@close=${g}
								...
								></cosmoz-image-viewer>`))}
					`)}
			`,Oc=t=>Ec(pc(t));customElements.define("cosmoz-image-viewer",U(Oc,{observedAttributes:["show-close","show-detach","show-fullscreen","show-nav","show-page-number","show-zoom","detached-show-zoom","loop","title"]}));
