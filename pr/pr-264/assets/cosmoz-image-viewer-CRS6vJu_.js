...
import{r as pi,D as yt,A as Z,b,E as H,p as fi,n as _n,M as yn,u as re,v as Pe,h as et,j as bn}from"./iframe-Cy1SF7eE.js";import{_ as ns}from"./preload-helper-PPVm8Dsz.js";let nt,gi=0;function _s(t){nt=t}function ys(){nt=null,gi=0}function vn(){return gi++}const It=Symbol("haunted.phase"),tt=Symbol("haunted.hook"),bs=Symbol("haunted.update"),vs=Symbol("haunted.commit"),ue=Symbol("haunted.effects"),Te=Symbol("haunted.layoutEffects"),Xt="haunted.context";class wn{update;host;virtual;[tt];[ue];[Te];constructor(e,s){this.update=e,this.host=s,this[tt]=new Map,this[ue]=[],this[Te]=[]}run(e){_s(this);let s=e();return ys(),s}_runEffects(e){let s=this[e];_s(this);for(let i of s)i.call(this);ys()}runEffects(){this._runEffects(ue)}runLayoutEffects(){this._runEffects(Te)}teardown(){this[tt].forEach(s=>{typeof s.teardown=="function"&&s.teardown(!0)})}}const xn=Promise.resolve().then.bind(Promise.resolve());function mi(){let t=[],e;function s(){e=null;let i=t;t=[];for(var n=0,r=i.length;n<r;n++)i[n]()}return function(i){t.push(i),e==null&&(e=xn(s))}}const Sn=mi(),ws=mi();class Pn{renderer;host;state;[It];_updateQueued;_active;constructor(e,s){this.renderer=e,this.host=s,this.state=new wn(this.update.bind(this),s),this[It]=null,this._updateQueued=!1,this._active=!1}update(){this._active&&(this._updateQueued||(Sn(()=>{let e=this.handlePhase(bs);ws(()=>{this.handlePhase(vs,e),ws(()=>{this.handlePhase(ue)})}),this._updateQueued=!1}),this._updateQueued=!0))}handlePhase(e,s){switch(this[It]=e,e){case vs:this.commit(s),this.runEffects(Te);return;case bs:return this.render();case ue:return this.runEffects(ue)}}render(){return this.state.run(()=>this.renderer.call(this.host,this.host))}runEffects(e){this.state._runEffects(e)}teardown(){this.state.teardown()}pause(){this._active=!1}resume(){this._active=!0}}const rs=(...t)=>{const e=new CSSStyleSheet;return e.replaceSync(t.join("")),e},Cn=t=>t?.map(e=>typeof e=="string"?rs(e):e),En=(t,...e)=>t.flatMap((s,i)=>[s,e[i]||""]).join(""),pe=En,On=(t="")=>t.replace(/-+([a-z])?/g,(e,s)=>s?s.toUpperCase():"");function $n(t){class e extends Pn{frag;renderResult;constructor(n,r,o){super(n,o||r),this.frag=r}commit(n){this.renderResult=t(n,this.frag)}}function s(i,n,r){const o=(r||n||{}).baseElement||HTMLElement,{observedAttributes:a=[],useShadowDOM:l=!0,shadowRootInit:c={},styleSheets:u}=r||n||{},d=Cn(i.styleSheets||u);class h extends o{_scheduler;static get observedAttributes(){return i.observedAttributes||a||[]}constructor(){if(super(),l===!1)this._scheduler=new e(i,this);else{const m=this.attachShadow({mode:"open",...c});d&&(m.adoptedStyleSheets=d),this._scheduler=new e(i,m,this)}}connectedCallback(){this._scheduler.resume(),this._scheduler.update(),this._scheduler.renderResult?.setConnected(!0)}disconnectedCallback(){this._scheduler.pause(),this._scheduler.teardown(),this._scheduler.renderResult?.setConnected(!1)}attributeChangedCallback(m,_,v){if(_===v)return;let w=v===""?!0:v;Reflect.set(this,On(m),w)}}function p(g){let m=g,_=!1;return Object.freeze({enumerable:!0,configurable:!0,get(){return m},set(v){_&&m===v||(_=!0,m=v,this._scheduler&&this._scheduler.update())}})}const f=new Proxy(o.prototype,{getPrototypeOf(g){return g},set(g,m,_,v){let w;return m in g?(w=Object.getOwnPropertyDescriptor(g,m),w&&w.set?(w.set.call(v,_),!0):(Reflect.set(g,m,_,v),!0)):(typeof m=="symbol"||m[0]==="_"?w={enumerable:!0,configurable:!0,writable:!0,value:_}:w=p(_),Object.defineProperty(v,m,w),w.set&&w.set.call(v,_),!0)}});return Object.setPrototypeOf(h.prototype,f),h}return s}class ee{id;state;constructor(e,s){this.id=e,this.state=s}}function zn(t,...e){let s=vn(),i=nt[tt],n=i.get(s);return n||(n=new t(s,nt,...e),i.set(s,n)),n.update(...e)}function te(t){return zn.bind(null,t)}function _i(t){return te(class extends ee{callback;lastValues;values;_teardown;constructor(e,s,i,n){super(e,s),t(s,this)}update(e,s){this.callback=e,this.values=s}call(){const e=!this.values||this.hasChanged();this.lastValues=this.values,e&&this.run()}run(){this.teardown(),this._teardown=this.callback.call(this.state)}teardown(e){typeof this._teardown=="function"&&(this._teardown(),this._teardown=void 0),e&&(this.lastValues=this.values=void 0)}hasChanged(){return!this.lastValues||this.values.some((e,s)=>this.lastValues[s]!==e)}})}function yi(t,e){t[ue].push(e)}const z=_i(yi),Tn=t=>t instanceof Element?t:t.startNode||t.endNode||t.parentNode,bi=te(class extends ee{Context;value;_ranEffect;_unsubscribe;constructor(t,e,s){super(t,e),this._updater=this._updater.bind(this),this._ranEffect=!1,this._unsubscribe=null,yi(e,this)}update(t){return this.Context!==t&&(this._subscribe(t),this.Context=t),this.value}call(){this._ranEffect||(this._ranEffect=!0,this._unsubscribe&&this._unsubscribe(),this._subscribe(this.Context),this.state.update())}_updater(t){this.value=t,this.state.update()}_subscribe(t){const e={Context:t,callback:this._updater};Tn(this.state.host).dispatchEvent(new CustomEvent(Xt,{detail:e,bubbles:!0,cancelable:!0,composed:!0}));const{unsubscribe:i=null,value:n}=e;this.value=i?n:t.defaultValue,this._unsubscribe=i}teardown(){this._unsubscribe&&this._unsubscribe()}});function An(t){return e=>{const s={Provider:class extends HTMLElement{listeners;_value;constructor(){super(),this.style.display="contents",this.listeners=new Set,this.addEventListener(Xt,this)}disconnectedCallback(){this.removeEventListener(Xt,this)}handleEvent(i){const{detail:n}=i;n.Context===s&&(n.value=this.value,n.unsubscribe=this.unsubscribe.bind(this,n.callback),this.listeners.add(n.callback),i.stopPropagation())}unsubscribe(i){this.listeners.delete(i)}set value(i){this._value=i;for(let n of this.listeners)n(i)}get value(){return this._value}},Consumer:t(function({render:i}){const n=bi(s);return i(n)},{useShadowDOM:!1}),defaultValue:e};return s}}const I=te(class extends ee{value;values;constructor(t,e,s,i){super(t,e),this.value=s(),this.values=i}update(t,e){return this.hasChanged(e)&&(this.values=e,this.value=t()),this.value}hasChanged(t=[]){return t.some((e,s)=>this.values[s]!==e)}}),C=(t,e)=>I(()=>t,e);function Ln(t,e){t[Te].push(e)}const rt=_i(Ln),Q=te(class extends ee{args;constructor(t,e,s){super(t,e),this.updater=this.updater.bind(this),typeof s=="function"&&(s=s()),this.makeArgs(s)}update(){return this.args}updater(t){const[e]=this.args;typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&(this.makeArgs(t),this.state.update())}makeArgs(t){this.args=Object.freeze([t,this.updater])}}),vi=te(class extends ee{reducer;currentState;constructor(t,e,s,i,n){super(t,e),this.dispatch=this.dispatch.bind(this),this.currentState=n!==void 0?n(i):i}update(t){return this.reducer=t,[this.currentState,this.dispatch]}dispatch(t){this.currentState=this.reducer(this.currentState,t),this.state.update()}}),Rn=/([A-Z])/gu,Ie=te(class extends ee{property;eventName;constructor(t,e,s,i){if(super(t,e),this.state.virtual)throw new Error("Can't be used with virtual components.");this.updater=this.updater.bind(this),this.property=s,this.eventName=s.replace(Rn,"-$1").toLowerCase()+"-changed",this.state.host[this.property]==null&&(typeof i=="function"&&(i=i()),i!=null&&this.updateProp(i))}update(t,e){return[this.state.host[this.property],this.updater]}updater(t){const e=this.state.host[this.property];typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&this.updateProp(t)}updateProp(t){this.notify(t).defaultPrevented||(this.state.host[this.property]=t)}notify(t){const e=new CustomEvent(this.eventName,{detail:{value:t,path:this.property},cancelable:!0});return this.state.host.dispatchEvent(e),e}}),xs=t=>e=>{e.preventDefault(),t(e.detail.value)};function kn(t){let e=t;return{get current(){return e},set current(s){e=s},get value(){return e},set value(s){e=s}}}function se(t){return I(()=>kn(t),[])}te(class extends ee{update(){return this.state.host}});function Nn({render:t}){const e=$n(t),s=An(e);return{component:e,createContext:s}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const G={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},ie=t=>(...e)=>({_$litDirective$:t,values:e});let we=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,s,i){this._$Ct=e,this._$AM=s,this._$Ci=i}_$AS(e,s){return this.update(e,s)}update(e,s){return this.render(...s)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ae=(t,e)=>{const s=t._$AN;if(s===void 0)return!1;for(const i of s)i._$AO?.(e,!1),Ae(i,e);return!0},ot=t=>{let e,s;do{if((e=t._$AM)===void 0)break;s=e._$AN,s.delete(t),t=e}while(s?.size===0)},wi=t=>{for(let e;e=t._$AM;t=e){let s=e._$AN;if(s===void 0)e._$AN=s=new Set;else if(s.has(t))break;s.add(t),Dn(e)}};function In(t){this._$AN!==void 0?(ot(this),this._$AM=t,wi(this)):this._$AM=t}function Mn(t,e=!1,s=0){const i=this._$AH,n=this._$AN;if(n!==void 0&&n.size!==0)if(e)if(Array.isArray(i))for(let r=s;r<i.length;r++)Ae(i[r],!1),ot(i[r]);else i!=null&&(Ae(i,!1),ot(i));else Ae(this,t)}const Dn=t=>{t.type==G.CHILD&&(t._$AP??=Mn,t._$AQ??=In)};class bt extends we{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,s,i){super._$AT(e,s,i),wi(this),this.isConnected=e._$AU}_$AO(e,s=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),s&&(Ae(this,e),ot(this))}setValue(e){if(pi(this._$Ct))this._$Ct._$AI(e,this);else{const s=[...this._$Ct._$AH];s[this._$Ci]=e,this._$Ct._$AI(s,this,0)}}disconnected(){}reconnected(){}}const{component:U,createContext:Fn}=Nn({render:yt}),vt=(t,...e)=>t.flatMap((s,i)=>[s,e[i]??""]).join(""),os=(...t)=>{const e=new CSSStyleSheet;return e.replaceSync(t.join("")),e},Mt=new WeakMap,xe=ie(class extends bt{render(t){return Z}update(t,[e]){const s=e!==this.G;return s&&this.G!==void 0&&this.rt(void 0),(s||this.lt!==this.ct)&&(this.G=e,this.ht=t.options?.host,this.rt(this.ct=t.element)),Z}rt(t){if(this.isConnected||(t=void 0),typeof this.G=="function"){const e=this.ht??globalThis;let s=Mt.get(e);s===void 0&&(s=new WeakMap,Mt.set(e,s)),s.get(this.G)!==void 0&&this.G.call(this.ht,void 0),s.set(this.G,t),t!==void 0&&this.G.call(this.ht,t)}else this.G.value=t}get lt(){return typeof this.G=="function"?Mt.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),jn=({host:t,popoverRef:e,disabled:s,openOnHover:i,openOnFocus:n,open:r,close:o})=>{const a=se(),l=()=>clearTimeout(a.current),c=()=>{clearTimeout(a.current),a.current=setTimeout(()=>{const d=e.current;i&&(t.matches(":hover")||d?.matches(":hover"))||t.matches(":focus-within")||d?.matches(":focus-within")||o()},100)},u=()=>{s||(l(),r())};return z(()=>{if(!(!i||s))return t.addEventListener("pointerenter",u),t.addEventListener("pointerleave",c),()=>{l(),t.removeEventListener("pointerenter",u),t.removeEventListener("pointerleave",c)}},[i,s,t]),z(()=>{if(!(!n||s))return t.addEventListener("focusin",u),t.addEventListener("focusout",c),()=>{l(),t.removeEventListener("focusin",u),t.removeEventListener("focusout",c)}},[n,s,t]),{scheduleClose:c,cancelClose:l}},Vn=t=>{if(t.newState!=="open")return;const i=t.target.querySelector("slot:not([name])")?.assignedElements({flatten:!0})??[];for(const n of i){const r=n.matches("[autofocus]")?n:n.querySelector("[autofocus]");if(r instanceof HTMLElement){r.focus();break}}},Bn=pe`
	:host {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const wt=ie(class extends we{constructor(t){if(super(t),t.type!==G.PROPERTY&&t.type!==G.ATTRIBUTE&&t.type!==G.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!pi(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===H||e===Z)return e;const s=t.element,i=t.name;if(t.type===G.PROPERTY){if(e===s[i])return H}else if(t.type===G.BOOLEAN_ATTRIBUTE){if(!!e===s.hasAttribute(i))return H}else if(t.type===G.ATTRIBUTE&&s.getAttribute(i)===e+"")return H;return fi(t),e}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function k(t,e,s){return t?e(t):s?.(t)}const xi=(t,{label:e,invalid:s,errorMessage:i})=>b`
...
`,Un=t=>I(()=>{if(t==null)return;const e=new RegExp(t,"u");return s=>{!s.defaultPrevented&&s.data&&!e.test(s.data)&&s.preventDefault()}},[t]),as=te(class extends ee{values;constructor(t,e,s,i){super(t,e),Object.assign(e.host,s),this.values=i}update(t,e){this.hasChanged(e)&&(this.values=e,Object.assign(this.state.host,t))}hasChanged(t=[]){return t.some((e,s)=>this.values[s]!==e)}}),Ue=te(class extends ee{update(){return this.state.host}}),Yn=/([A-Z])/gu,Jt=(t,e,s)=>{t[e]=s,t.dispatchEvent(new CustomEvent(e.replace(Yn,"-$1").toLowerCase()+"-changed",{detail:{value:s}}))},Kn=(t,e,s=[e])=>{const i=Ue();z(()=>{Jt(i,t,e)},s)},Ci=t=>{const e=se(void 0),s=C(l=>e.current=l,[]),i=t.shadowRoot,n=C(l=>t.dispatchEvent(new Event(l.type,{bubbles:l.bubbles})),[]),r=C(l=>Jt(t,"value",l.target.value),[]),o=C(l=>Jt(t,"focused",l.type==="focus"),[]),a=C(()=>{const l=e.current?.checkValidity();return t.toggleAttribute("invalid",!l),l},[]);return as({validate:a},[a]),z(()=>{const l=c=>{c.composedPath()[0]?.closest?.("input, textarea")||(c.preventDefault(),e.current?.focus())};return i.addEventListener("mousedown",l),()=>i.removeEventListener("mousedown",l)},[]),{onChange:n,onFocus:o,onInput:r,onRef:s}},Xn=({placeholder:t,noLabelFloat:e,label:s})=>(e?s:void 0)||t||" ",Jn=["type","pattern","allowed-pattern","min","max","step","autosize","label","placeholder",...Si],Wn=t=>{const{type:e="text",pattern:s,allowedPattern:i,autocomplete:n,value:r,readonly:o,disabled:a,min:l,max:c,step:u,maxlength:d}=t,{onChange:h,onFocus:p,onInput:f,onRef:g}=Ci(t),m=Un(i);return xi(b`
			<input
				${xe(g)}
				...
				step=${X(u)}
			/>
		`,t)};customElements.define("cosmoz-input",U(Wn,{observedAttributes:Jn,styleSheets:[rs(Pi)],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const Ps=t=>{t.style.height="",t.style.height=`${t.scrollHeight}px`},Zn=(t,e=0)=>{if(e>0){const s=t.getAttribute("rows")??"",i=t.style.height;t.style.height="",t.setAttribute("rows",e),t.style.maxHeight=t.getBoundingClientRect().height+"px",t.style.height=i,t.setAttribute("rows",s)}},Gn=t=>{const{value:e,maxRows:s}=t,i=I(()=>()=>t.shadowRoot.querySelector("#input"),[]);z(()=>Zn(i(),s),[s,i]),z(()=>Ps(i()),[i,e]),z(()=>{const n=i(),r=new ResizeObserver(()=>requestAnimationFrame(()=>Ps(n)));return r.observe(n),()=>r.unobserve(n)},[i])},qn=["rows","placeholder",...Si],Qn=t=>{const{autocomplete:e,value:s,placeholder:i,readonly:n,disabled:r,rows:o,cols:a,maxlength:l}=t,{onChange:c,onFocus:u,onInput:d,onRef:h}=Ci(t);return Gn(t),xi(b`
			<textarea id="input" part="input"
				...
				.value=${wt(s??"")} maxlength=${X(l)} @input=${d}
				@change=${c} @focus=${u} @blur=${u}>`,t)};customElements.define("cosmoz-textarea",U(Qn,{observedAttributes:qn,styleSheets:[rs(Pi)],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const er=t=>{const{label:e,value:s,disabled:i,error:n}=t,r=C(o=>t.dispatchEvent(new CustomEvent("change",{detail:o.target.checked})),[]);return b`<input
			id="toggle"
			class="toggle"
			part="toggle"
			type="checkbox"
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Is=t=>!_n(t)&&typeof t.then=="function",Ms=1073741823;let Tr=class extends bt{constructor(){super(...arguments),this._$Cwt=Ms,this._$Cbt=[],this._$CK=new $r(this),this._$CX=new zr}render(...e){return e.find(s=>!Is(s))??H}update(e,s){const i=this._$Cbt;let n=i.length;this._$Cbt=s;const r=this._$CK,o=this._$CX;this.isConnected||this.disconnected();for(let a=0;a<s.length&&!(a>this._$Cwt);a++){const l=s[a];if(!Is(l))return this._$Cwt=a,l;a<n&&l===i[a]||(this._$Cwt=Ms,n=0,Promise.resolve(l).then(async c=>{for(;o.get();)await o.get();const u=r.deref();if(u!==void 0){const d=u._$Cbt.indexOf(l);d>-1&&d<u._$Cwt&&(u._$Cwt=d,u.setValue(c))}}))}return H}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}};const De=ie(Tr);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ds=(t,e,s)=>{const i=new Map;for(let n=e;n<=s;n++)i.set(t[n],n);return i},$i=ie(class extends we{constructor(t){if(super(t),t.type!==G.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const n=[],r=[];let o=0;for(const a of t)n[o]=i?i(a,o):o,r[o]=s(a,o),o++;return{values:r,keys:n}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const n=yn(t),{values:r,keys:o}=this.dt(e,s,i);if(!Array.isArray(n))return this.ut=o,r;const a=this.ut??=[],l=[];let c,u,d=0,h=n.length-1,p=0,f=r.length-1;for(;d<=h&&p<=f;)if(n[d]===null)d++;else if(n[h]===null)h--;else if(a[d]===o[p])l[p]=re(n[d],r[p]),d++,p++;else if(a[h]===o[f])l[f]=re(n[h],r[f]),h--,f--;else if(a[d]===o[f])l[f]=re(n[d],r[f]),Pe(t,l[f+1],n[d]),d++,f--;else if(a[h]===o[p])l[p]=re(n[h],r[p]),Pe(t,n[d],n[h]),h--,p++;else if(c===void 0&&(c=Ds(o,p,f),u=Ds(a,d,h)),c.has(a[d]))if(c.has(a[h])){const g=u.get(o[p]),m=g!==void 0?n[g]:null;if(m===null){const _=Pe(t,n[d]);re(_,r[p]),l[p]=_}else l[p]=re(m,r[p]),Pe(t,n[d],m),n[g]=null;p++}else et(n[h]),h--;else et(n[d]),d++;for(;p<=f;){const g=Pe(t,l[f+1]);re(g,r[p]),l[p++]=g}for(;d<=h;){const g=n[d++];g!==null&&et(g)}return this.ut=o,fi(t,l),H}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,Gr=({index:t,itemHeight:e,auto:s})=>pe`
	${k(!s,()=>pe`
			.item {
				line-height: ${e}px;
				height: ${e}px;
...
`,qr=t=>{const e=t==="auto",[s,i]=Q(e?40:t);return[s,n=>e?i(n):void 0]},Ti=Fn(()=>zi);customElements.define("cosmoz-keybinding-provider",Ti.Provider);const cs=t=>{const e=I(()=>({}),[]);return I(()=>Object.assign(e,t),[e,...Object.values(t)])},Re=(t,e)=>{const s=bi(Ti),i=cs(t);z(()=>s(i),e)},Qr=Symbol("listbox.navigate.up"),eo=Symbol("listbox.navigate.down"),to=Symbol("listbox.select"),so=({onUp:t,onDown:e,onEnter:s})=>{const i=Ue();Re({activity:Qr,callback:t,element:()=>i},[]),Re({activity:eo,callback:e,element:()=>i},[]),Re({activity:to,callback:s,element:()=>i},[])},io=({items:t,onSelect:e,defaultIndex:s=0})=>{const[i,n]=Q({index:s}),{index:r}=i,{length:o}=t;return z(()=>{n({index:i.index<0?s:Math.min(i.index,t.length-1),scroll:!0})},[t,s]),so({onUp:C(()=>n(a=>({index:a.index>0?a.index-1:o-1,scroll:!0})),[o]),onDown:C(()=>n(a=>({index:a.index<o-1?a.index+1:0,scroll:!0})),[o]),onEnter:C(()=>r>-1&&r<o&&e?.(t[r],r),[r,t,e])}),{position:i,highlight:C(a=>n({index:a}),[]),select:C(a=>e?.(a),[e])}},no=t=>typeof t=="object"&&t!==null&&Symbol.iterator in t;function oe(t){return t==null?[]:Array.isArray(t)?t:typeof t=="string"?[t]:no(t)?Array.from(t):[t]}const jt=(t,e=dt)=>s=>{const i=oe(t).map(e);return oe(s).filter(n=>!i.includes(e(n)))},ro=(t,e)=>e?s=>s!=null&&oe(t).find(i=>i[e]===s[e]):s=>s!=null&&oe(t).includes(s),oo=(t,e)=>{if(!e||!t)return t;const s=t.toLowerCase().indexOf(e.toLowerCase());if(s<0)return t;const i=s+e.length;return[t.slice(0,s),b`<mark>${t.slice(s,i)}</mark>`,t.slice(i)]},ao=(t=dt)=>(e,s,{highlight:i,select:n,textual:r=dt,query:o,isSelected:a})=>{const l=r(e),c=oo(l,o),u=t(c,e,s);return b`<div
				class="item"
				role="option"
				part="option"
				?aria-selected=${a(e)}
			...
			<div class="sizer" virtualizer-sizer>${u}</div>`},lo=({itemRenderer:t=ao(),...e})=>{const s=cs(e);return C((i,n)=>t(i,n,s),[s,t])},co=["query","items","onSelect","textual","anchor","itemHeight","itemLimit","itemRenderer","defaultIndex","value","valueProperty","loading"],uo=({value:t,valueProperty:e,items:s,onSelect:i,defaultIndex:n,query:r,textual:o,itemRenderer:a,itemHeight:l=40,itemLimit:c=5})=>{const u=I(()=>ro(t,e),[t,e]),d=I(()=>s.slice(),[s,u]),{position:h,highlight:p,select:f}=io({items:d,onSelect:i,defaultIndex:isNaN(n)?void 0:Number(n)}),[g,m]=qr(l);return{position:h,items:d,height:Math.min(c,d.length)*g,highlight:p,select:f,itemHeight:g,setItemHeight:m,renderItem:lo({itemRenderer:a,items:d,position:h,highlight:p,select:f,textual:o,query:r,isSelected:u})}},Bs=zi,ho=t=>{const e=se(void 0),{position:s,items:i,renderItem:n,height:r,itemHeight:o,setItemHeight:a}=uo(t);return z(()=>{const l=e.current?.[Zt];l&&l.layoutComplete.then(()=>{t.dispatchEvent(new CustomEvent("layout-complete"));const{averageChildSize:c,averageMarginSize:u}=l._layout._metricsCache;return a(c+u*2)},Bs)},[i]),z(()=>{if(!s.scroll)return;const l=e.current?.[Zt];if(l){if(!l?._layout){l.layoutComplete.then(()=>l.element(s.index)?.scrollIntoView({block:"nearest"}),Bs);return}l.element(s.index)?.scrollIntoView({block:"nearest"})}},[s]),Kr(Gr({...s,itemHeight:o,auto:t.itemHeight==="auto"})),b`<div
			class="items"
		...
		<slot></slot>`};customElements.define("cosmoz-listbox",U(ho,{styleSheets:[os(Zr)]}));const po=({multi:t,...e},s)=>b`<cosmoz-listbox
		part="listbox"
		?multi=${t}
		...=${Hr(Jr(co)(e))}
		>${s}</cosmoz-listbox
...
`;customElements.define("cosmoz-autocomplete-chip",U(mo,{observedAttributes:["disabled"],styleSheets:[os(fo)]}));const _o=({content:t,onClear:e,disabled:s,hidden:i,className:n="chip",slot:r})=>b`<cosmoz-autocomplete-chip
		class=${X(n)}
		slot=${X(r)}
		part="chip"
...
`;customElements.define("cosmoz-autocomplete-skeleton-span",U(()=>Z,{styleSheets:[bo]}));const vo=vt`
	:host {
		display: block;
		position: relative;
		min-width: 35px;
...
`,us=(t,e=()=>({}))=>{const s={type:t,toString(){return t}};return Object.assign((...n)=>Object.assign(e(...n),s),s)},Hs=t=>t.type||t.toString(),Us=t=>Array.isArray(t)?t:[t],wo=(t,e)=>{const s=Us(e),i=(s.every(Array.isArray)?s:[s]).map(([n,r])=>({actions:Us(n).map(Hs),handle:r}));return(n=t,r)=>{const o=i.find(a=>a.actions.includes(Hs(r)));return o?o.handle(n,r):n}},de={pending:"pending",rejected:"rejected",resolved:"resolved"},Ai={error:void 0,result:void 0,state:de.pending},Li=us(de.pending),Ri=us(de.resolved,t=>({result:t})),ki=us(de.rejected,t=>({error:t})),xo=wo(Ai,[[Li,()=>({error:void 0,result:void 0,state:de.pending})],[Ri,(t,{result:e})=>({error:void 0,result:e,state:de.resolved})],[ki,(t,{error:e})=>({error:e,result:void 0,state:de.rejected})]]),Ni=t=>{const[{error:e,result:s,state:i},n]=vi(xo,Ai);return z(()=>{if(!t)return;let r=!1;return n(Li()),t.then(o=>!r&&n(Ri(o)),o=>!r&&n(ki(o))),()=>{r=!0}},[t]),[s,e,i]},So=Symbol("autocomplete.deselect.last"),Po=Symbol("autocomplete.search.when.selected"),Ys=t=>t.normalize("NFD").replace(/[\u0300-\u036f]/gu,""),Co=(t,e,s)=>{if(!e)return t;const i=Ys(e.toLowerCase()),n=[];for(const r of t){const a=Ys(s(r).toLowerCase()).indexOf(i);a<0||n.push({item:r,index:a})}return n.sort((r,o)=>r.index-o.index).map(({item:r})=>r)},Eo=t=>t===!1||t==null?[]:t,Oo=(t,e,s)=>t.dispatchEvent(new CustomEvent(e,{detail:s})),Ks=[],$o=t=>(...e)=>{let s;const i=()=>{s&&cancelAnimationFrame(s)};return i(),s=requestAnimationFrame(()=>{s=void 0,t(...e)}),i},zo=(t,e,s)=>C(i=>{e?.(i),t.dispatchEvent(new CustomEvent(s,{detail:i}))},[e]),To=({value:t,text:e,onChange:s,onText:i,onSelect:n,limit:r,min:o,source:a,textProperty:l,textual:c,valueProperty:u,keepOpened:d,keepQuery:h,preserveOrder:p,defaultIndex:f,externalSearch:g,disabled:m,lazyOpen:_})=>{const v=r!=null?Number(r):void 0,w=I(()=>(c??Xr)(l),[c,l]),x=Ue(),[E,$]=Ie("opened",!1),y=!e,A=I(()=>e?.trim(),[e]),R=zo(x,i,"text"),N=C(P=>{s?.(P,()=>$(!1)),Oo(x,"value",P)},[s]),[M,me]=Q([]),Y=!!(_&&!A),K=I(()=>Y?Promise.resolve([]):Promise.resolve(typeof a=="function"?a({query:A,active:E}):a).then(Eo),[a,E,A,Y]),j=I(()=>oe(t),[t]);z(()=>K.then(me),[K]),Re({activity:So,callback:()=>{const P=oe(j);P.length>0&&N(P.slice(0,-1))},check:()=>!m&&y&&x.matches(":focus-within"),element:()=>x},[]),Re({activity:Po,callback:P=>{const F=oe(j),J=v===1;F.length>0&&J&&P.key.length===1&&N(F.slice(0,-1))},allowDefault:!0,check:()=>!m&&y&&x.matches(":focus-within"),element:()=>x},[v]),z(()=>{!E&&!h&&R("")},[E,h]),z(()=>{x.toggleAttribute("opened",!!E)},[E]);const D=cs({onText:R,onChange:N,value:j,limit:v,min:o,keepQuery:h,keepOpened:d,setOpened:$,onSelect:n,valueProperty:u}),[,,ae]=Ni(K);return{limit:v,opened:E,query:A,textual:w,value:j,source$:K,loading:ae==="pending",items:I(()=>{if(!E||Y)return Ks;const P=p?M:[...j,...jt(j,st(u))(M)];return g?P:Co(P,A,w)},[M,E,A,w,y,j,p,u,g,Y]),onToggle:C(P=>{m||$(P.newState==="open")},[m]),onText:C(P=>{m||(R(P.target.value),$(!0))},[m,R,e,$]),onSelect:C(P=>{if(m)return;D.onSelect?.(P,D);const{onChange:F,onText:J,limit:le,min:At,value:Lt,keepQuery:Rt,keepOpened:kt,setOpened:Nt,valueProperty:Se}=D;Rt||J(""),kt||Nt(!1);const ce=oe(Lt),L=st(Se),Ke=ce.some(Xe=>L(Xe)===L(P));Ke&&ce.length===At||F((Ke?jt(P,L)(ce):[...ce,P]).slice(-le))},[m,D]),onDeselect:C(P=>{m||D.onChange(jt(P,st(D.valueProperty))(D.value))},[m,D]),defaultIndex:A!==void 0&&A?.length>0?0:f}},Ao=t=>{const e=t.shadowRoot.querySelectorAll(".chip"),s=t.shadowRoot.querySelector(".badge");s.hidden=!0;for(const a of e)a.hidden=!1;const n=t.shadowRoot.querySelector("cosmoz-input").shadowRoot?.querySelector(".control")?.getBoundingClientRect();let r;for(r=0;r<e.length;r++){const l=e[r].getBoundingClientRect();if(!(l.x+l.width<=n.x+n.width-24))break}const o=e.length-r;for(s.querySelector("span").textContent="+"+o.toString(),s.hidden=o<1;r<e.length;r++)e[r].hidden=!0},Lo=({value:t,opened:e,wrap:s,limit:i})=>{const n=Ue(),r=!(s||i===1),o=I(()=>$o(()=>Ao(n)),[]),[a,l]=Q(0);rt(()=>{if(!r)return;const c=n.shadowRoot.querySelector("cosmoz-input"),u=new ResizeObserver(d=>{l(d[0].contentRect.width)});return u.observe(c),()=>u.disconnect()},[r]),rt(()=>r?o():void 0,[r,a,e,t])},Ro=["input","control","label","line","error","wrap"].map(t=>`${t}: input-${t}`).join(),ko=({opened:t,isSingle:e,showSingle:s,hasResultsOrQuery:i})=>!t||e&&!s?!1:i,No=t=>{const{opened:e,invalid:s,errorMessage:i,label:n,placeholder:r,disabled:o,noLabelFloat:a,alwaysFloatLabel:l,textual:c,text:u,onText:d,onToggle:h,onDeselect:p,value:f,limit:g,min:m,showSingle:_,items:v,source$:w,loading:x,chipRenderer:E}=t,$=g===1,y=$&&f?.[0]!=null,A=x||v.length>0||u!=null&&u.length>0;return b`<cosmoz-dropdown-next
			open-on-focus
			?disabled=${o}
			.opened=${e}
			@dropdown-toggle=${h}
 ...
 */const ji="important",Mo=" !"+ji,Vi=ie(class extends we{constructor(t){if(super(t),t.type!==G.ATTRIBUTE||t.name!=="style"||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,s)=>{const i=t[s];return i==null?e:e+`${s=s.includes("-")?s:s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`},"")}update(t,[e]){const{style:s}=t.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const i of this.ft)e[i]==null&&(this.ft.delete(i),i.includes("-")?s.removeProperty(i):s[i]=null);for(const i in e){const n=e[i];if(n!=null){this.ft.add(i);const r=typeof n=="string"&&n.endsWith(Mo);i.includes("-")||r?s.setProperty(i,r?n.slice(0,-11):n,r?ji:""):s[i]=n}}return H}});class Do extends Promise{constructor(e){const s={};super((i,n)=>Object.assign(s,{resolve:i,reject:n})),Object.assign(this,s),e?.(s.resolve,s.reject)}resolve=()=>{}}const Bi={host:{position:"relative",display:"flex",overflow:"hidden"},slide:{position:"static",width:"100%",height:"100%"}},Fo=t=>{const{slide:e}=t,[s,i]=Q([]);return rt(()=>void Object.assign(t.style,Bi.host),[]),z(()=>{if(e==null)return;const n={animationEnd$:new Do,...e};i((r=[])=>{const o=r.findIndex(({id:a,out:l})=>a===n.id&&l!==!0);return o!==-1?[...r.slice(0,o),n,...r.slice(o+1,r.length)]:[...r,n]})},[e]),rt(async()=>{if(s.filter(l=>!l.out).length<2){const l=s[0];l&&requestAnimationFrame(()=>requestAnimationFrame(()=>l.animationEnd$.resolve()));return}const n=s[s.length-1],r=s[s.length-2],o=n.el,a=r.el;r.out=!0,o&&a&&await n.animation?.(o,a),i((l=[])=>l.filter(c=>c!==r))},[s]),{slides:s}},jo=t=>b`<div
...
</style>`;customElements.define("cz-spinner",U(Uo));const Yo=te(class extends ee{constructor(t,e){super(t,e),this.dispatchEvent=(...s)=>{e.host.dispatchEvent.apply(e.host,s)}}update(){return this.dispatchEvent}}),Vt=(t,e=.08,s=.001)=>{const[i,n]=Q(null);return z(()=>{if(i==null){n(t);return}if(e>=1){n(t);return}const r=i;window.requestAnimationFrame(()=>{const o=t-r;n(Math.abs(o)<s?t:i+o*e)})},[i,n,t,e,s]),i},Ko=(t,e)=>{"ResizeObserver"in window&&z(()=>{if(e==null)return;const s=new ResizeObserver(([{contentRect:i}])=>t(i));return s.observe(e),t(e.getBoundingClientRect()),()=>s.unobserve(e)},[t,e])},Fe=(t,e,s)=>Math.max(e,Math.min(s,t)),ds=(t,e,s,i)=>s/i<t/e?s/t:i/e,Xo=(t,e,s,i)=>s/i>t/e?s/t:i/e,Hi=(t,e,s,i,n)=>{const r=ds(t,e,s,i),o=r*n,a=t*o,l=e*o,c=a<s?(-s+a)/2:(s-a)/2,u=a<s?(s-a)/2:(-s+a)/2,d=l<i?(-i+l)/2:(i-l)/2,h=l<i?(i-l)/2:(-i+l)/2;return{x:[c,u],y:[d,h]}},Ui="empty",Et="loading",Yi="loaded",hs="error",Ye="idle",Ot="panning",ke="pinching",Jo=1.1,Wo=t=>Jo/t,Zo=t=>2*t,ht=(t,e,s,i)=>{const n=ds(t,e,s,i),r=Xo(t*n,e*n,s,i);return Math.max(Wo(n),Zo(r))},Go={status:Ui,interaction:Ye,iw:100,ih:100,cw:100,ch:100,zoom:1,panX:0,panY:0,pointers:{}},Ki=(t,e)=>{const s={...t};return delete s[e],s},Xs=t=>{const e=Object.keys(t);if(e.length<2)return null;const s=t[e[0]],i=t[e[1]];return{midX:(s.x+i.x)/2,midY:(s.y+i.y)/2,distance:Math.hypot(i.x-s.x,i.y-s.y)}},je=t=>{const e=Hi(t.iw,t.ih,t.cw,t.ch,t.zoom);return{...t,panX:Fe(t.panX,e.x[0],e.x[1]),panY:Fe(t.panY,e.y[0],e.y[1])}},Gt=(t,e,s,i=2)=>t<e?e-(e-t)/i:t>s?s+(t-s)/i:t,Xi=t=>{const e=Hi(t.iw,t.ih,t.cw,t.ch,t.zoom);return{...t,panX:Gt(t.panX,e.x[0],e.x[1]),panY:Gt(t.panY,e.y[0],e.y[1])}},qo=t=>{const e=ht(t.iw,t.ih,t.cw,t.ch);return{...t,zoom:Gt(t.zoom,1,e)}},Ji=(t,{dPanX:e=0,dPanY:s=0,scaleDiff:i=1,originX:n=0,originY:r=0})=>{const o=t.zoom*i;return{...t,zoom:o,panX:e+n+(t.panX-n)*i,panY:s+r+(t.panY-r)*i}},Wi=(t,e,s)=>{const i=ht(t.iw,t.ih,t.cw,t.ch),n=Fe(t.zoom,1,i);if(n===t.zoom)return t;const r=n/t.zoom;return{...t,zoom:n,panX:e+(t.panX-e)*r,panY:s+(t.panY-s)*r}},Qo=(t,e)=>{switch(e.type){case"load":return{...t,status:Et};default:return t}},ea=(t,e)=>{switch(e.type){case"loaded":return{...t,status:Yi,...e.dimensions,panX:0,panY:0,zoom:1};case"error":return{...t,status:hs};default:return t}},ta=(t,e)=>{switch(e.type){case"load":return{...t,status:Et};default:return t}},sa=(t,e)=>{switch(e.type){case"pointerdown":return{...t,interaction:Ot,pointers:{...t.pointers,[e.id]:{x:e.x,y:e.y}}};default:return t}},ia=(t,e)=>{switch(e.type){case"pointerdown":{const s={...t.pointers,[e.id]:{x:e.x,y:e.y}};return{...t,interaction:ke,pointers:s}}case"pointermove":{const s=t.pointers[e.id];if(!s)return t;const i=e.x-s.x,n=e.y-s.y;return Xi({...t,panX:t.panX+i,panY:t.panY+n,pointers:{...t.pointers,[e.id]:{x:e.x,y:e.y}}})}case"pointerup":{const s=Ki(t.pointers,e.id);if(Object.keys(s).length===0){const i=Wi({...t,pointers:s},e.settleOriginX??0,e.settleOriginY??0);return je({...i,interaction:Ye})}return{...t,pointers:s}}default:return t}},na=(t,e)=>{switch(e.type){case"pointermove":{if(!t.pointers[e.id])return t;const i=Xs(t.pointers),n={...t.pointers,[e.id]:{x:e.x,y:e.y}},r=Xs(n);if(!i||!r)return{...t,pointers:n};const o=i.distance?r.distance/i.distance:1,a=r.midX-i.midX,l=r.midY-i.midY,c=Ji({...t,pointers:n},{dPanX:a,dPanY:l,scaleDiff:o,originX:e.containerOriginX,originY:e.containerOriginY});return Xi(qo(c))}case"pointerup":{const s=Ki(t.pointers,e.id);if(Object.keys(s).length<=1){const i=je(Wi({...t,pointers:s},e.settleOriginX??0,e.settleOriginY??0));return Object.keys(s).length===1?{...i,interaction:Ot}:{...i,interaction:Ye}}return{...t,pointers:s}}default:return t}},ra=(t,e)=>{switch(t.interaction){case Ye:return sa(t,e);case Ot:return ia(t,e);case ke:return na(t,e);default:return t}},oa=(t,e)=>{switch(e.type){case"load":return{...t,status:Et,interaction:Ye,panX:0,panY:0,zoom:1,pointers:{}};case"zoom":{const s=ht(t.iw,t.ih,t.cw,t.ch),i=Fe(e.zoom,1,s);return je({...t,zoom:i})}case"wheel":{const{delta:s,originX:i,originY:n}=e,r=1+s,o=Ji(t,{scaleDiff:r,originX:i,originY:n}),a=ht(o.iw,o.ih,o.cw,o.ch);return je({...o,zoom:Fe(o.zoom,1,a)})}case"pointerdown":case"pointermove":case"pointerup":return ra(t,e);default:return t}},aa=(t,e)=>{if(e.type==="resize")return je({...t,cw:e.rect.width,ch:e.rect.height});switch(t.status){case Ui:return Qo(t,e);case Et:return ea(t,e);case Yi:return oa(t,e);case hs:return ta(t,e);default:return t}},la=(t,e,s,i)=>{const{iw:n=100,ih:r=100,cw:o=100,ch:a=100}=t,l=ds(n,r,o,a),c=l*e;return{position:"absolute",top:"50%",left:"50%",transform:["translate(-50%, -50%)",`translate(${s}px, ${i}px)`,`scale(${c})`].join(" ")}},Bt=(t,e,s)=>{const i=s.current?.getBoundingClientRect();return i?{originX:t-i.left-i.width/2,originY:e-i.top-i.height/2}:{originX:0,originY:0}},ca=(t,e=.08)=>{const[s,i]=vi(aa,Go),n=se(),r=C(()=>i({type:"load"}),[i]),o=C(y=>i({type:"loaded",dimensions:y}),[i]),a=C(()=>i({type:"error"}),[i]),l=C(y=>i({type:"zoom",zoom:y}),[i]),c=C(y=>y&&i({type:"resize",rect:y}),[i]),u=C(()=>c(n.current&&n.current.getBoundingClientRect()),[c]);Ko(c,n.current);const d=C(y=>o({iw:y.target.naturalWidth,ih:y.target.naturalHeight}),[o]),h=C(y=>{n.current?.setPointerCapture(y.pointerId),i({type:"pointerdown",id:y.pointerId,x:y.clientX,y:y.clientY})},[i]),p=C(y=>{const{originX:A,originY:R}=Bt(y.clientX,y.clientY,n);i({type:"pointermove",id:y.pointerId,x:y.clientX,y:y.clientY,containerOriginX:A,containerOriginY:R})},[i]),f=se({x:0,y:0});I(()=>{if(s.interaction!==ke)return;const y=Object.keys(s.pointers);if(y.length>=2){const A=s.pointers[y[0]],R=s.pointers[y[1]],N=(A.x+R.x)/2,M=(A.y+R.y)/2,{originX:me,originY:Y}=Bt(N,M,n);f.current={x:me,y:Y}}},[s.pointers,s.interaction]);const g=C(y=>{try{n.current?.releasePointerCapture(y.pointerId)}catch{}i({type:"pointerup",id:y.pointerId,settleOriginX:f.current.x,settleOriginY:f.current.y})},[i]),m=C(y=>{y.preventDefault();const{originX:A,originY:R}=Bt(y.clientX,y.clientY,n);i({type:"wheel",delta:-Math.sign(y.deltaY)*.8,originX:A,originY:R})},[i]),_=s.interaction===ke,v=s.interaction===Ot||s.interaction===ke;let w=e;_?w=.8:v&&(w=.9);const x=Vt(s.zoom,w),E=Vt(s.panX,w),$=Vt(s.panY,w);return{...s,load:r,loaded:o,error:a,zoomTo:l,resize:u,onPointerDown:h,onPointerMove:p,onPointerUp:g,onImageLoad:d,onWheel:m,containerRef:n,style:la(s,x,E,$)}},ua=({src:t,disabled:e,panStiffness:s,zoomStiffness:i})=>{const{status:n,zoom:r,load:o,error:a,zoomTo:l,resize:c,onPointerDown:u,onPointerMove:d,onPointerUp:h,onImageLoad:p,onWheel:f,style:g,containerRef:m}=ca(s,i);if(z(o,[t]),as({zoomTo:l,resize:c,zoom:r},[l,c,r]),!t)return Z;const _=Yo();return z(()=>_(new CustomEvent("zoom-changed",{detail:{value:r}})),[_,r]),z(()=>_(new CustomEvent("status-changed",{detail:{value:n}})),[_,n]),b`
		<style>
			:host {
				display: block;
			}
	...
	`};class da extends HTMLElement{resize(){}zoomTo(){}}customElements.define("haunted-pan-zoom",U(ua,{observedAttributes:["src","disabled","pan-stiffness","zoom-stiffness"],baseElement:da}));/**
@license
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const fa=!window.ShadyDOM||!window.ShadyDOM.inUse;!window.ShadyCSS||window.ShadyCSS.nativeCss;const ga=fa&&"adoptedStyleSheets"in Document.prototype&&"replaceSync"in CSSStyleSheet.prototype&&(()=>{try{const t=new CSSStyleSheet;t.replaceSync("");const e=document.createElement("div");return e.attachShadow({mode:"open"}),e.shadowRoot.adoptedStyleSheets=[t],e.shadowRoot.adoptedStyleSheets[0]===t}catch{return!1}})();let ma=window.Polymer&&window.Polymer.rootPath||fs(document.baseURI||window.location.href),pt=window.Polymer&&window.Polymer.sanitizeDOMValue||void 0;window.Polymer&&window.Polymer.setPassiveTouchGestures;let qt=window.Polymer&&window.Polymer.strictTemplatePolicy||!1,_a=window.Polymer&&window.Polymer.allowTemplateFromDomModule||!1,ya=window.Polymer&&window.Polymer.legacyOptimizations||!1,ba=window.Polymer&&window.Polymer.legacyWarnings||!1,va=window.Polymer&&window.Polymer.syncInitialRender||!1,Qt=window.Polymer&&window.Polymer.legacyUndefined||!1,wa=window.Polymer&&window.Polymer.orderedComputed||!1,Js=window.Polymer&&window.Polymer.removeNestedTemplates||!1,xa=window.Polymer&&window.Polymer.fastDomIf||!1;window.Polymer&&window.Polymer.suppressTemplateNotifications;window.Polymer&&window.Polymer.legacyNoObservedAttributes;let Sa=window.Polymer&&window.Polymer.useAdoptedStyleSheetsWithBuiltCSS||!1;/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let Pa=0;const fe=function(t){let e=t.__mixinApplications;e||(e=new WeakMap,t.__mixinApplications=e);let s=Pa++;function i(n){let r=n.__mixinSet;if(r&&r[s])return n;let o=e,a=o.get(n);if(!a){a=t(n),o.set(n,a);let l=Object.create(a.__mixinSet||r||null);l[s]=!0,a.__mixinSet=l}return a}return i};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let gs={},Zi={};function Ws(t,e){gs[t]=Zi[t.toLowerCase()]=e}function Zs(t){return gs[t]||Zi[t.toLowerCase()]}function Ca(t){t.querySelector("style")&&console.warn("dom-module %s has style outside template",t.id)}class Ve extends HTMLElement{static get observedAttributes(){return["id"]}static import(e,s){if(e){let i=Zs(e);return i&&s?i.querySelector(s):i}return null}attributeChangedCallback(e,s,i,n){s!==i&&this.register()}get assetpath(){if(!this.__assetpath){const e=window.HTMLImports&&HTMLImports.importForElement?HTMLImports.importForElement(this)||document:this.ownerDocument,s=Ne(this.getAttribute("assetpath")||"",e.baseURI);this.__assetpath=fs(s)}return this.__assetpath}register(e){if(e=e||this.id,e){if(qt&&Zs(e)!==void 0)throw Ws(e,null),new Error(`strictTemplatePolicy: dom-module ${e} re-registered`);this.id=e,Ws(e,this),Ca(this)}}}Ve.prototype.modules=gs;customElements.define("dom-module",Ve);/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const Ea="link[rel=import][type~=css]",Oa="include",Gs="shady-unscoped";function Gi(t){return Ve.import(t)}function qs(t){let e=t.body?t.body:t;const s=ps(e.textContent,t.baseURI),i=document.createElement("style");return i.textContent=s,i}function $a(t){const e=t.trim().split(/\s+/),s=[];for(let i=0;i<e.length;i++)s.push(...za(e[i]));return s}function za(t){const e=Gi(t);if(!e)return console.warn("Could not find style data in module named",t),[];if(e._styles===void 0){const s=[];s.push(...Qi(e));const i=e.querySelector("template");i&&s.push(...qi(i,e.assetpath)),e._styles=s}return e._styles}function qi(t,e){if(!t._styles){const s=[],i=t.content.querySelectorAll("style");for(let n=0;n<i.length;n++){let r=i[n],o=r.getAttribute(Oa);o&&s.push(...$a(o).filter(function(a,l,c){return c.indexOf(a)===l})),e&&(r.textContent=ps(r.textContent,e)),s.push(r)}t._styles=s}return t._styles}function Ta(t){let e=Gi(t);return e?Qi(e):[]}function Qi(t){const e=[],s=t.querySelectorAll(Ea);for(let i=0;i<s.length;i++){let n=s[i];if(n.import){const r=n.import,o=n.hasAttribute(Gs);if(o&&!r._unscopedStyle){const a=qs(r);a.setAttribute(Gs,""),r._unscopedStyle=a}else r._style||(r._style=qs(r));e.push(o?r._unscopedStyle:r._style)}}return e}/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/function es(t){return t.indexOf(".")>=0}function ge(t){let e=t.indexOf(".");return e===-1?t:t.slice(0,e)}function Aa(t,e){return t.indexOf(e+".")===0}function ft(t,e){return e.indexOf(t+".")===0}function gt(t,e,s){return e+s.slice(t.length)}function $e(t){if(Array.isArray(t)){let e=[];for(let s=0;s<t.length;s++){let i=t[s].toString().split(".");for(let n=0;n<i.length;n++)e.push(i[n])}return e.join(".")}else return t}function en(t){return Array.isArray(t)?$e(t).split("."):t.toString().split(".")}function V(t,e,s){let i=t,n=en(e);for(let r=0;r<n.length;r++){if(!i)return;let o=n[r];i=i[o]}return s&&(s.path=n.join(".")),i}function Qs(t,e,s){let i=t,n=en(e),r=n[n.length-1];if(n.length>1){for(let o=0;o<n.length-1;o++){let a=n[o];if(i=i[a],!i)return}i[r]=s}else i[e]=s;return n.join(".")}/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const mt={},La=/-[a-z]/g,Ra=/([A-Z])/g;function tn(t){return mt[t]||(mt[t]=t.indexOf("-")<0?t:t.replace(La,e=>e[1].toUpperCase()))}function $t(t){return mt[t]||(mt[t]=t.replace(Ra,"-$1").toLowerCase())}/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let ka=0,sn=0,be=[],Na=0,ts=!1,nn=document.createTextNode("");new window.MutationObserver(Ia).observe(nn,{characterData:!0});function Ia(){ts=!1;const t=be.length;for(let e=0;e<t;e++){let s=be[e];if(s)try{s()}catch(i){setTimeout(()=>{throw i})}}be.splice(0,t),sn+=t}const Ma={run(t){return ts||(ts=!0,nn.textContent=Na++),be.push(t),ka++},cancel(t){const e=t-sn;if(e>=0){if(!be[e])throw new Error("invalid async handle: "+t);be[e]=null}}};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const Ba={"dom-if":!0,"dom-repeat":!0};let ei=!1,ti=!1;function Ha(){if(!ei){ei=!0;const t=document.createElement("textarea");t.placeholder="a",ti=t.placeholder===t.textContent}return ti}function Ua(t){Ha()&&t.localName==="textarea"&&t.placeholder&&t.placeholder===t.textContent&&(t.textContent=null)}const Ya=(()=>{const t=window.trustedTypes&&window.trustedTypes.createPolicy("polymer-template-event-attribute-policy",{createScript:e=>e});return(e,s,i)=>{const n=s.getAttribute(i);if(t&&i.startsWith("on-")){e.setAttribute(i,t.createScript(n,i));return}e.setAttribute(i,n)}})();function Ka(t){let e=t.getAttribute("is");if(e&&Ba[e]){let s=t;for(s.removeAttribute("is"),t=s.ownerDocument.createElement(e),s.parentNode.replaceChild(t,s),t.appendChild(s);s.attributes.length;){const{name:i}=s.attributes[0];Ya(t,s,i),s.removeAttribute(i)}}return t}function an(t,e){let s=e.parentInfo&&an(t,e.parentInfo);if(s){for(let i=s.firstChild,n=0;i;i=i.nextSibling)if(e.parentIndex===n++)return i}else return t}function Xa(t,e,s,i){i.id&&(e[i.id]=s)}function Ja(t,e,s){if(s.events&&s.events.length)for(let i=0,n=s.events,r;i<n.length&&(r=n[i]);i++)t._addMethodEventListenerToNode(e,r.name,r.value,t)}function Wa(t,e,s,i){s.templateInfo&&(e._templateInfo=s.templateInfo,e._parentTemplateInfo=i)}function Za(t,e,s){return t=t._methodHost||t,function(n){t[s]?t[s](n,n.detail):console.warn("listener method `"+s+"` not defined")}}const Ga=fe(t=>{class e extends t{static _parseTemplate(i,n){if(!i._templateInfo){let r=i._templateInfo={};r.nodeInfoList=[],r.nestedTemplate=!!n,r.stripWhiteSpace=n&&n.stripWhiteSpace||i.hasAttribute&&i.hasAttribute("strip-whitespace"),this._parseTemplateContent(i,r,{parent:null})}return i._templateInfo}static _parseTemplateContent(i,n,r){return this._parseTemplateNode(i.content,n,r)}static _parseTemplateNode(i,n,r){let o=!1,a=i;return a.localName=="template"&&!a.hasAttribute("preserve-content")?o=this._parseTemplateNestedTemplate(a,n,r)||o:a.localName==="slot"&&(n.hasInsertionPoint=!0),Ua(a),a.firstChild&&this._parseTemplateChildNodes(a,n,r),a.hasAttributes&&a.hasAttributes()&&(o=this._parseTemplateNodeAttributes(a,n,r)||o),o||r.noted}static _parseTemplateChildNodes(i,n,r){if(!(i.localName==="script"||i.localName==="style"))for(let o=i.firstChild,a=0,l;o;o=l){if(o.localName=="template"&&(o=Ka(o)),l=o.nextSibling,o.nodeType===Node.TEXT_NODE){let u=l;for(;u&&u.nodeType===Node.TEXT_NODE;)o.textContent+=u.textContent,l=u.nextSibling,i.removeChild(u),u=l;if(n.stripWhiteSpace&&!o.textContent.trim()){i.removeChild(o);continue}}let c={parentIndex:a,parentInfo:r};this._parseTemplateNode(o,n,c)&&(c.infoIndex=n.nodeInfoList.push(c)-1),o.parentNode&&a++}}static _parseTemplateNestedTemplate(i,n,r){let o=i,a=this._parseTemplate(o,n);return(a.content=o.content.ownerDocument.createDocumentFragment()).appendChild(o.content),r.templateInfo=a,!0}static _parseTemplateNodeAttributes(i,n,r){let o=!1,a=Array.from(i.attributes);for(let l=a.length-1,c;c=a[l];l--)o=this._parseTemplateNodeAttribute(i,n,r,c.name,c.value)||o;return o}static _parseTemplateNodeAttribute(i,n,r,o,a){return o.slice(0,3)==="on-"?(i.removeAttribute(o),r.events=r.events||[],r.events.push({name:o.slice(3),value:a}),!0):o==="id"?(r.id=a,!0):!1}static _contentForTemplate(i){let n=i._templateInfo;return n&&n.content||i.content}_stampTemplate(i,n){i&&!i.content&&window.HTMLTemplateElement&&HTMLTemplateElement.decorate&&HTMLTemplateElement.decorate(i),n=n||this.constructor._parseTemplate(i);let r=n.nodeInfoList,o=n.content||i.content,a=document.importNode(o,!0);a.__noInsertionPoint=!n.hasInsertionPoint;let l=a.nodeList=new Array(r.length);a.$={};for(let c=0,u=r.length,d;c<u&&(d=r[c]);c++){let h=l[c]=an(a,d);Xa(this,a.$,h,d),Wa(this,h,d,n),Ja(this,h,d)}return a=a,a}_addMethodEventListenerToNode(i,n,r,o){o=o||i;let a=Za(o,n,r);return this._addEventListenerToNode(i,n,a),a}_addEventListenerToNode(i,n,r){i.addEventListener(n,r)}_removeEventListenerFromNode(i,n,r){i.removeEventListener(n,r)}}return e});/**
 * @fileoverview
 ...
 */let Be=0;const He=[],O={COMPUTE:"__computeEffects",REFLECT:"__reflectEffects",NOTIFY:"__notifyEffects",PROPAGATE:"__propagateEffects",OBSERVE:"__observeEffects",READ_ONLY:"__readOnly"},ln="__computeInfo",qa=/[A-Z]/;function Ht(t,e,s){let i=t[e];if(!i)i=t[e]={};else if(!t.hasOwnProperty(e)&&(i=t[e]=Object.create(t[e]),s))for(let n in i){let r=i[n],o=i[n]=Array(r.length);for(let a=0;a<r.length;a++)o[a]=r[a]}return i}function ze(t,e,s,i,n,r){if(e){let o=!1;const a=Be++;for(let l in s){let c=n?ge(l):l,u=e[c];if(u)for(let d=0,h=u.length,p;d<h&&(p=u[d]);d++)(!p.info||p.info.lastRun!==a)&&(!n||ms(l,p.trigger))&&(p.info&&(p.info.lastRun=a),p.fn(t,l,s,i,p.info,n,r),o=!0)}return o}return!1}function Qa(t,e,s,i,n,r,o,a){let l=!1,c=o?ge(i):i,u=e[c];if(u)for(let d=0,h=u.length,p;d<h&&(p=u[d]);d++)(!p.info||p.info.lastRun!==s)&&(!o||ms(i,p.trigger))&&(p.info&&(p.info.lastRun=s),p.fn(t,i,n,r,p.info,o,a),l=!0);return l}function ms(t,e){if(e){let s=e.name;return s==t||!!(e.structured&&Aa(s,t))||!!(e.wildcard&&ft(s,t))}else return!0}function si(t,e,s,i,n){let r=typeof n.method=="string"?t[n.method]:n.method,o=n.property;r?r.call(t,t.__data[o],i[o]):n.dynamicFn||console.warn("observer method `"+n.method+"` not defined")}function el(t,e,s,i,n){let r=t[O.NOTIFY],o,a=Be++;for(let c in e)e[c]&&(r&&Qa(t,r,a,c,s,i,n)||n&&tl(t,c,s))&&(o=!0);let l;o&&(l=t.__dataHost)&&l._invalidateProperties&&l._invalidateProperties()}function tl(t,e,s){let i=ge(e);if(i!==e){let n=$t(i)+"-changed";return cn(t,n,s[e],e),!0}return!1}function cn(t,e,s,i){let n={value:s,queueProperty:!0};i&&(n.path=i),he(t).dispatchEvent(new CustomEvent(e,{detail:n}))}function sl(t,e,s,i,n,r){let a=(r?ge(e):e)!=e?e:null,l=a?V(t,a):t.__data[e];a&&l===void 0&&(l=s[e]),cn(t,n.eventName,l,a)}function il(t,e,s,i,n){let r,o=t.detail,a=o&&o.path;a?(i=gt(s,i,a),r=o&&o.value):r=t.currentTarget[s],r=n?!r:r,(!e[O.READ_ONLY]||!e[O.READ_ONLY][i])&&e._setPendingPropertyOrPath(i,r,!0,!!a)&&(!o||!o.queueProperty)&&e._invalidateProperties()}function nl(t,e,s,i,n){let r=t.__data[e];pt&&(r=pt(r,n.attrName,"attribute",t)),t._propertyToAttribute(e,n.attrName,r)}function rl(t,e,s,i){let n=t[O.COMPUTE];if(n)if(wa){Be++;const r=al(t),o=[];for(let l in e)ii(l,n,o,r,i);let a;for(;a=o.shift();)un(t,"",e,s,a)&&ii(a.methodInfo,n,o,r,i);Object.assign(s,t.__dataOld),Object.assign(e,t.__dataPending),t.__dataPending=null}else{let r=e;for(;ze(t,n,r,s,i);)Object.assign(s,t.__dataOld),Object.assign(e,t.__dataPending),r=t.__dataPending,t.__dataPending=null}}const ol=(t,e,s)=>{let i=0,n=e.length-1,r=-1;for(;i<=n;){const o=i+n>>1,a=s.get(e[o].methodInfo)-s.get(t.methodInfo);if(a<0)i=o+1;else if(a>0)n=o-1;else{r=o;break}}r<0&&(r=n+1),e.splice(r,0,t)},ii=(t,e,s,i,n)=>{const r=n?ge(t):t,o=e[r];if(o)for(let a=0;a<o.length;a++){const l=o[a];l.info.lastRun!==Be&&(!n||ms(t,l.trigger))&&(l.info.lastRun=Be,ol(l.info,s,i))}};function al(t){let e=t.constructor.__orderedComputedDeps;if(!e){e=new Map;const s=t[O.COMPUTE];let{counts:i,ready:n,total:r}=ll(t),o;for(;o=n.shift();){e.set(o,e.size);const a=s[o];a&&a.forEach(l=>{const c=l.info.methodInfo;--r,--i[c]===0&&n.push(c)})}r!==0&&console.warn(`Computed graph for ${t.localName} incomplete; circular?`),t.constructor.__orderedComputedDeps=e}return e}function ll(t){const e=t[ln],s={},i=t[O.COMPUTE],n=[];let r=0;for(let o in e){const a=e[o];r+=s[o]=a.args.filter(l=>!l.literal).length+(a.dynamicFn?1:0)}for(let o in i)e[o]||n.push(o);return{counts:s,ready:n,total:r}}function un(t,e,s,i,n){let r=ss(t,e,s,i,n);if(r===He)return!1;let o=n.methodInfo;return t.__dataHasAccessor&&t.__dataHasAccessor[o]?t._setPendingProperty(o,r,!0):(t[o]=r,!1)}function cl(t,e,s){let i=t.__dataLinkedPaths;if(i){let n;for(let r in i){let o=i[r];ft(r,e)?(n=gt(r,o,e),t._setPendingPropertyOrPath(n,s,!0,!0)):ft(o,e)&&(n=gt(o,r,e),t._setPendingPropertyOrPath(n,s,!0,!0))}}}function Ut(t,e,s,i,n,r,o){s.bindings=s.bindings||[];let a={kind:i,target:n,parts:r,literal:o,isCompound:r.length!==1};if(s.bindings.push(a),fl(a)){let{event:c,negate:u}=a.parts[0];a.listenerEvent=c||$t(n)+"-changed",a.listenerNegate=u}let l=e.nodeInfoList.length;for(let c=0;c<a.parts.length;c++){let u=a.parts[c];u.compoundIndex=c,ul(t,e,a,u,l)}}function ul(t,e,s,i,n){if(!i.literal)if(s.kind==="attribute"&&s.target[0]==="-")console.warn("Cannot set attribute "+s.target+' because "-" is not a valid attribute starting character');else{let r=i.dependencies,o={index:n,binding:s,part:i,evaluator:t};for(let a=0;a<r.length;a++){let l=r[a];typeof l=="string"&&(l=hn(l),l.wildcard=!0),t._addTemplatePropertyEffect(e,l.rootProperty,{fn:dl,info:o,trigger:l})}}}function dl(t,e,s,i,n,r,o){let a=o[n.index],l=n.binding,c=n.part;if(r&&c.source&&e.length>c.source.length&&l.kind=="property"&&!l.isCompound&&a.__isPropertyEffectsClient&&a.__dataHasAccessor&&a.__dataHasAccessor[l.target]){let u=s[e];e=gt(c.source,l.target,e),a._setPendingPropertyOrPath(e,u,!1,!0)&&t._enqueueClient(a)}else{let u=n.evaluator._evaluateBinding(t,c,e,s,i,r);u!==He&&hl(t,a,l,c,u)}}function hl(t,e,s,i,n){if(n=pl(e,n,s,i),pt&&(n=pt(n,s.target,s.kind,e)),s.kind=="attribute")t._valueToNodeAttribute(e,n,s.target);else{let r=s.target;e.__isPropertyEffectsClient&&e.__dataHasAccessor&&e.__dataHasAccessor[r]?(!e[O.READ_ONLY]||!e[O.READ_ONLY][r])&&e._setPendingProperty(r,n)&&t._enqueueClient(e):t._setUnmanagedPropertyToNode(e,r,n)}}function pl(t,e,s,i){if(s.isCompound){let n=t.__dataCompoundStorage[s.target];n[i.compoundIndex]=e,e=n.join("")}return s.kind!=="attribute"&&(s.target==="textContent"||s.target==="value"&&(t.localName==="input"||t.localName==="textarea"))&&(e=e??""),e}function fl(t){return!!t.target&&t.kind!="attribute"&&t.kind!="text"&&!t.isCompound&&t.parts[0].mode==="{"}function gl(t,e){let{nodeList:s,nodeInfoList:i}=e;if(i.length)for(let n=0;n<i.length;n++){let r=i[n],o=s[n],a=r.bindings;if(a)for(let l=0;l<a.length;l++){let c=a[l];ml(o,c),_l(o,t,c)}o.__dataHost=t}}function ml(t,e){if(e.isCompound){let s=t.__dataCompoundStorage||(t.__dataCompoundStorage={}),i=e.parts,n=new Array(i.length);for(let o=0;o<i.length;o++)n[o]=i[o].literal;let r=e.target;s[r]=n,e.literal&&e.kind=="property"&&(r==="className"&&(t=he(t)),t[r]=e.literal)}}function _l(t,e,s){if(s.listenerEvent){let i=s.parts[0];t.addEventListener(s.listenerEvent,function(n){il(n,e,s.target,i.source,i.negate)})}}function ni(t,e,s,i,n,r){r=e.static||r&&(typeof r!="object"||r[e.methodName]);let o={methodName:e.methodName,args:e.args,methodInfo:n,dynamicFn:r};for(let a=0,l;a<e.args.length&&(l=e.args[a]);a++)l.literal||t._addPropertyEffect(l.rootProperty,s,{fn:i,info:o,trigger:l});return r&&t._addPropertyEffect(e.methodName,s,{fn:i,info:o}),o}function ss(t,e,s,i,n){let r=t._methodHost||t,o=r[n.methodName];if(o){let a=t._marshalArgs(n.args,e,s);return a===He?He:o.apply(r,a)}else n.dynamicFn||console.warn("method `"+n.methodName+"` not defined")}const yl=[],dn="(?:[a-zA-Z_$][\\w.:$\\-*]*)",bl="(?:[-+]?[0-9]*\\.?[0-9]+(?:[eE][-+]?[0-9]+)?)",vl="(?:'(?:[^'\\\\]|\\\\.)*')",wl='(?:"(?:[^"\\\\]|\\\\.)*")',xl="(?:"+vl+"|"+wl+")",ri="(?:("+dn+"|"+bl+"|"+xl+")\\s*)",Sl="(?:"+ri+"(?:,\\s*"+ri+")*)",Pl="(?:\\(\\s*(?:"+Sl+"?)\\)\\s*)",Cl="("+dn+"\\s*"+Pl+"?)",El="(\\[\\[|{{)\\s*",Ol="(?:]]|}})",$l="(?:(!)\\s*)?",zl=El+$l+Cl+Ol,oi=new RegExp(zl,"g");function ai(t){let e="";for(let s=0;s<t.length;s++){let i=t[s].literal;e+=i||""}return e}function Yt(t){let e=t.match(/([^\s]+?)\(([\s\S]*)\)/);if(e){let i={methodName:e[1],static:!0,args:yl};if(e[2].trim()){let n=e[2].replace(/\\,/g,"&comma;").split(",");return Tl(n,i)}else return i}return null}function Tl(t,e){return e.args=t.map(function(s){let i=hn(s);return i.literal||(e.static=!1),i},this),e}function hn(t){let e=t.trim().replace(/&comma;/g,",").replace(/\\(.)/g,"$1"),s={name:e,value:"",literal:!1},i=e[0];switch(i==="-"&&(i=e[1]),i>="0"&&i<="9"&&(i="#"),i){case"'":case'"':s.value=e.slice(1,-1),s.literal=!0;break;case"#":s.value=Number(e),s.literal=!0;break}return s.literal||(s.rootProperty=ge(e),s.structured=es(e),s.structured&&(s.wildcard=e.slice(-2)==".*",s.wildcard&&(s.name=e.slice(0,-2)))),s}function li(t,e,s){let i=V(t,s);return i===void 0&&(i=e[s]),i}function pn(t,e,s,i){const n={indexSplices:i};Qt&&!t._overrideLegacyUndefined&&(e.splices=n),t.notifyPath(s+".splices",n),t.notifyPath(s+".length",e.length),Qt&&!t._overrideLegacyUndefined&&(n.indexSplices=[])}function Ee(t,e,s,i,n,r){pn(t,e,s,[{index:i,addedCount:n,removed:r,object:e,type:"splice"}])}function Al(t){return t[0].toUpperCase()+t.substring(1)}const Ll=fe(t=>{const e=Ga(Va(t));class s extends e{constructor(){super(),this.__isPropertyEffectsClient=!0,this.__dataClientsReady,this.__dataPendingClients,this.__dataToNotify,this.__dataLinkedPaths,this.__dataHasPaths,this.__dataCompoundStorage,this.__dataHost,this.__dataTemp,this.__dataClientsInitialized,this.__data,this.__dataPending,this.__dataOld,this.__computeEffects,this.__computeInfo,this.__reflectEffects,this.__notifyEffects,this.__propagateEffects,this.__observeEffects,this.__readOnly,this.__templateInfo,this._overrideLegacyUndefined}get PROPERTY_EFFECT_TYPES(){return O}_initializeProperties(){super._initializeProperties(),this._registerHost(),this.__dataClientsReady=!1,this.__dataPendingClients=null,this.__dataToNotify=null,this.__dataLinkedPaths=null,this.__dataHasPaths=!1,this.__dataCompoundStorage=this.__dataCompoundStorage||null,this.__dataHost=this.__dataHost||null,this.__dataTemp={},this.__dataClientsInitialized=!1}_registerHost(){if(Oe.length){let n=Oe[Oe.length-1];n._enqueueClient(this),this.__dataHost=n}}_initializeProtoProperties(n){this.__data=Object.create(n),this.__dataPending=Object.create(n),this.__dataOld={}}_initializeInstanceProperties(n){let r=this[O.READ_ONLY];for(let o in n)(!r||!r[o])&&(this.__dataPending=this.__dataPending||{},this.__dataOld=this.__dataOld||{},this.__data[o]=this.__dataPending[o]=n[o])}_addPropertyEffect(n,r,o){this._createPropertyAccessor(n,r==O.READ_ONLY);let a=Ht(this,r,!0)[n];a||(a=this[r][n]=[]),a.push(o)}_removePropertyEffect(n,r,o){let a=Ht(this,r,!0)[n],l=a.indexOf(o);l>=0&&a.splice(l,1)}_hasPropertyEffect(n,r){let o=this[r];return!!(o&&o[n])}_hasReadOnlyEffect(n){return this._hasPropertyEffect(n,O.READ_ONLY)}_hasNotifyEffect(n){return this._hasPropertyEffect(n,O.NOTIFY)}_hasReflectEffect(n){return this._hasPropertyEffect(n,O.REFLECT)}_hasComputedEffect(n){return this._hasPropertyEffect(n,O.COMPUTE)}_setPendingPropertyOrPath(n,r,o,a){if(a||ge(Array.isArray(n)?n[0]:n)!==n){if(!a){let l=V(this,n);if(n=Qs(this,n,r),!n||!super._shouldPropertyChange(n,r,l))return!1}if(this.__dataHasPaths=!0,this._setPendingProperty(n,r,o))return cl(this,n,r),!0}else{if(this.__dataHasAccessor&&this.__dataHasAccessor[n])return this._setPendingProperty(n,r,o);this[n]=r}return!1}_setUnmanagedPropertyToNode(n,r,o){(o!==n[r]||typeof o=="object")&&(r==="className"&&(n=he(n)),n[r]=o)}_setPendingProperty(n,r,o){let a=this.__dataHasPaths&&es(n),l=a?this.__dataTemp:this.__data;return this._shouldPropertyChange(n,r,l[n])?(this.__dataPending||(this.__dataPending={},this.__dataOld={}),n in this.__dataOld||(this.__dataOld[n]=this.__data[n]),a?this.__dataTemp[n]=r:this.__data[n]=r,this.__dataPending[n]=r,(a||this[O.NOTIFY]&&this[O.NOTIFY][n])&&(this.__dataToNotify=this.__dataToNotify||{},this.__dataToNotify[n]=o),!0):!1}_setProperty(n,r){this._setPendingProperty(n,r,!0)&&this._invalidateProperties()}_invalidateProperties(){this.__dataReady&&this._flushProperties()}_enqueueClient(n){this.__dataPendingClients=this.__dataPendingClients||[],n!==this&&this.__dataPendingClients.push(n)}_flushClients(){this.__dataClientsReady?this.__enableOrFlushClients():(this.__dataClientsReady=!0,this._readyClients(),this.__dataReady=!0)}__enableOrFlushClients(){let n=this.__dataPendingClients;if(n){this.__dataPendingClients=null;for(let r=0;r<n.length;r++){let o=n[r];o.__dataEnabled?o.__dataPending&&o._flushProperties():o._enableProperties()}}}_readyClients(){this.__enableOrFlushClients()}setProperties(n,r){for(let o in n)(r||!this[O.READ_ONLY]||!this[O.READ_ONLY][o])&&this._setPendingPropertyOrPath(o,n[o],!0);this._invalidateProperties()}ready(){this._flushProperties(),this.__dataClientsReady||this._flushClients(),this.__dataPending&&this._flushProperties()}_propertiesChanged(n,r,o){let a=this.__dataHasPaths;this.__dataHasPaths=!1;let l;rl(this,r,o,a),l=this.__dataToNotify,this.__dataToNotify=null,this._propagatePropertyChanges(r,o,a),this._flushClients(),ze(this,this[O.REFLECT],r,o,a),ze(this,this[O.OBSERVE],r,o,a),l&&el(this,l,r,o,a),this.__dataCounter==1&&(this.__dataTemp={})}_propagatePropertyChanges(n,r,o){this[O.PROPAGATE]&&ze(this,this[O.PROPAGATE],n,r,o),this.__templateInfo&&this._runEffectsForTemplate(this.__templateInfo,n,r,o)}_runEffectsForTemplate(n,r,o,a){const l=(c,u)=>{ze(this,n.propertyEffects,c,o,u,n.nodeList);for(let d=n.firstChild;d;d=d.nextSibling)this._runEffectsForTemplate(d,c,o,u)};n.runEffects?n.runEffects(l,r,a):l(r,a)}linkPaths(n,r){n=$e(n),r=$e(r),this.__dataLinkedPaths=this.__dataLinkedPaths||{},this.__dataLinkedPaths[n]=r}unlinkPaths(n){n=$e(n),this.__dataLinkedPaths&&delete this.__dataLinkedPaths[n]}notifySplices(n,r){let o={path:""},a=V(this,n,o);pn(this,a,o.path,r)}get(n,r){return V(r||this,n)}set(n,r,o){o?Qs(o,n,r):(!this[O.READ_ONLY]||!this[O.READ_ONLY][n])&&this._setPendingPropertyOrPath(n,r,!0)&&this._invalidateProperties()}push(n,...r){let o={path:""},a=V(this,n,o),l=a.length,c=a.push(...r);return r.length&&Ee(this,a,o.path,l,r.length,[]),c}pop(n){let r={path:""},o=V(this,n,r),a=!!o.length,l=o.pop();return a&&Ee(this,o,r.path,o.length,0,[l]),l}splice(n,r,o,...a){let l={path:""},c=V(this,n,l);r<0?r=c.length-Math.floor(-r):r&&(r=Math.floor(r));let u;return arguments.length===2?u=c.splice(r):u=c.splice(r,o,...a),(a.length||u.length)&&Ee(this,c,l.path,r,a.length,u),u}shift(n){let r={path:""},o=V(this,n,r),a=!!o.length,l=o.shift();return a&&Ee(this,o,r.path,0,0,[l]),l}unshift(n,...r){let o={path:""},a=V(this,n,o),l=a.unshift(...r);return r.length&&Ee(this,a,o.path,0,r.length,[]),l}notifyPath(n,r){let o;if(arguments.length==1){let a={path:""};r=V(this,n,a),o=a.path}else Array.isArray(n)?o=$e(n):o=n;this._setPendingPropertyOrPath(o,r,!0,!0)&&this._invalidateProperties()}_createReadOnlyProperty(n,r){this._addPropertyEffect(n,O.READ_ONLY),r&&(this["_set"+Al(n)]=function(o){this._setProperty(n,o)})}_createPropertyObserver(n,r,o){let a={property:n,method:r,dynamicFn:!!o};this._addPropertyEffect(n,O.OBSERVE,{fn:si,info:a,trigger:{name:n}}),o&&this._addPropertyEffect(r,O.OBSERVE,{fn:si,info:a,trigger:{name:r}})}_createMethodObserver(n,r){let o=Yt(n);if(!o)throw new Error("Malformed observer expression '"+n+"'");ni(this,o,O.OBSERVE,ss,null,r)}_createNotifyingProperty(n){this._addPropertyEffect(n,O.NOTIFY,{fn:sl,info:{eventName:$t(n)+"-changed",property:n}})}_createReflectedProperty(n){let r=this.constructor.attributeNameForProperty(n);r[0]==="-"?console.warn("Property "+n+" cannot be reflected to attribute "+r+' because "-" is not a valid starting attribute name. Use a lowercase first letter for the property instead.'):this._addPropertyEffect(n,O.REFLECT,{fn:nl,info:{attrName:r}})}_createComputedProperty(n,r,o){let a=Yt(r);if(!a)throw new Error("Malformed computed expression '"+r+"'");const l=ni(this,a,O.COMPUTE,un,n,o);Ht(this,ln)[n]=l}_marshalArgs(n,r,o){const a=this.__data,l=[];for(let c=0,u=n.length;c<u;c++){let{name:d,structured:h,wildcard:p,value:f,literal:g}=n[c];if(!g)if(p){const m=ft(d,r),_=li(a,o,m?r:d);f={path:m?r:d,value:_,base:m?V(a,d):_}}else f=h?li(a,o,d):a[d];if(Qt&&!this._overrideLegacyUndefined&&f===void 0&&n.length>1)return He;l[c]=f}return l}static addPropertyEffect(n,r,o){this.prototype._addPropertyEffect(n,r,o)}static createPropertyObserver(n,r,o){this.prototype._createPropertyObserver(n,r,o)}static createMethodObserver(n,r){this.prototype._createMethodObserver(n,r)}static createNotifyingProperty(n){this.prototype._createNotifyingProperty(n)}static createReadOnlyProperty(n,r){this.prototype._createReadOnlyProperty(n,r)}static createReflectedProperty(n){this.prototype._createReflectedProperty(n)}static createComputedProperty(n,r,o){this.prototype._createComputedProperty(n,r,o)}static bindTemplate(n){return this.prototype._bindTemplate(n)}_bindTemplate(n,r){let o=this.constructor._parseTemplate(n),a=this.__preBoundTemplateInfo==o;if(!a)for(let l in o.propertyEffects)this._createPropertyAccessor(l);if(r)if(o=Object.create(o),o.wasPreBound=a,!this.__templateInfo)this.__templateInfo=o;else{const l=n._parentTemplateInfo||this.__templateInfo,c=l.lastChild;o.parent=l,l.lastChild=o,o.previousSibling=c,c?c.nextSibling=o:l.firstChild=o}else this.__preBoundTemplateInfo=o;return o}static _addTemplatePropertyEffect(n,r,o){let a=n.hostProps=n.hostProps||{};a[r]=!0;let l=n.propertyEffects=n.propertyEffects||{};(l[r]=l[r]||[]).push(o)}_stampTemplate(n,r){r=r||this._bindTemplate(n,!0),Oe.push(this);let o=super._stampTemplate(n,r);if(Oe.pop(),r.nodeList=o.nodeList,!r.wasPreBound){let a=r.childNodes=[];for(let l=o.firstChild;l;l=l.nextSibling)a.push(l)}return o.templateInfo=r,gl(this,r),this.__dataClientsReady&&(this._runEffectsForTemplate(r,this.__data,null,!1),this._flushClients()),o}_removeBoundDom(n){const r=n.templateInfo,{previousSibling:o,nextSibling:a,parent:l}=r;o?o.nextSibling=a:l&&(l.firstChild=a),a?a.previousSibling=o:l&&(l.lastChild=o),r.nextSibling=r.previousSibling=null;let c=r.childNodes;for(let u=0;u<c.length;u++){let d=c[u];he(he(d).parentNode).removeChild(d)}}static _parseTemplateNode(n,r,o){let a=e._parseTemplateNode.call(this,n,r,o);if(n.nodeType===Node.TEXT_NODE){let l=this._parseBindings(n.textContent,r);l&&(n.textContent=ai(l)||" ",Ut(this,r,o,"text","textContent",l),a=!0)}return a}static _parseTemplateNodeAttribute(n,r,o,a,l){let c=this._parseBindings(l,r);if(c){let u=a,d="property";qa.test(a)?d="attribute":a[a.length-1]=="$"&&(a=a.slice(0,-1),d="attribute");let h=ai(c);return h&&d=="attribute"&&(a=="class"&&n.hasAttribute("class")&&(h+=" "+n.getAttribute(a)),n.setAttribute(a,h)),d=="attribute"&&u=="disable-upgrade$"&&n.setAttribute(a,""),n.localName==="input"&&u==="value"&&n.setAttribute(u,""),n.removeAttribute(u),d==="property"&&(a=tn(a)),Ut(this,r,o,d,a,c,h),!0}else return e._parseTemplateNodeAttribute.call(this,n,r,o,a,l)}static _parseTemplateNestedTemplate(n,r,o){let a=e._parseTemplateNestedTemplate.call(this,n,r,o);const l=n.parentNode,c=o.templateInfo,u=l.localName==="dom-if",d=l.localName==="dom-repeat";Js&&(u||d)&&(l.removeChild(n),o=o.parentInfo,o.templateInfo=c,o.noted=!0,a=!1);let h=c.hostProps;if(xa&&u)h&&(r.hostProps=Object.assign(r.hostProps||{},h),Js||(o.parentInfo.noted=!0));else{let p="{";for(let f in h){let g=[{mode:p,source:f,dependencies:[f],hostProp:!0}];Ut(this,r,o,"property","_host_"+f,g)}}return a}static _parseBindings(n,r){let o=[],a=0,l;for(;(l=oi.exec(n))!==null;){l.index>a&&o.push({literal:n.slice(a,l.index)});let c=l[1][0],u=!!l[2],d=l[3].trim(),h=!1,p="",f=-1;c=="{"&&(f=d.indexOf("::"))>0&&(p=d.substring(f+2),d=d.substring(0,f),h=!0);let g=Yt(d),m=[];if(g){let{args:_,methodName:v}=g;for(let x=0;x<_.length;x++){let E=_[x];E.literal||m.push(E)}let w=r.dynamicFns;(w&&w[v]||g.static)&&(m.push(v),g.dynamicFn=!0)}else m.push(d);o.push({source:d,mode:c,negate:u,customEvent:h,signature:g,dependencies:m,event:p}),a=oi.lastIndex}if(a&&a<n.length){let c=n.substring(a);c&&o.push({literal:c})}return o.length?o:null}static _evaluateBinding(n,r,o,a,l,c){let u;return r.signature?u=ss(n,o,a,l,r.signature):o!=r.source?u=V(n,r.source):c&&es(o)?u=V(n,o):u=n.__data[o],r.negate&&(u=!u),u}}return s}),Oe=[];/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const Ml=Il(HTMLElement),it=[],zt=()=>{T.isInitialized||T.init({lng:"en",resStore:{en:{}},fallbackLng:!1})},Tt=t=>t.reduce((e,s,i)=>(e.count===void 0&&typeof s=="number"&&(e.count=s),typeof s=="object"?{...e,...s}:(e[i]=s,e)),{}),W=function(t){zt();const e=Tt([...arguments].slice(1));return delete e.count,T.t(t,e)},Dl=function(t,e){zt();const s=Tt([...arguments].slice(2)),i=s.count;let n;delete s.count;const r=T.services.pluralResolver.getSuffix(T.language,i);return r?(s.defaultValue=e,n=t+r):(n=t,s.defaultValue=t),T.t(n,s)},Fl=function(t,e){zt();const s=Tt([...arguments].slice(2));return s.context=t,delete s.count,T.t(e,s)},jl=function(t,e,s){zt();const i=Tt([...arguments].slice(3)),n=i.count,r=t?"_"+t:"";let o=e;delete i.count;const a=T.services.pluralResolver.getSuffix(T.language,n);return a?(i.defaultValue=s,o=e+r+a):(o=e,i.context=t),T.t(o,i)},Vl=(t,e,s)=>{T.init({resources:{}}),T.addResourceBundle(t,e,s)};fe(t=>class extends t{static get properties(){return{t:{type:Object,value(){return{}}}}}_filterT(e){return e.filter(s=>s!==this.t)}_(){return W.apply(null,this._filterT([...arguments]))}connectedCallback(){super.connectedCallback(),it.push(this)}disconnectedCallback(){super.disconnectedCallback();const e=it.indexOf(this);e>=0&&it.splice(e,1)}gettext(){return W.apply(null,this._filterT([...arguments]))}ngettext(){return Dl.apply(null,this._filterT([...arguments]))}pgettext(){return Fl.apply(null,this._filterT([...arguments]))}npgettext(){return jl.apply(null,this._filterT([...arguments]))}});class Bl extends Ml{static get properties(){return{compatibilityJSON:{type:String,value:"v3"},domain:{type:String,value:"messages"},interpolationPrefix:{type:String,value:"__"},interpolationSuffix:{type:String,value:"__"},language:{type:String,value:"en"},namespace:{type:String,value:"translation"},translations:{type:Object,observer(e){e!=null&&(Vl(this.language,this.namespace,e),it.forEach(s=>s.set("t",{})))}},keySeparator:{type:String,value:"."},nsSeparator:{type:String,value:":"}}}ready(){super.ready(),T.init({compatibilityJSON:this.compatibilityJSON,interpolation:{escapeValue:!1,prefix:this.interpolationPrefix,suffix:this.interpolationSuffix},keySeparator:this.keySeparator,lng:this.language,nsSeparator:this.nsSeparator,resStore:{}})}}customElements.define("cosmoz-i18next",Bl);const ui=()=>document.createComment(""),Hl=yt(Z,new DocumentFragment).constructor;class Ul extends HTMLElement{onDisconnect;disconnectedCallback(){this.onDisconnect?.()}}customElements.define("disconnect-observer",Ul);class Yl extends bt{_op;_outlet;_content;render(e,s=document.body){return b`<disconnect-observer
			.onDisconnect=${()=>{this.isConnected=!1,this.disconnected()}}
		></disconnect-observer>`}update(e,[s,i=document.body]){return this.updateOutlet(i,s),this.render(s,i)}updateOutlet(e,s){this._outlet!==e&&this.clearOutlet(),this._outlet=e;const i=this._op??=new Hl(e.appendChild(ui()),e.appendChild(ui()));re(i,this._content=s)}clearOutlet(){const e=this._op;e&&(bn(e),et(e),this._op=void 0)}disconnected(){this.clearOutlet()}reconnected(){this._outlet&&this._content&&this.updateOutlet(this._outlet,this._content)}}const Kl=ie(Yl),Xl=`:host {
    display: flex;
...
`,Jl=Symbol("memo"),fn=t=>{let e=Jl,s;return function(i){if(e===i)return s;const n=t(i);return s=n,e=i,n}},Wl=(t,e)=>{const s=t.width/t.height,i=e.width/e.height;return s>i?{width:e.width,height:t.height*(e.width/t.width)}:{width:t.width*(e.height/t.height),height:e.height}},Zl=async(t,e)=>{const s={credentials:"include"},[{jsPDF:i},...n]=await Promise.all([ns(()=>import("./jspdf.es-C8lXQ5JU.js").then(a=>a.j),__vite__mapDeps([0,1]),import.meta.url),...t.map(async a=>{const l=await Promise.resolve(ls(a)),c=await fetch(l,s);return c.ok?{url:l,data:new Uint8Array(await c.arrayBuffer())}:void 0})]),r=n.filter(Boolean);if(r.length<1)return;const o=new i;return r.filter(Boolean).forEach(({url:a,data:l},c)=>{const{internal:{pageSize:d}}=o,{width:h,height:p}=Wl(o.getImageProperties(l),{width:d.getWidth()-4,height:d.getHeight()-4});c>0&&o.addPage(),o.addImage(l,a.split(".").pop().toUpperCase(),2,2,h,p)}),o.output("blob")},gn=(t,e)=>{const s=URL.createObjectURL(t),i=document.body.appendChild(document.createElement("a"));i.href=s,i.download=`${e}.pdf`,i.click(),document.body.removeChild(i),URL.revokeObjectURL(s)},Gl=async(t,e,s)=>{const i=await Zl(t);if(i)return gn(i,e),i},ql=async(t,e,s={})=>{const{httpHeaders:i,withCredentials:n=!0}=s,r=await fetch(t,{credentials:n?"include":"omit",headers:i});if(!r.ok)return;const o=await r.blob();return gn(o,e),o},Ql=t=>Object.entries(t).map(([e,s])=>e+"="+s).join(",");let is=!1;const ec=({source:t,attachmentIndex:e,index:s,syncImageIndex:i,syncAttachmentIndex:n,title:r,loop:o,detachedShowZoom:a,onDetach:l,onClose:c})=>{const u=window.open(void 0,"czimgviewer",Ql({height:700,width:800}));yt(b`<style>
				html {
					background: #000;
				}
			</style>
			<cosmoz-image-viewer
				...
				?loop=${o}
				@close=${()=>u.close()}
			></cosmoz-image-viewer>`,u.document.body),u._onClose?.(),l(),is=!0,u._onClose=c,u.addEventListener("beforeunload",c),u.addEventListener("beforeunload",()=>is=!1),u.document.title=r??W("Cosmoz image viewer")},tc=t=>new Promise(e=>{const s=setInterval(()=>{t()&&(e(),clearInterval(s))},100)}),sc=({images:t})=>{const e=window.open(void 0,"czimgviewerprint");yt(b`<style>
				img {
					display: block;
			...
			${t.map(s=>b`<img src="${De(Promise.resolve(ls(s)))}" />`)}`,e.document.body),tc(()=>Array.from(e.document.querySelectorAll("img")).every(s=>s.src&&s.complete)).then(()=>e.print()).then(()=>e.close())},di=[],ic=t=>{const e=I(()=>typeof t=="function"?Promise.resolve(t()):void 0,[t]),[s,i,n]=Ni(e);return typeof t!="function"?{attachments:t??di,loading:!1,error:void 0}:{attachments:s??di,loading:n==="pending",error:i}},nc=50,rc=300,oc=(t,{onSwipeLeft:e,onSwipeRight:s,enabled:i})=>{const n=se(null);z(()=>{if(!i)return;const r=a=>{if(a.touches.length!==1)return;const l=a.touches[0];n.current={x:l.clientX,y:l.clientY,t:Date.now()}},o=a=>{if(!n.current)return;const l=a.changedTouches[0],c=l.clientX-n.current.x,u=l.clientY-n.current.y,d=Date.now()-n.current.t;n.current=null,!(d>rc)&&(Math.abs(c)<nc||Math.abs(c)<Math.abs(u)||(c<0?e?.():s?.()))};return t.addEventListener("touchstart",r,{passive:!0}),t.addEventListener("touchend",o,{passive:!0}),()=>{t.removeEventListener("touchstart",r),t.removeEventListener("touchend",o)}},[t,e,s,i])},mn=t=>{if(!t.currentTarget.parentElement)return;t.currentTarget.parentElement.querySelector(".error").removeAttribute("hidden"),t.currentTarget.setAttribute("hidden",!0)},ac=t=>t.detail.value==="error"&&mn(t),lc=({src$:t,showZoom:e,isZoomed:s,_onZoomChanged:i})=>{const n=ve(t,()=>De(t));return[e?b`<haunted-pan-zoom
						.src=${n}
						?disabled=${!s}
						@zoom-changed=${i}
						@status-changed=${ac}
					></haunted-pan-zoom>`:b`<img
						...
						style="width:100%"
						@error=${mn}
					/>`,ve(t,()=>De(t.then(()=>Z),b`<cz-spinner></cz-spinner>`))]},cc=t=>b`<div>
			<div hidden class="error">
				<h2>An error occurred while loading the image.</h2>
				<div class="desc">${t.image}</div>
			</div>
			${lc(t)}
		</div>`,_t=[],Kt=(t,e,s)=>Math.max(e,Math.min(s,t)),uc=(t,e,s)=>{const[i,n]=Q(_t),r=I(()=>fn(o=>ns(async()=>{const{loadPdfThunks:a}=await import("./pdf-loader-BSiQZefA.js");return{loadPdfThunks:a}},__vite__mapDeps([2,1]),import.meta.url).then(({loadPdfThunks:a})=>a(o,e))),[e]);return z(()=>{if(!t){n(_t);return}let o=!1;return r(t).then(a=>{o||n(a)}),()=>{o=!0}},[t,r]),t?i:s},hi=(t,e,s,i)=>{const n=t.length;for(let r=1;r<=n;r++){const o=(e+r*s+n)%n;if(!i&&s>0&&o<=e||!i&&s<0&&o>=e)return;const a=t[o];if((a.images?.length??0)>0||a.pdf)return o}},dc=t=>{const{showZoom:e,title:s,loop:i,detachedShowZoom:n}=t,{attachments:r,loading:o,error:a}=ic(t.source),[l,c]=Ie("currentAttachmentIndex",0),u=r.length>0?Kt(l??0,0,r.length-1):0,d=r[u],h=d?[d]:_t,p=se(Ge),f=C(L=>{const Ke=L.detail?.[0],Xe=r.indexOf(Ke);Xe>=0&&(p.current=Ge,c(Xe))},[r]),g=d?.pdf,m=d?.pdfOptions,_=d?.downloadFileName??"archive",v=d?.images??_t,w=uc(g,m,v),[x,E]=Q(!1),$=L=>E(L.detail.value>1),y=I(()=>fn(L=>Promise.resolve(ls(L))),[]),[A,R]=Ie("currentImageIndex",0),N=w.length>0?Kt(A??0,0,w.length-1):0,M=w[N],me=I(()=>M==null?{id:Math.random(),content:Z,animation:Ge}:{id:M,render:()=>cc({src$:y(M),showZoom:e,isZoomed:x,_onZoomChanged:$,image:M}),animation:p.current},[M,e,x,$]),Y=se(!1),K=!i&&u===0&&N<=0,j=!i&&u===r.length-1&&N>=w.length-1,D=C(()=>{if(p.current=Ge,N<w.length-1)return R(N+1);const L=hi(r,u,1,i);L!=null&&(c(L),R(0))},[N,w.length,r,u,i]),ae=C(()=>{if(p.current=Ho,N>0)return R(N-1);const L=hi(r,u,-1,i);L!=null&&(Y.current=!0,c(L))},[N,r,u,i]);oc(t,{onSwipeLeft:D,onSwipeRight:ae,enabled:!x});const[P,F]=Q(!1),[J,le]=Q(!1),At=()=>le(!0),Lt=()=>le(!1),Rt=L=>F(L.detail.value),kt=L=>R(L.detail.value),Nt=L=>c(L.detail.value),Se=C(()=>ec({source:r,attachmentIndex:u,index:N,syncImageIndex:kt,syncAttachmentIndex:Nt,title:s,loop:i,detachedShowZoom:n,onDetach:()=>F(!0),onClose:()=>F(!1)}),[r,u,N,s,i]),ce=C(()=>{is&&Se()},[Se]);return z(()=>{if(w.length===0)return;if(Y.current){Y.current=!1,R(w.length-1);return}const L=A??0;L>=w.length&&R(Kt(L,0,w.length-1))},[w]),z(()=>{const L=l??0;r.length>0&&L>=r.length&&c(0)},[r]),Kn("detached",P,[P]),z(()=>{t.toggleAttribute("hidden",P)},[P]),as({syncState:ce},[ce]),{host:t,isZoomed:x,currentSlide:me,nextImage:D,previousImage:ae,first:K,last:j,total:w.length,currentImageIndex:N,selectedImageNumber:N+1,onDownloadPdf:g?()=>ql(g,_,m):()=>Gl(w,_),isFullscreen:J,openFullscreen:At,closeFullscreen:Lt,onPrintPdf:()=>sc({images:w}),detached:P,detach:Se,syncDetachedState:Rt,setAttachmentIndex:c,setImageIndex:R,loading:o,error:a,attachments:r,selected:d,selectedIndex:u,value:h,onSelect:f,images:w}},hc=b`<svg
	viewBox="0 0 24 24"
