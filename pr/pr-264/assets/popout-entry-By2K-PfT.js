const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./iframe-Bf1O2fT1.js","./preload-helper-PPVm8Dsz.js","./iframe-Bv8SCm1X.css"])))=>i.map(i=>d[i]);
import{_ as a}from"./preload-helper-PPVm8Dsz.js";import{D as n,b as c}from"./iframe-Bf1O2fT1.js";import"./cosmoz-image-viewer-Dq54jylL.js";const u=import.meta.url;try{const{default:r}=await a(async()=>{const{default:e}=await import("./iframe-Bf1O2fT1.js").then(o=>o.i);return{default:e}},__vite__mapDeps([0,1,2]),import.meta.url);document.adoptedStyleSheets=[...document.adoptedStyleSheets,r]}catch{}const t=window.__popoutState;if(t){try{const{GlobalWorkerOptions:e}=await a(async()=>{const{GlobalWorkerOptions:o}=await import("./pdf-C4heYEAT.js");return{GlobalWorkerOptions:o}},[],import.meta.url);t.pdfWorkerSrc&&(e.workerSrc=t.pdfWorkerSrc)}catch{}const r=e=>c`<cosmoz-image-viewer
			fullscreen
			.source="${e.source}"
