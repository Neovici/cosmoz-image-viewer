...
>
	...
	></path>
		...
		${_?G:y`
					${R(w,()=>y`<div class="loading">
								<cz-spinner></cz-spinner>
							</div>`)}
					${R(x,()=>y`<div class="error">
					...
					${R(!w&&!x,()=>y`
							${R(ne(t.showPageNumber,r),()=>y` <div class="counter">
										${c}/${r}
									</div>`)}
