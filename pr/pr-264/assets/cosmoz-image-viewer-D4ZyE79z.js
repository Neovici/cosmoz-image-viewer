...
`,Bn=t=>{const{placement:e="bottom span-right",disabled:s,openOnHover:i,openOnFocus:n}=t,r=te(),[o,a]=Fe("opened",!1),l=x(()=>{s||(a(!0),r.current?.showPopover())},[s]),c=x(()=>{a(!1),r.current?.hidePopover()},[]),u=x(()=>{if(s)return;r.current?.matches(":popover-open")?c():l()},[s]);z(()=>{const g=r.current;g&&(o?g.showPopover():g.hidePopover())},[o]),z(()=>{t.toggleAttribute("opened",!!o)},[o]);const{scheduleClose:d,cancelClose:h}=Fn({host:t,popoverRef:r,disabled:s,openOnHover:i,openOnFocus:n,open:l,close:c}),p=n?l:u,f=x(g=>{jn(g),a(g.newState==="open"),t.dispatchEvent(new ToggleEvent("dropdown-toggle",{newState:g.newState,oldState:g.oldState,composed:!0}))},[]);return v`
	...
	`};customElements.define("cosmoz-dropdown-next",B(Bn,{styleSheets:[Vn],observedAttributes:["placement","disabled","open-on-hover","open-on-focus"],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const X=t=>t??Z;const yt=se(class extends ye{constructor(t){if(super(t),t.type!==W.PROPERTY&&t.type!==W.ATTRIBUTE&&t.type!==W.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!oi(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===V||e===Z)return e;const s=t.element,i=t.name;if(t.type===W.PROPERTY){if(e===s[i])return V}else if(t.type===W.BOOLEAN_ATTRIBUTE){if(!!e===s.hasAttribute(i))return V}else if(t.type===W.ATTRIBUTE&&s.getAttribute(i)===e+"")return V;return ai(t),e}});function A(t,e,s){return t?e(t):s?.(t)}const gi=(t,{label:e,invalid:s,errorMessage:i})=>v`
	...
	`,mi=["autocomplete","readonly","disabled","maxlength","invalid","no-label-float","always-float-label"],ms=_t`
	.wrap {
...
`,Zr=t=>{const e=t==="auto",[s,i]=ee(e?40:t);return[s,n=>e?i(n):void 0]},Si=Dn(()=>xi);customElements.define("cosmoz-keybinding-provider",Si.Provider);const Qt=t=>{const e=R(()=>({}),[]);return R(()=>Object.assign(e,t),[e,...Object.values(t)])},Te=(t,e)=>{const s=hi(Si),i=Qt(t);z(()=>s(i),e)},qr=Symbol("listbox.navigate.up"),Qr=Symbol("listbox.navigate.down"),eo=Symbol("listbox.select"),to=({onUp:t,onDown:e,onEnter:s})=>{const i=je();Te({activity:qr,callback:t,element:()=>i},[]),Te({activity:Qr,callback:e,element:()=>i},[]),Te({activity:eo,callback:s,element:()=>i},[])},so=({items:t,onSelect:e,defaultIndex:s=0})=>{const[i,n]=ee({index:s}),{index:r}=i,{length:o}=t;return z(()=>{n({index:i.index<0?s:Math.min(i.index,t.length-1),scroll:!0})},[t,s]),to({onUp:x(()=>n(a=>({index:a.index>0?a.index-1:o-1,scroll:!0})),[o]),onDown:x(()=>n(a=>({index:a.index<o-1?a.index+1:0,scroll:!0})),[o]),onEnter:x(()=>r>-1&&r<o&&e?.(t[r],r),[r,t,e])}),{position:i,highlight:x(a=>n({index:a}),[]),select:x(a=>e?.(a),[e])}},io=t=>typeof t=="object"&&t!==null&&Symbol.iterator in t;function re(t){return t==null?[]:Array.isArray(t)?t:typeof t=="string"?[t]:io(t)?Array.from(t):[t]}const kt=(t,e=rt)=>s=>{const i=re(t).map(e);return re(s).filter(n=>!i.includes(e(n)))},no=(t,e)=>e?s=>s!=null&&re(t).find(i=>i[e]===s[e]):s=>s!=null&&re(t).includes(s),ro=(t,e)=>{if(!e||!t)return t;const s=t.toLowerCase().indexOf(e.toLowerCase());if(s<0)return t;const i=s+e.length;return[t.slice(0,s),v`<mark>${t.slice(s,i)}</mark>`,t.slice(i)]},oo=(t=rt)=>(e,s,{highlight:i,select:n,textual:r=rt,query:o,isSelected:a})=>{const l=r(e),c=ro(l,o),u=t(c,e,s);return v`<div
				class="item"
				role="option"
				part="option"
				?aria-selected=${a(e)}
...
`;customElements.define("cosmoz-autocomplete-skeleton-span",B(()=>Z,{styleSheets:[yo]}));const bo=_t`
	:host {
		display: block;
		position: relative;
		min-width: 35px;
...
</style>`;customElements.define("cz-spinner",B(Ho));const Uo=Q(class extends q{constructor(t,e){super(t,e),this.dispatchEvent=(...s)=>{e.host.dispatchEvent.apply(e.host,s)}}update(){return this.dispatchEvent}}),at=(t,e,s)=>Math.max(e,Math.min(s,t)),lt=at,ts=(t,e,s,i)=>s/i<t/e?s/t:i/e,Yo=(t,e,s,i)=>s/i>t/e?s/t:i/e,Ii=(t,e,s,i,n)=>{const r=ts(t,e,s,i),o=r*n,a=t*o,l=e*o,c=a<s?(-s+a)/2:(s-a)/2,u=a<s?(s-a)/2:(-s+a)/2,d=l<i?(-i+l)/2:(i-l)/2,h=l<i?(i-l)/2:(-i+l)/2;return{x:[c,u],y:[d,h]}},Mi="empty",Pt="loading",Di="loaded",ss="error",Ve="idle",Ct="panning",Le="pinching",Xo=1.1,Ko=t=>Xo/t,Jo=t=>2*t,is=(t,e,s,i)=>{const n=ts(t,e,s,i),r=Yo(t*n,e*n,s,i);return Math.max(Ko(n),Jo(r))},Wo={status:Mi,interaction:Ve,iw:100,ih:100,cw:100,ch:100,zoom:1,panX:0,panY:0,pointers:{}},Fi=(t,e)=>{const s={...t};return delete s[e],s},js=t=>{const e=Object.keys(t);if(e.length<2)return null;const s=t[e[0]],i=t[e[1]];return{midX:(s.x+i.x)/2,midY:(s.y+i.y)/2,distance:Math.hypot(i.x-s.x,i.y-s.y)}},Ne=t=>{const e=Ii(t.iw,t.ih,t.cw,t.ch,t.zoom);return{...t,panX:lt(t.panX,e.x[0],e.x[1]),panY:lt(t.panY,e.y[0],e.y[1])}},Ut=(t,e,s,i=2)=>t<e?e-(e-t)/i:t>s?s+(t-s)/i:t,ji=t=>{const e=Ii(t.iw,t.ih,t.cw,t.ch,t.zoom);return{...t,panX:Ut(t.panX,e.x[0],e.x[1]),panY:Ut(t.panY,e.y[0],e.y[1])}},Vi=(t,{dPanX:e=0,dPanY:s=0,scaleDiff:i=1,originX:n=0,originY:r=0})=>{const o=t.zoom*i;return{...t,zoom:o,panX:e+n+(t.panX-n)*i,panY:s+r+(t.panY-r)*i}},ns=(t,e,s)=>{const i=is(t.iw,t.ih,t.cw,t.ch),n=lt(t.zoom,1,i);if(n===t.zoom)return t;const r=n/t.zoom;return{...t,zoom:n,panX:e+(t.panX-e)*r,panY:s+(t.panY-s)*r}},Go=(t,e)=>e.type==="load"?{...t,status:Pt}:t,Zo=(t,e)=>{switch(e.type){case"loaded":return{...t,status:Di,...e.dimensions,panX:0,panY:0,zoom:1};case"error":return{...t,status:ss};default:return t}},qo=(t,e)=>e.type==="load"?{...t,status:Pt}:t,Qo=(t,e)=>e.type==="pointerdown"?{...t,interaction:Ct,pointers:{...t.pointers,[e.id]:{x:e.x,y:e.y}}}:t,ea=(t,e)=>{switch(e.type){case"pointerdown":{const s={...t.pointers,[e.id]:{x:e.x,y:e.y}};return{...t,interaction:Le,pointers:s}}case"pointermove":{const s=t.pointers[e.id];if(!s)return t;const i=e.x-s.x,n=e.y-s.y;return ji({...t,panX:t.panX+i,panY:t.panY+n,pointers:{...t.pointers,[e.id]:{x:e.x,y:e.y}}})}case"pointerup":{const s=Fi(t.pointers,e.id);if(Object.keys(s).length===0){const i=ns({...t,pointers:s},e.settleOriginX??0,e.settleOriginY??0);return Ne({...i,interaction:Ve})}return{...t,pointers:s}}default:return t}},ta=(t,e)=>{switch(e.type){case"pointermove":{if(!t.pointers[e.id])return t;const i=js(t.pointers),n={...t.pointers,[e.id]:{x:e.x,y:e.y}},r=js(n);if(!i||!r)return{...t,pointers:n};const o=i.distance?r.distance/i.distance:1,a=r.midX-i.midX,l=r.midY-i.midY,c=e.containerOriginX+(r.midX-e.x),u=e.containerOriginY+(r.midY-e.y),d=Vi({...t,pointers:n},{dPanX:a,dPanY:l,scaleDiff:o,originX:c,originY:u}),h=is(t.iw,t.ih,t.cw,t.ch),p=Ut(d.zoom,1,h),f=p/d.zoom,g=c+(d.panX-c)*f,m=u+(d.panY-u)*f;return ji({...d,zoom:p,panX:g,panY:m})}case"pointerup":{const s=Fi(t.pointers,e.id);if(Object.keys(s).length<=1){const i=Ne(ns({...t,pointers:s},e.settleOriginX??0,e.settleOriginY??0));return Object.keys(s).length===1?{...i,interaction:Ct}:{...i,interaction:Ve}}return{...t,pointers:s}}default:return t}},sa=(t,e)=>{switch(t.interaction){case Ve:return Qo(t,e);case Ct:return ea(t,e);case Le:return ta(t,e);default:return t}},ia=(t,e)=>{switch(e.type){case"load":return{...t,status:Pt,interaction:Ve,panX:0,panY:0,zoom:1,pointers:{}};case"zoom":{const s=is(t.iw,t.ih,t.cw,t.ch),i=lt(e.zoom,1,s);return Ne({...t,zoom:i})}case"wheel":{const{delta:s,originX:i,originY:n}=e,r=1+s,o=Vi(t,{scaleDiff:r,originX:i,originY:n});return Ne(ns(o,i,n))}case"pointerdown":case"pointermove":case"pointerup":return sa(t,e);default:return t}},na=(t,e)=>{if(e.type==="resize")return Ne({...t,cw:e.rect.width,ch:e.rect.height});switch(t.status){case Mi:return Go(t,e);case Pt:return Zo(t,e);case Di:return ia(t,e);case ss:return qo(t,e);default:return t}},ra=(t,e)=>{"ResizeObserver"in window&&z(()=>{if(e==null)return;const s=new ResizeObserver(([{contentRect:i}])=>t(i));return s.observe(e),t(e.getBoundingClientRect()),()=>s.unobserve(e)},[t,e])},Nt=(t,e=.08,s=.001)=>{const[i,n]=ee(null);return z(()=>{if(i==null){n(t);return}if(e>=1){n(t);return}const r=i;window.requestAnimationFrame(()=>{const o=t-r;n(Math.abs(o)<s?t:i+o*e)})},[i,n,t,e,s]),i},oa=(t,e,s,i)=>{const{iw:n=100,ih:r=100,cw:o=100,ch:a=100}=t,l=ts(n,r,o,a),c=l*e;return{position:"absolute",top:"50%",left:"50%",transform:["translate(-50%, -50%)",`translate(${s}px, ${i}px)`,`scale(${c})`].join(" ")}},It=(t,e,s)=>{const i=s.current?.getBoundingClientRect();return i?{originX:t-i.left-i.width/2,originY:e-i.top-i.height/2}:{originX:0,originY:0}},aa=(t=.08)=>{const[e,s]=pi(na,Wo),i=te(),n=x(()=>s({type:"load"}),[s]),r=x(b=>s({type:"loaded",dimensions:b}),[s]),o=x(()=>s({type:"error"}),[s]),a=x(b=>s({type:"zoom",zoom:b}),[s]),l=x(b=>b&&s({type:"resize",rect:b}),[s]),c=x(()=>l(i.current&&i.current.getBoundingClientRect()),[l]);ra(l,i.current);const u=x(b=>r({iw:b.target.naturalWidth,ih:b.target.naturalHeight}),[r]),d=x(b=>{i.current?.setPointerCapture(b.pointerId),s({type:"pointerdown",id:b.pointerId,x:b.clientX,y:b.clientY})},[s]),h=x(b=>{const{originX:E,originY:T}=It(b.clientX,b.clientY,i);s({type:"pointermove",id:b.pointerId,x:b.clientX,y:b.clientY,containerOriginX:E,containerOriginY:T})},[s]),p=te({x:0,y:0});z(()=>{if(e.interaction!==Le)return;const b=Object.keys(e.pointers);if(b.length>=2){const E=e.pointers[b[0]],T=e.pointers[b[1]],N=(E.x+T.x)/2,H=(E.y+T.y)/2,{originX:M,originY:ie}=It(N,H,i);p.current={x:M,y:ie}}},[e.pointers,e.interaction]);const f=x(b=>{try{i.current?.releasePointerCapture(b.pointerId)}catch{}s({type:"pointerup",id:b.pointerId,settleOriginX:p.current.x,settleOriginY:p.current.y})},[s]),g=x(b=>{b.preventDefault();const{originX:E,originY:T}=It(b.clientX,b.clientY,i);s({type:"wheel",delta:-Math.sign(b.deltaY)*.8,originX:E,originY:T})},[s]),m=e.interaction===Le,y=e.interaction===Ct||e.interaction===Le;let _=t;m?_=.8:y&&(_=.9);const P=Nt(e.zoom,_),S=Nt(e.panX,_),C=Nt(e.panY,_);return{...e,load:n,loaded:r,error:o,zoomTo:a,resize:c,onPointerDown:d,onPointerMove:h,onPointerUp:f,onImageLoad:u,onWheel:g,containerRef:i,style:oa(e,P,S,C)}},la=({src:t,disabled:e,zoomStiffness:s})=>{const{status:i,zoom:n,load:r,error:o,zoomTo:a,resize:l,onPointerDown:c,onPointerMove:u,onPointerUp:d,onImageLoad:h,onWheel:p,style:f,containerRef:g}=aa(s);if(z(r,[t]),qt({zoomTo:a,resize:l,zoom:n},[a,l,n]),!t)return Z;const m=Uo();return z(()=>m(new CustomEvent("zoom-changed",{detail:{value:n}})),[m,n]),z(()=>m(new CustomEvent("status-changed",{detail:{value:i}})),[m,i]),v`
		<style>
			:host {
				display: block;
			}
...
</html>`),a.close(),pt=t,t.addEventListener("beforeunload",()=>t._onClose?.()),t.addEventListener("beforeunload",()=>pt=null)},ec=async({source:t,fileIndex:e,index:s,syncImageIndex:i,syncFileIndex:n,title:r,loop:o,detachedShowZoom:a,onDetach:l,onClose:c})=>{const u=window.open(void 0,"czimgviewer",ql({height:700,width:800})),d=globalThis["pdfjs-dist/build/pdf"]?.GlobalWorkerOptions?.workerSrc??globalThis.pdfjsLib?.GlobalWorkerOptions?.workerSrc,h={source:t,fileIndex:e,index:s,detachedShowZoom:a,loop:o,title:r,pdfWorkerSrc:d},p={imageIndex:g=>i({detail:{value:g}}),fileIndex:g=>n({detail:{value:g}})};if(an()&&u.__popoutUpdate){u._onClose?.(),u.__popoutUpdate(h),u.__popoutSync=p,u._onClose=c,l();return}const f=await Zl();Ql(u,{entryUrl:f,state:h,sync:p,title:r,onDetach:l,onClose:c})},tc=t=>new Promise(e=>{const s=setInterval(()=>{t()&&(e(),clearInterval(s))},100)}),sc=({images:t})=>{const e=window.open(void 0,"czimgviewerprint");Gt(v`<style>
				img {
					display: block;
...
>
	...
	></path>
					...
					<div class="actions">
						${[A(t.showNav&&a,()=>v`
								...
								`),A(N.length>1,()=>v`<cosmoz-autocomplete
										...
										.value=${M}
										@value=${ie}
									></cosmoz-autocomplete>`),v`<span style="flex:auto"></span>`,A(t.showZoom&&o,()=>v`<button
										class="nav"
										@click=${J=>J.target.getRootNode().querySelector("haunted-pan-zoom").zoomTo(s())}
										title="${Y("Zoom image")}"
									>
										${Ac(e)}
									</button>`),A(t.showDetach&&o,()=>v`<button
										class="nav"
										@click=${y}
									...
									>
										${Tc}
									</button>`),A(t.showFullscreen&&o,()=>v`<button
										class="nav"
										@click="${f}"
										title="${Y("Fullscreen image")}"
									>
										${Cc}
									</button>`),A(t.showClose&&o,()=>v` <button
										class="nav"
				...
				?loop=${t.loop}
			></cosmoz-image-viewer>`))],kc=t=>Rc(xc(t));customElements.define("cosmoz-image-viewer",B(kc,{observedAttributes:["download-file-name","pdf","show-close","show-detach","show-fullscreen","show-nav","show-page-number","show-zoom","detached-show-zoom","loop","title"],styleSheets:[Yl]}));
