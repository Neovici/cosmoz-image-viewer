...
`,w=({showZoom:e,showNav:o,showPageNumber:s})=>t`
    ...
    >
        <div
            slot="overlay-page-0"
            style="color: white; font-size: 14px; pointer-events: auto;"
        >
            <div
                style="position: absolute; top: 10%; left: 10%; background: rgba(0,0,0,0.5); padding: 8px 12px; border-radius: 4px;"
            >
        ...
        >
            <div
                style="position: absolute; bottom: 10%; right: 10%; background: rgba(0,0,0,0.5); padding: 8px 12px; border-radius: 4px;"
            >
