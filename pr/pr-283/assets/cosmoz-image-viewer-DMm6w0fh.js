const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./jspdf.es-CKFOE4aL.js","./preload-helper-PPVm8Dsz.js","./popout-entry-C-5_s-zE.js","./iframe-CaUfsFFH.js","./iframe-Bv8SCm1X.css","./pdf-loader-B_xPwwqY.js"])))=>i.map(i=>d[i]);
import{r as hs,D as tn,A as Z,b as v,E as X,p as ps,n as mi,M as _i,u as re,v as ve,h as We,j as yi}from"./iframe-CaUfsFFH.js";import{_ as gt}from"./preload-helper-PPVm8Dsz.js";let Qe,fs=0;function mn(t){Qe=t}function _n(){Qe=null,fs=0}function bi(){return fs++}const Nt=Symbol("haunted.phase"),Ge=Symbol("haunted.hook"),yn=Symbol("haunted.update"),bn=Symbol("haunted.commit"),ae=Symbol("haunted.effects"),Oe=Symbol("haunted.layoutEffects"),Yt="haunted.context";class vi{update;host;virtual;[Ge];[ae];[Oe];constructor(e,n){this.update=e,this.host=n,this[Ge]=new Map,this[ae]=[],this[Oe]=[]}run(e){mn(this);let n=e();return _n(),n}_runEffects(e){let n=this[e];mn(this);for(let s of n)s.call(this);_n()}runEffects(){this._runEffects(ae)}runLayoutEffects(){this._runEffects(Oe)}teardown(){this[Ge].forEach(n=>{typeof n.teardown=="function"&&n.teardown(!0)})}}const wi=Promise.resolve().then.bind(Promise.resolve());function gs(){let t=[],e;function n(){e=null;let s=t;t=[];for(var i=0,r=s.length;i<r;i++)s[i]()}return function(s){t.push(s),e==null&&(e=wi(n))}}const xi=gs(),vn=gs();class Si{renderer;host;state;[Nt];_updateQueued;_active;constructor(e,n){this.renderer=e,this.host=n,this.state=new vi(this.update.bind(this),n),this[Nt]=null,this._updateQueued=!1,this._active=!1}update(){this._active&&(this._updateQueued||(xi(()=>{let e=this.handlePhase(yn);vn(()=>{this.handlePhase(bn,e),vn(()=>{this.handlePhase(ae)})}),this._updateQueued=!1}),this._updateQueued=!0))}handlePhase(e,n){switch(this[Nt]=e,e){case bn:this.commit(n),this.runEffects(Oe);return;case yn:return this.render();case ae:return this.runEffects(ae)}}render(){return this.state.run(()=>this.renderer.call(this.host,this.host))}runEffects(e){this.state._runEffects(e)}teardown(){this.state.teardown()}pause(){this._active=!1}resume(){this._active=!0}}const mt=(...t)=>{const e=new CSSStyleSheet;return e.replaceSync(t.join("")),e},Pi=t=>t?.map(e=>typeof e=="string"?mt(e):e),Ci=(t,...e)=>t.flatMap((n,s)=>[n,e[s]||""]).join(""),ue=Ci,Ei=(t="")=>t.replace(/-+([a-z])?/g,(e,n)=>n?n.toUpperCase():"");function Oi(t){class e extends Si{frag;renderResult;constructor(i,r,o){super(i,o||r),this.frag=r}commit(i){this.renderResult=t(i,this.frag)}}function n(s,i,r){const o=(r||i||{}).baseElement||HTMLElement,{observedAttributes:a=[],useShadowDOM:l=!0,shadowRootInit:c={},styleSheets:u}=r||i||{},d=Pi(s.styleSheets||u);class h extends o{_scheduler;static get observedAttributes(){return s.observedAttributes||a||[]}constructor(){if(super(),l===!1)this._scheduler=new e(s,this);else{const m=this.attachShadow({mode:"open",...c});d&&(m.adoptedStyleSheets=d),this._scheduler=new e(s,m,this)}}connectedCallback(){this._scheduler.resume(),this._scheduler.update(),this._scheduler.renderResult?.setConnected(!0)}disconnectedCallback(){this._scheduler.pause(),this._scheduler.teardown(),this._scheduler.renderResult?.setConnected(!1)}attributeChangedCallback(m,y,_){if(y===_)return;let P=_===""?!0:_;Reflect.set(this,Ei(m),P)}}function p(g){let m=g,y=!1;return Object.freeze({enumerable:!0,configurable:!0,get(){return m},set(_){y&&m===_||(y=!0,m=_,this._scheduler&&this._scheduler.update())}})}const f=new Proxy(o.prototype,{getPrototypeOf(g){return g},set(g,m,y,_){let P;return m in g?(P=Object.getOwnPropertyDescriptor(g,m),P&&P.set?(P.set.call(_,y),!0):(Reflect.set(g,m,y,_),!0)):(typeof m=="symbol"||m[0]==="_"?P={enumerable:!0,configurable:!0,writable:!0,value:y}:P=p(y),Object.defineProperty(_,m,P),P.set&&P.set.call(_,y),!0)}});return Object.setPrototypeOf(h.prototype,f),h}return n}class ee{id;state;constructor(e,n){this.id=e,this.state=n}}function $i(t,...e){let n=bi(),s=Qe[Ge],i=s.get(n);return i||(i=new t(n,Qe,...e),s.set(n,i)),i.update(...e)}function te(t){return $i.bind(null,t)}function ms(t){return te(class extends ee{callback;lastValues;values;_teardown;constructor(e,n,s,i){super(e,n),t(n,this)}update(e,n){this.callback=e,this.values=n}call(){const e=!this.values||this.hasChanged();this.lastValues=this.values,e&&this.run()}run(){this.teardown(),this._teardown=this.callback.call(this.state)}teardown(e){typeof this._teardown=="function"&&(this._teardown(),this._teardown=void 0),e&&(this.lastValues=this.values=void 0)}hasChanged(){return!this.lastValues||this.values.some((e,n)=>this.lastValues[n]!==e)}})}function _s(t,e){t[ae].push(e)}const $=ms(_s),zi=t=>t instanceof Element?t:t.startNode||t.endNode||t.parentNode,ys=te(class extends ee{Context;value;_ranEffect;_unsubscribe;constructor(t,e,n){super(t,e),this._updater=this._updater.bind(this),this._ranEffect=!1,this._unsubscribe=null,_s(e,this)}update(t){return this.Context!==t&&(this._subscribe(t),this.Context=t),this.value}call(){this._ranEffect||(this._ranEffect=!0,this._unsubscribe&&this._unsubscribe(),this._subscribe(this.Context),this.state.update())}_updater(t){this.value=t,this.state.update()}_subscribe(t){const e={Context:t,callback:this._updater};zi(this.state.host).dispatchEvent(new CustomEvent(Yt,{detail:e,bubbles:!0,cancelable:!0,composed:!0}));const{unsubscribe:s=null,value:i}=e;this.value=s?i:t.defaultValue,this._unsubscribe=s}teardown(){this._unsubscribe&&this._unsubscribe()}});function Ti(t){return e=>{const n={Provider:class extends HTMLElement{listeners;_value;constructor(){super(),this.style.display="contents",this.listeners=new Set,this.addEventListener(Yt,this)}disconnectedCallback(){this.removeEventListener(Yt,this)}handleEvent(s){const{detail:i}=s;i.Context===n&&(i.value=this.value,i.unsubscribe=this.unsubscribe.bind(this,i.callback),this.listeners.add(i.callback),s.stopPropagation())}unsubscribe(s){this.listeners.delete(s)}set value(s){this._value=s;for(let i of this.listeners)i(s)}get value(){return this._value}},Consumer:t(function({render:s}){const i=ys(n);return s(i)},{useShadowDOM:!1}),defaultValue:e};return n}}const N=te(class extends ee{value;values;constructor(t,e,n,s){super(t,e),this.value=n(),this.values=s}update(t,e){return this.hasChanged(e)&&(this.values=e,this.value=t()),this.value}hasChanged(t=[]){return t.some((e,n)=>this.values[n]!==e)}}),x=(t,e)=>N(()=>t,e);function Li(t,e){t[Oe].push(e)}const et=ms(Li),ne=te(class extends ee{args;constructor(t,e,n){super(t,e),this.updater=this.updater.bind(this),typeof n=="function"&&(n=n()),this.makeArgs(n)}update(){return this.args}updater(t){const[e]=this.args;typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&(this.makeArgs(t),this.state.update())}makeArgs(t){this.args=Object.freeze([t,this.updater])}}),bs=te(class extends ee{reducer;currentState;constructor(t,e,n,s,i){super(t,e),this.dispatch=this.dispatch.bind(this),this.currentState=i!==void 0?i(s):s}update(t){return this.reducer=t,[this.currentState,this.dispatch]}dispatch(t){this.currentState=this.reducer(this.currentState,t),this.state.update()}}),Ai=/([A-Z])/gu,Fe=te(class extends ee{property;eventName;constructor(t,e,n,s){if(super(t,e),this.state.virtual)throw new Error("Can't be used with virtual components.");this.updater=this.updater.bind(this),this.property=n,this.eventName=n.replace(Ai,"-$1").toLowerCase()+"-changed",this.state.host[this.property]==null&&(typeof s=="function"&&(s=s()),s!=null&&this.updateProp(s))}update(t,e){return[this.state.host[this.property],this.updater]}updater(t){const e=this.state.host[this.property];typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&this.updateProp(t)}updateProp(t){this.notify(t).defaultPrevented||(this.state.host[this.property]=t)}notify(t){const e=new CustomEvent(this.eventName,{detail:{value:t,path:this.property},cancelable:!0});return this.state.host.dispatchEvent(e),e}}),wn=t=>e=>{e.preventDefault(),t(e.detail.value)};function Ri(t){let e=t;return{get current(){return e},set current(n){e=n},get value(){return e},set value(n){e=n}}}function W(t){return N(()=>Ri(t),[])}te(class extends ee{update(){return this.state.host}});function ki({render:t}){const e=Oi(t),n=Ti(e);return{component:e,createContext:n}}const q={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},se=t=>(...e)=>({_$litDirective$:t,values:e});let ye=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,n,s){this._$Ct=e,this._$AM=n,this._$Ci=s}_$AS(e,n){return this.update(e,n)}update(e,n){return this.render(...n)}};const $e=(t,e)=>{const n=t._$AN;if(n===void 0)return!1;for(const s of n)s._$AO?.(e,!1),$e(s,e);return!0},tt=t=>{let e,n;do{if((e=t._$AM)===void 0)break;n=e._$AN,n.delete(t),t=e}while(n?.size===0)},vs=t=>{for(let e;e=t._$AM;t=e){let n=e._$AN;if(n===void 0)e._$AN=n=new Set;else if(n.has(t))break;n.add(t),Mi(e)}};function Ni(t){this._$AN!==void 0?(tt(this),this._$AM=t,vs(this)):this._$AM=t}function Ii(t,e=!1,n=0){const s=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(e)if(Array.isArray(s))for(let r=n;r<s.length;r++)$e(s[r],!1),tt(s[r]);else s!=null&&($e(s,!1),tt(s));else $e(this,t)}const Mi=t=>{t.type==q.CHILD&&(t._$AP??=Ii,t._$AQ??=Ni)};class _t extends ye{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,n,s){super._$AT(e,n,s),vs(this),this.isConnected=e._$AU}_$AO(e,n=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),n&&($e(this,e),tt(this))}setValue(e){if(hs(this._$Ct))this._$Ct._$AI(e,this);else{const n=[...this._$Ct._$AH];n[this._$Ci]=e,this._$Ct._$AI(n,this,0)}}disconnected(){}reconnected(){}}const{component:K,createContext:Di}=ki({render:tn}),yt=(t,...e)=>t.flatMap((n,s)=>[n,e[s]??""]).join(""),nn=(...t)=>{const e=new CSSStyleSheet;return e.replaceSync(t.join("")),e},It=new WeakMap,be=se(class extends _t{render(t){return Z}update(t,[e]){const n=e!==this.G;return n&&this.G!==void 0&&this.rt(void 0),(n||this.lt!==this.ct)&&(this.G=e,this.ht=t.options?.host,this.rt(this.ct=t.element)),Z}rt(t){if(this.isConnected||(t=void 0),typeof this.G=="function"){const e=this.ht??globalThis;let n=It.get(e);n===void 0&&(n=new WeakMap,It.set(e,n)),n.get(this.G)!==void 0&&this.G.call(this.ht,void 0),n.set(this.G,t),t!==void 0&&this.G.call(this.ht,t)}else this.G.value=t}get lt(){return typeof this.G=="function"?It.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Fi=({host:t,popoverRef:e,disabled:n,openOnHover:s,openOnFocus:i,open:r,close:o})=>{const a=W(),l=()=>clearTimeout(a.current),c=()=>{clearTimeout(a.current),a.current=setTimeout(()=>{const d=e.current;s&&(t.matches(":hover")||d?.matches(":hover"))||t.matches(":focus-within")||d?.matches(":focus-within")||o()},100)},u=()=>{n||(l(),r())};return $(()=>{if(!(!s||n))return t.addEventListener("pointerenter",u),t.addEventListener("pointerleave",c),()=>{l(),t.removeEventListener("pointerenter",u),t.removeEventListener("pointerleave",c)}},[s,n,t]),$(()=>{if(!(!i||n))return t.addEventListener("focusin",u),t.addEventListener("focusout",c),()=>{l(),t.removeEventListener("focusin",u),t.removeEventListener("focusout",c)}},[i,n,t]),{scheduleClose:c,cancelClose:l}},ji=t=>{if(t.newState!=="open")return;const s=t.target.querySelector("slot:not([name])")?.assignedElements({flatten:!0})??[];for(const i of s){const r=i.matches("[autofocus]")?i:i.querySelector("[autofocus]");if(r instanceof HTMLElement){r.focus();break}}},Vi=ue`
	:host {
...
`,Bi=t=>{const{placement:e="bottom span-right",disabled:n,openOnHover:s,openOnFocus:i}=t,r=W(),[o,a]=Fe("opened",!1),l=x(()=>{n||(a(!0),r.current?.showPopover())},[n]),c=x(()=>{a(!1),r.current?.hidePopover()},[]),u=x(()=>{if(n)return;r.current?.matches(":popover-open")?c():l()},[n]);$(()=>{const g=r.current;g&&(o?g.showPopover():g.hidePopover())},[o]),$(()=>{t.toggleAttribute("opened",!!o)},[o]);const{scheduleClose:d,cancelClose:h}=Fi({host:t,popoverRef:r,disabled:n,openOnHover:s,openOnFocus:i,open:l,close:c}),p=i?l:u,f=x(g=>{ji(g),a(g.newState==="open"),t.dispatchEvent(new ToggleEvent("dropdown-toggle",{newState:g.newState,oldState:g.oldState,composed:!0}))},[]);return v`
	...
	`};customElements.define("cosmoz-dropdown-next",K(Bi,{styleSheets:[Vi],observedAttributes:["placement","disabled","open-on-hover","open-on-focus"],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const J=t=>t??Z;const bt=se(class extends ye{constructor(t){if(super(t),t.type!==q.PROPERTY&&t.type!==q.ATTRIBUTE&&t.type!==q.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!hs(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===X||e===Z)return e;const n=t.element,s=t.name;if(t.type===q.PROPERTY){if(e===n[s])return X}else if(t.type===q.BOOLEAN_ATTRIBUTE){if(!!e===n.hasAttribute(s))return X}else if(t.type===q.ATTRIBUTE&&n.getAttribute(s)===e+"")return X;return ps(t),e}});function A(t,e,n){return t?e(t):n?.(t)}const ws=(t,{label:e,invalid:n,errorMessage:s})=>v`
...
`,Hi=t=>N(()=>{if(t==null)return;const e=new RegExp(t,"u");return n=>{!n.defaultPrevented&&n.data&&!e.test(n.data)&&n.preventDefault()}},[t]),sn=te(class extends ee{values;constructor(t,e,n,s){super(t,e),Object.assign(e.host,n),this.values=s}update(t,e){this.hasChanged(e)&&(this.values=e,Object.assign(this.state.host,t))}hasChanged(t=[]){return t.some((e,n)=>this.values[n]!==e)}}),je=te(class extends ee{update(){return this.state.host}}),Ui=/([A-Z])/gu,Xt=(t,e,n)=>{t[e]=n,t.dispatchEvent(new CustomEvent(e.replace(Ui,"-$1").toLowerCase()+"-changed",{detail:{value:n}}))},Yi=(t,e,n=[e])=>{const s=je();$(()=>{Xt(s,t,e)},n)},Ps=t=>{const e=W(void 0),n=x(l=>e.current=l,[]),s=t.shadowRoot,i=x(l=>t.dispatchEvent(new Event(l.type,{bubbles:l.bubbles})),[]),r=x(l=>Xt(t,"value",l.target.value),[]),o=x(l=>Xt(t,"focused",l.type==="focus"),[]),a=x(()=>{const l=e.current?.checkValidity();return t.toggleAttribute("invalid",!l),l},[]);return sn({validate:a},[a]),$(()=>{const l=c=>{c.composedPath()[0]?.closest?.("input, textarea")||(c.preventDefault(),e.current?.focus())};return s.addEventListener("mousedown",l),()=>s.removeEventListener("mousedown",l)},[]),{onChange:i,onFocus:o,onInput:r,onRef:n}},Xi=({placeholder:t,noLabelFloat:e,label:n})=>(e?n:void 0)||t||" ",Ki=["type","pattern","allowed-pattern","min","max","step","autosize","label","placeholder",...xs],Ji=t=>{const{type:e="text",pattern:n,allowedPattern:s,autocomplete:i,value:r,readonly:o,disabled:a,min:l,max:c,step:u,maxlength:d}=t,{onChange:h,onFocus:p,onInput:f,onRef:g}=Ps(t),m=Hi(s);return ws(v`
		...
		`,t)};customElements.define("cosmoz-input",K(Ji,{observedAttributes:Ki,styleSheets:[mt(Ss)],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const Sn=t=>{t.style.height="",t.style.height=`${t.scrollHeight}px`},Wi=(t,e=0)=>{if(e>0){const n=t.getAttribute("rows")??"",s=t.style.height;t.style.height="",t.setAttribute("rows",e),t.style.maxHeight=t.getBoundingClientRect().height+"px",t.style.height=s,t.setAttribute("rows",n)}},Gi=t=>{const{value:e,maxRows:n}=t,s=N(()=>()=>t.shadowRoot.querySelector("#input"),[]);$(()=>Wi(s(),n),[n,s]),$(()=>Sn(s()),[s,e]),$(()=>{const i=s(),r=new ResizeObserver(()=>requestAnimationFrame(()=>Sn(i)));return r.observe(i),()=>r.unobserve(i)},[s])},Zi=["rows","placeholder",...xs],qi=t=>{const{autocomplete:e,value:n,placeholder:s,readonly:i,disabled:r,rows:o,cols:a,maxlength:l}=t,{onChange:c,onFocus:u,onInput:d,onRef:h}=Ps(t);return Gi(t),ws(v`
			<textarea id="input" part="input"
				...
				.value=${bt(n??"")} maxlength=${J(l)} @input=${d}
				@change=${c} @focus=${u} @blur=${u}>`,t)};customElements.define("cosmoz-textarea",K(qi,{observedAttributes:Zi,styleSheets:[mt(Ss)],shadowRootInit:{mode:"open",delegatesFocus:!0}}));const Qi=t=>{const{label:e,value:n,disabled:s,error:i}=t,r=x(o=>t.dispatchEvent(new CustomEvent("change",{detail:o.target.checked})),[]);return v`<input
			id="toggle"
			class="toggle"
			part="toggle"
			type="checkbox"
		...
		<slot name="suffix"></slot>
		${A(i,o=>v`<div class="failure">${o}</div>`)} `},er=ue`
	.toggle {
		appearance: none;
		width: 35px;
		height: 18px;
...
`,Gr=({index:t,itemHeight:e,auto:n})=>ue`
	${A(!n,()=>ue`
			.item {
				line-height: ${e}px;
				height: ${e}px;
...
`,Zr=t=>{const e=t==="auto",[n,s]=ne(e?40:t);return[n,i=>e?s(i):void 0]},zs=Di(()=>$s);customElements.define("cosmoz-keybinding-provider",zs.Provider);const rn=t=>{const e=N(()=>({}),[]);return N(()=>Object.assign(e,t),[e,...Object.values(t)])},Te=(t,e)=>{const n=ys(zs),s=rn(t);$(()=>n(s),e)},qr=Symbol("listbox.navigate.up"),Qr=Symbol("listbox.navigate.down"),eo=Symbol("listbox.select"),to=({onUp:t,onDown:e,onEnter:n})=>{const s=je();Te({activity:qr,callback:t,element:()=>s},[]),Te({activity:Qr,callback:e,element:()=>s},[]),Te({activity:eo,callback:n,element:()=>s},[])},no=({items:t,onSelect:e,defaultIndex:n=0})=>{const[s,i]=ne({index:n}),{index:r}=s,{length:o}=t;return $(()=>{i({index:s.index<0?n:Math.min(s.index,t.length-1),scroll:!0})},[t,n]),to({onUp:x(()=>i(a=>({index:a.index>0?a.index-1:o-1,scroll:!0})),[o]),onDown:x(()=>i(a=>({index:a.index<o-1?a.index+1:0,scroll:!0})),[o]),onEnter:x(()=>r>-1&&r<o&&e?.(t[r],r),[r,t,e])}),{position:s,highlight:x(a=>i({index:a}),[]),select:x(a=>e?.(a),[e])}},so=t=>typeof t=="object"&&t!==null&&Symbol.iterator in t;function oe(t){return t==null?[]:Array.isArray(t)?t:typeof t=="string"?[t]:so(t)?Array.from(t):[t]}const Ft=(t,e=ot)=>n=>{const s=oe(t).map(e);return oe(n).filter(i=>!s.includes(e(i)))},io=(t,e)=>e?n=>n!=null&&oe(t).find(s=>s[e]===n[e]):n=>n!=null&&oe(t).includes(n),ro=(t,e)=>{if(!e||!t)return t;const n=t.toLowerCase().indexOf(e.toLowerCase());if(n<0)return t;const s=n+e.length;return[t.slice(0,n),v`<mark>${t.slice(n,s)}</mark>`,t.slice(s)]},oo=(t=ot)=>(e,n,{highlight:s,select:i,textual:r=ot,query:o,isSelected:a})=>{const l=r(e),c=ro(l,o),u=t(c,e,n);return v`<div
				class="item"
				role="option"
				part="option"
				?aria-selected=${a(e)}
		...
		<slot></slot>`};customElements.define("cosmoz-listbox",K(uo,{styleSheets:[nn(Wr)]}));const ho=({multi:t,...e},n)=>v`<cosmoz-listbox
		part="listbox"
		?multi=${t}
		...=${Br(Kr(lo)(e))}
		>${n}</cosmoz-listbox
...
`;customElements.define("cosmoz-autocomplete-chip",K(go,{observedAttributes:["disabled"],styleSheets:[nn(po)]}));const mo=({content:t,onClear:e,disabled:n,hidden:s,className:i="chip",slot:r})=>v`<cosmoz-autocomplete-chip
		class=${J(i)}
		slot=${J(r)}
		part="chip"
	...
	>`,_o=({value:t,min:e=0,onDeselect:n,textual:s,disabled:i,chipRenderer:r=mo})=>[...t.filter(Boolean).map(o=>r({item:o,content:s(o),onClear:t.length>e&&(()=>n(o)),disabled:i,slot:"control"})),r({item:null,content:v`<span></span>`,className:"badge",disabled:!0,slot:"control",hidden:!0})],yo=ue`
	:host {
		display: inline-block;
		vertical-align: middle;
...
`;customElements.define("cosmoz-autocomplete-skeleton-span",K(()=>Z,{styleSheets:[yo]}));const bo=yt`
	:host {
		display: block;
		position: relative;
		min-width: 35px;
...
`,on=(t,e=()=>({}))=>{const n={type:t,toString(){return t}};return Object.assign((...i)=>Object.assign(e(...i),n),n)},Bn=t=>t.type||t.toString(),Hn=t=>Array.isArray(t)?t:[t],vo=(t,e)=>{const n=Hn(e),s=(n.every(Array.isArray)?n:[n]).map(([i,r])=>({actions:Hn(i).map(Bn),handle:r}));return(i=t,r)=>{const o=s.find(a=>a.actions.includes(Bn(r)));return o?o.handle(i,r):i}},le={pending:"pending",rejected:"rejected",resolved:"resolved"},Ts={error:void 0,result:void 0,state:le.pending},Ls=on(le.pending),As=on(le.resolved,t=>({result:t})),Rs=on(le.rejected,t=>({error:t})),wo=vo(Ts,[[Ls,()=>({error:void 0,result:void 0,state:le.pending})],[As,(t,{result:e})=>({error:void 0,result:e,state:le.resolved})],[Rs,(t,{error:e})=>({error:e,result:void 0,state:le.rejected})]]),ks=t=>{const[{error:e,result:n,state:s},i]=bs(wo,Ts);return $(()=>{if(!t)return;let r=!1;return i(Ls()),t.then(o=>!r&&i(As(o)),o=>!r&&i(Rs(o))),()=>{r=!0}},[t]),[n,e,s]},xo=Symbol("autocomplete.deselect.last"),So=Symbol("autocomplete.search.when.selected"),Un=t=>t.normalize("NFD").replace(/[\u0300-\u036f]/gu,""),Po=(t,e,n)=>{if(!e)return t;const s=Un(e.toLowerCase()),i=[];for(const r of t){const a=Un(n(r).toLowerCase()).indexOf(s);a<0||i.push({item:r,index:a})}return i.sort((r,o)=>r.index-o.index).map(({item:r})=>r)},Co=t=>t===!1||t==null?[]:t,Eo=(t,e,n)=>t.dispatchEvent(new CustomEvent(e,{detail:n})),Yn=[],Oo=t=>(...e)=>{let n;const s=()=>{n&&cancelAnimationFrame(n)};return s(),n=requestAnimationFrame(()=>{n=void 0,t(...e)}),s},$o=(t,e,n)=>x(s=>{e?.(s),t.dispatchEvent(new CustomEvent(n,{detail:s}))},[e]),zo=({value:t,text:e,onChange:n,onText:s,onSelect:i,limit:r,min:o,source:a,textProperty:l,textual:c,valueProperty:u,keepOpened:d,keepQuery:h,preserveOrder:p,defaultIndex:f,externalSearch:g,disabled:m,lazyOpen:y})=>{const _=r!=null?Number(r):void 0,P=N(()=>(c??Xr)(l),[c,l]),S=je(),[C,L]=Fe("opened",!1),z=!e,R=N(()=>e?.trim(),[e]),b=$o(S,s,"text"),k=x(E=>{n?.(E,()=>L(!1)),Eo(S,"value",E)},[n]),[I,M]=ne([]),j=!!(y&&!R),F=N(()=>j?Promise.resolve([]):Promise.resolve(typeof a=="function"?a({query:R,active:C}):a).then(Co),[a,C,R,j]),D=N(()=>oe(t),[t]);$(()=>F.then(M),[F]),Te({activity:xo,callback:()=>{const E=oe(D);E.length>0&&k(E.slice(0,-1))},check:()=>!m&&z&&S.matches(":focus-within"),element:()=>S},[]),Te({activity:So,callback:E=>{const H=oe(D),B=_===1;H.length>0&&B&&E.key.length===1&&k(H.slice(0,-1))},allowDefault:!0,check:()=>!m&&z&&S.matches(":focus-within"),element:()=>S},[_]),$(()=>{!C&&!h&&b("")},[C,h]),$(()=>{S.toggleAttribute("opened",!!C)},[C]);const V=rn({onText:b,onChange:k,value:D,limit:_,min:o,keepQuery:h,keepOpened:d,setOpened:L,onSelect:i,valueProperty:u}),[,,pe]=ks(F);return{limit:_,opened:C,query:R,textual:P,value:D,source$:F,loading:pe==="pending",items:N(()=>{if(!C||j)return Yn;const E=p?I:[...D,...Ft(D,Ze(u))(I)];return g?E:Po(E,R,P)},[I,C,R,P,z,D,p,u,g,j]),onToggle:x(E=>{m||L(E.newState==="open")},[m]),onText:x(E=>{m||(b(E.target.value),L(!0))},[m,b,e,L]),onSelect:x(E=>{if(m)return;V.onSelect?.(E,V);const{onChange:H,onText:B,limit:ie,min:Tt,value:Be,keepQuery:Lt,keepOpened:At,setOpened:Rt,valueProperty:fi}=V;Lt||B(""),At||Rt(!1);const He=oe(Be),kt=Ze(fi),gn=He.some(gi=>kt(gi)===kt(E));gn&&He.length===Tt||H((gn?Ft(E,kt)(He):[...He,E]).slice(-ie))},[m,V]),onDeselect:x(E=>{m||V.onChange(Ft(E,Ze(V.valueProperty))(V.value))},[m,V]),defaultIndex:R!==void 0&&R?.length>0?0:f}},To=t=>{const e=t.shadowRoot.querySelectorAll(".chip"),n=t.shadowRoot.querySelector(".badge");n.hidden=!0;for(const a of e)a.hidden=!1;const i=t.shadowRoot.querySelector("cosmoz-input").shadowRoot?.querySelector(".control")?.getBoundingClientRect();let r;for(r=0;r<e.length;r++){const l=e[r].getBoundingClientRect();if(!(l.x+l.width<=i.x+i.width-24))break}const o=e.length-r;for(n.querySelector("span").textContent="+"+o.toString(),n.hidden=o<1;r<e.length;r++)e[r].hidden=!0},Lo=({value:t,opened:e,wrap:n,limit:s})=>{const i=je(),r=!(n||s===1),o=N(()=>Oo(()=>To(i)),[]),[a,l]=ne(0);et(()=>{if(!r)return;const c=i.shadowRoot.querySelector("cosmoz-input"),u=new ResizeObserver(d=>{l(d[0].contentRect.width)});return u.observe(c),()=>u.disconnect()},[r]),et(()=>r?o():void 0,[r,a,e,t])},Ao=["input","control","label","line","error","wrap"].map(t=>`${t}: input-${t}`).join(),Ro=({opened:t,isSingle:e,showSingle:n,hasResultsOrQuery:s})=>!t||e&&!n?!1:s,ko=t=>{const{opened:e,invalid:n,errorMessage:s,label:i,placeholder:r,disabled:o,noLabelFloat:a,alwaysFloatLabel:l,textual:c,text:u,onText:d,onToggle:h,onDeselect:p,value:f,limit:g,min:m,showSingle:y,items:_,source$:P,loading:S,chipRenderer:C}=t,L=g===1,z=L&&f?.[0]!=null,R=S||_.length>0||u!=null&&u.length>0;return v`<cosmoz-dropdown-next
			open-on-focus
			?disabled=${o}
			.opened=${e}
			@dropdown-toggle=${h}
		...
		>
			<cosmoz-input
				...
				.errorMessage=${_e([P,s],()=>ke(P.then(()=>s,b=>b.message),s))}
				.value=${bt(u)}
				@value-changed=${d}
				autocomplete="off"
				exportparts=${Ao}
	...
	`};class ca extends HTMLElement{resize(){}zoomTo(){}}customElements.define("haunted-pan-zoom",K(la,{observedAttributes:["src","disabled","zoom-stiffness"],baseElement:ca}));const ua=mt`:host {
    display: flex;
...
<body>
	<script type="module" src="${e}"><\/script>
			...
			${t.map(n=>v`<img src="${ke(Promise.resolve(Pt(n)))}" />`)}`,e.document.body),Zl(()=>Array.from(e.document.querySelectorAll("img")).every(n=>n.src&&n.complete)).then(()=>e.print()).then(()=>e.close())},Ql=({files:t,safeFileIndex:e,imageIndex:n,title:s,loop:i,detachedShowZoom:r,setImageIndex:o,setFileIndex:a})=>{const[l,c]=ne(!1),u=x(p=>o(p.detail.value),[o]),d=x(p=>a(p.detail.value),[a]),h=x(()=>Gl({source:t,fileIndex:e,index:n,syncImageIndex:u,syncFileIndex:d,title:s,loop:i,detachedShowZoom:r,onDetach:()=>c(!0),onClose:()=>c(!1)}),[t,e,n,s,i,r]);return{detached:l,detach:h,syncDetachedState:p=>c(p.detail.value)}},cs=[],ec=({source:t,images:e,pdf:n,pdfOptions:s})=>t??(e!=null||n!=null?[{images:e??cs,pdf:n,pdfOptions:s}]:cs),tc=[],nc=t=>{const e=N(()=>Promise.resolve(Pt(t)),[t]),[n,s,i]=ks(e);return{files:n??tc,loading:i==="pending",error:s}},sc=[],ic=t=>{const e=N(()=>ec({source:t.source,images:t.images,pdf:t.pdf,pdfOptions:t.pdfOptions}),[t.source,t.images,t.pdf,t.pdfOptions]),{files:n,loading:s,error:i}=nc(e),[r,o]=Fe("currentFileIndex",0),a=n.length>0?lt(r??0,0,n.length-1):0,l=n[a],c=l?[l]:sc,u=W(at),d=x(h=>{const p=h.detail?.[0],f=n.indexOf(p);f>=0&&(u.current=at,o(f))},[n]);return $(()=>{const h=r??0;n.length>0&&h>=n.length&&o(0)},[n]),{files:n,loading:s,error:i,fileIndex:r,setFileIndex:o,safeFileIndex:a,selectedFile:l,value:c,onSelect:d,directionRef:u}},rc=()=>{const[t,e]=ne(!1);return{isFullscreen:t,openFullscreen:()=>e(!0),closeFullscreen:()=>e(!1)}},us=(t,e,n,s)=>{const i=t.length;let r=1;for(;r<=i;){const o=(e+r*n+i)%i;if(!s&&(n>0&&o<=e||n<0&&o>=e))return null;const a=t[o];if(a.images?.length||a.pdf)return o;r++}return null},Pe=[],oc=t=>{const[e,n]=ne({images:Pe,loading:!1,error:void 0});return $(()=>{if(!t){n({images:Pe,loading:!1,error:void 0});return}const s=t.pdf,i=t.images??Pe;if(!s){n({images:i,loading:!1,error:void 0});return}n({images:Pe,loading:!0,error:void 0});let r=!1;return gt(async()=>{const{loadPdfThunks:o}=await import("./pdf-loader-B_xPwwqY.js");return{loadPdfThunks:o}},__vite__mapDeps([5,1]),import.meta.url).then(({loadPdfThunks:o})=>o(s,t.pdfOptions)).then(o=>{r||n({images:o,loading:!1,error:void 0})}).catch(o=>{r||n({images:Pe,loading:!1,error:o})}),()=>{r=!0}},[t]),e},ac=({files:t,safeFileIndex:e,loop:n,setFileIndex:s,directionRef:i})=>{const[r,o]=Fe("currentImageIndex",0),a=t[e],{images:l,loading:c,error:u}=oc(a),d=l.length>0?lt(r??0,0,l.length-1):0,h=l[d],p=!n&&e===0&&d<=0,f=!n&&e===t.length-1&&d>=l.length-1,g=W(!1),m=x(()=>{if(i.current=at,d<l.length-1)return o(d+1);const _=us(t,e,1,n);_!=null&&(s(_),o(0))},[d,l.length,t,e,n]),y=x(()=>{if(i.current=Bo,d>0)return o(d-1);const _=us(t,e,-1,n);_!=null&&(g.current=!0,s(_))},[d,t,e,n]);return $(()=>{if(l.length===0)return;if(g.current){g.current=!1,o(l.length-1);return}const _=r??0;_>=l.length&&o(lt(_,0,l.length-1))},[l]),{imageIndex:r,setImageIndex:o,nextImage:m,previousImage:y,first:p,last:f,index:d,image:h,images:l,contentLoading:c,contentError:u,downloadFileName:a?.downloadFileName??"archive"}},lc=Symbol("memo"),cc=t=>{let e=lc,n;return function(s){if(e===s)return n;const i=t(s);return n=i,e=s,i}},pi=t=>{if(!t.currentTarget.parentElement)return;t.currentTarget.parentElement.querySelector(".error").removeAttribute("hidden"),t.currentTarget.setAttribute("hidden",!0)},uc=t=>t.detail.value==="error"&&pi(t),dc=({src$:t,showZoom:e,isZoomed:n,pageIndex:s})=>{const i=_e(t,()=>ke(t));return[e?v`<haunted-pan-zoom
					.src=${i}
					?disabled=${!n}
					@status-changed=${uc}
				>
					${s!=null?v`<slot name="overlay-page-${s}"></slot>`:Z}
				</haunted-pan-zoom>`:v`<img .src=${i} style="width:100%" @error=${pi} />`,_e(t,()=>ke(t.then(()=>Z),v`<cz-spinner></cz-spinner>`))]},hc=t=>v`<div>
		<div hidden class="error">
			<h2>An error occurred while loading the image.</h2>
			<div class="desc">${t.image}</div>
		</div>
		${dc(t)}
	</div>`,pc=({image:t,showZoom:e,isZoomed:n,directionRef:s,pageIndex:i})=>{const r=N(()=>cc(o=>Promise.resolve(Pt(o))),[]);return N(()=>t==null?{id:Math.random(),content:Z,animation:at}:{id:t,render:()=>hc({src$:r(t),showZoom:e,isZoomed:n,image:t,pageIndex:i}),animation:s.current},[t,e,n,i])},fc=50,gc=300,mc=(t,{onSwipeLeft:e,onSwipeRight:n,enabled:s})=>{const i=W(null);$(()=>{if(!s)return;const r=a=>{if(a.touches.length!==1)return;const l=a.touches[0];i.current={x:l.clientX,y:l.clientY,t:Date.now()}},o=a=>{if(!i.current)return;const l=a.changedTouches[0],c=l.clientX-i.current.x,u=l.clientY-i.current.y,d=Date.now()-i.current.t;i.current=null,!(d>gc)&&(Math.abs(c)<fc||Math.abs(c)<Math.abs(u)||(c<0?e?.():n?.()))};return t.addEventListener("touchstart",r,{passive:!0}),t.addEventListener("touchend",o,{passive:!0}),()=>{t.removeEventListener("touchstart",r),t.removeEventListener("touchend",o)}},[t,e,n,s])},_c=()=>{const[t,e]=ne(!1),n=x(()=>(e(s=>!s),t?1:1.5),[t]);return{isZoomed:t,toggleZoom:n}},yc=t=>{const{showZoom:e,showPageNumber:n,showNav:s,showDetach:i,showFullscreen:r,showClose:o,title:a,loop:l,detachedShowZoom:c}=t,{files:u,loading:d,error:h,setFileIndex:p,safeFileIndex:f,selectedFile:g,value:m,onSelect:y,directionRef:_}=ic(t),{setImageIndex:P,nextImage:S,previousImage:C,first:L,last:z,index:R,image:b,images:k,contentLoading:I,contentError:M,downloadFileName:j}=ac({files:u,safeFileIndex:f,loop:l,setFileIndex:p,directionRef:_}),{isZoomed:F,toggleZoom:D}=_c();mc(t,{enabled:!F,onSwipeLeft:S,onSwipeRight:C});const V=pc({image:b,showZoom:e,isZoomed:F,directionRef:_,pageIndex:R}),{isFullscreen:pe,openFullscreen:E,closeFullscreen:H}=rc(),{detached:B,detach:ie,syncDetachedState:Tt}=Ql({files:u,safeFileIndex:f,imageIndex:R,title:a,loop:l,detachedShowZoom:c,setImageIndex:P,setFileIndex:p}),Be=x(()=>{hi()&&ie()},[ie]);Yi("detached",B,[B]),$(()=>{t.toggleAttribute("hidden",B)},[B]),sn({syncState:Be},[Be]);const Lt=u.length>1||k.length>=2,At=N(()=>g?.pdf?()=>fa(g.pdf,j,g.pdfOptions):()=>pa(k,j),[g,j,k]),Rt=x(()=>ql({images:k}),[k]);return{host:t,isZoomed:F,toggleZoom:D,currentSlide:V,nextImage:S,previousImage:C,first:L,last:z,total:k.length,hasNav:Lt,currentImageIndex:R,selectedImageNumber:R+1,onDownloadPdf:At,isFullscreen:pe,openFullscreen:E,closeFullscreen:H,onPrintPdf:Rt,detached:B,detach:ie,syncDetachedState:Tt,setFileIndex:p,setImageIndex:P,loading:d||I,error:h,contentError:M,files:u,selectedFile:g,selectedIndex:f,value:m,onSelect:y,images:k,showPageNumber:n,showNav:s,showZoom:e,showDetach:i,showFullscreen:r,showClose:o}},ds=()=>document.createComment(""),bc=tn(Z,new DocumentFragment).constructor;class vc extends HTMLElement{onDisconnect;disconnectedCallback(){this.onDisconnect?.()}}customElements.define("disconnect-observer",vc);class wc extends _t{_op;_outlet;_content;render(e,n=document.body){return v`<disconnect-observer
			.onDisconnect=${()=>{this.isConnected=!1,this.disconnected()}}
		></disconnect-observer>`}update(e,[n,s=document.body]){return this.updateOutlet(s,n),this.render(n,s)}updateOutlet(e,n){this._outlet!==e&&this.clearOutlet(),this._outlet=e;const s=this._op??=new bc(e.appendChild(ds()),e.appendChild(ds()));re(s,this._content=n)}clearOutlet(){const e=this._op;e&&(yi(e),We(e),this._op=void 0)}disconnected(){this.clearOutlet()}reconnected(){this._outlet&&this._content&&this.updateOutlet(this._outlet,this._content)}}const xc=se(wc),Sc=v`<svg
	viewBox="0 0 24 24"
...
>
	...
	></path>
	...
	</div>`,Yc=(t,e)=>A(t,()=>v`<p class="error">${G("Failed to load PDF.")}</p>`,()=>A(!e,()=>v`<p>${G("No image loaded.")}</p>`)),Xc=t=>A(!t.loading&&!t.error,()=>v`
		...
		`),Kc=({files:t,selectedIndex:e,currentImageIndex:n,setFileIndex:s,setImageIndex:i,syncDetachedState:r,closeFullscreen:o,host:a})=>xc(v`<cosmoz-image-viewer
			...
			?loop=${a.loop}
		></cosmoz-image-viewer>`),Jc=t=>[A(!t.detached,()=>[A(t.loading,Rc),A(t.error,()=>kc(t.error)),Xc(t)]),A(t.isFullscreen,()=>Kc(t))],Wc=t=>Jc(yc(t));customElements.define("cosmoz-image-viewer",K(Wc,{observedAttributes:["download-file-name","pdf","show-close","show-detach","show-fullscreen","show-nav","show-page-number","show-zoom","detached-show-zoom","loop","title"],styleSheets:[ua]}));
