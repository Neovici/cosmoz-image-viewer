 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const u=(e,s,t)=>{const r=new Map;for(let l=s;l<=t;l++)r.set(e[l],l);return r},c$1=e$1(class extends i$3{constructor(e){if(super(e),e.type!==t.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,s,t){let r;void 0===t?t=s:void 0!==s&&(r=s);const l=[],o=[];let i=0;for(const s of e)l[i]=r?r(s,i):i,o[i]=t(s,i),i++;return {values:o,keys:l}}render(e,s,t){return this.dt(e,s,t).values}update(s,[t,r,c]){const d=p(s),{values:p$1,keys:a}=this.dt(t,r,c);if(!Array.isArray(d))return this.ut=a,p$1;const h=this.ut??=[],v$1=[];let m,y,x=0,j=d.length-1,k=0,w$1=p$1.length-1;for(;x<=j&&k<=w$1;)if(null===d[x])x++;else if(null===d[j])j--;else if(h[x]===a[k])v$1[k]=v(d[x],p$1[k]),x++,k++;else if(h[j]===a[w$1])v$1[w$1]=v(d[j],p$1[w$1]),j--,w$1--;else if(h[x]===a[w$1])v$1[w$1]=v(d[x],p$1[w$1]),r$1(s,v$1[w$1+1],d[x]),x++,w$1--;else if(h[j]===a[k])v$1[k]=v(d[j],p$1[k]),r$1(s,d[x],d[j]),j--,k++;else if(void 0===m&&(m=u(a,k,w$1),y=u(h,x,j)),m.has(h[x]))if(m.has(h[j])){const e=y.get(a[k]),t=void 0!==e?d[e]:null;if(null===t){const e=r$1(s,d[x]);v(e,p$1[k]),v$1[k]=e;}else v$1[k]=v(t,p$1[k]),r$1(s,d[x],t),d[e]=null;k++;}else h$2(d[j]),j--;else h$2(d[x]),x++;for(;k<=w$1;){const e=r$1(s,v$1[w$1+1]);v(e,p$1[k]),v$1[k++]=e;}for(;x<=j;){const e=d[x++];null!==e&&h$2(e);}return this.ut=a,m$1(s,v$1),w}});

const o$1=new WeakMap,n$3=e$1(class extends f{render(i){return T}update(i,[s]){const e=s!==this.Y;return e&&void 0!==this.Y&&this.rt(void 0),(e||this.lt!==this.ct)&&(this.Y=s,this.ht=i.options?.host,this.rt(this.ct=i.element)),T}rt(t){if(this.isConnected||(t=void 0),"function"==typeof this.Y){const i=this.ht??globalThis;let s=o$1.get(i);void 0===s&&(s=new WeakMap,o$1.set(i,s)),void 0!==s.get(this.Y)&&this.Y.call(this.ht,void 0),s.set(this.Y,t),void 0!==t&&this.Y.call(this.ht,t);}else this.Y.value=t;}get lt(){return "function"==typeof this.Y?o$1.get(this.ht??globalThis)?.get(this.Y):this.Y?.value}disconnected(){this.lt===this.ct&&this.rt(void 0);}reconnected(){this.rt(this.ct);}});

/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const n$2="important",i$2=" !"+n$2,o=e$1(class extends i$3{constructor(t$1){if(super(t$1),t$1.type!==t.ATTRIBUTE||"style"!==t$1.name||t$1.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((e,r)=>{const s=t[r];return null==s?e:e+`${r=r.includes("-")?r:r.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`}),"")}update(e,[r]){const{style:s}=e.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(r)),this.render(r);for(const t of this.ft)null==r[t]&&(this.ft.delete(t),t.includes("-")?s.removeProperty(t):s[t]=null);for(const t in r){const e=r[t];if(null!=e){this.ft.add(t);const r="string"==typeof e&&e.endsWith(i$2);t.includes("-")||r?s.setProperty(t,r?e.slice(0,-11):e,r?n$2:""):s[t]=e;}}return w}});
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const e={},i$1=e$1(class extends i$3{constructor(){super(...arguments),this.ot=e;}render(r,t){return t()}update(t,[s,e]){if(Array.isArray(s)){if(Array.isArray(this.ot)&&this.ot.length===s.length&&s.every(((r,t)=>r===this.ot[t])))return w}else if(this.ot===s)return w;return this.ot=Array.isArray(s)?Array.from(s):s,this.render(s,e)}});
...
const useSlider = (host) => {
    ...
    useLayoutEffect(async () => {
        if (slides.filter((slide) => !slide.out).length < 2) {
            ...
            slide &&
                requestAnimationFrame(() => requestAnimationFrame(() => slide.animationEnd$.resolve()));
            return;
        }
...
const renderSlide = (slide) => x `<div
		${n$3((el) => Object.assign(slide, { el }))}
		class="slide"
		style=${o(styles.slide)}
	>
		${i$1([slide], () => slide.content ?? slide.render?.(slide))}
	</div>`;
const renderSlider = ({ slides }) => i$1([slides], () => c$1(slides, ({ id }) => id, renderSlide));
...
const useSlideList = (items, { initial, render, id = identity, loop }) => {
    const [item, setItem] = useState(() => initial ?? items[0]), index = useMemo(() => items.indexOf(item), [items, item]), prevIndex = useLastValue(index), prev = useCallback(() => setItem(() => loop
        ? items[(index - 1 + items.length) % items.length]
        : items[Math.max(0, Math.min(items.length - 1, index - 1))]), [items, index, loop]), next = useCallback(() => setItem(() => loop
        ? items[(index + 1) % items.length]
        : items[Math.max(0, Math.min(items.length - 1, index + 1))]), [items, index, loop]), goto = useCallback((index) => setItem(() => items[index]), [items]), first = loop ? false : index <= 0, last = loop ? false : index === items.length - 1, animation = 
...
const useDispatchEvent = hook(class extends Hook {
  constructor(id, el) {
    super(id, el);
...
const useSpring = (target, stiffness = 0.08, precision = 1e-3) => {
...
const getBounded = (val, min, max) => Math.max(min, Math.min(max, val)), getFitScale = (iw, ih, cw, ch) => cw / ch < iw / ih ? cw / iw : ch / ih, getCoverScale = (iw, ih, cw, ch) => cw / ch > iw / ih ? cw / iw : ch / ih, center = (arr) => {
  const sum = arr.reduce((acc, i) => [acc[0] + i[0], acc[1] + i[1]], [0, 0]);
  return sum.map((s) => s / arr.length);
}, calculateBounds = (iw, ih, cw, ch, zoom) => {
  const fitScale = getFitScale(iw, ih, cw, ch), scale = fitScale * zoom, siw = iw * scale, sih = ih * scale, minX = siw < cw ? (-cw + siw) / 2 : (cw - siw) / 2, maxX = siw < cw ? (cw - siw) / 2 : (-cw + siw) / 2, minY = sih < ch ? (-ch + sih) / 2 : (ch - sih) / 2, maxY = sih < ch ? (ch - sih) / 2 : (-ch + sih) / 2;
  return {
    x: [minX, maxX],
    y: [minY, maxY]
  };
...
const DRAGGING$1 = "dragging", INIT$2 = "init", initState$3 = {
  status: INIT$2,
  deltaX: 0,
  deltaY: 0,
  lastX: 0,
...
const useMousePan = () => {
  const host = useHost();
  const [state, dispatch] = useReducer(panReducer$1, initState$3), start = useCallback(
    (ev) => {
      ev.stopPropagation();
      dispatch({
        type: "start",
...
const INIT$1 = "init", DRAGGING = "dragging", initState$2 = {
  status: INIT$1,
  deltaX: 0,
  deltaY: 0,
  lastX: 0,
...
const centerFromEvent = (ev) => center(Array.from(ev.touches).map((t) => [t.pageX, t.pageY])), useTouchPan = () => {
  const [state, dispatch] = useReducer(panReducer, initState$2), start = useCallback((ev) => {
  ...
  }, [dispatch]), onTouchMove = useCallback((ev) => {
    const [x, y] = centerFromEvent(ev);
    dispatch({
      type: "drag",
      x,
  ...
  }, [dispatch]), onTouchEnd = useCallback((ev) => {
  ...
  }, [dispatch]), onTouchStart = useCallback((ev) => {
    const [x, y] = centerFromEvent(ev);
    dispatch({
      type: "one-little-finger",
      x,
...
const usePan = (bounds = {
  ...
  const [panX, setPanX] = useState(0), [panY, setPanY] = useState(0), [status, deltaX, deltaY, timestamp, start] = useMousePan(), [touchStatus, touchDeltaX, touchDeltaY, timestamp2, startTouch] = useTouchPan();
  ...
  const panning = status === DRAGGING$1 || touchStatus === DRAGGING;
  useEffect(() => {
    if (panning) {
      return;
    }
...
const INIT = "init", PINCHING = "pinching", initState$1 = {
  status: INIT,
  lastDistance: 0,
  delta: 0
...
const getDistance = (ev1, ev2) => Math.hypot(ev2.pageX - ev1.pageX, ev2.pageY - ev1.pageY), usePinch = () => {
  const [state, dispatch] = useReducer(pinchReducer, initState$1), start = useCallback((ev) => {
  ...
  }, [dispatch]), pinch = useCallback((ev) => {
    dispatch({
      type: "pinch",
      distance: getDistance(...ev.touches)
    });
  }, [dispatch]), stop = useCallback((ev) => {
    if (ev.touches.length > 2) {
      return;
    }
    dispatch({ type: "stop" });
...
const EMPTY = "empty", LOADING = "loading", LOADED = "loaded", ERROR = "error", initState = {
  status: EMPTY,
  iw: 100,
  ih: 100,
  cw: 100,
  ch: 100,
  zoom: 1
}, maxZoomPixelRatio = 1.1, maxZoomLevelByPixelRatio = (fitScale) => maxZoomPixelRatio / fitScale, maxZoomLevelByCoverage = (coverScale) => 2 * coverScale, getBoundedZoom = (zoom, iw, ih, cw, ch) => {
  const fitScale = getFitScale(iw, ih, cw, ch), coverScale = getCoverScale(iw * fitScale, ih * fitScale, cw, ch), maxZoom = Math.max(maxZoomLevelByPixelRatio(fitScale), maxZoomLevelByCoverage(coverScale));
  ...
  switch (action.type) {
    ...
    case "zoomBy":
      return {
        ...state,
        zoom: action.bounded ? getBoundedZoom(
...
const getStyle = (opts, zoom, panX, panY) => {
  const {
    ...
    cw = 100,
    ch = 100
  } = opts, fitScale = getFitScale(iw, ih, cw, ch), scale = fitScale * zoom;
  return {
    position: "absolute",
    top: "50%",
    left: "50%",
  ...
  const [state, dispatch] = useReducer(panZoomReducer, initState), load = useCallback(() => dispatch({ type: "load" }), [dispatch]), loaded = useCallback((dimensions) => dispatch({
    type: "loaded",
    dimensions
  }), [dispatch]), error = useCallback(() => dispatch({ type: "error" }), [dispatch]), zoomBy = useCallback((delta, bounded = true) => dispatch({
    type: "zoomBy",
    delta,
    bounded
  }), [dispatch]), zoomTo = useCallback((zoom) => dispatch({
    type: "zoom",
    zoom
  }), [dispatch]), containerRef = useRef(), onResize = useCallback((rect) => rect && dispatch({
    type: "resize",
    rect
  }), [dispatch]), resize = useCallback(() => onResize(containerRef.current && containerRef.current.getBoundingClientRect()), [onResize, containerRef]);
  ...
  }), [loaded]), onWheel = useCallback((event) => {
    event.preventDefault();
    zoomBy(-Math.sign(event.deltaY) * 0.8);
  }, [zoomBy, state.zoom]), [pinchStatus, pinchDelta, startPinch] = usePinch(), pinching = pinchStatus === PINCHING;
  ...
  const bounds = useMemo(() => calculateBounds(state.iw, state.ih, state.cw, state.ch, state.zoom), [state.iw, state.ih, state.cw, state.ch, state.zoom]), [interacting, panX, panY, startMousePan, startTouchPan] = usePan(bounds), springX = useSpring(panX, interacting ? 0.9 : panStiffness), springY = useSpring(panY, interacting ? 0.9 : panStiffness), springZoom = useSpring(state.zoom, pinching ? 0.8 : zoomStiffness);
  return {
    ...state,
    load,
    loaded,
...
const HauntedPanZoom = ({ src, disabled, panStiffness, zoomStiffness }) => {
  ...
  return x`
		...
		<div
			...
			@wheel=${onWheel}
			${n$3((el) => containerRef.current = el)}
		>
			${!src || status === ERROR ? T : x`
						<img
							src=${src}
							draggable="false"
...
const translationElements = [],
	...
	ngettext = function (singular, plural) {
		...
		const pluralSuffix = instance.services.pluralResolver.getSuffix(instance.language, n);
		if (pluralSuffix) {
	...
	loadTranslations = (lang, namespace, translations) => {
		...
		instance.addResourceBundle(lang, namespace, translations);
	};
	dedupingMixin(baseClass => class extends baseClass {
		/**
...
const fit = (rect, bounds) => {
  const rectRatio = rect.width / rect.height, boundsRatio = bounds.width / bounds.height;
  ...
  const options = { credentials: credentials ? "include" : "omit" }, [{ jsPDF }, ...responses$] = await Promise.all([
    import('./jspdf.es.min-6Ou23TId.js').then(function (n) { return n.j; }),
    ...urls.map(async (_url) => {
  ...
  responses.filter(Boolean).forEach(({ url, data }, i) => {
    const padding = 2, {
      internal: { pageSize }
    } = pdf, { width, height } = fit(pdf.getImageProperties(data), {
  ...
  const url = URL.createObjectURL(blob), a = document.body.appendChild(document.createElement("a"));
  a.href = url;
...
const toFeatures = (obj) => Object.entries(obj).map(([key, value]) => key + "=" + value).join(",");
let hasWindow = false;
const popout = ({
  images,
  index,
  ...
  pout.document.title = title ?? gettext("Cosmoz image viewer");
};
...
const print = ({ images }) => {
  const pout = window.open(void 0, "czimgviewerprint");
  j(
    x`<style>
				img {
					display: block;
			...
			${images.map(
      (src) => x`<img src="${m(Promise.resolve(invoke(src)))}" />`
    )}`,
    pout.document.body
  );
  waitFor(
  ...
  ).then(() => pout.print()).then(() => pout.close());
};
...
const onImageError = (e) => {
...
}, onStatusChanged = (ev) => ev.detail.value === "error" && onImageError(ev), renderImage = ({ src$, showZoom, isZoomed, _onZoomChanged }) => {
  const src = i$1(src$, () => m(src$));
  return [
    showZoom ? x`<haunted-pan-zoom
						class="image-zoom"
						.src=${src}
						?disabled=${!isZoomed}
						@zoom-changed=${_onZoomChanged}
						@status-changed=${onStatusChanged}
				  ></haunted-pan-zoom>` : x`<img
						class="image"
						.src=${src}
						style="width:100%"
						@error=${onImageError}
    ...
    i$1(
      ...
      () => m(
        ...
        x`<cz-spinner></cz-spinner>`
			...
			${renderImage(opts)}
		</div>`, empty = [], useCosmozImageViewer = (host) => {
  const {
    images = empty,
    showZoom,
    title,
    ...
    loop,
    detachedShowZoom
  } = host, [isZoomed, setIsZoomed] = useState(false), _onZoomChanged = (ev) => setIsZoomed(ev.detail.value > 1), _invoke = useMemo(
  ...
  }), [isFullscreen, setIsFullscreen] = useState(false), openFullscreen = () => setIsFullscreen(true), closeFullscreen = () => setIsFullscreen(false), syncImageIndex = (event) => goto(event.detail.value), [detached, setDetached] = useState(false), detach = useCallback(
    () => popout({
      images,
      index,
      title,
    ...
    if (!hasWindow) return;
    detach();
  }, [detach]), syncDetachedState = (ev) => setDetached(ev.detail.value);
...
const renderCosmozImageViewer = ({
  ...
  () => x`<button
								class="nav"
								@click=${detach}
								title="${gettext("Detach image to separate window")}"
							>
								${launch}
							</button>`
)}
  ...
  () => x`<button
								...
								title="${gettext("Fullscreen image")}"
							>
								${fullscreen}
							</button>`
)}
  ...
  () => x` <button
				...
				<div id="imageContainer">
					${n$1(total === 0, () => x`<p>${gettext("No image loaded.")}</p>`)}
  ...
  () => portal(
    x`<cosmoz-image-viewer
		  ...
		  `;
const CosmozImageViewer = (host) => renderCosmozImageViewer(useCosmozImageViewer(host));
customElements.define(
  "cosmoz-image-viewer",
